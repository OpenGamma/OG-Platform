...
/**
 * Trade wrapper for ForwardRateAgreement trades.
 */
@BeanDefinition
public final class ForwardRateAgreementTrade extends TradeWrapper<ForwardRateAgreementSecurity> implements ImmutableBean {
  ...
  private ForwardRateAgreementTrade(ImmutableTradeBundle tradeBundle) {
    super(ForwardRateAgreementSecurity.class, tradeBundle);
    _tradeBundle = tradeBundle;
  }
  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code ForwardRateAgreementTrade}.
   * @return the meta-bean, not null
   */
  public static ForwardRateAgreementTrade.Meta meta() {
    return ForwardRateAgreementTrade.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(ForwardRateAgreementTrade.Meta.INSTANCE);
  }
   ...
   */
  public static ForwardRateAgreementTrade.Builder builder() {
    return new ForwardRateAgreementTrade.Builder();
  }

  @Override
  public ForwardRateAgreementTrade.Meta metaBean() {
    return ForwardRateAgreementTrade.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ForwardRateAgreementTrade other = (ForwardRateAgreementTrade) obj;
  ...
  public String toString() {
    ...
    buf.append("ForwardRateAgreementTrade{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableTradeBundle> _tradeBundle = DirectMetaProperty.ofImmutable(
        this, "tradeBundle", ForwardRateAgreementTrade.class, ImmutableTradeBundle.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public ForwardRateAgreementTrade.Builder builder() {
      return new ForwardRateAgreementTrade.Builder();
    }

    @Override
    public Class<? extends ForwardRateAgreementTrade> beanType() {
      return ForwardRateAgreementTrade.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1481798406:  // tradeBundle
          return ((ForwardRateAgreementTrade) bean).getTradeBundle();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code ForwardRateAgreementTrade}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<ForwardRateAgreementTrade> {
     ...
     */
    private Builder(ForwardRateAgreementTrade beanToCopy) {
    ...
    @Override
    public ForwardRateAgreementTrade build() {
      return new ForwardRateAgreementTrade(
          _tradeBundle);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(64);
      buf.append("ForwardRateAgreementTrade.Builder{");
