 ...
 */
@BeanDefinition
public final class StandardCDSTrade extends TradeWrapper<StandardCDSSecurity> implements ImmutableBean {
   ...
   */
  public StandardCDSTrade(Trade trade) {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code StandardCDSTrade}.
   * @return the meta-bean, not null
   */
  public static StandardCDSTrade.Meta meta() {
    return StandardCDSTrade.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(StandardCDSTrade.Meta.INSTANCE);
  }
   ...
   */
  public static StandardCDSTrade.Builder builder() {
    return new StandardCDSTrade.Builder();
  }

  @Override
  public StandardCDSTrade.Meta metaBean() {
    return StandardCDSTrade.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      StandardCDSTrade other = (StandardCDSTrade) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableTradeBundle> _tradeBundle = DirectMetaProperty.ofImmutable(
        this, "tradeBundle", StandardCDSTrade.class, ImmutableTradeBundle.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public StandardCDSTrade.Builder builder() {
      return new StandardCDSTrade.Builder();
    }

    @Override
    public Class<? extends StandardCDSTrade> beanType() {
      return StandardCDSTrade.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1481798406:  // tradeBundle
          return ((StandardCDSTrade) bean).getTradeBundle();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code StandardCDSTrade}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<StandardCDSTrade> {
     ...
     */
    private Builder(StandardCDSTrade beanToCopy) {
    ...
    @Override
    public StandardCDSTrade build() {
      return new StandardCDSTrade(
          _tradeBundle);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(64);
      buf.append("StandardCDSTrade.Builder{");
