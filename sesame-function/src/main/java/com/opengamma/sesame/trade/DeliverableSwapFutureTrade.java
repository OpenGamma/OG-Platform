 ...
 */
@BeanDefinition
public final class DeliverableSwapFutureTrade extends TradeWrapper<DeliverableSwapFutureSecurity> implements ImmutableBean {
  ...
  private DeliverableSwapFutureTrade(ImmutableTradeBundle tradeBundle) {
    super(DeliverableSwapFutureSecurity.class, tradeBundle);
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableTradeBundle> _tradeBundle = DirectMetaProperty.ofImmutable(
        this, "tradeBundle", DeliverableSwapFutureTrade.class, ImmutableTradeBundle.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1481798406:  // tradeBundle
          return ((DeliverableSwapFutureTrade) bean).getTradeBundle();
      }
