...
public final class FXForwardTrade extends TradeWrapper<FXForwardSecurity> implements ImmutableBean {
   ...
   *
   * @param tradeBundle the trade containing the instrument, not null.
   */
  public FXForwardTrade(Trade trade) {
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableTradeBundle> _tradeBundle = DirectMetaProperty.ofImmutable(
        this, "tradeBundle", FXForwardTrade.class, ImmutableTradeBundle.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1481798406:  // tradeBundle
          return ((FXForwardTrade) bean).getTradeBundle();
      }
