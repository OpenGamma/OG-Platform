 ...
 */
@BeanDefinition
public final class InterestRateFutureTrade extends TradeWrapper<InterestRateFutureSecurity> implements ImmutableBean {
  ...
  private InterestRateFutureTrade(ImmutableTradeBundle tradeBundle) {
    super(InterestRateFutureSecurity.class, tradeBundle);
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableTradeBundle> _tradeBundle = DirectMetaProperty.ofImmutable(
        this, "tradeBundle", InterestRateFutureTrade.class, ImmutableTradeBundle.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1481798406:  // tradeBundle
          return ((InterestRateFutureTrade) bean).getTradeBundle();
      }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<InterestRateFutureTrade> {
     ...
     */
    private Builder(InterestRateFutureTrade beanToCopy) {
