...
public final class FedFundsFutureTrade extends TradeWrapper<FederalFundsFutureSecurity> implements ImmutableBean {
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableTradeBundle> _tradeBundle = DirectMetaProperty.ofImmutable(
        this, "tradeBundle", FedFundsFutureTrade.class, ImmutableTradeBundle.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1481798406:  // tradeBundle
          return ((FedFundsFutureTrade) bean).getTradeBundle();
      }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<FedFundsFutureTrade> {
     ...
     */
    private Builder(FedFundsFutureTrade beanToCopy) {
