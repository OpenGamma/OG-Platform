...
public class ExampleHistoricalTimeSeriesSourceComponentFactory extends HistoricalTimeSeriesSourceComponentFactory {
  ...
  protected HistoricalTimeSeriesResolver initResolver() {
    final MockHistoricalTimeSeriesFieldAdjustmentMapFactoryBean factory = new MockHistoricalTimeSeriesFieldAdjustmentMapFactoryBean();
    ...
    HistoricalTimeSeriesResolver resolver = new FieldMappingHistoricalTimeSeriesResolver(fieldAdjustmentMaps, selector, getHistoricalTimeSeriesMaster());
    if (getCacheManager() != null) {
      resolver = new EHCachingHistoricalTimeSeriesResolver(resolver, getCacheManager());
    }
    return resolver;
  }
