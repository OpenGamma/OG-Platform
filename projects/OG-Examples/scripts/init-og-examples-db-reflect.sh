...
$JAVA  -cp "$CLASSPATH" \
  ...
  -arg1 "-jdbcUrl jdbc:hsqldb:file:data/hsqldb/og-fin-user -database og-financial -user OpenGamma -password OpenGamma -drop true -create true  -createtables true  -dbscriptbasedir ." \
