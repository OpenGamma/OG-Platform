 ...
 * 
 */
public class DiskStoreEHCachingReferenceDataProvider extends AbstractCachingReferenceDataProvider {
   ...
   */
  public DiskStoreEHCachingReferenceDataProvider(final ReferenceDataProvider underlying, final CacheManager cacheManager) {
   ...
   */
  public DiskStoreEHCachingReferenceDataProvider(final ReferenceDataProvider underlying, final CacheManager cacheManager, final FudgeContext fudgeContext) {
  ...
  private PerSecurityReferenceDataResult parseCachedObject(CachedPerSecurityReferenceDataResult fromCache) {
    ...
    result.setFieldData(getFudgeContext().deserialize(fromCache._fieldData).getMessage());
    return result;
  }
  ...
  protected CachedPerSecurityReferenceDataResult createCachedObject(PerSecurityReferenceDataResult refDataResult) {
    ...
    result._fieldData = getFudgeContext().toByteArray(refDataResult.getFieldData());
    return result;
  }
