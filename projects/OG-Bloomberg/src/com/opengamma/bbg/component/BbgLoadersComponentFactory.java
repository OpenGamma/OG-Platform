...
/**
 * Component factory for a standard set of Bloomberg-based loader components.
 */
@BeanDefinition
public class BbgLoadersComponentFactory extends AbstractComponentFactory {
  ...
  protected SecurityLoader initSecurityLoader(ComponentRepository repo, ReferenceDataProvider refData, HistoricalTimeSeriesSource bbgHtsSource) {
    ...
    SecurityLoader bbgSecLoader = new BloombergSecurityLoader(getSecurityProvider(), getSecurityMaster());
    
    ComponentInfo info = new ComponentInfo(SecurityLoader.class, "standard");
    repo.registerComponent(info, bbgSecLoader);
    return bbgSecLoader;
  }
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code BbgLoadersComponentFactory}.
   * @return the meta-bean, not null
   */
  public static BbgLoadersComponentFactory.Meta meta() {
    return BbgLoadersComponentFactory.Meta.INSTANCE;
  }
  static {
    JodaBeanUtils.registerMetaBean(BbgLoadersComponentFactory.Meta.INSTANCE);
  }

  @Override
  public BbgLoadersComponentFactory.Meta metaBean() {
    return BbgLoadersComponentFactory.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      BbgLoadersComponentFactory other = (BbgLoadersComponentFactory) obj;
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    private final MetaProperty<URI> _bbgServerConfigurationUri = DirectMetaProperty.ofReadWrite(
        this, "bbgServerConfigurationUri", BbgLoadersComponentFactory.class, URI.class);
    /**
    ...
    private final MetaProperty<String> _referenceDataJmsTopic = DirectMetaProperty.ofReadWrite(
        this, "referenceDataJmsTopic", BbgLoadersComponentFactory.class, String.class);
    /**
    ...
    private final MetaProperty<SecurityProvider> _securityProvider = DirectMetaProperty.ofReadWrite(
        this, "securityProvider", BbgLoadersComponentFactory.class, SecurityProvider.class);
    /**
    ...
    private final MetaProperty<HistoricalTimeSeriesProvider> _historicalTimeSeriesProvider = DirectMetaProperty.ofReadWrite(
        this, "historicalTimeSeriesProvider", BbgLoadersComponentFactory.class, HistoricalTimeSeriesProvider.class);
    /**
    ...
    private final MetaProperty<SecurityMaster> _securityMaster = DirectMetaProperty.ofReadWrite(
        this, "securityMaster", BbgLoadersComponentFactory.class, SecurityMaster.class);
    /**
    ...
    private final MetaProperty<HistoricalTimeSeriesMaster> _historicalTimeSeriesMaster = DirectMetaProperty.ofReadWrite(
        this, "historicalTimeSeriesMaster", BbgLoadersComponentFactory.class, HistoricalTimeSeriesMaster.class);
    /**
    ...
    private final MetaProperty<FudgeContext> _fudgeContext = DirectMetaProperty.ofReadWrite(
        this, "fudgeContext", BbgLoadersComponentFactory.class, FudgeContext.class);
    /**
     * The meta-property for the {@code jmsConnector} property.
     */
    private final MetaProperty<JmsConnector> _jmsConnector = DirectMetaProperty.ofReadWrite(
        this, "jmsConnector", BbgLoadersComponentFactory.class, JmsConnector.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends BbgLoadersComponentFactory> builder() {
      return new DirectBeanBuilder<BbgLoadersComponentFactory>(new BbgLoadersComponentFactory());
    }

    @Override
    public Class<? extends BbgLoadersComponentFactory> beanType() {
      return BbgLoadersComponentFactory.class;
    }
