...
public class IRFutureOptionLoader extends SecurityLoader {
  ...
  /** Logger. */
  private static final Logger s_logger = LoggerFactory.getLogger(IRFutureOptionLoader.class);
  /**
   ...
   */
  public IRFutureOptionLoader(ReferenceDataProvider referenceDataProvider) {
    super(s_logger, referenceDataProvider, SecurityType.IR_FUTURE_OPTION);
  }
