...
public class BloombergBpipePermissionCheckProviderComponentFactory extends AbstractComponentFactory {
   ...
   */
  @PropertyDefinition
  private long _identityExpiryTime = 24;
  ...
  public void init(ComponentRepository repo, LinkedHashMap<String, String> configuration) throws Exception {
    ArgumentChecker.isTrue(getIdentityExpiryTime() > 0, "identity expiry time must be positive");
   ...
   * @return the value of the property
   */
  public long getIdentityExpiryTime() {
   ...
   */
  public void setIdentityExpiryTime(long identityExpiryTime) {
   ...
   * @return the property, not null
   */
  public final Property<Long> identityExpiryTime() {
  ...
  /**
   * Sets the referenceDataProvider.
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    private final MetaProperty<Long> _identityExpiryTime = DirectMetaProperty.ofReadWrite(
        this, "identityExpiryTime", BloombergBpipePermissionCheckProviderComponentFactory.class, Long.TYPE);
    /**
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<Long> identityExpiryTime() {
      return _identityExpiryTime;
    }
