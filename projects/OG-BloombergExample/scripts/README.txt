...
The key difference is the properties file that is invoked:
      Scripts - /OG BloombergExample/config/fullstack/fullstack-example-bin.properties
  Development - /OG BloombergExample/config/fullstack/fullstack-example-dev.properties
