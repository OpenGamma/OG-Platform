...
public class ExampleToolContext extends ToolContext implements BloombergToolContext {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code ExampleToolContext}.
   * @return the meta-bean, not null
   */
  public static ExampleToolContext.Meta meta() {
    return ExampleToolContext.Meta.INSTANCE;
  }
  static {
    JodaBeanUtils.registerMetaBean(ExampleToolContext.Meta.INSTANCE);
  }

  @Override
  public ExampleToolContext.Meta metaBean() {
    return ExampleToolContext.Meta.INSTANCE;
  }
  ...
  public static class Meta extends ToolContext.Meta {
    ...
    private final MetaProperty<BloombergSecurityMaster> _bloombergSecuritySource = DirectMetaProperty.ofReadWrite(
        this, "bloombergSecuritySource", ExampleToolContext.class, BloombergSecurityMaster.class);
    /**
    ...
    private final MetaProperty<ReferenceDataProvider> _bloombergReferenceDataProvider = DirectMetaProperty.ofReadWrite(
        this, "bloombergReferenceDataProvider", ExampleToolContext.class, ReferenceDataProvider.class);
    /**
    ...
    private final MetaProperty<HistoricalTimeSeriesSource> _bloombergHistoricalTimeSeriesSource = DirectMetaProperty.ofReadWrite(
        this, "bloombergHistoricalTimeSeriesSource", ExampleToolContext.class, HistoricalTimeSeriesSource.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends ExampleToolContext> builder() {
      return new DirectBeanBuilder<ExampleToolContext>(new ExampleToolContext());
    }

    @Override
    public Class<? extends ExampleToolContext> beanType() {
      return ExampleToolContext.class;
    }
