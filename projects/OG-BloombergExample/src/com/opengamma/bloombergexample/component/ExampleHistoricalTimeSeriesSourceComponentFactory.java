 ...
 */
@BeanDefinition
public class ExampleHistoricalTimeSeriesSourceComponentFactory extends IntegrationFieldMappingHistoricalTimeSeriesSourceComponentFactory {
  ...
  protected FieldMappingHistoricalTimeSeriesResolver initResolver() {
    ...
    FieldMappingHistoricalTimeSeriesResolver res = super.initResolver();
    fieldAdjustmentMaps.addAll(res.getFieldMaps());
   ...
   * The meta-bean for {@code ExampleHistoricalTimeSeriesSourceComponentFactory}.
   */
  public static class Meta extends IntegrationFieldMappingHistoricalTimeSeriesSourceComponentFactory.Meta {
    /**
