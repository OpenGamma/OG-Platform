...
import com.opengamma.timeseries.fast.AbstractFastObjectTimeSeries;
...
public abstract class AbstractFastLongObjectTimeSeries<T>
  ...
  @Override
  public Long getTimeAtIndex(final int index) {
  ...
  public ObjectTimeSeries<Long, T> newInstance(final Long[] times, final T[] values) {
    return (ObjectTimeSeries<Long, T>) newInstanceFast(TimeSeriesUtils.toPrimitive(times), values);
  }
