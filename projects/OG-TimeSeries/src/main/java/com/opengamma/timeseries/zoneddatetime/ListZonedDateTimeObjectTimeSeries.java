...
public class ListZonedDateTimeObjectTimeSeries<T> extends MutableZonedDateTimeObjectTimeSeries.Long<T> {
  ...
  private static final long serialVersionUID = 8105967430961054886L;
  ...
  public ListZonedDateTimeObjectTimeSeries(ZoneId timeZone) {
  ...
  public ListZonedDateTimeObjectTimeSeries(final ZoneId timeZone, final ZonedDateTime[] dates, final T[] values) {
  ...
  public ListZonedDateTimeObjectTimeSeries(final ZoneId timeZone, final List<ZonedDateTime> dates, final List<T> values) {
    super(new ZonedDateTimeEpochMillisConverter(timeZone), new FastListLongObjectTimeSeries<T>(DateTimeNumericEncoding.TIME_EPOCH_MILLIS, new ZonedDateTimeEpochMillisConverter(timeZone)
        .convertToLong(dates), values));
  }
  ...
  @SuppressWarnings({"unchecked", "rawtypes" })
  public ListZonedDateTimeObjectTimeSeries(final ZoneId timeZone, final ObjectTimeSeries<ZonedDateTime, T> dts) {
  ...
  public ListZonedDateTimeObjectTimeSeries(final ZoneId timeZone, final FastMutableLongObjectTimeSeries<T> pmidts) {
