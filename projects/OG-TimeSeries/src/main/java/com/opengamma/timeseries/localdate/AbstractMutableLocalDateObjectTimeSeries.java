...
public abstract class AbstractMutableLocalDateObjectTimeSeries<V>
    ...
    implements MutableLocalDateObjectTimeSeries<V> {
   ...
   */
  public AbstractMutableLocalDateObjectTimeSeries(final DateTimeConverter<LocalDate> converter, final FastMutableIntObjectTimeSeries<V> timeSeries) {
