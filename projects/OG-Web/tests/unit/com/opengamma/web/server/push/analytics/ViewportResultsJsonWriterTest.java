...
public class ViewportResultsJsonWriterTest {
  ...
  private final ViewportSpecification _viewportSpec =
      new ViewportSpecification(ImmutableList.of(0), ImmutableList.of(0), false);
  ...
  private List<List<ViewportResults.Cell>> createResults(Object value, List<Object> history) {
    ImmutableList<ViewportResults.Cell> innerList = ImmutableList.of(ViewportResults.valueCell(value, _valueSpec, history));
    return ImmutableList.<List<ViewportResults.Cell>>of(innerList);
  }

  @Test
  public void valueWithNoHistory() throws JSONException {
    List<List<ViewportResults.Cell>> results = createResults("val", null);
    ViewportResults viewportResults = new ViewportResults(results, _viewportSpec, createColumns(String.class), 0);
  ...
  public void valueWithHistory() throws JSONException {
    ...
    ViewportResults viewportResults = new ViewportResults(results, _viewportSpec, createColumns(Double.class), 0);
    String json = _writer.getJson(viewportResults);
  ...
  public void valueWithUnknownType() throws JSONException {
    List<List<ViewportResults.Cell>> results = createResults(3d, null);
  ...
  public void errorValueNoHistory() throws JSONException {
    List<List<ViewportResults.Cell>> results = createResults(NotCalculatedSentinel.EVALUATION_ERROR, null);
    ViewportResults viewportResults = new ViewportResults(results, _viewportSpec, createColumns(String.class), 0);
    String json = _writer.getJson(viewportResults);
  ...
  public void errorValueWithHistory() throws JSONException {
    ...
    List<List<ViewportResults.Cell>> results = createResults(NotCalculatedSentinel.EVALUATION_ERROR, history);
    ViewportResults viewportResults = new ViewportResults(results, _viewportSpec, createColumns(Double.class), 0);
    String json = _writer.getJson(viewportResults);
  ...
  public void errorValueInHistory() throws JSONException {
    ...
    List<List<ViewportResults.Cell>> results = createResults(3d, history);
    ViewportResults viewportResults = new ViewportResults(results, _viewportSpec, createColumns(Double.class), 0);
    String json = _writer.getJson(viewportResults);
