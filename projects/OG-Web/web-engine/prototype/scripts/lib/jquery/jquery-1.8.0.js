...
(function (window, undefined) {
  ...
  jQuery.event = {
    ...
    dispatch: function (event) {
      ...
      var i, j, cur, jqcur, ret, selMatch, matched, matches, handleObj, sel, related, handlers = ((jQuery._data(this, "events") || {})[event.type] || []),
...
/* matches from matchExpr.CHILD
    ...
    function handlePOS(selector, context, results, seed, groups) {
      var match, not, anchor, ret, elements, currentContexts, part, lastIndex, i = 0,
        len = groups.length,
        rpos = matchExpr["POS"],
    ...
    function addCombinator(matcher, combinator, context) {
      ...
      function (elem, context) {
        ...
        var cache, dirkey = doneName + "." + dirruns,
          ...
          if (!seed && !xml && (!rbuggyQSA || !rbuggyQSA.test(selector))) {
            if (context.nodeType === 9) {
              ...
              try {
                ...
                selector.replace(rgroups, "[id='" + nid + "'] $&")), 0));
                return results;
      ...
      if (this[0]) {
        ...
        if (first) {
          ...
          for (iNoClone = results.cacheable || l - 1; i < l; i++) {
            callback.call(
            table && jQuery.nodeName(this[i], "table") ? findOrAppend(this[i], "tbody") : this[i], i === iNoClone ? fragment : jQuery.clone(fragment, true, true));
          }
        }
  ...
  jQuery.extend({
    ...
    clean: function (elems, context, fragment, scripts) {
      var j, safe, elem, tag, wrap, depth, div, hasBody, tbody, len, handleScript, jsTags, i = 0,
        ret = [];
  ...
  jQuery.each(["height", "width"], function (i, name) {
    jQuery.cssHooks[name] = {
      ...
      set: function (elem, value, extra) {
        ...
        elem, name, extra, jQuery.support.boxSizing && jQuery.css(elem, "boxSizing") === "border-box") : 0);
      }
    };
  });
