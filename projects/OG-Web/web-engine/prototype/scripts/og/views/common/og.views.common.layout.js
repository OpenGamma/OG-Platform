        ...
        return {
            admin: function () {return {
                main: $('.OG-layout-admin-container').layout({
                    defaults: {enableCursorHotkey: false, onresizeall_end: 'og.common.gadgets.manager.resize'},
            ...
            analytics2: function () {return {
                main: $('.OG-layout-analytics-container').layout({
                    ...
                    east: {
                        spacing_closed: 0, initClosed: false, paneClass: 'OG-layout-analytics-dock', size: 350
                    },
                    center: {
