<#escape x as x?html>
<@page title="Update - ${legalEntityDoc.name}">
...
<@section title="Update legal entity">
  ...
  <p>
    ...
    <@rowin label="LegalEntity (XML)">
      <div style="border:2px solid black;padding:2px;"><textarea rows="30" cols="80" name="legalEntityXML" id="xmltextarea">${legalEntityXML}</textarea></div>
    </@rowin>
