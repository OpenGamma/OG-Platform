...
/**
 * Converts function configurations into a format suitable 
 * for viewing on the web. Can also handle filtering of
 * query results via a predicate method.
 */
class WebFunctionQueryDelegate {
  ...
  public SortedMap<String, WebFunctionTypeDetails> query(Predicate<WebFunctionTypeDetails> predicate) {
    FunctionConfigurationBundle functionConfiguration = _functionConfigurationSource.getFunctionConfiguration();
