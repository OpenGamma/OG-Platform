...
public class WebHistoricalTimeSeriesData extends DirectBean {
  ...
  /**
   * The loaded historical time-series.
   */
  @PropertyDefinition
  private HistoricalTimeSeriesDocument _historicalTimeSeries;
   ...
   */
  public String getBestHistoricalTimeSeriesUriId(final UniqueIdentifier overrideId) {
    if (overrideId != null) {
      return overrideId.toLatest().toString();
    }
    return getHistoricalTimeSeries() != null ? getHistoricalTimeSeries().getUniqueId().toLatest().toString() : getUriHistoricalTimeSeriesId();
  }
  ...
  protected Object propertyGet(String propertyName) {
    switch (propertyName.hashCode()) {
      ...
      case 1640772622:  // historicalTimeSeries
  ...
  protected void propertySet(String propertyName, Object newValue) {
    switch (propertyName.hashCode()) {
      ...
      case 1609878101:  // uriHistoricalTimeSeriesId
        ...
        return;
      case 1640772622:  // historicalTimeSeries
        setHistoricalTimeSeries((HistoricalTimeSeriesDocument) newValue);
        return;
    }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(getHistoricalTimeSeriesMaster(), other.getHistoricalTimeSeriesMaster()) &&
          ...
          JodaBeanUtils.equal(getHistoricalTimeSeries(), other.getHistoricalTimeSeries());
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash += hash * 31 + JodaBeanUtils.hashCode(getHistoricalTimeSeries());
    return hash;
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the loaded historical time-series.
   * @return the value of the property
   */
  public HistoricalTimeSeriesDocument getHistoricalTimeSeries() {
    return _historicalTimeSeries;
  }

  /**
   * Sets the loaded historical time-series.
   * @param historicalTimeSeries  the new value of the property
   */
  public void setHistoricalTimeSeries(HistoricalTimeSeriesDocument historicalTimeSeries) {
    this._historicalTimeSeries = historicalTimeSeries;
  }

  /**
   * Gets the the {@code historicalTimeSeries} property.
   * @return the property, not null
   */
  public final Property<HistoricalTimeSeriesDocument> historicalTimeSeries() {
    return metaBean().historicalTimeSeries().createProperty(this);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    /**
     * The meta-property for the {@code historicalTimeSeries} property.
     */
    private final MetaProperty<HistoricalTimeSeriesDocument> _historicalTimeSeries = DirectMetaProperty.ofReadWrite(
        this, "historicalTimeSeries", WebHistoricalTimeSeriesData.class, HistoricalTimeSeriesDocument.class);
    /**
     * The meta-properties.
     */
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<HistoricalTimeSeriesDocument> historicalTimeSeries() {
      return _historicalTimeSeries;
    }
