...
public class DoubleConverter implements ResultConverter<Object> {
  ...
  private static enum PrecisionType { SIGNIFICANT_FIGURES, DECIMAL_PLACES }
  
  private static class DoubleValueConversionSettings {
    
    public static final DoubleValueConversionSettings NON_CCY_5SF = DoubleValueConversionSettings.of(5, PrecisionType.SIGNIFICANT_FIGURES, false);
    public static final DoubleValueConversionSettings NON_CCY_2DP = DoubleValueConversionSettings.of(2, PrecisionType.DECIMAL_PLACES, false);
    public static final DoubleValueConversionSettings NON_CCY_4DP = DoubleValueConversionSettings.of(4, PrecisionType.DECIMAL_PLACES, false);
    public static final DoubleValueConversionSettings NON_CCY_6DP = DoubleValueConversionSettings.of(6, PrecisionType.DECIMAL_PLACES, false);
    public static final DoubleValueConversionSettings CCY_2DP = DoubleValueConversionSettings.of(2, PrecisionType.DECIMAL_PLACES, true);
    public static final DoubleValueConversionSettings CCY_4DP = DoubleValueConversionSettings.of(4, PrecisionType.DECIMAL_PLACES, true);
    public static final DoubleValueConversionSettings CCY_6DP = DoubleValueConversionSettings.of(6, PrecisionType.DECIMAL_PLACES, true);
  ...
  static {
    ...
    addConversion(ValueRequirementNames.CAPM_REGRESSION_STANDARD_ERROR_OF_ALPHA, DoubleValueConversionSettings.NON_CCY_5SF);
    addConversion(ValueRequirementNames.CAPM_REGRESSION_STANDARD_ERROR_OF_BETA, DoubleValueConversionSettings.NON_CCY_5SF);
  ...
  private static void addBulkConversion(String valueRequirementFieldNamePattern, DoubleValueConversionSettings conversionSettings) {
