...
public class ViewRequestMessageBodyReader implements MessageBodyReader<ViewRequest> {

  @Override
  public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
    return type.equals(ViewRequest.class);
  }

  @Override
  public ViewRequest readFrom(Class<ViewRequest> type,
                              Type genericType,
