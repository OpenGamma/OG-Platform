...
import com.opengamma.financial.analytics.timeseries.HistoricalTimeSeriesLatestValueShiftFunction;
import com.opengamma.financial.analytics.timeseries.HistoricalTimeSeriesShiftFunction;
import com.opengamma.financial.analytics.timeseries.YieldCurveHistoricalTimeSeriesFunction;
import com.opengamma.financial.analytics.timeseries.YieldCurveHistoricalTimeSeriesShiftFunction;
...
import com.opengamma.financial.analytics.timeseries.YieldCurveInstrumentConversionHistoricalTimeSeriesShiftFunction;
...
public class DemoStandardFunctionConfiguration extends SingletonFactoryBean<RepositoryConfigurationSource> {
  ...
  protected static void addHistoricalDataFunctions(final List<FunctionConfiguration> functionConfigs) {
    ...
    functionConfigs.add(functionConfiguration(HistoricalTimeSeriesShiftFunction.class));
    functionConfigs.add(functionConfiguration(HistoricalTimeSeriesLatestValueFunction.class));
    functionConfigs.add(functionConfiguration(HistoricalTimeSeriesLatestValueShiftFunction.class));
    functionConfigs.add(functionConfiguration(YieldCurveHistoricalTimeSeriesFunction.class));
    functionConfigs.add(functionConfiguration(YieldCurveHistoricalTimeSeriesShiftFunction.class));
    functionConfigs.add(functionConfiguration(YieldCurveInstrumentConversionHistoricalTimeSeriesFunction.class));
    functionConfigs.add(functionConfiguration(YieldCurveInstrumentConversionHistoricalTimeSeriesShiftFunction.class));
  ...
  private static void addSABRCalculators(final List<FunctionConfiguration> functionConfigs) {
    ...
    functionConfigs.add(functionConfiguration(SABRNoExtrapolationDefaults.class, "FORWARD_6M", "FUNDING", "BLOOMBERG", "NonLinearLeastSquares", "PresentValue", "EUR", "GBP"));
    functionConfigs.add(functionConfiguration(SABRRightExtrapolationDefaults.class, "FORWARD_6M", "FUNDING", "BLOOMBERG", "NonLinearLeastSquares", "PresentValue", "0.07", "10.0", "EUR", "GBP"));
    functionConfigs.add(functionConfiguration(SABRNoExtrapolationVegaDefaults.class, "FORWARD_6M", "FUNDING", "BLOOMBERG", "NonLinearLeastSquares", "PresentValue",
        "Linear", "FlatExtrapolator", "FlatExtrapolator", "Linear", "FlatExtrapolator", "FlatExtrapolator", "EUR", "GBP"));
    functionConfigs.add(functionConfiguration(SABRRightExtrapolationVegaDefaults.class, "FORWARD_6M", "FUNDING", "BLOOMBERG", "NonLinearLeastSquares", "PresentValue",
