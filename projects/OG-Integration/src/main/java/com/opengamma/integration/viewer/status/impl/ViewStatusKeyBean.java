...
public class ViewStatusKeyBean extends DirectBean implements ViewStatusKey {
   ...
   */
  public ViewStatusKeyBean(String securityType, String valueRequirementName, Currency currency) {
    ...
    setCurrencyStr(currency.getCode());
  }
  ...
  /**
   * Get the meta property of bean given an aggregation type.
   * 
   * @param aggregationType the aggregation type, not null
   * @return the meta property for a given aggregation type or null if not supported.
   */
  public static MetaProperty<String> getMetaProperty(final ViewAggregationType aggregationType) {
    ArgumentChecker.notNull(aggregationType, "aggregationType");
    
    Meta meta = meta();
    switch (aggregationType) {
      case SECURITY:
        return meta.securityType();
      case VALUE_REQUIREMENT_NAME:
        return meta.valueRequirementName();
      case CURRENCY:
        return meta.currencyStr();
      default:
        return null;
    }
  }
  ...
  public Currency getCurrency() {
    return Currency.of(_currencyStr);
  }
  ...
  protected Object propertyGet(String propertyName, boolean quiet) {
    switch (propertyName.hashCode()) {
      ...
      case 586616928:  // currencyStr
        return getCurrencyStr();
    }
  ...
  protected void propertySet(String propertyName, Object newValue, boolean quiet) {
    switch (propertyName.hashCode()) {
      ...
      case 1646585789:  // valueRequirementName
        ...
        return;
      case 586616928:  // currencyStr
        setCurrencyStr((String) newValue);
        return;
    }
  ...
  protected void validate() {
    ...
    JodaBeanUtils.notNull(_currencyStr, "currencyStr");
    super.validate();
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(getSecurityType(), other.getSecurityType()) &&
          ...
          JodaBeanUtils.equal(getCurrencyStr(), other.getCurrencyStr());
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash += hash * 31 + JodaBeanUtils.hashCode(getCurrencyStr());
    return hash;
  }
  ...
  /**
   * Sets the currencyStr.
   * @param currencyStr  the new value of the property, not null
   */
  public void setCurrencyStr(String currencyStr) {
    JodaBeanUtils.notNull(currencyStr, "currencyStr");
    this._currencyStr = currencyStr;
  }

  /**
   * Gets the the {@code currencyStr} property.
   * @return the property, not null
   */
  public final Property<String> currencyStr() {
    return metaBean().currencyStr().createProperty(this);
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    /**
     * The meta-property for the {@code currencyStr} property.
     */
    private final MetaProperty<String> _currencyStr = DirectMetaProperty.ofReadWrite(
        this, "currencyStr", ViewStatusKeyBean.class, String.class);
    /**
     * The meta-properties.
     */
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<String> currencyStr() {
      return _currencyStr;
    }
