 ...
 */
public class SingleSheetSimpleSnapshotWriter extends SingleSheetSnapshotWriter {

  private static final Logger s_logger = LoggerFactory.getLogger(SingleSheetSimpleSnapshotWriter.class);
  ...
  public SingleSheetSimpleSnapshotWriter(SheetWriter sheet, RowParser rowParser, boolean includeTrades) {
    super(sheet);
  ...
  public SingleSheetSimpleSnapshotWriter(SheetWriter sheet, RowParser rowParser) {
    this(sheet, rowParser, false);
  }

  public SingleSheetSimpleSnapshotWriter(SheetWriter sheet, String securityType) {
    this(sheet, JodaBeanRowParser.newJodaBeanRowParser(securityType));    
  }

  public SingleSheetSimpleSnapshotWriter(SheetFormat sheetFormat, OutputStream outputStream, RowParser rowParser) {
  ...
  public SingleSheetSimpleSnapshotWriter(String filename, RowParser rowParser) {
    this(SheetWriter.newSheetWriter(filename, rowParser.getColumns()), rowParser);
  }

  public SingleSheetSimpleSnapshotWriter(String filename, RowParser rowParser, boolean includeTrades) {
    this(SheetWriter.newSheetWriter(filename, rowParser.getColumns()), rowParser, includeTrades);
  }

  public SingleSheetSimpleSnapshotWriter(String filename, String securityType) {
    this(filename, JodaBeanRowParser.newJodaBeanRowParser(securityType));
  }

  public SingleSheetSimpleSnapshotWriter(String filename, String securityType, boolean includeTrades) {
    this(filename, JodaBeanRowParser.newJodaBeanRowParser(securityType), includeTrades);
  }

  public SingleSheetSimpleSnapshotWriter(SheetFormat sheetFormat, OutputStream outputStream, String securityType) {
