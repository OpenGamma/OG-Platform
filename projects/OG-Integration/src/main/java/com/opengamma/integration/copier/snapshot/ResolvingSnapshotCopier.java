...
/**
 * A snapshot copier that copies positions/securities from readers to the specified writer while resolving time-series.
 */
public class ResolvingSnapshotCopier implements SnapshotCopier {

  private static final Logger s_logger = LoggerFactory.getLogger(ResolvingSnapshotCopier.class);
  ...
  public ResolvingSnapshotCopier(
  ...
  void resolveTimeSeries(BloombergHistoricalTimeSeriesLoader bbgLoader, ManageableSecurity security, String[] dataFields, String dataProvider, SnapshotCopierVisitor visitor) {
