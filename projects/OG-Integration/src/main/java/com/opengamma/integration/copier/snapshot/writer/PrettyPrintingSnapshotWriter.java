...
/**
 * A dummy snapshot writer, which pretty-prints information instead of persisting
 */
public class PrettyPrintingSnapshotWriter implements SnapshotWriter {

  private String[] _currentPath = new String[] {};
  private boolean _prettyPrint;
  
  public PrettyPrintingSnapshotWriter(boolean prettyPrint) {
