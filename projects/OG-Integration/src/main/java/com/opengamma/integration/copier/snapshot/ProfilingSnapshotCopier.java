 ...
 */
public class ProfilingSnapshotCopier implements SnapshotCopier {

  private static final Logger s_logger = LoggerFactory.getLogger(ProfilingSnapshotCopier.class);
  private String[] _structure;

  private int _readTime;
  private int _writeTime;

  public ProfilingSnapshotCopier() {
    _structure = null;
  }


  public ProfilingSnapshotCopier(String[] structure) {
