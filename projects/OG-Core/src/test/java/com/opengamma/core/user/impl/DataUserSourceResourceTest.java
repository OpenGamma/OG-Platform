...
public class DataUserSourceResourceTest {
  ...
  public void testGetUserByUid() {
    final SimpleOGUser target = new SimpleOGUser("bob");
  ...
  public void testSearch() {
    ...
    target.setExternalIdBundle(BUNDLE);
    target.setName("Test");
    Collection targetColl = ImmutableList.<OGUser>of(target);
    
    when(_underlying.getUsers(eq(BUNDLE), eq(VC))).thenReturn(targetColl);
