...
/**
 * Tests DataLegalEntitySourceResource.
 */
@Test(groups = TestGroup.UNIT)
public class DataLegalEntitySourceResourceTest {
  ...
  private DataLegalEntitySourceResource _resource;

  @BeforeMethod
  public void setUp() {
    _underlying = mock(LegalEntitySource.class);
    _uriInfo = mock(UriInfo.class);
    when(_uriInfo.getBaseUri()).thenReturn(URI.create("testhost"));
    _resource = new DataLegalEntitySourceResource(_underlying);
  }

  //-------------------------------------------------------------------------
  @Test
  public void testGetLegalEntityByUid() {
    final LegalEntity target = new SimpleLegalEntity();
    target.
  ...
  @Test
  public void testGetLegalEntityByOid() {
    final SimpleLegalEntity target = new SimpleLegalEntity();
    target.setType(LegalEntityType.BANK);
    target.setRegionExternalId(EID);
