 ...
 */
@BeanDefinition
public final class ResolvedSnapshotLink<C>
    extends SnapshotLink<C>
  ...
  /* package */ ResolvedSnapshotLink(C value) {
   ...
   */
  @SuppressWarnings("unchecked")
  public static <R> ResolvedSnapshotLink.Meta<R> metaResolvedSnapshotLink(Class<R> cls) {
    return ResolvedSnapshotLink.Meta.INSTANCE;
  }
   ...
   */
  public static <C> ResolvedSnapshotLink.Builder<C> builder() {
    return new ResolvedSnapshotLink.Builder<C>();
  }

  @SuppressWarnings("unchecked")
  @Override
  public ResolvedSnapshotLink.Meta<C> metaBean() {
    return ResolvedSnapshotLink.Meta.INSTANCE;
  }
  ...
  @Override
  public ResolvedSnapshotLink<C> clone() {
    return this;
  }
  ...
  public static final class Meta<C> extends DirectMetaBean {
    ...
    @Override
    public ResolvedSnapshotLink.Builder<C> builder() {
      return new ResolvedSnapshotLink.Builder<C>();
    }

    @SuppressWarnings({"unchecked", "rawtypes" })
    @Override
    public Class<? extends ResolvedSnapshotLink<C>> beanType() {
   ...
   */
  public static final class Builder<C> extends DirectFieldsBeanBuilder<ResolvedSnapshotLink<C>> {
     ...
     */
    private Builder(ResolvedSnapshotLink<C> beanToCopy) {
    ...
    @Override
    public ResolvedSnapshotLink<C> build() {
      return new ResolvedSnapshotLink<C>(
          _value);
    }
