...
public interface LegalEntitySource
   ...
   *
   * @param <T>      the type of the legal entity to get
   * @param uniqueId the unique identifier to search for, not null
   * @param type     the type of the legal entity to get, not null
   ...
   */
  <T extends LegalEntity> T get(UniqueId uniqueId, Class<T> type);
   ...
   * @throws RuntimeException         if an error occurs
   */
  <T extends LegalEntity> T get(ObjectId objectId, VersionCorrection versionCorrection, Class<T> type);
   ...
   * @throws RuntimeException         if an error occurs
   */
  <T extends LegalEntity> T getSingle(ExternalIdBundle bundle, VersionCorrection versionCorrection, Class<T> type);
   ...
   * @throws RuntimeException         if an error occurs
   */
  <T extends LegalEntity> T getSingle(ExternalId externalId, Class<T> type);
   ...
   * @throws RuntimeException         if an error occurs
   */
  <T extends LegalEntity> T getSingle(ExternalIdBundle bundle, Class<T> type);
