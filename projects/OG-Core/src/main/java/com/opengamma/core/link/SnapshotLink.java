...
public abstract class SnapshotLink<S extends NamedSnapshot> implements Link<S> {
   ...
   *
   * @param <NS> the type of the object being linked to
   ...
   */
  public static <NS extends NamedSnapshot> SnapshotLink<NS> resolvable(String name, Class<NS> type) {
    return new ResolvableSnapshotLink<>(name, type, new ServiceContextSnapshotLinkResolver<NS>());
  }
   ...
   * @return a snapshot link, not null
   */
  public static <NS extends NamedSnapshot> SnapshotLink<NS> resolvable(String name, Class<NS> type, ServiceContext serviceContext) {
    return new ResolvableSnapshotLink<>(name, type, new ServiceContextSnapshotLinkResolver<NS>(serviceContext));
  }
   ...
   *
   * @param <NS> the type of the object being linked to, not null
   * @param snapshot the snapshot to embed in the link, not null
   * @return the snapshot link, not null
   */
  public static <NS extends NamedSnapshot> SnapshotLink<NS> resolved(NS snapshot) {
