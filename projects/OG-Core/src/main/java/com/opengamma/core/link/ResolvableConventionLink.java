...
public class ResolvableConventionLink<T extends Convention> extends ConventionLink<T> implements ImmutableBean {
  ...
  private ResolvableConventionLink(ExternalIdBundle linkIdentifier) {
    this(linkIdentifier, new ServiceContextConventionLinkResolver<T>());
  }

  /* package */ ResolvableConventionLink(ExternalIdBundle identifier, LinkResolver<T, ExternalIdBundle> resolver) {
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets identifier to enable resolution of the link.
  ...
  public static class Meta<T extends Convention> extends DirectMetaBean {
    ...
    private final MetaProperty<ExternalIdBundle> _identifier = DirectMetaProperty.ofImmutable(
        this, "identifier", ResolvableConventionLink.class, ExternalIdBundle.class);
    /**
     * The meta-properties.
     */
     ...
     */
    public final MetaProperty<ExternalIdBundle> identifier() {
      return _identifier;
    }
