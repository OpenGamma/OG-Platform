...
public class Obligation implements Bean {
  ...
  @PropertyDefinition
  private ObjectId _security; //TODO refactor <ObjectId> to <SecurityLink> when SecurityLink is ready.
   ...
   */
  public void setSecurity(ObjectId security) {
   ...
   * @return the property, not null
   */
  public final Property<ObjectId> security() {
  ...
  public Obligation clone() {
    BeanBuilder<? extends Obligation> builder = metaBean().builder();
  ...
  public static class Meta extends DirectMetaBean {
     ...
     */
    private final MetaProperty<ObjectId> _security = DirectMetaProperty.ofReadWrite(
        this, "security", Obligation.class, ObjectId.class);
    /**
     * The meta-properties.
     */
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<ObjectId> security() {
      return _security;
    }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3373707:  // name
          ...
          return;
        case 949122880:  // security
          ((Obligation) bean).setSecurity((ObjectId) newValue);
          return;
      }
