 ...
 */
package com.opengamma.core.snapshot.impl;
...
/**
 * An item stored in the snapshot master.
 * 
 * @param <T> the type of the underlying item
 */
@BeanDefinition
public class SnapshotItem<T> extends DirectBean implements UniqueIdentifiable, ObjectIdentifiable, Serializable {
   ...
   */
  public static <T> SnapshotItem<T> of(final T object) {
    final SnapshotItem<T> item = new SnapshotItem<T>(object);
   ...
   * @return the item, not null
   */
  public static <T> SnapshotItem<T> of(final T object, final String name) {
    final SnapshotItem<T> snapshotItem = new SnapshotItem<T>(object);
    snapshotItem.setName(name);
    return snapshotItem;
  }
   ...
   * @return the item, not null
   */
  public static <T> SnapshotItem<T> of(final T object, final String name, final Class<?> type) {
    final SnapshotItem<T> snapshotItemItem = new SnapshotItem<T>(object);
    snapshotItemItem.setName(name);
    snapshotItemItem.setType(type);
    return snapshotItemItem;
  }
   ...
   */
  protected SnapshotItem(final T value) {
    _value = value;
  }
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code SnapshotItem}.
   * @return the meta-bean, not null
   */
  @SuppressWarnings("rawtypes")
  public static SnapshotItem.Meta meta() {
    return SnapshotItem.Meta.INSTANCE;
  }
  ...
  public static <R> SnapshotItem.Meta<R> metaSnapshotItem(Class<R> cls) {
    return SnapshotItem.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(SnapshotItem.Meta.INSTANCE);
  }

  @SuppressWarnings("unchecked")
  @Override
  public SnapshotItem.Meta<T> metaBean() {
    return SnapshotItem.Meta.INSTANCE;
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Sets the type of the snapshot item.
  ...
  public static class Meta<T> extends DirectMetaBean {
    ...
    private final MetaProperty<T> _value = (DirectMetaProperty) DirectMetaProperty.ofReadWrite(
        this, "value", SnapshotItem.class, Object.class);
    /**
     * The meta-property for the {@code uniqueId} property.
     */
    private final MetaProperty<UniqueId> _uniqueId = DirectMetaProperty.ofReadWrite(
        this, "uniqueId", SnapshotItem.class, UniqueId.class);
    /**
     * The meta-property for the {@code name} property.
     */
    private final MetaProperty<String> _name = DirectMetaProperty.ofReadWrite(
        this, "name", SnapshotItem.class, String.class);
    /**
     * The meta-property for the {@code type} property.
     */
    @SuppressWarnings({"unchecked", "rawtypes" })
    private final MetaProperty<Class<?>> _type = DirectMetaProperty.ofReadWrite(
        this, "type", SnapshotItem.class, (Class) Class.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends SnapshotItem<T>> builder() {
      return new DirectBeanBuilder<SnapshotItem<T>>(new SnapshotItem<T>());
    }

    @SuppressWarnings({"unchecked", "rawtypes" })
    @Override
    public Class<? extends SnapshotItem<T>> beanType() {
      return (Class) SnapshotItem.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 111972721:  // value
          return ((SnapshotItem<?>) bean).getValue();
        case -294460212:  // uniqueId
          return ((SnapshotItem<?>) bean).getUniqueId();
        case 3373707:  // name
          return ((SnapshotItem<?>) bean).getName();
        case 3575610:  // type
          return ((SnapshotItem<?>) bean).getType();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 111972721:  // value
          ((SnapshotItem<T>) bean).setValue((T) newValue);
          return;
        case -294460212:  // uniqueId
          ((SnapshotItem<T>) bean).setUniqueId((UniqueId) newValue);
          return;
        case 3373707:  // name
          ((SnapshotItem<T>) bean).setName((String) newValue);
          return;
        case 3575610:  // type
          ((SnapshotItem<T>) bean).setType((Class<?>) newValue);
          return;
      }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((SnapshotItem<?>) bean)._value, "value");
      JodaBeanUtils.notNull(((SnapshotItem<?>) bean)._name, "name");
    }
  ...
  public static SnapshotItem<?> fromFudgeMsg(final FudgeDeserializer deserializer, final FudgeMsg msg) {
    final SnapshotItem<?> instance = new SnapshotItem<Object>();
