...
public interface SourceWithExternalBundle<V extends UniqueIdentifiable & ExternalBundleIdentifiable> extends Source<V>, ChangeProvider {
  ...
  /**
   * Gets all objects at the latest version-correction that match the specified
   * bundle of keys.
   * <p>
   ...
   * <p>
   * The simplest implementation of this method will return a object if it matches one of the keys.
