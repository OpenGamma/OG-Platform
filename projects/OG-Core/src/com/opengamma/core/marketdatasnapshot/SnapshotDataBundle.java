...
public class SnapshotDataBundle extends DirectBean {
   ...
   */
  @PropertyDefinition
  private Map<UniqueIdentifier, Double> _dataPoints;
   ...
   */
  public Map<UniqueIdentifier, Double> getDataPoints() {
    return _dataPoints;
  }
   ...
   */
  public void setDataPoints(Map<UniqueIdentifier, Double> dataPoints) {
   ...
   */
  public final Property<Map<UniqueIdentifier, Double>> dataPoints() {
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Map<UniqueIdentifier, Double>> _dataPoints = DirectMetaProperty.ofReadWrite(
     ...
     */
    public final MetaProperty<Map<UniqueIdentifier, Double>> dataPoints() {
      return _dataPoints;
    }
