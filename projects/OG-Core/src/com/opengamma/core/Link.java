...
@PublicAPI
@BeanDefinition
public class Link<T extends UniqueIdentifiable> extends DirectBean implements ObjectIdentifiable, Serializable {
   ...
   */
  public void addSecurityKey(final Identifier idKey) {
