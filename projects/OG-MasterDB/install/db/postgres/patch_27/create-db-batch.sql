...
create table rsk_value (
    ...
    value_constraints_id int not null,
    ...
    constraint rsk_fk_value2value_constraints
        foreign key (value_constraints_id) references rsk_value_constraints (id),
    ...
    constraint rsk_chk_uq_value unique (calculation_configuration_id, value_name_id, value_constraints_id, computation_target_id)
);
...
create table rsk_failure (			
    ...
    constraint rsk_fk_failure2value_name
        foreign key (value_name_id) references rsk_value_name (id),
    constraint rsk_fk_failure2value_constraints
        foreign key (value_constraints_id) references rsk_value_constraints (id),
    ...
    constraint rsk_chk_uq_failure unique (calculation_configuration_id, value_name_id, value_constraints_id, computation_target_id)
);    
