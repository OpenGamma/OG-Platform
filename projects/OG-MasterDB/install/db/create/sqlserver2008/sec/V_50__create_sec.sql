...
INSERT INTO sec_schema_version (version_key, version_value) VALUES ('schema_patch', '50');
...
CREATE TABLE sec_bond (
    ...
    interestaccrual_date DATETIME2(6) NOT NULL,
    interestaccrual_zone VARCHAR(50) NOT NULL,
    settlement_date DATETIME2(6) NOT NULL,
    settlement_zone VARCHAR(50) NOT NULL,
    firstcoupon_date DATETIME2(6) NOT NULL,
