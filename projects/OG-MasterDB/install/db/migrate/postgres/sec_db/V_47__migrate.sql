START TRANSACTION;
  ...
  ALTER  TABLE sec_security_attribute RENAME COLUMN key TO attr_key;
  ALTER  TABLE sec_security_attribute RENAME COLUMN value TO attr_value;
  ALTER  TABLE sec_security_attribute ADD CONSTRAINT sec_chk_uq_security_attribute UNIQUE (security_id, attr_key, attr_value);
  CREATE INDEX sec_security_attribute ix_sec_security_attr_key ON sec_security_attribute(attr_key);
COMMIT;
