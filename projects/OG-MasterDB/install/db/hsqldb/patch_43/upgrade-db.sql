...
ALTER TABLE rsk_compute_host ALTER COLUMN id SET DATA TYPE bigint

ALTER TABLE rsk_compute_node ALTER COLUMN id SET DATA TYPE bigint
ALTER TABLE rsk_compute_node ALTER COLUMN compute_host_id SET DATA TYPE bigint

ALTER TABLE rsk_computation_target_type ALTER COLUMN id SET DATA TYPE bigint

ALTER TABLE rsk_computation_target ALTER COLUMN id SET DATA TYPE bigint
ALTER TABLE rsk_computation_target ALTER COLUMN type_id SET DATA TYPE bigint

ALTER TABLE rsk_function_unique_id ALTER COLUMN id SET DATA TYPE bigint

ALTER TABLE rsk_live_data_field ALTER COLUMN id SET DATA TYPE bigint

ALTER TABLE rsk_live_data_snapshot ALTER COLUMN id SET DATA TYPE bigint

ALTER TABLE rsk_live_data_snapshot_entry ALTER COLUMN id SET DATA TYPE bigint
ALTER TABLE rsk_live_data_snapshot_entry ALTER COLUMN snapshot_id SET DATA TYPE bigint
ALTER TABLE rsk_live_data_snapshot_entry ALTER COLUMN computation_target_id SET DATA TYPE bigint
ALTER TABLE rsk_live_data_snapshot_entry ALTER COLUMN field_id SET DATA TYPE bigint

ALTER TABLE rsk_view_definition ALTER COLUMN id SET DATA TYPE bigint

ALTER TABLE rsk_version_correction ALTER COLUMN id SET DATA TYPE bigint

ALTER TABLE rsk_run ALTER COLUMN id SET DATA TYPE bigint
ALTER TABLE rsk_run ALTER COLUMN version_correction_id SET DATA TYPE bigint
ALTER TABLE rsk_run ALTER COLUMN view_definition_id SET DATA TYPE bigint
ALTER TABLE rsk_run ALTER COLUMN live_data_snapshot_id SET DATA TYPE bigint

ALTER TABLE rsk_calculation_configuration ALTER COLUMN id SET DATA TYPE bigint

ALTER TABLE rsk_run_property ALTER COLUMN id SET DATA TYPE bigint
ALTER TABLE rsk_run_property ALTER COLUMN id SET DATA TYPE bigint

ALTER TABLE rsk_run_status_code ALTER COLUMN id SET DATA TYPE bigint

ALTER TABLE rsk_run_status ALTER COLUMN id SET DATA TYPE bigint
ALTER TABLE rsk_run_status ALTER COLUMN calculation_configuration_id SET DATA TYPE bigint
ALTER TABLE rsk_run_status ALTER COLUMN computation_target_id SET DATA TYPE bigint

ALTER TABLE rsk_value_name ALTER COLUMN id SET DATA TYPE bigint
...
ALTER TABLE rsk_value ALTER COLUMN value_name_id SET DATA TYPE bigint
ALTER TABLE rsk_value ALTER COLUMN value_requirement_id SET DATA TYPE bigint
ALTER TABLE rsk_value ALTER COLUMN value_specification_id SET DATA TYPE bigint
ALTER TABLE rsk_value ALTER COLUMN function_unique_id SET DATA TYPE bigint
ALTER TABLE rsk_value ALTER COLUMN computation_target_id SET DATA TYPE bigint
ALTER TABLE rsk_value ALTER COLUMN run_id SET DATA TYPE bigint
ALTER TABLE rsk_value ALTER COLUMN compute_node_id SET DATA TYPE bigint
