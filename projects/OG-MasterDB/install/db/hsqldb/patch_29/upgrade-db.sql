...
ALTER TABLE rsk_value_requirement ALTER COLUMN synthetic_constraints RENAME TO synthetic_form;

ALTER TABLE rsk_value ALTER COLUMN value_constraints_id RENAME TO value_requirement_id;
...
ALTER TABLE rsk_failure ALTER COLUMN value_constraints_id RENAME TO value_requirement_id;
