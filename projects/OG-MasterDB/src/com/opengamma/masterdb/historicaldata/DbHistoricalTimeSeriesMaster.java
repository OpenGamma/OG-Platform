...
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.DEACTIVATE_META_DATA;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.DELETE_DATA_POINT;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.DELETE_DATA_POINTS_BY_DATE;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.DELETE_TIME_SERIES_BY_ID;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.FIND_DATA_POINT_BY_DATE_AND_ID;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.GET_ACTIVE_META_DATA;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.GET_ACTIVE_META_DATA_BY_IDENTIFIERS;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.GET_ACTIVE_META_DATA_BY_OID;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.GET_ACTIVE_META_DATA_WITH_DATES;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.GET_ACTIVE_META_DATA_WITH_DATES_BY_IDENTIFIERS;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.GET_ACTIVE_TIME_SERIES_KEY;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.GET_ACTIVE_TIME_SERIES_KEY_BY_ID;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.GET_TIME_SERIES_BY_ID;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.GET_TS_DATE_RANGE_BY_OID;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.IDENTIFIER_VALUE_COLUMN;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INSERT_DATA_FIELD;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INSERT_DATA_PROVIDER;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INSERT_DATA_SOURCE;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INSERT_IDENTIFIER;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INSERT_OBSERVATION_TIME;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INSERT_QUOTED_OBJECT;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INSERT_SCHEME;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INSERT_TIME_SERIES;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INSERT_TIME_SERIES_DELTA_D;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INSERT_TIME_SERIES_DELTA_I;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INSERT_TIME_SERIES_DELTA_U;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INSERT_TIME_SERIES_KEY;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.INVALID_KEY;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.LOAD_ALL_DATA_FIELDS;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.LOAD_ALL_DATA_PROVIDER;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.LOAD_ALL_DATA_SOURCES;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.LOAD_ALL_IDENTIFIERS;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.LOAD_ALL_OBSERVATION_TIMES;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.LOAD_ALL_SCHEME;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.LOAD_TIME_SERIES_DELTA;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.LOAD_TIME_SERIES_WITH_DATES;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.OBSERVATION_TIME_COLUMN;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.SCHEME;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.SELECT_BUNDLE_FROM_IDENTIFIERS;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.SELECT_DATA_FIELD_ID;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.SELECT_DATA_PROVIDER_ID;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.SELECT_DATA_SOURCE_ID;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.SELECT_OBSERVATION_TIME_ID;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.SELECT_QUOTED_OBJECT_ID;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.SELECT_SCHEME_ID;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.UPDATE_TIME_SERIES;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.VALID_FROM;
import static com.opengamma.masterdb.historicaldata.DbHistoricalTimeSeriesMasterConstants.VALID_TO;
...
public abstract class DbHistoricalTimeSeriesMaster implements HistoricalTimeSeriesMaster {
  ...
  private Map<Long, List<IdentifierWithDates>> searchIdentifierBundles(final HistoricalTimeSeriesSearchRequest request) {
  ...
  public HistoricalTimeSeriesDocument get(UniqueIdentifier uniqueId) {
    return doGet(new HistoricalTimeSeriesGetRequest(uniqueId));
  }
  ...
  private HistoricalTimeSeriesDocument doGet(HistoricalTimeSeriesGetRequest request) {
  ...
  //-------------------------------------------------------------------------
  @Override
  public HistoricalTimeSeriesSearchResult search(HistoricalTimeSeriesSearchRequest request) {
    ArgumentChecker.notNull(request, "timeseries request");
    return doSearch(request);
  }

  private HistoricalTimeSeriesSearchResult doSearch(HistoricalTimeSeriesSearchRequest request) {
    HistoricalTimeSeriesSearchResult result = new HistoricalTimeSeriesSearchResult();  
    ...
    HistoricalTimeSeriesInfoRowMapper rowMapper = new HistoricalTimeSeriesInfoRowMapper(this);
  ...
  private boolean hasIdentifier(HistoricalTimeSeriesSearchRequest request) {
  ...
  private String getMetaDataSQL(final HistoricalTimeSeriesSearchRequest request, final Set<Long> ids, final DbMapSqlParameterSource parameters) {
  ...
  public DataPointDocument updateDataPoint(DataPointDocument document) {
    ...
    long tsId = validateId(document.getHistoricalTimeSeriesId());
  ...
  public UniqueIdentifier resolveIdentifier(
    ...
    HistoricalTimeSeriesSearchResult searchResult = search(request);
