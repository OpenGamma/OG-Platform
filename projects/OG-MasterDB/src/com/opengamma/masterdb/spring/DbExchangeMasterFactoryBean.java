 ...
 */
@BeanDefinition
public class DbExchangeMasterFactoryBean extends SpringFactoryBean<DbExchangeMaster> {
  ...
  protected DbExchangeMaster createObject() {
    ...
    if (getJmsConnector() != null) {
      master.setChangeManager(new JmsChangeManager(getJmsConnector(), "ExchangeMaster"));
    }
    return master;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      DbExchangeMasterFactoryBean other = (DbExchangeMasterFactoryBean) obj;
   ...
   * The meta-bean for {@code DbExchangeMasterFactoryBean}.
   */
  public static class Meta extends SpringFactoryBean.Meta<DbExchangeMaster> {
    /**
    ...
    private final MetaProperty<DbConnector> _dbConnector = DirectMetaProperty.ofReadWrite(
        this, "dbConnector", DbExchangeMasterFactoryBean.class, DbConnector.class);
    /**
     * The meta-property for the {@code jmsConnector} property.
     */
    private final MetaProperty<JmsConnector> _jmsConnector = DirectMetaProperty.ofReadWrite(
        this, "jmsConnector", DbExchangeMasterFactoryBean.class, JmsConnector.class);
    /**
    ...
    private final MetaProperty<String> _uniqueIdScheme = DirectMetaProperty.ofReadWrite(
        this, "uniqueIdScheme", DbExchangeMasterFactoryBean.class, String.class);
    /**
    ...
    private final MetaProperty<Integer> _maxRetries = DirectMetaProperty.ofReadWrite(
        this, "maxRetries", DbExchangeMasterFactoryBean.class, Integer.class);
    /**
     * The meta-properties.
     */
