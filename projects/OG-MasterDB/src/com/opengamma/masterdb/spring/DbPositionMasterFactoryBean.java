 ...
 */
@BeanDefinition
public class DbPositionMasterFactoryBean extends SpringFactoryBean<DbPositionMaster> {
  ...
  public DbPositionMaster createObject() {
    ...
    if (getJmsConnector() != null) {
      master.setChangeManager(new JmsChangeManager(getJmsConnector(), "PositionMaster"));
    }
    return master;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      DbPositionMasterFactoryBean other = (DbPositionMasterFactoryBean) obj;
   ...
   * The meta-bean for {@code DbPositionMasterFactoryBean}.
   */
  public static class Meta extends SpringFactoryBean.Meta<DbPositionMaster> {
    /**
    ...
    private final MetaProperty<DbConnector> _dbConnector = DirectMetaProperty.ofReadWrite(
        this, "dbConnector", DbPositionMasterFactoryBean.class, DbConnector.class);
    /**
     * The meta-property for the {@code jmsConnector} property.
     */
    private final MetaProperty<JmsConnector> _jmsConnector = DirectMetaProperty.ofReadWrite(
        this, "jmsConnector", DbPositionMasterFactoryBean.class, JmsConnector.class);
    /**
    ...
    private final MetaProperty<String> _uniqueIdScheme = DirectMetaProperty.ofReadWrite(
        this, "uniqueIdScheme", DbPositionMasterFactoryBean.class, String.class);
    /**
    ...
    private final MetaProperty<Integer> _maxRetries = DirectMetaProperty.ofReadWrite(
        this, "maxRetries", DbPositionMasterFactoryBean.class, Integer.class);
    /**
     * The meta-properties.
     */
