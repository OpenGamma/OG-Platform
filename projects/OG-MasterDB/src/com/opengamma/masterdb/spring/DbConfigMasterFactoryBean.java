 ...
 */
@BeanDefinition
public class DbConfigMasterFactoryBean extends SpringFactoryBean<DbConfigMaster> {
  ...
  protected DbConfigMaster createObject() {
    ...
    if (getJmsConnector() != null) {
      master.setChangeManager(new JmsChangeManager(getJmsConnector(), "ConfigMaster"));
    }
    return master;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      DbConfigMasterFactoryBean other = (DbConfigMasterFactoryBean) obj;
   ...
   * The meta-bean for {@code DbConfigMasterFactoryBean}.
   */
  public static class Meta extends SpringFactoryBean.Meta<DbConfigMaster> {
    /**
    ...
    private final MetaProperty<DbConnector> _dbConnector = DirectMetaProperty.ofReadWrite(
        this, "dbConnector", DbConfigMasterFactoryBean.class, DbConnector.class);
    /**
     * The meta-property for the {@code jmsConnector} property.
     */
    private final MetaProperty<JmsConnector> _jmsConnector = DirectMetaProperty.ofReadWrite(
        this, "jmsConnector", DbConfigMasterFactoryBean.class, JmsConnector.class);
    /**
    ...
    private final MetaProperty<String> _uniqueIdScheme = DirectMetaProperty.ofReadWrite(
        this, "uniqueIdScheme", DbConfigMasterFactoryBean.class, String.class);
    /**
    ...
    private final MetaProperty<Integer> _maxRetries = DirectMetaProperty.ofReadWrite(
        this, "maxRetries", DbConfigMasterFactoryBean.class, Integer.class);
    /**
     * The meta-properties.
     */
