 ...
 */
@BeanDefinition
public class DbPortfolioMasterFactoryBean extends SpringFactoryBean<DbPortfolioMaster> {
  ...
  public DbPortfolioMaster createObject() {
    ...
    if (getJmsConnector() != null) {
      master.setChangeManager(new JmsChangeManager(getJmsConnector(), "PortfolioMaster"));
    }
    return master;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      DbPortfolioMasterFactoryBean other = (DbPortfolioMasterFactoryBean) obj;
   ...
   * The meta-bean for {@code DbPortfolioMasterFactoryBean}.
   */
  public static class Meta extends SpringFactoryBean.Meta<DbPortfolioMaster> {
    /**
    ...
    private final MetaProperty<DbConnector> _dbConnector = DirectMetaProperty.ofReadWrite(
        this, "dbConnector", DbPortfolioMasterFactoryBean.class, DbConnector.class);
    /**
     * The meta-property for the {@code jmsConnector} property.
     */
    private final MetaProperty<JmsConnector> _jmsConnector = DirectMetaProperty.ofReadWrite(
        this, "jmsConnector", DbPortfolioMasterFactoryBean.class, JmsConnector.class);
    /**
    ...
    private final MetaProperty<String> _uniqueIdScheme = DirectMetaProperty.ofReadWrite(
        this, "uniqueIdScheme", DbPortfolioMasterFactoryBean.class, String.class);
    /**
    ...
    private final MetaProperty<Integer> _maxRetries = DirectMetaProperty.ofReadWrite(
        this, "maxRetries", DbPortfolioMasterFactoryBean.class, Integer.class);
    /**
     * The meta-properties.
     */
