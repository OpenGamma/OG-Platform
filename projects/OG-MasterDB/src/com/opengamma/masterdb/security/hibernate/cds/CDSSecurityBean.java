...
public class CDSSecurityBean extends SecurityBean {
  ...
  @PropertyDefinition(validate = "notNull")
  private ZonedDateTimeBean _firstPremiumDate;
  ...
  protected void propertySet(String propertyName, Object newValue, boolean quiet) {
    switch (propertyName.hashCode()) {
      ...
      case 313843601:  // maturity
        ...
        return;
      case 2071819733:  // firstPremiumDate
        setFirstPremiumDate((ZonedDateTimeBean) newValue);
        return;
      case 146671813:  // premiumFrequency
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the firstPremiumDate.
   * @return the value of the property, not null
   */
  public ZonedDateTimeBean getFirstPremiumDate() {
    return _firstPremiumDate;
  }

  /**
   * Sets the firstPremiumDate.
   * @param firstPremiumDate  the new value of the property, not null
   */
  public void setFirstPremiumDate(ZonedDateTimeBean firstPremiumDate) {
   ...
   * @return the property, not null
   */
  public final Property<ZonedDateTimeBean> firstPremiumDate() {
  ...
  public static class Meta extends SecurityBean.Meta {
    ...
    private final MetaProperty<Double> _premiumRate = DirectMetaProperty.ofReadWrite(
        this, "premiumRate", CDSSecurityBean.class, Double.TYPE);
    /**
     ...
     */
    private final MetaProperty<ZonedDateTimeBean> _firstPremiumDate = DirectMetaProperty.ofReadWrite(
        this, "firstPremiumDate", CDSSecurityBean.class, ZonedDateTimeBean.class);
    /**
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<ZonedDateTimeBean> firstPremiumDate() {
      return _firstPremiumDate;
    }
