 ...
 */
public abstract class AbstractDocumentDbMaster2<D extends AbstractDocument> extends AbstractDbMaster implements AbstractMaster<D> {

  /** Logger. */
  private static final Logger s_logger = LoggerFactory.getLogger(AbstractDocumentDbMaster2.class);
   ...
   */
  public AbstractDocumentDbMaster2(final DbConnector dbConnector, final String defaultScheme) {
