...
final class MockNamedSnapshot implements NamedSnapshot, ImmutableBean {
  ...
  @Override
  public MockNamedSnapshot clone() {
    return this;
  }
   ...
   */
  public static class Builder extends DirectFieldsBeanBuilder<MockNamedSnapshot> {
     ...
     */
    protected Builder(MockNamedSnapshot beanToCopy) {
