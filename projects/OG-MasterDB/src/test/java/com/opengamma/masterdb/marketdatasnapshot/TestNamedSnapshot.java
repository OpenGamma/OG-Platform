 ...
 */
@BeanDefinition
final class TestNamedSnapshot implements NamedSnapshot, ImmutableBean {
  ...
  TestNamedSnapshot(UniqueId uniqueId, String name, int answer) {
    _uniqueId = uniqueId;
    _name = name;
    _answer = answer;
  }
  ...
  public NamedSnapshot withUniqueId(UniqueId uniqueId) {
    return new TestNamedSnapshot(uniqueId, _name, _answer);
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code TestNamedSnapshot}.
   * @return the meta-bean, not null
   */
  public static TestNamedSnapshot.Meta meta() {
    return TestNamedSnapshot.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(TestNamedSnapshot.Meta.INSTANCE);
  }
   ...
   */
  public static TestNamedSnapshot.Builder builder() {
    return new TestNamedSnapshot.Builder();
  }

  @Override
  public TestNamedSnapshot.Meta metaBean() {
    return TestNamedSnapshot.Meta.INSTANCE;
  }
  ...
  @Override
  public TestNamedSnapshot clone() {
    return this;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      TestNamedSnapshot other = (TestNamedSnapshot) obj;
  ...
  public static class Meta extends DirectMetaBean {
    ...
    @Override
    public TestNamedSnapshot.Builder builder() {
      return new TestNamedSnapshot.Builder();
    }

    @Override
    public Class<? extends TestNamedSnapshot> beanType() {
      return TestNamedSnapshot.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -294460212:  // uniqueId
          return ((TestNamedSnapshot) bean).getUniqueId();
        case 3373707:  // name
          return ((TestNamedSnapshot) bean).getName();
        case -1412808770:  // answer
          return ((TestNamedSnapshot) bean).getAnswer();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code TestNamedSnapshot}.
   */
  public static class Builder extends DirectFieldsBeanBuilder<TestNamedSnapshot> {
     ...
     */
    protected Builder(TestNamedSnapshot beanToCopy) {
    ...
    @Override
    public TestNamedSnapshot build() {
      return new TestNamedSnapshot(
          _uniqueId,
          _name,
          _answer);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("TestNamedSnapshot.Builder{");
      int len = buf.length();
      toString(buf);
      if (buf.length() > len) {
        buf.setLength(buf.length() - 2);
