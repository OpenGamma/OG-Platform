...
CREATE TABLE hol_holiday (
    ...
    provider_scheme varchar2(255),
    provider_value varchar2(255),
    hol_type varchar2(255) NOT NULL,
    region_scheme varchar2(255),
    region_value varchar2(255),
    exchange_scheme varchar2(255),
    exchange_value varchar2(255),
    custom_scheme varchar2(255),
    custom_value varchar2(255),
    currency_iso varchar2(255),
...
CREATE TABLE exg_idkey (
    id decimal(19) NOT NULL,
    key_scheme varchar2(255) NOT NULL,
