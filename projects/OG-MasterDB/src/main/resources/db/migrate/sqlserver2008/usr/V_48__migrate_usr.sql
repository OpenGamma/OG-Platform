...
DROP INDEX ix_usr_oguser_oid ON usr_oguser;
DROP INDEX ix_usr_oguser_ver_from_instant ON usr_oguser;
DROP INDEX ix_usr_oguser_ver_to_instant ON usr_oguser;
DROP INDEX ix_usr_oguser_corr_from_instant ON usr_oguser;
DROP INDEX ix_usr_oguser_corr_to_instant ON usr_oguser;
DROP INDEX ix_usr_oguser_userid ON usr_oguser;
DROP INDEX ix_usr_oguser_name ON usr_oguser;
DROP INDEX ix_usr_oguser_zone ON usr_oguser;
DROP INDEX ix_usr_oguser_email ON usr_oguser;
DROP INDEX ix_usr_oguser2idkey_idkey ON usr_oguser2idkey;
...
DROP TABLE usr_oguser_seq;
DROP TABLE usr_idkey_seq;


-- Main user tables
CREATE TABLE usr_user_seq (
  SeqID INT identity(1000,1) PRIMARY KEY,
  SeqVal VARCHAR(1)
);
CREATE TABLE usr_user_idkey_seq (
  SeqID INT identity(1000,1) PRIMARY KEY,
  SeqVal VARCHAR(1)
);
CREATE TABLE usr_user_perm_seq (
  SeqID INT identity(1000,1) PRIMARY KEY,
  SeqVal VARCHAR(1)
);
CREATE TABLE usr_user_extn_seq (
  SeqID INT identity(1000,1) PRIMARY KEY,
  SeqVal VARCHAR(1)
);
CREATE TABLE usr_user_event_seq (
  SeqID INT identity(1000,1) PRIMARY KEY,
  SeqVal VARCHAR(1)
);
...
CREATE TABLE usr_user_event_history (
    ...
    event_instant DATETIME2(6) NOT NULL,
    PRIMARY KEY (id)
);
...
-- Main role tables
CREATE TABLE usr_role_seq (
  SeqID INT identity(1000,1) PRIMARY KEY,
  SeqVal VARCHAR(1)
);
CREATE TABLE usr_role_assocuser_seq (
  SeqID INT identity(1000,1) PRIMARY KEY,
  SeqVal VARCHAR(1)
);
CREATE TABLE usr_role_assocperm_seq (
  SeqID INT identity(1000,1) PRIMARY KEY,
  SeqVal VARCHAR(1)
);
CREATE TABLE usr_role_assocrole_seq (
  SeqID INT identity(1000,1) PRIMARY KEY,
  SeqVal VARCHAR(1)
);
CREATE TABLE usr_role_event_seq (
  SeqID INT identity(1000,1) PRIMARY KEY,
  SeqVal VARCHAR(1)
);
