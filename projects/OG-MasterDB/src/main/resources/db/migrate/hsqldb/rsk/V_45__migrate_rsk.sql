...
-------------------------------------;
CREATE SEQUENCE rsk_batch_seq AS bigint START WITH 1000 INCREMENT BY 1 NO CYCLE;
...
ALTER TABLE rsk_run_property ALTER COLUMN run_id SET DATA TYPE bigint;


ALTER TABLE rsk_run_status ALTER COLUMN status SET DATA TYPE VARCHAR(255);
