...
public abstract class FutureSecurityBean extends SecurityBean {
  ...
  public interface Visitor<T> {
    ...
    T visitFXFutureType(ForeignExchangeFutureBean bean);

    T visitEnergyFutureType(EnergyFutureBean bean);

    T visitInterestRateFutureType(InterestRateFutureBean bean);

    T visitMetalFutureType(MetalFutureBean bean);

    T visitIndexFutureType(IndexFutureBean bean);

    T visitStockFutureType(StockFutureBean bean);
  ...
  public static class Meta extends SecurityBean.Meta {
    ...
    private final MetaProperty<CurrencyBean> _currency = DirectMetaProperty.ofReadWrite(
        this, "currency", FutureSecurityBean.class, CurrencyBean.class);
    /**
    ...
    private final MetaProperty<ContractCategoryBean> _category = DirectMetaProperty.ofReadWrite(
        this, "category", FutureSecurityBean.class, ContractCategoryBean.class);
    /**
     * The meta-properties.
     */
    ...
    public BeanBuilder<? extends FutureSecurityBean> builder() {
      throw new UnsupportedOperationException("FutureSecurityBean is an abstract class");
    }
