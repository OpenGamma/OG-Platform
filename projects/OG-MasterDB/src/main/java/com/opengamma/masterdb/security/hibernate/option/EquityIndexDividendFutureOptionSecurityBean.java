...
/**
 * A Hibernate bean representation of {@link EquityIndexDividendFutureOptionSecurity}.
 */
@BeanDefinition
public class EquityIndexDividendFutureOptionSecurityBean extends SecurityBean {
  @PropertyDefinition
  ...
  public EquityIndexDividendFutureOptionSecurityBean() {
    super();
  }

  @Override
  public boolean equals(final Object other) {
    if (!(other instanceof EquityIndexDividendFutureOptionSecurityBean)) {
      return false;
    }
    final EquityIndexDividendFutureOptionSecurityBean option = (EquityIndexDividendFutureOptionSecurityBean) other;
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code EquityIndexDividendFutureOptionSecurityBean}.
  ...
  @Override
  public EquityIndexDividendFutureOptionSecurityBean.Meta metaBean() {
    return EquityIndexDividendFutureOptionSecurityBean.Meta.INSTANCE;
  }
  ...
  //-----------------------------------------------------------------------
  @Override
  public EquityIndexDividendFutureOptionSecurityBean clone() {
    return (EquityIndexDividendFutureOptionSecurityBean) super.clone();
  }
  ...
  public static class Meta extends SecurityBean.Meta {
    ...
    private final MetaProperty<OptionExerciseType> _optionExerciseType = DirectMetaProperty.ofReadWrite(
        this, "optionExerciseType", EquityIndexDividendFutureOptionSecurityBean.class, OptionExerciseType.class);
    /**
    ...
    private final MetaProperty<OptionType> _optionType = DirectMetaProperty.ofReadWrite(
        this, "optionType", EquityIndexDividendFutureOptionSecurityBean.class, OptionType.class);
    /**
     * The meta-property for the {@code strike} property.
     */
    private final MetaProperty<Double> _strike = DirectMetaProperty.ofReadWrite(
        this, "strike", EquityIndexDividendFutureOptionSecurityBean.class, Double.TYPE);
    /**
     * The meta-property for the {@code expiry} property.
     */
    private final MetaProperty<ExpiryBean> _expiry = DirectMetaProperty.ofReadWrite(
        this, "expiry", EquityIndexDividendFutureOptionSecurityBean.class, ExpiryBean.class);
    /**
     * The meta-property for the {@code currency} property.
     */
    private final MetaProperty<CurrencyBean> _currency = DirectMetaProperty.ofReadWrite(
        this, "currency", EquityIndexDividendFutureOptionSecurityBean.class, CurrencyBean.class);
    /**
    ...
    private final MetaProperty<ExchangeBean> _exchange = DirectMetaProperty.ofReadWrite(
        this, "exchange", EquityIndexDividendFutureOptionSecurityBean.class, ExchangeBean.class);
    /**
    ...
    private final MetaProperty<Boolean> _margined = DirectMetaProperty.ofReadWrite(
        this, "margined", EquityIndexDividendFutureOptionSecurityBean.class, Boolean.class);
    /**
    ...
    private final MetaProperty<Double> _pointValue = DirectMetaProperty.ofReadWrite(
        this, "pointValue", EquityIndexDividendFutureOptionSecurityBean.class, Double.class);
    /**
     * The meta-property for the {@code underlying} property.
     */
    private final MetaProperty<ExternalIdBean> _underlying = DirectMetaProperty.ofReadWrite(
        this, "underlying", EquityIndexDividendFutureOptionSecurityBean.class, ExternalIdBean.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends EquityIndexDividendFutureOptionSecurityBean> builder() {
      return new DirectBeanBuilder<EquityIndexDividendFutureOptionSecurityBean>(new EquityIndexDividendFutureOptionSecurityBean());
    }

    @Override
    public Class<? extends EquityIndexDividendFutureOptionSecurityBean> beanType() {
      return EquityIndexDividendFutureOptionSecurityBean.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -266326457:  // optionExerciseType
          return ((EquityIndexDividendFutureOptionSecurityBean) bean).getOptionExerciseType();
        case 1373587791:  // optionType
          return ((EquityIndexDividendFutureOptionSecurityBean) bean).getOptionType();
        case -891985998:  // strike
          return ((EquityIndexDividendFutureOptionSecurityBean) bean).getStrike();
        case -1289159373:  // expiry
          return ((EquityIndexDividendFutureOptionSecurityBean) bean).getExpiry();
        case 575402001:  // currency
          return ((EquityIndexDividendFutureOptionSecurityBean) bean).getCurrency();
        case 1989774883:  // exchange
          return ((EquityIndexDividendFutureOptionSecurityBean) bean).getExchange();
        case 243392205:  // margined
          return ((EquityIndexDividendFutureOptionSecurityBean) bean).getMargined();
        case 1257391553:  // pointValue
          return ((EquityIndexDividendFutureOptionSecurityBean) bean).getPointValue();
        case -1770633379:  // underlying
          return ((EquityIndexDividendFutureOptionSecurityBean) bean).getUnderlying();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -266326457:  // optionExerciseType
          ((EquityIndexDividendFutureOptionSecurityBean) bean).setOptionExerciseType((OptionExerciseType) newValue);
          return;
        case 1373587791:  // optionType
          ((EquityIndexDividendFutureOptionSecurityBean) bean).setOptionType((OptionType) newValue);
          return;
        case -891985998:  // strike
          ((EquityIndexDividendFutureOptionSecurityBean) bean).setStrike((Double) newValue);
          return;
        case -1289159373:  // expiry
          ((EquityIndexDividendFutureOptionSecurityBean) bean).setExpiry((ExpiryBean) newValue);
          return;
        case 575402001:  // currency
          ((EquityIndexDividendFutureOptionSecurityBean) bean).setCurrency((CurrencyBean) newValue);
          return;
        case 1989774883:  // exchange
          ((EquityIndexDividendFutureOptionSecurityBean) bean).setExchange((ExchangeBean) newValue);
          return;
        case 243392205:  // margined
          ((EquityIndexDividendFutureOptionSecurityBean) bean).setMargined((Boolean) newValue);
          return;
        case 1257391553:  // pointValue
          ((EquityIndexDividendFutureOptionSecurityBean) bean).setPointValue((Double) newValue);
          return;
        case -1770633379:  // underlying
          ((EquityIndexDividendFutureOptionSecurityBean) bean).setUnderlying((ExternalIdBean) newValue);
          return;
      }
