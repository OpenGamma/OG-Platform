...
/**
 * A Hibernate bean representation of {@link com.opengamma.financial.security.option.FxFutureOptionSecurity}.
 */
@BeanDefinition
public class FxFutureOptionSecurityBean extends SecurityBean {
  @PropertyDefinition
  ...
  public boolean equals(final Object other) {
    if (!(other instanceof FxFutureOptionSecurityBean)) {
      return false;
    }
    final FxFutureOptionSecurityBean option = (FxFutureOptionSecurityBean) other;
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code FxFutureOptionSecurityBean}.
  ...
  @Override
  public FxFutureOptionSecurityBean.Meta metaBean() {
    return FxFutureOptionSecurityBean.Meta.INSTANCE;
  }
  ...
  public static class Meta extends SecurityBean.Meta {
    ...
    private final MetaProperty<OptionExerciseType> _optionExerciseType = DirectMetaProperty.ofReadWrite(
        this, "optionExerciseType", FxFutureOptionSecurityBean.class, OptionExerciseType.class);
    /**
    ...
    private final MetaProperty<ExchangeBean> _tradingExchange = DirectMetaProperty.ofReadWrite(
        this, "tradingExchange", FxFutureOptionSecurityBean.class, ExchangeBean.class);
    /**
    ...
    private final MetaProperty<ExchangeBean> _settlementExchange = DirectMetaProperty.ofReadWrite(
        this, "settlementExchange", FxFutureOptionSecurityBean.class, ExchangeBean.class);
    /**
    ...
    private final MetaProperty<Double> _pointValue = DirectMetaProperty.ofReadWrite(
        this, "pointValue", FxFutureOptionSecurityBean.class, Double.class);
    /**
     * The meta-property for the {@code underlying} property.
     */
    private final MetaProperty<ExternalIdBean> _underlying = DirectMetaProperty.ofReadWrite(
        this, "underlying", FxFutureOptionSecurityBean.class, ExternalIdBean.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends FxFutureOptionSecurityBean> builder() {
      return new DirectBeanBuilder<FxFutureOptionSecurityBean>(new FxFutureOptionSecurityBean());
    }

    @Override
    public Class<? extends FxFutureOptionSecurityBean> beanType() {
      return FxFutureOptionSecurityBean.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -266326457:  // optionExerciseType
          return ((FxFutureOptionSecurityBean) bean).getOptionExerciseType();
        case 1373587791:  // optionType
          return ((FxFutureOptionSecurityBean) bean).getOptionType();
        case -891985998:  // strike
          return ((FxFutureOptionSecurityBean) bean).getStrike();
        case -1289159373:  // expiry
          return ((FxFutureOptionSecurityBean) bean).getExpiry();
        case 575402001:  // currency
          return ((FxFutureOptionSecurityBean) bean).getCurrency();
        case -661485980:  // tradingExchange
          return ((FxFutureOptionSecurityBean) bean).getTradingExchange();
        case 389497452:  // settlementExchange
          return ((FxFutureOptionSecurityBean) bean).getSettlementExchange();
        case 1257391553:  // pointValue
          return ((FxFutureOptionSecurityBean) bean).getPointValue();
        case -1770633379:  // underlying
          return ((FxFutureOptionSecurityBean) bean).getUnderlying();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -266326457:  // optionExerciseType
          ((FxFutureOptionSecurityBean) bean).setOptionExerciseType((OptionExerciseType) newValue);
          return;
        case 1373587791:  // optionType
          ((FxFutureOptionSecurityBean) bean).setOptionType((OptionType) newValue);
          return;
        case -891985998:  // strike
          ((FxFutureOptionSecurityBean) bean).setStrike((Double) newValue);
          return;
        case -1289159373:  // expiry
          ((FxFutureOptionSecurityBean) bean).setExpiry((ExpiryBean) newValue);
          return;
        case 575402001:  // currency
          ((FxFutureOptionSecurityBean) bean).setCurrency((CurrencyBean) newValue);
          return;
        case -661485980:  // tradingExchange
          ((FxFutureOptionSecurityBean) bean).setTradingExchange((ExchangeBean) newValue);
          return;
        case 389497452:  // settlementExchange
          ((FxFutureOptionSecurityBean) bean).setSettlementExchange((ExchangeBean) newValue);
          return;
        case 1257391553:  // pointValue
          ((FxFutureOptionSecurityBean) bean).setPointValue((Double) newValue);
          return;
        case -1770633379:  // underlying
          ((FxFutureOptionSecurityBean) bean).setUnderlying((ExternalIdBean) newValue);
          return;
      }
