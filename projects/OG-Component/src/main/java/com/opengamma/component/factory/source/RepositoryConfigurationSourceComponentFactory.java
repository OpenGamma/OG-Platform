...
public class RepositoryConfigurationSourceComponentFactory extends AbstractComponentFactory {
  ...
  protected RepositoryConfigurationSource surfaceConfiguration() {
    final DemoSurfaceFunctionConfiguration factory = new DemoSurfaceFunctionConfiguration();
  ...
  protected List<RepositoryConfigurationSource> initSources() {
    return Arrays.asList(financialFunctions(), standardConfiguration(), curveConfigurations(), surfaceConfiguration(), cubeConfigurations());
  }
