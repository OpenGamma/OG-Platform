...
public class DataTrackingExchangeMasterComponentFactory extends AbstractComponentFactory {
  ...
  public void init(ComponentRepository repo, LinkedHashMap<String, String> configuration) throws Exception {
    ...
    ComponentInfo componentInfo = new ComponentInfo(ExchangeMaster.class, _classifier);
    
    DataTrackingExchangeMaster dataTrackingExchangeMaster = new DataTrackingExchangeMaster(_trackedMaster);
  ...
  public DataTrackingExchangeMasterComponentFactory clone() {
    return (DataTrackingExchangeMasterComponentFactory) super.clone();
  }
