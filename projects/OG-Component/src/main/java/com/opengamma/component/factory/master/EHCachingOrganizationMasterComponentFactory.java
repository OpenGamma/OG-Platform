...
public class EHCachingOrganizationMasterComponentFactory extends AbstractComponentFactory {
  ...
  //-----------------------------------------------------------------------
  @Override
  public EHCachingOrganizationMasterComponentFactory clone() {
    return (EHCachingOrganizationMasterComponentFactory) super.clone();
  }
  ...
  public String toString() {
    ...
    buf.append("EHCachingOrganizationMasterComponentFactory{");
    int len = buf.length();
    toString(buf);
    if (buf.length() > len) {
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    private final MetaProperty<CacheManager> _cacheManager = DirectMetaProperty.ofReadWrite(
        this, "cacheManager", EHCachingOrganizationMasterComponentFactory.class, CacheManager.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          return ((EHCachingOrganizationMasterComponentFactory) bean).getClassifier();
        case -614707837:  // publishRest
          return ((EHCachingOrganizationMasterComponentFactory) bean).isPublishRest();
        case -1770633379:  // underlying
          return ((EHCachingOrganizationMasterComponentFactory) bean).getUnderlying();
        case -1452875317:  // cacheManager
          return ((EHCachingOrganizationMasterComponentFactory) bean).getCacheManager();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          ((EHCachingOrganizationMasterComponentFactory) bean).setClassifier((String) newValue);
          return;
        case -614707837:  // publishRest
          ((EHCachingOrganizationMasterComponentFactory) bean).setPublishRest((Boolean) newValue);
          return;
        case -1770633379:  // underlying
          ((EHCachingOrganizationMasterComponentFactory) bean).setUnderlying((OrganizationMaster) newValue);
          return;
        case -1452875317:  // cacheManager
          ((EHCachingOrganizationMasterComponentFactory) bean).setCacheManager((CacheManager) newValue);
          return;
      }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((EHCachingOrganizationMasterComponentFactory) bean)._classifier, "classifier");
      JodaBeanUtils.notNull(((EHCachingOrganizationMasterComponentFactory) bean)._underlying, "underlying");
      super.validate(bean);
    }
