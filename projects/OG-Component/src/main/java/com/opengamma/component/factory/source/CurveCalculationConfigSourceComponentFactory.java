...
/**
 * Component factory providing the {@code CurveCalculationConfigSource}. This is a minimal class that does not contain any caching or REST capabilities.
 */
@BeanDefinition
public class CurveCalculationConfigSourceComponentFactory extends AbstractComponentFactory {
  ...
  public void init(final ComponentRepository repo, final LinkedHashMap<String, String> configuration) {
    ...
    final CurveCalculationConfigSource source = new ConfigDBCurveCalculationConfigSource(getConfigSource());
