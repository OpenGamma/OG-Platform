...
public class DbOrganizationMasterComponentFactory extends AbstractDocumentDbMasterComponentFactory<OrganizationMaster, DbOrganizationMaster> {
  ...
  @Override
  protected OrganizationMaster wrapMasterWithTrackingInterface(OrganizationMaster postProcessedMaster) {
    return new DataTrackingOrganizationMaster(postProcessedMaster);
  }
