 ...
 */
@BeanDefinition
public class DbConventionMasterComponentFactory extends AbstractDbMasterComponentFactory {
  ...
  public void init(ComponentRepository repo, LinkedHashMap<String, String> configuration) {
    ComponentInfo info = new ComponentInfo(ConventionMaster.class, getClassifier());
    ...
    checkSchema(master.getSchemaVersion(), "cnv");
  ...
  public static class Meta extends AbstractDbMasterComponentFactory.Meta {
    ...
    private final MetaProperty<String> _classifier = DirectMetaProperty.ofReadWrite(
        this, "classifier", DbConventionMasterComponentFactory.class, String.class);
    /**
     * The meta-property for the {@code publishRest} property.
     */
    private final MetaProperty<Boolean> _publishRest = DirectMetaProperty.ofReadWrite(
        this, "publishRest", DbConventionMasterComponentFactory.class, Boolean.TYPE);
    /**
     * The meta-property for the {@code jmsConnector} property.
     */
    private final MetaProperty<JmsConnector> _jmsConnector = DirectMetaProperty.ofReadWrite(
        this, "jmsConnector", DbConventionMasterComponentFactory.class, JmsConnector.class);
    /**
    ...
    private final MetaProperty<String> _jmsChangeManagerTopic = DirectMetaProperty.ofReadWrite(
        this, "jmsChangeManagerTopic", DbConventionMasterComponentFactory.class, String.class);
    /**
    ...
    private final MetaProperty<String> _uniqueIdScheme = DirectMetaProperty.ofReadWrite(
        this, "uniqueIdScheme", DbConventionMasterComponentFactory.class, String.class);
    /**
    ...
    private final MetaProperty<Integer> _maxRetries = DirectMetaProperty.ofReadWrite(
        this, "maxRetries", DbConventionMasterComponentFactory.class, Integer.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          return ((DbConventionMasterComponentFactory) bean).getClassifier();
        case -614707837:  // publishRest
          return ((DbConventionMasterComponentFactory) bean).isPublishRest();
        case -1495762275:  // jmsConnector
          return ((DbConventionMasterComponentFactory) bean).getJmsConnector();
        case -758086398:  // jmsChangeManagerTopic
          return ((DbConventionMasterComponentFactory) bean).getJmsChangeManagerTopic();
        case -1737146991:  // uniqueIdScheme
          return ((DbConventionMasterComponentFactory) bean).getUniqueIdScheme();
        case -2022653118:  // maxRetries
          return ((DbConventionMasterComponentFactory) bean).getMaxRetries();
        case 1366925483:  // populateDefaultConventions
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          ((DbConventionMasterComponentFactory) bean).setClassifier((String) newValue);
          return;
        case -614707837:  // publishRest
          ((DbConventionMasterComponentFactory) bean).setPublishRest((Boolean) newValue);
          return;
        case -1495762275:  // jmsConnector
          ((DbConventionMasterComponentFactory) bean).setJmsConnector((JmsConnector) newValue);
          return;
        case -758086398:  // jmsChangeManagerTopic
          ((DbConventionMasterComponentFactory) bean).setJmsChangeManagerTopic((String) newValue);
          return;
        case -1737146991:  // uniqueIdScheme
          ((DbConventionMasterComponentFactory) bean).setUniqueIdScheme((String) newValue);
          return;
        case -2022653118:  // maxRetries
          ((DbConventionMasterComponentFactory) bean).setMaxRetries((Integer) newValue);
          return;
        case 1366925483:  // populateDefaultConventions
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((DbConventionMasterComponentFactory) bean)._classifier, "classifier");
      super.validate(bean);
    }
