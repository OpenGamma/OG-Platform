 ...
 */
@BeanDefinition
public class DbConventionMasterComponentFactory extends AbstractDocumentDbMasterComponentFactory<DbConventionBeanMaster> {
  ...
  @Override
  protected AbstractDataResource createPublishedResource(DbConventionBeanMaster dbMaster, Object postProcessedMaster) {
    return new DataConventionMasterResource((ConventionMaster) postProcessedMaster);
  }
   ...
   * The meta-bean for {@code DbConventionMasterComponentFactory}.
   */
  public static class Meta extends AbstractDocumentDbMasterComponentFactory.Meta<DbConventionBeanMaster> {
    /**
