...
public abstract class AbstractNonVersionedRedisSourceComponentFactory extends AbstractComponentFactory {
  ...
  public void setResolverClassifier(String resolverClassifier) {
    this._resolverClassifier = resolverClassifier;
  }

  /**
   * Gets the the {@code resolverClassifier} property.
   * @return the property, not null
   */
  public final Property<String> resolverClassifier() {
    return metaBean().resolverClassifier().createProperty(this);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(getClassifier(), other.getClassifier()) &&
          ...
          JodaBeanUtils.equal(getResolverClassifier(), other.getResolverClassifier()) &&
          super.equals(obj);
    }
    return false;
  }
  ...
  protected void toString(StringBuilder buf) {
    ...
    buf.append("resolverClassifier").append('=').append(JodaBeanUtils.toString(getResolverClassifier())).append(',').append(' ');
  }
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    /**
     * The meta-property for the {@code resolverClassifier} property.
     */
    private final MetaProperty<String> _resolverClassifier = DirectMetaProperty.ofReadWrite(
        this, "resolverClassifier", AbstractNonVersionedRedisSourceComponentFactory.class, String.class);
    /**
     * The meta-properties.
     */
    ...
    protected MetaProperty<?> metaPropertyGet(String propertyName) {
      switch (propertyName.hashCode()) {
        ...
        case -614707837:  // publishRest
          return _publishRest;
        case -1651252537:  // resolverClassifier
          return _resolverClassifier;
      }
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<String> resolverClassifier() {
      return _resolverClassifier;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1651252537:  // resolverClassifier
          return ((AbstractNonVersionedRedisSourceComponentFactory) bean).getResolverClassifier();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -614707837:  // publishRest
          ...
          return;
        case -1651252537:  // resolverClassifier
          ((AbstractNonVersionedRedisSourceComponentFactory) bean).setResolverClassifier((String) newValue);
          return;
      }
