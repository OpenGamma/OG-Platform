 ...
 */
@BeanDefinition
public class DbLegalEntityMasterComponentFactory extends AbstractDbMasterComponentFactory {
  ...
  public void init(ComponentRepository repo, LinkedHashMap<String, String> configuration) {
    ...
    // create
    DbLegalEntityBeanMaster master = new DbLegalEntityBeanMaster(getDbConnector());
    master.registerMetrics(OpenGammaMetricRegistry.getSummaryInstance(), OpenGammaMetricRegistry.getDetailedInstance(), "DbLegalentitiesMaster-" + getClassifier());
    ...
    checkSchema(master.getSchemaVersion(), "len");
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      DbLegalEntityMasterComponentFactory other = (DbLegalEntityMasterComponentFactory) obj;
  ...
  public static class Meta extends AbstractDbMasterComponentFactory.Meta {
    ...
    private final MetaProperty<String> _classifier = DirectMetaProperty.ofReadWrite(
        this, "classifier", DbLegalEntityMasterComponentFactory.class, String.class);
    /**
     * The meta-property for the {@code publishRest} property.
     */
    private final MetaProperty<Boolean> _publishRest = DirectMetaProperty.ofReadWrite(
        this, "publishRest", DbLegalEntityMasterComponentFactory.class, Boolean.TYPE);
    /**
     * The meta-property for the {@code jmsConnector} property.
     */
    private final MetaProperty<JmsConnector> _jmsConnector = DirectMetaProperty.ofReadWrite(
        this, "jmsConnector", DbLegalEntityMasterComponentFactory.class, JmsConnector.class);
    /**
    ...
    private final MetaProperty<String> _jmsChangeManagerTopic = DirectMetaProperty.ofReadWrite(
        this, "jmsChangeManagerTopic", DbLegalEntityMasterComponentFactory.class, String.class);
    /**
    ...
    private final MetaProperty<String> _uniqueIdScheme = DirectMetaProperty.ofReadWrite(
        this, "uniqueIdScheme", DbLegalEntityMasterComponentFactory.class, String.class);
    /**
    ...
    private final MetaProperty<Integer> _maxRetries = DirectMetaProperty.ofReadWrite(
        this, "maxRetries", DbLegalEntityMasterComponentFactory.class, Integer.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          return ((DbLegalEntityMasterComponentFactory) bean).getClassifier();
        case -614707837:  // publishRest
          return ((DbLegalEntityMasterComponentFactory) bean).isPublishRest();
        case -1495762275:  // jmsConnector
          return ((DbLegalEntityMasterComponentFactory) bean).getJmsConnector();
        case -758086398:  // jmsChangeManagerTopic
          return ((DbLegalEntityMasterComponentFactory) bean).getJmsChangeManagerTopic();
        case -1737146991:  // uniqueIdScheme
          return ((DbLegalEntityMasterComponentFactory) bean).getUniqueIdScheme();
        case -2022653118:  // maxRetries
          return ((DbLegalEntityMasterComponentFactory) bean).getMaxRetries();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          ((DbLegalEntityMasterComponentFactory) bean).setClassifier((String) newValue);
          return;
        case -614707837:  // publishRest
          ((DbLegalEntityMasterComponentFactory) bean).setPublishRest((Boolean) newValue);
          return;
        case -1495762275:  // jmsConnector
          ((DbLegalEntityMasterComponentFactory) bean).setJmsConnector((JmsConnector) newValue);
          return;
        case -758086398:  // jmsChangeManagerTopic
          ((DbLegalEntityMasterComponentFactory) bean).setJmsChangeManagerTopic((String) newValue);
          return;
        case -1737146991:  // uniqueIdScheme
          ((DbLegalEntityMasterComponentFactory) bean).setUniqueIdScheme((String) newValue);
          return;
        case -2022653118:  // maxRetries
          ((DbLegalEntityMasterComponentFactory) bean).setMaxRetries((Integer) newValue);
          return;
      }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((DbLegalEntityMasterComponentFactory) bean)._classifier, "classifier");
      super.validate(bean);
    }
