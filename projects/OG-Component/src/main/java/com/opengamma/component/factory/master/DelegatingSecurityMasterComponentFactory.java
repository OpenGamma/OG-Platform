 ...
 */
@BeanDefinition
public class DelegatingSecurityMasterComponentFactory extends AbstractComponentFactory {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code DelegatingSecurityMasterComponentFactory}.
   * @return the meta-bean, not null
   */
  public static DelegatingSecurityMasterComponentFactory.Meta meta() {
    return DelegatingSecurityMasterComponentFactory.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(DelegatingSecurityMasterComponentFactory.Meta.INSTANCE);
  }

  @Override
  public DelegatingSecurityMasterComponentFactory.Meta metaBean() {
    return DelegatingSecurityMasterComponentFactory.Meta.INSTANCE;
  }
  ...
  //-----------------------------------------------------------------------
  @Override
  public DelegatingSecurityMasterComponentFactory clone() {
    return (DelegatingSecurityMasterComponentFactory) super.clone();
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      DelegatingSecurityMasterComponentFactory other = (DelegatingSecurityMasterComponentFactory) obj;
  ...
  public String toString() {
    ...
    buf.append("DelegatingSecurityMasterComponentFactory{");
    int len = buf.length();
    toString(buf);
    if (buf.length() > len) {
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    private final MetaProperty<String> _classifier = DirectMetaProperty.ofReadWrite(
        this, "classifier", DelegatingSecurityMasterComponentFactory.class, String.class);
    /**
     * The meta-property for the {@code publishRest} property.
     */
    private final MetaProperty<Boolean> _publishRest = DirectMetaProperty.ofReadWrite(
        this, "publishRest", DelegatingSecurityMasterComponentFactory.class, Boolean.TYPE);
    /**
    ...
    private final MetaProperty<SecurityMaster> _defaultSecurityMaster = DirectMetaProperty.ofReadWrite(
        this, "defaultSecurityMaster", DelegatingSecurityMasterComponentFactory.class, SecurityMaster.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends DelegatingSecurityMasterComponentFactory> builder() {
      return new DirectBeanBuilder<DelegatingSecurityMasterComponentFactory>(new DelegatingSecurityMasterComponentFactory());
    }

    @Override
    public Class<? extends DelegatingSecurityMasterComponentFactory> beanType() {
      return DelegatingSecurityMasterComponentFactory.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          return ((DelegatingSecurityMasterComponentFactory) bean).getClassifier();
        case -614707837:  // publishRest
          return ((DelegatingSecurityMasterComponentFactory) bean).isPublishRest();
        case 163592803:  // defaultSecurityMaster
          return ((DelegatingSecurityMasterComponentFactory) bean).getDefaultSecurityMaster();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          ((DelegatingSecurityMasterComponentFactory) bean).setClassifier((String) newValue);
          return;
        case -614707837:  // publishRest
          ((DelegatingSecurityMasterComponentFactory) bean).setPublishRest((Boolean) newValue);
          return;
        case 163592803:  // defaultSecurityMaster
          ((DelegatingSecurityMasterComponentFactory) bean).setDefaultSecurityMaster((SecurityMaster) newValue);
          return;
      }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((DelegatingSecurityMasterComponentFactory) bean)._classifier, "classifier");
      JodaBeanUtils.notNull(((DelegatingSecurityMasterComponentFactory) bean)._defaultSecurityMaster, "defaultSecurityMaster");
      super.validate(bean);
    }
