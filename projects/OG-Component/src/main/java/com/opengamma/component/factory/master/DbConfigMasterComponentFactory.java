 ...
 */
@BeanDefinition
public class DbConfigMasterComponentFactory extends AbstractDbMasterComponentFactory {
  ...
  public static class Meta extends AbstractDbMasterComponentFactory.Meta {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          return ((DbConfigMasterComponentFactory) bean).getClassifier();
        case -614707837:  // publishRest
          return ((DbConfigMasterComponentFactory) bean).isPublishRest();
        case -1495762275:  // jmsConnector
          return ((DbConfigMasterComponentFactory) bean).getJmsConnector();
        case -758086398:  // jmsChangeManagerTopic
          return ((DbConfigMasterComponentFactory) bean).getJmsChangeManagerTopic();
        case -1737146991:  // uniqueIdScheme
          return ((DbConfigMasterComponentFactory) bean).getUniqueIdScheme();
        case -2022653118:  // maxRetries
          return ((DbConfigMasterComponentFactory) bean).getMaxRetries();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          ((DbConfigMasterComponentFactory) bean).setClassifier((String) newValue);
          return;
        case -614707837:  // publishRest
          ((DbConfigMasterComponentFactory) bean).setPublishRest((Boolean) newValue);
          return;
        case -1495762275:  // jmsConnector
          ((DbConfigMasterComponentFactory) bean).setJmsConnector((JmsConnector) newValue);
          return;
        case -758086398:  // jmsChangeManagerTopic
          ((DbConfigMasterComponentFactory) bean).setJmsChangeManagerTopic((String) newValue);
          return;
        case -1737146991:  // uniqueIdScheme
          ((DbConfigMasterComponentFactory) bean).setUniqueIdScheme((String) newValue);
          return;
        case -2022653118:  // maxRetries
          ((DbConfigMasterComponentFactory) bean).setMaxRetries((Integer) newValue);
          return;
      }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((DbConfigMasterComponentFactory) bean)._classifier, "classifier");
      super.validate(bean);
    }
