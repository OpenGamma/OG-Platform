 ...
 */
@BeanDefinition
public class DbConfigMasterComponentFactory extends AbstractDocumentDbMasterComponentFactory<DbConfigMaster> {
  ...
  @Override
  protected AbstractDataResource createPublishedResource(DbConfigMaster dbMaster, Object postProcessedMaster) {
    return new DataConfigMasterResource((ConfigMaster) postProcessedMaster);
  }
   ...
   * The meta-bean for {@code DbConfigMasterComponentFactory}.
   */
  public static class Meta extends AbstractDocumentDbMasterComponentFactory.Meta<DbConfigMaster> {
    /**
