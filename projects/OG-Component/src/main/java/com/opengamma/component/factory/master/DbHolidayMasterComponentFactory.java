 ...
 */
@BeanDefinition
public class DbHolidayMasterComponentFactory extends AbstractDbMasterComponentFactory {
  ...
  public static class Meta extends AbstractDbMasterComponentFactory.Meta {
    ...
    private final MetaProperty<String> _uniqueIdScheme = DirectMetaProperty.ofReadWrite(
        this, "uniqueIdScheme", DbHolidayMasterComponentFactory.class, String.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          return ((DbHolidayMasterComponentFactory) bean).getClassifier();
        case -614707837:  // publishRest
          return ((DbHolidayMasterComponentFactory) bean).isPublishRest();
        case -1495762275:  // jmsConnector
          return ((DbHolidayMasterComponentFactory) bean).getJmsConnector();
        case -758086398:  // jmsChangeManagerTopic
          return ((DbHolidayMasterComponentFactory) bean).getJmsChangeManagerTopic();
        case -1737146991:  // uniqueIdScheme
          return ((DbHolidayMasterComponentFactory) bean).getUniqueIdScheme();
        case -2022653118:  // maxRetries
          return ((DbHolidayMasterComponentFactory) bean).getMaxRetries();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          ((DbHolidayMasterComponentFactory) bean).setClassifier((String) newValue);
          return;
        case -614707837:  // publishRest
          ((DbHolidayMasterComponentFactory) bean).setPublishRest((Boolean) newValue);
          return;
        case -1495762275:  // jmsConnector
          ((DbHolidayMasterComponentFactory) bean).setJmsConnector((JmsConnector) newValue);
          return;
        case -758086398:  // jmsChangeManagerTopic
          ((DbHolidayMasterComponentFactory) bean).setJmsChangeManagerTopic((String) newValue);
          return;
        case -1737146991:  // uniqueIdScheme
          ((DbHolidayMasterComponentFactory) bean).setUniqueIdScheme((String) newValue);
          return;
        case -2022653118:  // maxRetries
          ((DbHolidayMasterComponentFactory) bean).setMaxRetries((Integer) newValue);
          return;
      }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((DbHolidayMasterComponentFactory) bean)._classifier, "classifier");
      super.validate(bean);
    }
