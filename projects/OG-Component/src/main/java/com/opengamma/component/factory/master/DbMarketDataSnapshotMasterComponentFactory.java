...
public class DbMarketDataSnapshotMasterComponentFactory extends AbstractDbMasterComponentFactory {
  ...
  public static class Meta extends AbstractDbMasterComponentFactory.Meta {
    ...
    private final MetaProperty<String> _classifier = DirectMetaProperty.ofReadWrite(
        this, "classifier", DbMarketDataSnapshotMasterComponentFactory.class, String.class);
    /**
    ...
    private final MetaProperty<JmsConnector> _jmsConnector = DirectMetaProperty.ofReadWrite(
        this, "jmsConnector", DbMarketDataSnapshotMasterComponentFactory.class, JmsConnector.class);
    /**
    ...
    private final MetaProperty<String> _jmsChangeManagerTopic = DirectMetaProperty.ofReadWrite(
        this, "jmsChangeManagerTopic", DbMarketDataSnapshotMasterComponentFactory.class, String.class);
    /**
    ...
    private final MetaProperty<String> _uniqueIdScheme = DirectMetaProperty.ofReadWrite(
        this, "uniqueIdScheme", DbMarketDataSnapshotMasterComponentFactory.class, String.class);
    /**
    ...
    private final MetaProperty<Integer> _maxRetries = DirectMetaProperty.ofReadWrite(
        this, "maxRetries", DbMarketDataSnapshotMasterComponentFactory.class, Integer.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          return ((DbMarketDataSnapshotMasterComponentFactory) bean).getClassifier();
        case -614707837:  // publishRest
          return ((DbMarketDataSnapshotMasterComponentFactory) bean).isPublishRest();
        case -1495762275:  // jmsConnector
          return ((DbMarketDataSnapshotMasterComponentFactory) bean).getJmsConnector();
        case -758086398:  // jmsChangeManagerTopic
          return ((DbMarketDataSnapshotMasterComponentFactory) bean).getJmsChangeManagerTopic();
        case -1737146991:  // uniqueIdScheme
          return ((DbMarketDataSnapshotMasterComponentFactory) bean).getUniqueIdScheme();
        case -2022653118:  // maxRetries
          return ((DbMarketDataSnapshotMasterComponentFactory) bean).getMaxRetries();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          ((DbMarketDataSnapshotMasterComponentFactory) bean).setClassifier((String) newValue);
          return;
        case -614707837:  // publishRest
          ((DbMarketDataSnapshotMasterComponentFactory) bean).setPublishRest((Boolean) newValue);
          return;
        case -1495762275:  // jmsConnector
          ((DbMarketDataSnapshotMasterComponentFactory) bean).setJmsConnector((JmsConnector) newValue);
          return;
        case -758086398:  // jmsChangeManagerTopic
          ((DbMarketDataSnapshotMasterComponentFactory) bean).setJmsChangeManagerTopic((String) newValue);
          return;
        case -1737146991:  // uniqueIdScheme
          ((DbMarketDataSnapshotMasterComponentFactory) bean).setUniqueIdScheme((String) newValue);
          return;
        case -2022653118:  // maxRetries
          ((DbMarketDataSnapshotMasterComponentFactory) bean).setMaxRetries((Integer) newValue);
          return;
      }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((DbMarketDataSnapshotMasterComponentFactory) bean)._classifier, "classifier");
      super.validate(bean);
    }
