...
public class ConventionBundleSourceComponentFactory extends AbstractComponentFactory {
  ...
  /**
   * Whether to make the resource available via REST, defaults to true
   */
  @PropertyDefinition
  ...
  protected ConventionBundleSource getOrCreateConventionBundleSource() {
    return new DefaultConventionBundleSource(getOrCreateConventionBundleMaster());
  }

  @Override
  public void init(final ComponentRepository repo, final LinkedHashMap<String, String> configuration) {
    final ComponentInfo info = new ComponentInfo(ConventionBundleSource.class, getClassifier());
    final ConventionBundleSource source = getOrCreateConventionBundleSource();
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets whether to make the resource available via REST, defaults to true
