...
public class OrganizationSourceComponentFactory extends AbstractComponentFactory {
  ...
  //-----------------------------------------------------------------------
  @Override
  public OrganizationSourceComponentFactory clone() {
    return (OrganizationSourceComponentFactory) super.clone();
  }
  ...
  public String toString() {
    ...
    buf.append("OrganizationSourceComponentFactory{");
    int len = buf.length();
    toString(buf);
    if (buf.length() > len) {
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          return ((OrganizationSourceComponentFactory) bean).getClassifier();
        case -614707837:  // publishRest
          return ((OrganizationSourceComponentFactory) bean).isPublishRest();
        case -1158737547:  // organizationMaster
          return ((OrganizationSourceComponentFactory) bean).getOrganizationMaster();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -281470431:  // classifier
          ((OrganizationSourceComponentFactory) bean).setClassifier((String) newValue);
          return;
        case -614707837:  // publishRest
          ((OrganizationSourceComponentFactory) bean).setPublishRest((Boolean) newValue);
          return;
        case -1158737547:  // organizationMaster
          ((OrganizationSourceComponentFactory) bean).setOrganizationMaster((OrganizationMaster) newValue);
          return;
      }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((OrganizationSourceComponentFactory) bean)._classifier, "classifier");
      JodaBeanUtils.notNull(((OrganizationSourceComponentFactory) bean)._organizationMaster, "organizationMaster");
      super.validate(bean);
    }
