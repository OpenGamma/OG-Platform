...
public abstract class AbstractStandardLiveDataServerComponentFactory extends AbstractComponentFactory {
  ...
  public void init(ComponentRepository repo, LinkedHashMap<String, String> configuration) throws Exception {
    ...
    repo.registerLifecycle(new ReconnectManager(server));  // after registering component, for lifecycle ordering
  ...
  protected void publishRest(ComponentRepository repo, AbstractLiveDataServer server) {
    final LiveDataMetaData metaData = createMetaData();
   ...
   */
  protected abstract LiveDataMetaData createMetaData();

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code StandardLiveDataServerComponentFactory}.
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    public BeanBuilder<? extends AbstractStandardLiveDataServerComponentFactory> builder() {
      throw new UnsupportedOperationException("StandardLiveDataServerComponentFactory is an abstract class");
    }
