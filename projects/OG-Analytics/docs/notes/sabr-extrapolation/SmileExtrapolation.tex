...
\pgfdeclareimage[height=5.0cm]{extraPrice}{dexy--extrapolation-price.pdf}
\begin{figure}
\begin{center}
...
\pgfdeclareimage[height=5.0cm]{extraDensity}{dexy--extrapolation-density.pdf}
\begin{figure}
\begin{center}
...
\pgfdeclareimage[height=5.0cm]{extraSmile}{dexy--extrapolation-smile.pdf}
\begin{figure}
\begin{center}
