 ...
 */
public class BondFutureTransactionDefinition implements FixedIncomeInstrumentWithDataConverter<BondFutureTransaction, Double> {

  /**
   * Underlying future security.
   */
  private final BondFutureSecurityDefinition _underlyingFuture;
  /**
   ...
   */
  public BondFutureTransactionDefinition(final BondFutureSecurityDefinition underlyingFuture, final int quantity, final ZonedDateTime tradeDate, final double tradePrice) {
   ...
   */
  public BondFutureSecurityDefinition getUnderlyingFuture() {
  ...
  @Override
  public BondFutureTransaction toDerivative(ZonedDateTime date, String... yieldCurveNames) {
  ...
  @Override
  public BondFutureTransaction toDerivative(ZonedDateTime date, Double lastMarginPrice, String... yieldCurveNames) {
    ...
    final BondFutureSecurity underlyingFuture = _underlyingFuture.toDerivative(date, yieldCurveNames);
    ...
    BondFutureTransaction futureTransaction = new BondFutureTransaction(underlyingFuture, _quantity, referencePrice);
    return futureTransaction;
  }

  @Override
  public <U, V> V accept(FixedIncomeInstrumentDefinitionVisitor<U, V> visitor, U data) {
    return visitor.visitBondFutureTransactionDefinition(this, data);
  }

  @Override
  public <V> V accept(FixedIncomeInstrumentDefinitionVisitor<?, V> visitor) {
    return visitor.visitBondFutureTransactionDefinition(this);
  }
  ...
  public boolean equals(Object obj) {
    ...
    BondFutureTransactionDefinition other = (BondFutureTransactionDefinition) obj;
