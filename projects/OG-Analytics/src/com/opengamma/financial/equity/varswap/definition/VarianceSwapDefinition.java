...
public class VarianceSwapDefinition {
   ...
   */
  public VarianceSwap toDerivative(final ZonedDateTime valueDate, final DoubleTimeSeries<ZonedDateTime> underlyingTimeSeries) {
    ...
    DoubleTimeSeries<ZonedDateTime> realizedTS = underlyingTimeSeries.subSeries(_obsStartDate, true, valueDate, true);
