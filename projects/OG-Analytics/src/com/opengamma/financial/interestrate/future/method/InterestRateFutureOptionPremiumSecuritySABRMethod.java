 ...
 * i.e. 0 for normal options and x for x-year mid-curve options. The future prices are computed without convexity adjustments.
 */
public class InterestRateFutureOptionPremiumSecuritySABRMethod {
   ...
   */
  public double optionPriceFromFuturePrice(final InterestRateFutureOptionPremiumSecurity security, final SABRInterestRateDataBundle sabrData, final double priceFuture) {
    ...
    double volatility = sabrData.getSABRParameter().getVolatility(security.getExpirationTime(), delay, rateStrike, forward);
   ...
   * @return The security price.
   */
  public double optionPrice(final InterestRateFutureOptionPremiumSecurity security, final SABRInterestRateDataBundle sabrData) {
