...
public class BondFutureSecurityHullWhiteMethod implements PricingMethod {
  ...
  public BondFutureSecurityHullWhiteMethod() {
  }
   ...
   */
  public double priceFromCurves(final BondFutureSecurity future, final HullWhiteOneFactorPiecewiseConstantDataBundle hwData, final int nbPoint) {
   ...
   * @return The future price.
   */
  public double priceFromCurves(final BondFutureSecurity future, final HullWhiteOneFactorPiecewiseConstantDataBundle hwData) {
    return priceFromCurves(future, hwData, DEFAULT_NB_POINTS);
  }
