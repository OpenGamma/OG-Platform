 ...
 * 
 */
public class BondFutureCalculator1 {
  ...
  //    final BondForward forward = new BondForward(bond, deliveryDate);
  //    final double invoicePrice = futurePrice * conversionFactor + accruedInterest;
  //    final double dirtyPrice = DIRTY_PRICE_CALCULATOR.calculate(bond, cleanPrice);
  //    final double fdp = BOND_FORWARD_CALCULATOR.calculate(forward, dirtyPrice, repoRate);
