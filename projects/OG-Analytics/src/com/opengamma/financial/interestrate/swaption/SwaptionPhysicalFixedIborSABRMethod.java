...
/**
 *  Class used to compute the price of a physical swaption with SABR model.
 */
public class SwaptionPhysicalFixedIborSABRMethod {

  public double price(final SwaptionPhysicalFixedIbor swaption, SABRInterestRateDataBundle sabrData) {
