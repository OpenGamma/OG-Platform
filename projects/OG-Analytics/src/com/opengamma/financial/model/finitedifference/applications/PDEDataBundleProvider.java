...
public class PDEDataBundleProvider {
  ...
  public ConvectionDiffusionPDEDataBundle getBackwardsBlackScholes(final double vol, final double rate, final double strike, final boolean isCall) {
    ...
    return new ConvectionDiffusionPDEDataBundle(FunctionalDoublesSurface.from(a), FunctionalDoublesSurface.from(b),
        ConstantDoublesSurface.from(rate), new EuropeanPayoff(strike, isCall));
  }
  ...
  public ConvectionDiffusionPDEDataBundle getBackwardsLogBlackScholes(final double vol, final double rate, final double strike, final boolean isCall) {
    ...
    return new ConvectionDiffusionPDEDataBundle(ConstantDoublesSurface.from(a), ConstantDoublesSurface.from(b),
   ...
   * @return
   */
  public ConvectionDiffusionPDEDataBundle getBackwardsCEV(final double vol, final double rate, final double strike,
      final double beta, final boolean isCall) {
  ...
  public CoupledPDEDataBundle[] getCoupledForwardPair(ForwardCurve forward, final TwoStateMarkovChainDataBundle data) {
    AbsoluteLocalVolatilitySurface localVolOverlay = new AbsoluteLocalVolatilitySurface(ConstantDoublesSurface.from(1.0));
  ...
  public CoupledPDEDataBundle[] getCoupledForwardPair(ForwardCurve forward, final TwoStateMarkovChainDataBundle data,
    ...
    CoupledPDEDataBundle[] res = new CoupledPDEDataBundle[2];
  ...
  public ExtendedCoupledPDEDataBundle[] getCoupledFokkerPlankPair(ForwardCurve forward, final TwoStateMarkovChainDataBundle data) {
    AbsoluteLocalVolatilitySurface localVolOverlay = new AbsoluteLocalVolatilitySurface(ConstantDoublesSurface.from(1.0));
  ...
  public ExtendedCoupledPDEDataBundle[] getCoupledFokkerPlankPair(ForwardCurve forward, final TwoStateMarkovChainDataBundle data,
    ...
    ExtendedCoupledPDEDataBundle[] res = new ExtendedCoupledPDEDataBundle[2];
  ...
  private CoupledPDEDataBundle getCoupledForwardPDE(final ForwardCurve forward, final double vol, final double lambda1, final double lambda2,
    ...
    final Function<Double, Double> a = new Function<Double, Double>() {
      ...
      public Double evaluate(final Double... tk) {
        ...
        double t = tk[0];
        double k = tk[1];
        double temp = vol * Math.pow(k, beta) * localVol.getVolatility(t, k);
        return -0.5 * temp * temp;
      }
    };
