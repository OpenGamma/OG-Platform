 ...
 * 
 */
public class IntegratedCIRTimeChangeCharacteristicExponent1 implements CharacteristicExponent1 {
  private final double _kappa;
  private final double _theta;
  private final double _lambda;

  public IntegratedCIRTimeChangeCharacteristicExponent1(final double kappa, final double theta, final double lambda) {
    _kappa = kappa;
    _theta = theta;
    _lambda = lambda;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    final IntegratedCIRTimeChangeCharacteristicExponent1 other = (IntegratedCIRTimeChangeCharacteristicExponent1) obj;
