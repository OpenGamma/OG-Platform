 ...
 * 
 */
public class HestonCharacteristicExponent1 implements CharacteristicExponent1 {
  ...
  public HestonCharacteristicExponent1(final double kappa, final double theta, final double vol0, final double omega, final double rho) {
    _kappa = kappa;
    _theta = theta;
    _vol0 = vol0;
    _omega = omega;
  ...
  public boolean equals(final Object obj) {
    ...
    final HestonCharacteristicExponent1 other = (HestonCharacteristicExponent1) obj;
