 ...
 * \\end{align*}
 * }
 * where {@latex.inline $c_{BSM}$} is the Black-Scholes-Merton call price (see {@link BlackScholesMertonModel}), {@latex.inline $\\mu_3$} is the skewness, 
 * {@latex.inline $\\mu_4$} is the Pearson kurtosis and
 * {@latex.ilb %preamble{\\usepackage{amsmath}}
 * \\begin{align*}
