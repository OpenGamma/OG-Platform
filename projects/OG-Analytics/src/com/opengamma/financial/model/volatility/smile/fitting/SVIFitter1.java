 ...
 * 
 */
public class SVIFitter1 implements SmileFitter<BlackFunctionData> {
  ...
  @Override
  public LeastSquareResults solve(final EuropeanVanillaOption[] options, final BlackFunctionData data, final double[] blackVols, final double[] errors, final double[] initialValues, final BitSet fixed) {
