 ...
 * 
 */
public class LocalVolatilityMoneynessSurface extends LocalVolatilitySurface {
   ...
   */
  public LocalVolatilityMoneynessSurface(final Surface<Double, Double, Double> surface, final ForwardCurve forwardCurve) {
    super(surface);
