...
public class BlackImpliedVolatilityFormula {
  ...
  private double solveByBisection(final BlackFunctionData data, final EuropeanVanillaOption option, final double optionPrice, final double sigma, final double change) {
    final BracketRoot bracketer = new BracketRoot();
    final BisectionSingleRootFinder rootFinder = new BisectionSingleRootFinder(EPS);
    final Function1D<Double, Double> func = new Function1D<Double, Double>() {
