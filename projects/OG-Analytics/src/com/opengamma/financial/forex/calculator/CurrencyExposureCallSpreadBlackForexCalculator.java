 ...
 */
public final class CurrencyExposureCallSpreadBlackForexCalculator extends CurrencyExposureForexCalculator {
  ...
  public MultipleCurrencyAmount visitForexOptionDigital(final ForexOptionDigital derivative, final YieldCurveBundle data) {
    return _methodFxOptionDigital.currencyExposure(derivative, data);
  }
