 ...
 * \\end{align*}
 * }
 * The weights and abscissas are generated by {@link GaussJacobiOrthogonalPolynomialGeneratingFunction}.
 * <p>
 * In this integrator, {@latex.inline $\\alpha = 0$} and {@latex.inline $\\beta = 0$}, which means that no adjustment
 * to the function must be performed. However, the function is scaled in such a way as to allow any values for the
 * limits of the integrals.
 */
public class GaussJacobiQuadratureIntegrator1D extends GaussianQuadratureIntegrator1D {
  private static final GaussJacobiOrthogonalPolynomialGeneratingFunction GENERATOR = new GaussJacobiOrthogonalPolynomialGeneratingFunction(0, 0);
