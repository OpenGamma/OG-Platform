...
/**
 * Class that generates weights and abscissas for Gauss-Laguerre quadrature. The weights {@latex.inline $w_i$} are given by:
 * {@latex.ilb %preamble{\\usepackage{amsmath}}
 * \\begin{align*}
 * w_i = -\\frac{\\Gamma(\\alpha + n)}{n!L_i'(x_i)L_{i-1}(x_i)}
 * \\end{align*}
 * }
 * where {@latex.inline $x_i$} is the {@latex.inline $i^{th}$} root of the orthogonal polynomial, {@latex.inline $L_i$} is the {@latex.inline $i^{th}$} polynomial
 * and {@latex.inline $L_i'$} is the first derivative of the {@latex.inline $i^{th}$} polynomial. The orthogonal polynomial is generated by
 * {@link com.opengamma.math.function.special.LaguerrePolynomialFunction}.
 */
