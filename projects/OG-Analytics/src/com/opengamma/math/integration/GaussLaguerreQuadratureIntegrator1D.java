 ...
 * <p>
 * The function to integrate is scaled in such a way as to allow any values for the limits of integration. At present, this
 * integrator can only be used for the limits {@latex.inline $[0, \\infty]$}.
 */
