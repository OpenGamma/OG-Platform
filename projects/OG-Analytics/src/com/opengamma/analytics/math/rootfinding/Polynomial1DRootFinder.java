...
/**
 * Interface for classes that find the roots of a polynomial function {@link RealPolynomialFunction1D}. Although the coefficients of the polynomial
 * function must be real, the roots can be real or complex.
