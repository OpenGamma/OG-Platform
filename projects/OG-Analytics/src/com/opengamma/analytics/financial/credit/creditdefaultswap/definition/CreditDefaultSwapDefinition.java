...
public class CreditDefaultSwapDefinition {
  ...
  public CreditDefaultSwapDefinition(final String buySellProtection,
      final String protectionBuyer,
      final String protectionSeller,
      final String referenceEntity,
      final Currency currency,
      final String debtSeniority,
      ...
      final String scheduleGenerationMethod,
      final String couponFrequency,
      final String daycountFractionConvention,
      final String businessdayAdjustmentConvention,
      final double notional,
      final double parSpread,
      final double valuationRecoveryRate,
      final double curveRecoveryRate,
