...
public class EquityFutureDataBundle {
   ...
   */
  public EquityFutureDataBundle(YieldAndDiscountCurve fundingCurve, Double marketPrice, Double spotValue, Double dividendYield, Double costOfCarry) {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof EquityFutureDataBundle)) {
      return false;
    }
    EquityFutureDataBundle other = (EquityFutureDataBundle) obj;
