 ...
 */
public class MarketPriceIndexTimeDecorated extends MarketCurveBundle {
   ...
   */
  public MarketPriceIndexTimeDecorated(MarketCurveBundle market, IndexPrice index, double time, double shift) {
    super(market);
