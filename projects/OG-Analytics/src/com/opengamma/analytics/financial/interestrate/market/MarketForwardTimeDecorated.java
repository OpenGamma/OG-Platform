 ...
 */
public class MarketForwardTimeDecorated extends MarketCurveBundle {
   ...
   */
  public MarketForwardTimeDecorated(MarketCurveBundle market, IborIndex index, double time, double shift) {
    super(market);
