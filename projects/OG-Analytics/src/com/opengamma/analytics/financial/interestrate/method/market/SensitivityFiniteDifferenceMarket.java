...
public class SensitivityFiniteDifferenceMarket {
   ...
   */
  public static double[] curveSensitivity(final InstrumentDerivative instrument, final MarketCurveBundle market, Currency ccy, double[] nodeTimes, double deltaShift, PricingMarketMethod method,
    ...
    MarketCurveBundle marketBumped;
  ...
  public static double[] curveSensitivity(final InstrumentDerivative instrument, final MarketCurveBundle market, IborIndex index, double[] nodeTimes, double deltaShift, PricingMarketMethod method,
      final FiniteDifferenceType differenceType) {
    Validate.notNull(instrument, "Instrument");
    Validate.notNull(method, "Method");
    Validate.notNull(differenceType, "Difference type");
  ...
  public static double[] curveSensitivity(final InstrumentDerivative instrument, final MarketCurveBundle market, IndexPrice index, double[] nodeTimes, double deltaShift, PricingMarketMethod method,
      final FiniteDifferenceType differenceType) {
    Validate.notNull(instrument, "Instrument");
    Validate.notNull(method, "Method");
    Validate.notNull(differenceType, "Difference type");
