 ...
 */
public class MarketDiscountingDecorated extends MarketCurveBundle {
   ...
   */
  public MarketDiscountingDecorated(MarketCurveBundle market, Currency ccy, YieldAndDiscountCurve curve) {
    super(market);
