 ...
 * 
 */
public class FixedFloatSwap extends FixedCouponSwap<CouponIborSpread> {
   ...
   */
  public FixedFloatSwap(final AnnuityCouponFixed fixedLeg, final GenericAnnuity<CouponIborSpread> floatingLeg) {
