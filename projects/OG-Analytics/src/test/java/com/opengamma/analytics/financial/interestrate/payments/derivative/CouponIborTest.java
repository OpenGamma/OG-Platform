...
public class CouponIborTest {
  ...
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullDiscount() {
    new CouponIbor(EUR, PAYMENT_TIME, null, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME, FIXING_END_TIME, FIXING_ACCRUAL_FACTOR, FORWARD_CURVE_NAME);
  }
  ...
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullFwdCurve() {
    new CouponIbor(EUR, PAYMENT_TIME, DISCOUNTING_CURVE_NAME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME, FIXING_END_TIME, FIXING_ACCRUAL_FACTOR, null);
  }
