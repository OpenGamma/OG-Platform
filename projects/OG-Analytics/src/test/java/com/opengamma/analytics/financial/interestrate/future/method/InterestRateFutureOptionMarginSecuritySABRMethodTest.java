...
public class InterestRateFutureOptionMarginSecuritySABRMethodTest {
  ...
  //  private static final String NAME = "EDU2";
  //  private static final double STRIKE = 0.9850;
  //  private static final InterestRateFutureTransactionDefinition EDU2_DEFINITION = new InterestRateFutureTransactionDefinition(LAST_TRADING_DATE, STRIKE, LAST_TRADING_DATE, IBOR_INDEX, NOTIONAL, FUTURE_FACTOR,
  //      1, NAME);
  //  private static final ZonedDateTime REFERENCE_DATE = DateUtils.getUTCDate(2010, 8, 18);
  //  private static final String DISCOUNTING_CURVE_NAME = "Funding";
  //  private static final String FORWARD_CURVE_NAME = "Forward";
  //  private static final String[] CURVES = {DISCOUNTING_CURVE_NAME, FORWARD_CURVE_NAME};
  //  private static final InterestRateFutureTransaction EDU2 = EDU2_DEFINITION.toDerivative(REFERENCE_DATE, REFERENCE_PRICE, CURVES);
  //  // Option 
  //  private static final ZonedDateTime EXPIRATION_DATE = DateUtils.getUTCDate(2011, 9, 16);
  //  private static final DayCount ACT_ACT = DayCountFactory.INSTANCE.getDayCount("Actual/Actual ISDA");
  //  private static final double EXPIRATION_TIME = ACT_ACT.getDayCountFraction(REFERENCE_DATE, EXPIRATION_DATE);
