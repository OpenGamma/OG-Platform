...
import com.opengamma.analytics.financial.provider.calculator.blackbondfutures.PresentValueBlackFlatBondFuturesOptionCalculator;
import com.opengamma.analytics.financial.provider.calculator.blackbondfutures.PresentValueCurveSensitivityBlackFlatBondFuturesOptionCalculator;
...
public class BondFuturesOptionMarginTransactionBlackFlatMethodTest {
  ...
  public void presentValue() {
    ...
    final double priceOpt1 = METHOD_OPT_SEC.price(CALL_BOBLM4_125_TRA_1.getUnderlyingFuture(), BLACK_FLAT_BNDFUT);
    ...
    final double priceOpt2 = METHOD_OPT_SEC.price(CALL_BOBLM4_125_TRA_2.getUnderlyingFuture(), BLACK_FLAT_BNDFUT);
