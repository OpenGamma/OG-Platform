...
public class InterestRateFutureOptionMarginTransactionSABRMethodTest {
  ...
  //  private static final InterestRateFutureTransactionDefinition EDU2_DEFINITION = new InterestRateFutureTransactionDefinition(LAST_TRADING_DATE, STRIKE, LAST_TRADING_DATE, IBOR_INDEX, NOTIONAL, FUTURE_FACTOR, 1, NAME);
  //  private static final ZonedDateTime REFERENCE_DATE = DateUtils.getUTCDate(2010, 8, 18);
  //  private static final String DISCOUNTING_CURVE_NAME = "Funding";
  //  private static final String FORWARD_CURVE_NAME = "Forward";
  //  private static final String[] CURVES_NAMES = {DISCOUNTING_CURVE_NAME, FORWARD_CURVE_NAME };
  //  private static final InterestRateFutureTransaction EDU2 = EDU2_DEFINITION.toDerivative(REFERENCE_DATE, REFERENCE_PRICE, CURVES_NAMES);
  //  // Option 
  ...
  //    final InterestRateFutureTransactionDiscountingMethod methodFuture = InterestRateFutureTransactionDiscountingMethod.getInstance();
