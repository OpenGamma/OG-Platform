...
public class SwapRiskGbpAnalysis {
  ...
  private static final ParameterSensitivityParameterAbstractCalculator<MulticurveProviderInterface> PSC = new ParameterSensitivityParameterCalculator<>(PVCSDC);
