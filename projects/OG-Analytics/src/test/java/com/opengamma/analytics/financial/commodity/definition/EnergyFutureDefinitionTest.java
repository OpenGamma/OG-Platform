...
public class EnergyFutureDefinitionTest {
  ...
  public void cashHasNoDelivery() {
    new EnergyFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.CASH);
  }
  ...
  public void physicalHasDelivery() {
    new EnergyFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, null, 1000, "tonnes", SettlementType.PHYSICAL);
  }
  ...
  public void testHashEquals() {
    EnergyFutureDefinition first = new EnergyFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL);
    EnergyFutureDefinition second = new EnergyFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL);
    assertEquals(first, second);
    assertEquals(first.hashCode(), second.hashCode());
    EnergyFutureDefinition third = new EnergyFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, null, null, 1000, "tonnes", SettlementType.CASH);
  ...
  public void testBuilders() {
    EnergyFutureDefinition cash = EnergyFutureDefinition.withCashSettlement(EXPIRY_DATE, AN_UNDERLYING, 100, 1000, "tonnes");
    EnergyFutureDefinition physical = EnergyFutureDefinition.withPhysicalSettlement(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes");
    EnergyFutureDefinition first = new EnergyFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, null, null, 1000, "tonnes", SettlementType.CASH);
    EnergyFutureDefinition second = new EnergyFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL);
  ...
  public void testToDerivative() {
    ...
    EnergyFuture firstDerivative2 = new EnergyFuture(0.0027397260273972603, AN_UNDERLYING, 100, null, null, 1000, "tonnes", SettlementType.CASH);
