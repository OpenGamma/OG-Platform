...
public class MulticurveBuildingDiscountingDiscountUSD2DemoTest {
  ...
  public void forwardAnalysis() {
    CurveCalibrationTestsUtils.exportForwardIborCurve(CALIBRATION_DATE, CURVES_PAR_SPREAD_MQ_WITHOUT_TODAY_BLOCK.get(0).getFirst(), USDLIBOR3M, NYC,
        "demo-test-fwd-usd-libor3m.csv", 0, 350, 7);
  }
