...
public class CreditDefaultSwapOptionDefinitionTest {
  ...
  // TODO : Add all the argument checker tests
  ...
  private static final ZonedDateTime valuationDate = cdsSwaptionValuationDate;
  ...
  private static final LegacyCreditDefaultSwapDefinition underlyingCDS = new LegacyCreditDefaultSwapDefinition(
      buySellProtection,
      cdsProtectionBuyer,
      cdsProtectionSeller,
      cdsReferenceEntity,
