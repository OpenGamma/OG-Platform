...
public class ISDACreditDefaultSwapParallelIR01CalculatorTest {
  ...
  public void regressionTest() {
    ...
    final double deprecatedResult = DEPRECATED_CALCULATOR.getIR01ParallelShiftCreditDefaultSwap(VALUATION_DATE, cds, YIELD_CURVE, HR_DATES, HR_RATES, BP, InterestRateBumpType.ADDITIVE_PARALLEL, PriceType.CLEAN);
