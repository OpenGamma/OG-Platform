...
public class RecentDataSetsMulticurveStandardGbp {
  ...
  private static final Period[] DSC_2_GBP_TENOR = new Period[] {Period.ofDays(0),
    ...
    Period.ofMonths(3), Period.ofMonths(4), Period.ofMonths(5), Period.ofYears(6), Period.ofYears(7),
    Period.ofYears(8), Period.ofYears(9), Period.ofYears(10), Period.ofYears(11), Period.ofYears(12) };
