...
public class CapFloorCMSHullWhiteMethodsTest {
  ...
  public void presentValueApproximation() {
    for (int loopstrike = 0; loopstrike < NB_STRIKE; loopstrike++) {
      MultipleCurrencyAmount pvNumericalIntegration = METHOD_NI.presentValue(CAP_CMS[loopstrike], HW_MULTICURVES);
      MultipleCurrencyAmount pvApproximation = METHOD_APP.presentValue(CAP_CMS[loopstrike], HW_MULTICURVES);
