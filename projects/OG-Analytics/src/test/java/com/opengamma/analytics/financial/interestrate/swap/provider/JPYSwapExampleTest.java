...
public class JPYSwapExampleTest {
  ...
  public void testSwap() {
    ...
    double[] expectedFirstFixingPeriod = new double[] {
        0.08611111111111111, 0.08888888888888889, 0.08611111111111111, 0.08611111111111111, 0.09166666666666666, 
        0.08611111111111111, 0.08333333333333333, 0.08611111111111111, 0.08611111111111111, 0.07777777777777778, 
        0.09166666666666666, 0.08333333333333333, 0.08611111111111111, 0.09166666666666666, 0.08611111111111111, 
        0.09166666666666666, 0.08611111111111111, 0.08611111111111111, 0.08888888888888889, 0.08611111111111111, 
        0.08611111111111111, 0.08611111111111111, 0.08611111111111111, 0.08333333333333333, 0.09166666666666666, 
        0.08611111111111111, 0.08611111111111111, 0.08888888888888889, 0.08333333333333333, 0.08611111111111111, 
        0.09166666666666666, 0.08611111111111111, 0.08333333333333333, 0.08888888888888889, 0.08611111111111111, 
        0.08333333333333333, 0.08888888888888889, 0.08333333333333333, 0.08611111111111111, 0.09166666666666666, 
        0.08333333333333333, 0.09166666666666666, 0.08611111111111111, 0.08611111111111111, 0.08888888888888889, 
        0.08611111111111111, 0.08611111111111111, 0.09166666666666666, 0.08333333333333333, 0.08333333333333333, 
        0.09166666666666666, 0.08611111111111111, 0.08333333333333333, 0.08611111111111111, 0.08333333333333333, 
        0.09166666666666666, 0.08055555555555556, 0.08611111111111111, 0.08611111111111111, 0.09166666666666666};
    ...
    double[] expectedSecondFixingPeriod = new double[] {
        0.25555555555555554, 0.25555555555555554, 0.25555555555555554, 0.25555555555555554, 0.25555555555555554, 
        0.25555555555555554, 0.25555555555555554, 0.25277777777777777, 0.25555555555555554, 0.25555555555555554, 
        0.25277777777777777, 0.25277777777777777, 0.25555555555555554, 0.2611111111111111, 0.25277777777777777, 
        0.25555555555555554, 0.25555555555555554, 0.25555555555555554, 0.25555555555555554, 0.25555555555555554 };
...
//    System.out.print(coupon.getFixingPeriodAccrualFactor() + ", ");
    ...
    assertRelative("testSwap, single curve PV", -1.3644528540332057E7, pv1.getAmount(CCY), EPS); //-1.370494358316157E7
    if (print) {
      System.out.println("single curve PV: " + pv1);
    }
    MultipleCurrencyAmount pv2 = swap.accept(PVDC, TRIPLE_CURVE);
    assertRelative("testSwap, Multi-curve PV", -5993019.03856796, pv2.getAmount(CCY), EPS); //-5988005.581088446
    if (print) {
    ...
    if (fixingDate1M.isBefore(TRADE_DATE) && fixingDate3M.isBefore(TRADE_DATE)) {
      ...
      assertRelative("testSwap, Principal", -5839769.03856796, pricipal, EPS); // -5834755.581088446
    }
