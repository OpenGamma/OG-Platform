...
public class AgricultureFutureOptionDefinitionTest {
  ...
  private final static AgricultureFutureDefinition AN_UNDERLYING = new AgricultureFutureDefinition(EXPIRY_DATE, AN_ID, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL);
