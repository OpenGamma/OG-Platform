 ...
 * 
 */
public class MulticurveBuildingDiscountingDiscountWithONDepositTest {
  ...
  private static final GeneratorInstrument<? extends GeneratorAttribute>[] DSC_USD_GENERATORS = new GeneratorInstrument<?>[] {GENERATOR_DEPOSIT_ON_USD, GENERATOR_DEPOSIT_ON_USD,
    ...
    GENERATOR_DEPOSIT_ON_USD, GENERATOR_DEPOSIT_ON_USD, GENERATOR_DEPOSIT_ON_USD, GENERATOR_DEPOSIT_ON_USD, GENERATOR_DEPOSIT_ON_USD, GENERATOR_DEPOSIT_ON_USD, GENERATOR_DEPOSIT_ON_USD,
    GENERATOR_DEPOSIT_ON_USD, GENERATOR_DEPOSIT_ON_USD };
