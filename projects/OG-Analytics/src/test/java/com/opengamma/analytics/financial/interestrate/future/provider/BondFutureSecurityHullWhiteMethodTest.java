...
import com.opengamma.analytics.financial.provider.description.HullWhiteIssuerProviderDiscount;
...
public class BondFutureSecurityHullWhiteMethodTest {
  ...
  @Test
  public void price() {
    HullWhiteIssuerProviderDiscount hwIssuer6 = new HullWhiteIssuerProviderDiscount(IssuerProviderDiscountDataSets.createIssuerProvider6(), PARAMETERS_HW, ISSUER_CCY);
