...
public class CapletStripperPSplineTermStructureTest extends CapletStrippingSetup {
  ...
  public void singleStrikeTest() {
    ...
    double[] expChi2 = new double[] {0.277676669976045, 0.0022011319414088, 0.518347393499247, 0.00007981972507487, 1.54586760016073, 0.000527042501277108, 0.0522325414771529, 0.6992013245803,
    ...
    for (int i = 0; i < n; i++) {
      ...
      assertEquals(expChi2[i], res.getChiSqr(), 1e-7);
