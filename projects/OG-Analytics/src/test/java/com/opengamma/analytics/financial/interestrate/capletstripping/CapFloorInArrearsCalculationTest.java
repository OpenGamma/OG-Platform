 ...
 * </ul>
 */
public class CapFloorInArrearsCalculationTest {
  ...
  private static final IborIndex USDLIBOR3M = MASTER_IBOR_INDEX.getIndex(MASTER_IBOR_INDEX.USDLIBOR3M);
   ...
   */
  @Test
  public void capletStrippingDirectTest() {

    CapFloorIbor caplet = (CapFloorIbor) CAP_IA_LONG_DEFINITION.toDerivative(REFERENCE_DATE);
    SimpleOptionData option = CapFloorDecomposer.toOption(caplet, CURVES);
    ...
    CapFloorInArrearsCalculation cal = new CapFloorInArrearsCalculation(stripper, caps, capVols, MarketDataType.VOL, errors, guess, CURVES);

    System.out.println("non corrected price: " + cal.simpleOptionPrice(option) * NOTIONAL);
    for (int i = 0; i < 11; i++) {
    ...
    cal = new CapFloorInArrearsCalculation(stripper, caps, capVols, MarketDataType.VOL, errors, guess, CURVES);
   ...
   */
  @Test
  public void capletStrippingSABRTest() {
    ...
    CapFloorInArrearsCalculation cal = new CapFloorInArrearsCalculation(stripper, caps, capVols, MarketDataType.VOL, errors, SABR_START, CURVES);
