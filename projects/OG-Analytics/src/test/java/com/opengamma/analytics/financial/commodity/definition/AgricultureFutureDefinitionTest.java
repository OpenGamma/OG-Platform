...
public class AgricultureFutureDefinitionTest {
  ...
  public void cashHasNoDelivery() {
    new AgricultureFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.CASH);
  }
  ...
  public void physicalHasDelivery() {
    new AgricultureFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, null, 1000, "tonnes", SettlementType.PHYSICAL);
  }
  ...
  public void testHashEquals() {
    AgricultureFutureDefinition first = new AgricultureFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL);
    AgricultureFutureDefinition second = new AgricultureFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL);
    assertEquals(first, second);
    assertEquals(first.hashCode(), second.hashCode());
    AgricultureFutureDefinition third = new AgricultureFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, null, null, 1000, "tonnes", SettlementType.CASH);
  ...
  public void testBuilders() {
    AgricultureFutureDefinition cash = AgricultureFutureDefinition.withCashSettlement(EXPIRY_DATE, AN_UNDERLYING, 100, 1000, "tonnes");
    AgricultureFutureDefinition physical = AgricultureFutureDefinition.withPhysicalSettlement(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes");
    AgricultureFutureDefinition first = new AgricultureFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, null, null, 1000, "tonnes", SettlementType.CASH);
    AgricultureFutureDefinition second = new AgricultureFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL);
  ...
  public void testToDerivative() {
    ...
    AgricultureFuture firstDerivative2 = new AgricultureFuture(0.0027397260273972603, AN_UNDERLYING, 100, null, null, 1000, "tonnes", SettlementType.CASH);
