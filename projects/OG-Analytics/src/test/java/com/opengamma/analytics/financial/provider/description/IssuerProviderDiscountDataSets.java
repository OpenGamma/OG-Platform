...
public class IssuerProviderDiscountDataSets {
  ...
  private static final Pair<String, Currency> US_USD = new ObjectsPair<String, Currency>(BEL_NAME, EUR);
  private static final double[] USD_US_TIME = new double[] {0.0, 0.5, 1.0, 2.0, 5.0, 10.0};
  private static final double[] USD_US_RATE = new double[] {0.0090, 0.0110, 0.0110, 0.0120, 0.0120, 0.0120};
  ...
  /**
   * Returns a multi-curves provider with two currencies (EUR, USD) and two issuers (BELGIUM GOVT, US GOVT).
   * @return The provider.
   */
  ...
  public static String[] getIssuerNames() {
    return new String[] {BEL_NAME, US_NAME};
  }
