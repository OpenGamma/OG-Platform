...
public class UpfrontFlatTest {
  ...
  static {
    ...
    YIELD_CURVE = YIELD_CURVE_BUILDER.build(TODAY, SPOT_DATE, types, tenors, rates, moneyMarketDCC, swapDCC, swapInterval, curveDCC, FOLLOWING);
  }
  ...
  public void Test() {
    ...
    ISDACompliantCreditCurveBuilder builder = new FastCreditCurveBuilder();
    AnalyticCDSPricer pricer = new AnalyticCDSPricer();

    ISDACompliantCreditCurve creditCurve = builder.calibrateCreditCurve(TODAY, STEPIN_DATE, CASH_SETTLE_DATE, START_DATE, END_DATE, quotedSpread, payAccOnDefault, tenor, stubType, protectionStart,
