...
public class HazardRateCurveCalculatorTest {
  ...
  public void timeDeprecated() {
    ...
    System.out.println("Deprecated:\t" + (endTime - startTime) / j * 1000);
  }

  @Test(enabled = false)
  public void timeRefactored() {
    final double startTime = System.currentTimeMillis();
    int j = 0;
    for (int i = 0; i < 1000; i++) {
    ...
    final double endTime = System.currentTimeMillis();
    System.out.println("Refactored:\t" + (endTime - startTime) / j * 1000);
  }
}
