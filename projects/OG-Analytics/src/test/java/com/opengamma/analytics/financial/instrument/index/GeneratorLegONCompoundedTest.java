...
public class GeneratorLegONCompoundedTest {
  ...
  private static final GeneratorLegONCompounded GENERATOR = new GeneratorLegONCompounded(NAME, FEDFUND, 
      Period.ofMonths(12), OFFSET_SPOT, OFFSET_PAYMENT, BusinessDayConventions.MODIFIED_FOLLOWING, true, StubType.SHORT_START, false, NYC, NYC);
  
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullName() {
    new GeneratorLegONCompounded(null, FEDFUND, 
        Period.ofMonths(12), 2, 2, BusinessDayConventions.MODIFIED_FOLLOWING, true, StubType.SHORT_START, false, NYC, NYC);
  }
  
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullIndex() {
    new GeneratorLegONCompounded("LEG_USD1YFEDFUND", null, 
        Period.ofMonths(12), 2, 2, BusinessDayConventions.MODIFIED_FOLLOWING, true, StubType.SHORT_START, false, NYC, NYC);
  }
  
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullTenor() {
    new GeneratorLegONCompounded("LEG_USD1YFEDFUND", FEDFUND, 
  ...
  public void generateInstrument() {
    ...
    for(int loopcpn = 0 ; loopcpn<legTenorYear; loopcpn++) {
      ...
      ZonedDateTime paymentDate = ScheduleCalculator.getAdjustedDate(
          cpn.getFixingPeriodDate()[cpn.getFixingPeriodDate().length-2], GENERATOR.getPaymentOffset(), NYC);
