...
public class PoweredOptionFunctionProviderTest {
          ...
          for (final double interest : INTERESTS) {
            for (final double vol : VOLS) {
              ...
              for (final double dividend : DIVIDENDS) {
                final OptionFunctionProvider1D function = new PoweredOptionFunctionProvider(strike, nSteps, isCall, POWER);
    ...
    for (final boolean isCall : tfSet) {
      for (final double strike : STRIKES) {
        for (final double time : time_set) {
          ...
          final OptionFunctionProvider1D function = new PoweredOptionFunctionProvider(strike, steps, isCall, POWER);
  ...
  public void getPowerTest() {
    final PoweredOptionFunctionProvider function = new PoweredOptionFunctionProvider(103., 1003, true, 12.);
  ...
  public void negativePowerTest() {
    new PoweredOptionFunctionProvider(103., 1003, true, -12.);
  }
  ...
  //              //              assertEquals(price(SPOT, strike, TIME, vol, interest, interest - dividend, isCall, 1.),
