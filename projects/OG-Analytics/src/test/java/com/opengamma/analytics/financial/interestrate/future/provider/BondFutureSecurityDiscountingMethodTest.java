...
public class BondFutureSecurityDiscountingMethodTest {
  ...
  private static final Period PAYMENT_TENOR = DateUtils.periodOfMonths(6);
  ...
  private static final Period[] BOND_TENOR = new Period[] {DateUtils.periodOfYears(5), DateUtils.periodOfYears(5), DateUtils.periodOfYears(5), DateUtils.periodOfYears(8), DateUtils.periodOfYears(5), DateUtils.periodOfYears(5), DateUtils.periodOfYears(5)};
