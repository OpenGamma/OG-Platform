...
public class MetalFutureDefinitionTest {
  ...
  public void cashHasNoDelivery() {
    new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.CASH);
  }
  ...
  public void physicalHasDelivery() {
    new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, null, 1000, "tonnes", SettlementType.PHYSICAL);
  }
  ...
  public void testHashEquals() {
    MetalFutureDefinition first = new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL);
    MetalFutureDefinition second = new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL);
    assertEquals(first, second);
    assertEquals(first.hashCode(), second.hashCode());
    MetalFutureDefinition third = new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, null, null, 1000, "tonnes", SettlementType.CASH);
  ...
  public void testBuilders() {
    MetalFutureDefinition cash = MetalFutureDefinition.withCashSettlement(EXPIRY_DATE, AN_UNDERLYING, 100, 1000, "tonnes");
    MetalFutureDefinition physical = MetalFutureDefinition.withPhysicalSettlement(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes");
    MetalFutureDefinition first = new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, null, null, 1000, "tonnes", SettlementType.CASH);
    MetalFutureDefinition second = new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL);
  ...
  public void testToDerivative() {
    ...
    MetalFuture firstDerivative2 = new MetalFuture(0.0027397260273972603, AN_UNDERLYING, 100, null, null, 1000, "tonnes", SettlementType.CASH);
