...
public class MetalFutureDefinitionTest {
  ...
  public void cashHasNoDelivery() {
    new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.CASH, 0, Currency.GBP, SETTLEMENT_DATE);
  }
  ...
  public void physicalHasDelivery() {
    new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, null, 1000, "tonnes", SettlementType.PHYSICAL, 0, Currency.GBP, SETTLEMENT_DATE);
  }
  ...
  public void testHashEquals() {
    MetalFutureDefinition first = new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL, 0, Currency.GBP,
        SETTLEMENT_DATE);
    MetalFutureDefinition second = new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL, 0, Currency.GBP,
        SETTLEMENT_DATE);
    assertEquals(first, second);
    assertEquals(first.hashCode(), second.hashCode());
    MetalFutureDefinition third = new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, null, null, 1000, "tonnes", SettlementType.CASH, 0, Currency.GBP, SETTLEMENT_DATE);
  ...
  public void testBuilders() {
    MetalFutureDefinition cash = MetalFutureDefinition.withCashSettlement(EXPIRY_DATE, AN_UNDERLYING, 100, 1000, "tonnes", 0, Currency.GBP, SETTLEMENT_DATE);
    MetalFutureDefinition physical = MetalFutureDefinition.withPhysicalSettlement(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", 0, Currency.GBP,
        SETTLEMENT_DATE);
    MetalFutureDefinition first = new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, null, null, 1000, "tonnes", SettlementType.CASH, 0, Currency.GBP, SETTLEMENT_DATE);
    MetalFutureDefinition second = new MetalFutureDefinition(EXPIRY_DATE, AN_UNDERLYING, 100, FIRST_DELIVERY_DATE, LAST_DELIVERY_DATE, 1000, "tonnes", SettlementType.PHYSICAL, 0, Currency.GBP,
        SETTLEMENT_DATE);
  ...
  /**
   * Test method for {@link com.opengamma.analytics.financial.commodity.definition.MetalFutureDefinition#toDerivative(javax.time.calendar.ZonedDateTime)}.
   */
  @Test
  public void testToDerivative() {
    ...
    MetalFuture firstDerivative = first.toDerivative(A_DATE);
    MetalFuture secondDerivative = second.toDerivative(A_DATE);
    ...
    MetalFuture firstDerivative2 = new MetalFuture(0.0027397260273972603, AN_UNDERLYING, 100, null, null, 1000, "tonnes", SettlementType.CASH, 1.0035032562317538, 0, Currency.GBP);
