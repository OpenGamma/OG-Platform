...
import com.opengamma.analytics.financial.provider.calculator.sabr.PresentValueCurveSensitivitySABRCapRightExtrapolationCalculator;
import com.opengamma.analytics.financial.provider.calculator.sabr.PresentValueSABRCapRightExtrapolationCalculator;
import com.opengamma.analytics.financial.provider.description.MulticurveProviderDiscount;
import com.opengamma.analytics.financial.provider.description.MulticurveProviderDiscountDataSets;
import com.opengamma.analytics.financial.provider.description.SABRCapProviderDiscount;
import com.opengamma.analytics.financial.provider.sensitivity.multicurve.MultipleCurrencyMulticurveSensitivity;
import com.opengamma.analytics.financial.provider.sensitivity.multicurve.MultipleCurrencyParameterSensitivity;
import com.opengamma.analytics.financial.provider.sensitivity.sabr.ParameterSensitivitySABRCapCalculator;
import com.opengamma.analytics.financial.provider.sensitivity.sabr.ParameterSensitivitySABRCapDiscountInterpolatedFDCalculator;
...
public class CapFloorIborSABRExtrapolationRightMethodTest {
  ...
  private static final CapFloorIborDefinition CAP_HIGH_LONG_DEFINITION = CapFloorIborDefinition.from(NOTIONAL, FIXING_DATE, EURIBOR3M, STRIKE_HIGH, IS_CAP);
  ...
  private static final CapFloorIborDefinition CAP_HIGH_SHORT_DEFINITION = CapFloorIborDefinition.from(-NOTIONAL, FIXING_DATE, EURIBOR3M, STRIKE_HIGH, IS_CAP);
  ...
  private static final CapFloorIborDefinition FLOOR_HIGH_SHORT_DEFINITION = CapFloorIborDefinition.from(-NOTIONAL, FIXING_DATE, EURIBOR3M, STRIKE_HIGH, !IS_CAP);
