 ...
 */
public class YieldAverageBondFuturesSecurityDefinitionTest {
  ...
  public void nullLastTrading() {
    new YieldAverageBondFuturesSecurityDefinition(null, BASKET_SECURITY_DEFINITION, SYNTHETIC_COUPON, TENOR, NOTIONAL_FUTURES);
  }


  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullBasket() {
    new YieldAverageBondFuturesSecurityDefinition(LAST_TRADING_DATE, null, SYNTHETIC_COUPON, TENOR, NOTIONAL_FUTURES);
  }
  ...
  public void equalHash() {
    final YieldAverageBondFuturesSecurityDefinition other = new YieldAverageBondFuturesSecurityDefinition(LAST_TRADING_DATE, 
        BASKET_SECURITY_DEFINITION, SYNTHETIC_COUPON, TENOR, NOTIONAL_FUTURES);
    ...
    YieldAverageBondFuturesSecurityDefinition modified;
    modified = new YieldAverageBondFuturesSecurityDefinition(LAST_TRADING_DATE.plusDays(1), BASKET_SECURITY_DEFINITION, SYNTHETIC_COUPON, TENOR, NOTIONAL_FUTURES);
    ...
    modified = new YieldAverageBondFuturesSecurityDefinition(LAST_TRADING_DATE, BASKET_SECURITY_DEFINITION, SYNTHETIC_COUPON+0.01, TENOR, NOTIONAL_FUTURES);
    assertFalse("YieldAverageBondFuturesSecurityDefinition: equal - hash", FUT_SEC_DEFINITION.equals(modified));
    modified = new YieldAverageBondFuturesSecurityDefinition(LAST_TRADING_DATE, BASKET_SECURITY_DEFINITION, SYNTHETIC_COUPON, TENOR+1, NOTIONAL_FUTURES);
    assertFalse("YieldAverageBondFuturesSecurityDefinition: equal - hash", FUT_SEC_DEFINITION.equals(modified));
    modified = new YieldAverageBondFuturesSecurityDefinition(LAST_TRADING_DATE, BASKET_SECURITY_DEFINITION, SYNTHETIC_COUPON, TENOR, NOTIONAL_FUTURES*10);
    assertFalse("YieldAverageBondFuturesSecurityDefinition: equal - hash", FUT_SEC_DEFINITION.equals(modified));
  }
