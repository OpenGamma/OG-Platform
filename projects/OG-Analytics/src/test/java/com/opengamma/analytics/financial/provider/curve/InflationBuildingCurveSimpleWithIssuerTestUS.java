...
public class InflationBuildingCurveSimpleWithIssuerTestUS {
  ...
  public static final IssuerProviderDiscount usMulticurveProviderDiscount = MulticurveProviderDiscountDataSets.createIssuerProvider().copy();
  public static final InflationIssuerProviderDiscount KNOWN_DATA = new InflationIssuerProviderDiscount(usMulticurveProviderDiscount);
  ...
  private static Pair<InflationIssuerProviderDiscount, CurveBuildingBlockBundle> makeCurvesFromDefinitions(final InstrumentDefinition<?>[][][] definitions,
      ...
      final String[][] curveNames, final InflationIssuerProviderDiscount knownData, final InstrumentDerivativeVisitor<InflationProviderInterface, Double> calculator,
