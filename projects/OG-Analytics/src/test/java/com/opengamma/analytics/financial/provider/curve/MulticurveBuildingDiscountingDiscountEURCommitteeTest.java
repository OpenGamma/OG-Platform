...
public class MulticurveBuildingDiscountingDiscountEURCommitteeTest {
  ...
  private static final ZonedDateTime NOW = DateUtils.getUTCDate(2013, 1, 7);
  private static final ZonedDateTime[] MEETING_ECB_DATE = new ZonedDateTime[] {DateUtils.getUTCDate(2013, 2, 7), DateUtils.getUTCDate(2013, 3, 7), DateUtils.getUTCDate(2013, 4, 4),
      DateUtils.getUTCDate(2013, 5, 2), DateUtils.getUTCDate(2013, 6, 6), DateUtils.getUTCDate(2013, 7, 4), DateUtils.getUTCDate(2013, 8, 1), DateUtils.getUTCDate(2013, 9, 5),
      DateUtils.getUTCDate(2013, 10, 2), DateUtils.getUTCDate(2013, 11, 7), DateUtils.getUTCDate(2013, 12, 5), DateUtils.getUTCDate(2014, 1, 9)};
  ...
  public static final GeneratorInstrument[] DSC_EUR_GENERATORS = new GeneratorInstrument[] {GENERATOR_DEPOSIT_ON_EUR, GENERATOR_DEPOSIT_ON_EUR, GENERATOR_OIS_EUR, GENERATOR_OIS_EUR,
  ...
  public static final Period[] DSC_EUR_TENOR = new Period[] {Period.ofDays(0), Period.ofDays(1), Period.ofMonths(1), Period.ofMonths(2), Period.ofMonths(3), Period.ofMonths(4), Period.ofMonths(5),
  ...
  static {
    ...
    DEFINITIONS_FWD6_EUR = getDefinitions(FWD6_EUR_MARKET_QUOTES, FWD6_EUR_GENERATORS, FWD6_EUR_TENOR, new Double[FWD6_EUR_MARKET_QUOTES.length]);
    ...
    GENERATORS_UNITS[1][0] = new GeneratorYDCurve[] {new GeneratorCurveAddYield(genComp, false), genIntLin};
