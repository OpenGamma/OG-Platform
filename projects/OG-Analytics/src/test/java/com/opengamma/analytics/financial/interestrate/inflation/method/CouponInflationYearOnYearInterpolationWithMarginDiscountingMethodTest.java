...
public class CouponInflationYearOnYearInterpolationWithMarginDiscountingMethodTest {
  ...
  private static final CouponInflationYearOnYearInterpolationWithMargin YEAR_ON_YEAR_NO = YEAR_ON_YEAR_NO_DEFINITION.toDerivative(PRICING_DATE, "not used");
  ...
  private static final CouponInflationYearOnYearInterpolationWithMargin YEAR_ON_YEAR_WITH = YEAR_ON_YEAR_WITH_DEFINITION.toDerivative(PRICING_DATE, "not used");
