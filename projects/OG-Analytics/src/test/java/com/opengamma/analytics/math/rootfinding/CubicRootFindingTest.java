...
public class CubicRootFindingTest {
  ...
  private static final RealPolynomialFunction1D ONE_REAL_ROOT = new RealPolynomialFunction1D(new double[] {-10, 10, -3, 3});
  private static final RealPolynomialFunction1D ONE_DISTINCT_ROOT = new RealPolynomialFunction1D(new double[] {-1, 3, -3, 1});
