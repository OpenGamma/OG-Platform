...
public class PresentValueBlackBondFuturesCubeSensitivityTest {
  ...
  public void multiplyBy() {
    ...
    PresentValueBlackBondFuturesCubeSensitivity sensi1 = 
        new PresentValueBlackBondFuturesCubeSensitivity(cube.getMap(), CCY, LEGAL_ENTITY_GERMANY);
    final PresentValueBlackBondFuturesCubeSensitivity sensi2 = PresentValueBlackBondFuturesCubeSensitivity.multiplyBy(sensi1, factor);
  ...
  public void plus() {
    ...
    final PresentValueBlackBondFuturesCubeSensitivity sensi3 = PresentValueBlackBondFuturesCubeSensitivity.plus(sensi1, sensi2);
