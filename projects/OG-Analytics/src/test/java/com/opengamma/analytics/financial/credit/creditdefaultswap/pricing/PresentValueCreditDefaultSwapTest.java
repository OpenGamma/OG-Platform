...
public class PresentValueCreditDefaultSwapTest {
  ...
  /**
   * Tests relationship between valuation of clean and dirty prices matches accrued interest. <p>
   * This test works on trivial case of zero spreads. <p>
  ...
  /**
   * Tests relationship between valuation of clean and dirty prices matches accrued interest. <p>
   * This test works on provided hazard rates, hence no curve bootstrapping is performed. <p>
  ...
  /**
   * Test of calculator when full recovery is expected on default, a strange case where the contingent leg should have zero value. <p>
  ...
  public void testRecoveryRateEqualsOneWithHazardCurveProvided() {
    ...
    assertEquals(cleanPremiumLeg, -1550727.7944086404, EPS);
    assertEquals(dirtyPremiumLeg, -1551069.4610753073, EPS);
  }
  
  /**
   * Test of calculator when full recovery is expected on default, a strange case where the contingent leg should have zero value.<p>
   * In this test, market par cds spreads are provided. Calibration to market spreads is performed.<p>
  ...
  /**
   * Test of calculator when full recovery is expected on default, of which there is no implied risk and spreads and hazard rates are zero.<p>
   * In this test, market par cds spreads are provided. Calibration to market spreads is performed.<p>
   * Note: It is this calibration that is causing the exception.
   */
  @Test(expectedExceptions = OpenGammaRuntimeException.class)
  ...
  /**
   * Test trivial case with zero par spreads, zero hazard rates. 
   * This is a test that the methods in {@link PresentValueCreditDefaultSwap} are in sync with {@link PresentValueLegacyCreditDefaultSwap} 
   */
  @Test
