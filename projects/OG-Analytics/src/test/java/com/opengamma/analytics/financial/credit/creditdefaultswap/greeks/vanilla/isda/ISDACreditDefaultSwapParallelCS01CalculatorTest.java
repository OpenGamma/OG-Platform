...
public class ISDACreditDefaultSwapParallelCS01CalculatorTest {
  ...
  public void regressionTest() {
    ...
    final double deprecatedResult = DEPRECATED_CALCULATOR.getGammaParallelShiftCreditDefaultSwap(VALUATION_DATE, cds, YIELD_CURVE, HR_DATES, HR_RATES, BP, SpreadBumpType.ADDITIVE_PARALLEL,
        PriceType.CLEAN);
