...
public class DeliverableSwapFuturesSecurityHullWhiteMethodTest {
  ...
  private static final Period TENOR = Period.of(10, YEARS);
  ...
  private static final DeliverableSwapFuturesSecurity SWAP_FUTURES_SECURITY = SWAP_FUTURES_SECURITY_DEFINITION.toDerivative(REFERENCE_DATE, CURVES_NAMES);
