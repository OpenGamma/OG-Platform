...
public class DeprecatedCapFloorIborTest {
  ...
  public void withStrike() {
    ...
    final CapFloorIbor otherCap = new CapFloorIbor(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, otherStrike, IS_CAP);
  ...
  public void withNotional() {
    ...
    final CapFloorIbor cap = new CapFloorIbor(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, notional, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, STRIKE, IS_CAP);
  ...
  public void testHashCodeEquals() {
    final CapFloorIbor cap = new CapFloorIbor(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, STRIKE, IS_CAP);
    CapFloorIbor other = new CapFloorIbor(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, STRIKE, IS_CAP);
    assertEquals(cap, other);
    assertEquals(cap.hashCode(), other.hashCode());
    other = new CapFloorIbor(Currency.AUD, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, STRIKE, IS_CAP);
    assertFalse(other.equals(cap));
    other = new CapFloorIbor(CUR, PAYMENT_TIME + 1, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, STRIKE, IS_CAP);
    assertFalse(other.equals(cap));
    other = new CapFloorIbor(CUR, PAYMENT_TIME, FORWARD_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, STRIKE, IS_CAP);
    assertFalse(other.equals(cap));
    other = new CapFloorIbor(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION + 1, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, STRIKE, IS_CAP);
    assertFalse(other.equals(cap));
    other = new CapFloorIbor(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL + 1, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, STRIKE, IS_CAP);
    assertFalse(other.equals(cap));
    ...
    other = new CapFloorIbor(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME - 1e-8, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, STRIKE, IS_CAP);
    assertFalse(other.equals(cap));
    other = new CapFloorIbor(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME + 1,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, STRIKE, IS_CAP);
    assertFalse(other.equals(cap));
    other = new CapFloorIbor(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION + 1, FORWARD_CURVE_NAME, STRIKE, IS_CAP);
    assertFalse(other.equals(cap));
    other = new CapFloorIbor(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FUNDING_CURVE_NAME, STRIKE, IS_CAP);
    assertFalse(other.equals(cap));
    other = new CapFloorIbor(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, STRIKE + 1, IS_CAP);
    assertFalse(other.equals(cap));
    other = new CapFloorIbor(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, PAYMENT_YEAR_FRACTION, NOTIONAL, FIXING_TIME, INDEX, FIXING_START_TIME, FIXING_END_TIME,
        FIXING_YEAR_FRACTION, FORWARD_CURVE_NAME, STRIKE, !IS_CAP);
    assertFalse(other.equals(cap));
