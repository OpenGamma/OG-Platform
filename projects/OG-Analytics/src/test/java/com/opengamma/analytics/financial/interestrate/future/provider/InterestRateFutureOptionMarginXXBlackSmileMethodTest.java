...
public class InterestRateFutureOptionMarginXXBlackSmileMethodTest {
  ...
  private static final InterestRateFutureOptionMarginSecurity OPTION_ERU2 = OPTION_ERU2_DEFINITION.toDerivative(REFERENCE_DATE, NOT_USED_A);
  ...
  private static final InterestRateFutureOptionMarginTransaction TRANSACTION_1 = TRANSACTION_1_DEFINITION.toDerivative(REFERENCE_DATE, MARGIN_PRICE, NOT_USED_A);
  ...
  private static final InterestRateFutureOptionMarginTransaction TRANSACTION_2 = TRANSACTION_2_DEFINITION.toDerivative(REFERENCE_DATE, MARGIN_PRICE, NOT_USED_A);
  ...
  private static final ParameterSensitivityParameterCalculator<BlackSTIRFuturesSmileProviderInterface> PSHWC = new ParameterSensitivityParameterCalculator<BlackSTIRFuturesSmileProviderInterface>(
      PVCSBFC);
  ...
  public void priceBlackSensitivity() {
    ...
    BlackSTIRFuturesSmileProviderDiscount blackPlus = new BlackSTIRFuturesSmileProviderDiscount(MULTICURVES, blackParameterPlus, EURIBOR3M);
    BlackSTIRFuturesSmileProviderDiscount blackMinus = new BlackSTIRFuturesSmileProviderDiscount(MULTICURVES, blackParameterMinus, EURIBOR3M);
