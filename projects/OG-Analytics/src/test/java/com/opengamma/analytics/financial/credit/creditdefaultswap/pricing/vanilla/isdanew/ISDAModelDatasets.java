...
public abstract class ISDAModelDatasets {
  ...
  public static ISDA_Results[] getExample3() {
    ...
    final LocalDate[] cdsEndDate = new LocalDate[] {LocalDate.of(2018, 7, 4), LocalDate.of(2022, 5, 21), LocalDate.of(2017, 5, 22), LocalDate.of(2014, 6, 8), LocalDate.of(2020, 10, 1),
        ...
        LocalDate.of(2015, 12, 23), LocalDate.of(2014, 12, 31), LocalDate.of(2014, 1, 19), LocalDate.of(2021, 11, 29), LocalDate.of(2017, 6, 30), LocalDate.of(2021, 12, 26),
        LocalDate.of(2021, 10, 17), LocalDate.of(2021, 11, 13), LocalDate.of(2017, 8, 28), LocalDate.of(2014, 12, 26), LocalDate.of(2016, 10, 22)};
    ...
    final double[] premLeg = new double[] {4128091.89186224, 2851204.4544253, 2486562.75404386, 24974.843923837, 4242496.67235433, 1278551.84681265, 131087.920708078, 1201946.91606566,
        ...
        70042.4601512506, 917731.885652886, 814100.492050405, 2056661.49566407, 2340706.4229424, 5557011.54289956, 1593368.45471259, 2065891.63313401, 1667246.2127173, 250152.675542246,
        2564509.7658855};
