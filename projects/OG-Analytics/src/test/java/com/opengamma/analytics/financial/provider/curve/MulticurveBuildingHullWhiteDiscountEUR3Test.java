...
public class MulticurveBuildingHullWhiteDiscountEUR3Test {
  ...
  private static final GeneratorInterestRateFutures GENERATOR_ER = new GeneratorInterestRateFutures("GENERATOR_ER", EURIBOR3M, 0.25);
  ...
  static {
    ...
    DEFINITIONS_FWD3_EUR = getDefinitions(FWD3_EUR_MARKET_QUOTES, FWD3_EUR_GENERATORS, FWD3_EUR_TENOR, FWD3_EUR_EXTRA_DATA);
  ...
  public void comparison1Unit3Units() {
    HullWhiteOneFactorProviderDiscount[] units = new HullWhiteOneFactorProviderDiscount[2];
  ...
  public void curveConstructionTest(final InstrumentDefinition<?>[][][] definitions, final HullWhiteOneFactorProviderDiscount curves, final boolean withToday, int block) {
  ...
  public void forwardAnalysis() {
    HullWhiteOneFactorProviderInterface marketDsc = CURVES_PAR_SPREAD_MQ_WITHOUT_TODAY_BLOCK.get(0).getFirst();
    int jump = 1;
    int startIndex = 0;
    int nbDate = 2750;
  ...
  private static Pair<HullWhiteOneFactorProviderDiscount, CurveBuildingBlockBundle> makeCurvesFromDefinitions(final InstrumentDefinition<?>[][][] definitions, GeneratorYDCurve[][] curveGenerators,
      String[][] curveNames, HullWhiteOneFactorProviderDiscount knownData, final AbstractInstrumentDerivativeVisitor<HullWhiteOneFactorProviderInterface, Double> calculator,
      final AbstractInstrumentDerivativeVisitor<HullWhiteOneFactorProviderInterface, MulticurveSensitivity> sensitivityCalculator, boolean withToday) {
  ...
  @SuppressWarnings("rawtypes")
  private static DoubleTimeSeries[] getTSSwapFixedIbor(Boolean withToday) { // TODO: different fixing for 3 and 6 m
