...
public class CouponArithmeticAverageONDefinitionTest {
  ...
  public void nullIndex() {
    CouponArithmeticAverageONDefinition.from(null, EFFECTIVE_DATE, TENOR_3M, NOTIONAL, 0, MOD_FOL, true);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullStartDate() {
    CouponArithmeticAverageONDefinition.from(FEDFUND, null, TENOR_3M, NOTIONAL, 0, MOD_FOL, true);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullTenor() {
    CouponArithmeticAverageONDefinition.from(FEDFUND, EFFECTIVE_DATE, null, NOTIONAL, 0, MOD_FOL, true);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullBD() {
    CouponArithmeticAverageONDefinition.from(FEDFUND, EFFECTIVE_DATE, TENOR_3M, NOTIONAL, 0, null, true);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullEndDate() {
    CouponArithmeticAverageONDefinition.from(FEDFUND, EFFECTIVE_DATE, null, NOTIONAL, PAYMENT_LAG);
  }
  ...
  public void equalHash() {
    ...
    modified = CouponArithmeticAverageONDefinition.from(modifiedIndex, EFFECTIVE_DATE, TENOR_3M, NOTIONAL, PAYMENT_LAG, MOD_FOL, true);
    assertFalse("CouponArithmeticAverageON: equal-hash", FEDFUND_CPN_3M_DEF.equals(modified));
    modified = CouponArithmeticAverageONDefinition.from(FEDFUND, EFFECTIVE_DATE.plusDays(1), ACCRUAL_END_DATE, NOTIONAL, PAYMENT_LAG);
    assertFalse("CouponArithmeticAverageON: equal-hash", FEDFUND_CPN_3M_DEF.equals(modified));
    modified = CouponArithmeticAverageONDefinition.from(FEDFUND, EFFECTIVE_DATE, ACCRUAL_END_DATE.plusDays(1), NOTIONAL, PAYMENT_LAG);
    assertFalse("CouponArithmeticAverageON: equal-hash", FEDFUND_CPN_3M_DEF.equals(modified));
    modified = CouponArithmeticAverageONDefinition.from(FEDFUND, EFFECTIVE_DATE, ACCRUAL_END_DATE, NOTIONAL + 1000, PAYMENT_LAG);
    assertFalse("CouponArithmeticAverageON: equal-hash", FEDFUND_CPN_3M_DEF.equals(modified));
    modified = CouponArithmeticAverageONDefinition.from(FEDFUND, EFFECTIVE_DATE, ACCRUAL_END_DATE, NOTIONAL, PAYMENT_LAG + 1);
    assertFalse("CouponArithmeticAverageON: equal-hash", FEDFUND_CPN_3M_DEF.equals(modified));
  }

  @Test
  public void toDerivativesNoData() {
    CouponArithmeticAverageON cpnConverted = FEDFUND_CPN_3M_DEF.toDerivative(REFERENCE_DATE, NOT_USED);
    double payTime = TimeCalculator.getTimeBetween(REFERENCE_DATE, FEDFUND_CPN_3M_DEF.getPaymentDate());
    double[] fixingTime = TimeCalculator.getTimeBetween(REFERENCE_DATE, FEDFUND_CPN_3M_DEF.getFixingPeriodDate());
    CouponArithmeticAverageON cpnExpected = CouponArithmeticAverageON.from(payTime, FEDFUND_CPN_3M_DEF.getPaymentYearFraction(), NOTIONAL, FEDFUND, fixingTime,
