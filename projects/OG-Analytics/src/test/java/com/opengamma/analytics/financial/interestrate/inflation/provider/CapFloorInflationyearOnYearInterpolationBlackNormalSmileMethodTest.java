...
public class CapFloorInflationyearOnYearInterpolationBlackNormalSmileMethodTest {
  ...
  private static final CouponInflationYearOnYearInterpolationDefinition YEAR_ON_YEAR_DEFINITION = CouponInflationYearOnYearInterpolationDefinition.from(PAYMENT_DATE_MINUS_1Y, PAYMENT_DATE,
      NOTIONAL, PRICE_INDEX_EUR, MONTH_LAG, true, WEIGHT_START, WEIGHT_END);
  private static final CapFloorInflationYearOnYearInterpolationDefinition YEAR_ON_YEAR_DEFINITION_CAP = CapFloorInflationYearOnYearInterpolationDefinition.from(YEAR_ON_YEAR_DEFINITION,
  ...
  */
  ...
  public void presentValue() {
    ...
    final double initialIndex = YEAR_ON_YEAR_CAP.getWeightStart() * initialIndexMonth0 + (1 - YEAR_ON_YEAR_CAP.getWeightStart()) * initialIndexMonth1;
