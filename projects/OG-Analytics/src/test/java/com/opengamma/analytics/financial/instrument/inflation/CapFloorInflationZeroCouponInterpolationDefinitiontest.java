...
public class CapFloorInflationZeroCouponInterpolationDefinitiontest {
  ...
  private static final CapFloorInflationZeroCouponInterpolationDefinition ZERO_COUPON_CAP_DEFINITION = new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
      ACCRUAL_END_DATE, 1.0, NOTIONAL, PRICE_INDEX, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, STRIKE, IS_CAP);
  ...
  public void testNullEnd() {
    new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        null, 1.0, NOTIONAL, PRICE_INDEX, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, STRIKE, IS_CAP);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testNullIndex() {
    new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL, null, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, STRIKE, IS_CAP);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testNullRefEnd() {
    new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL, PRICE_INDEX, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE, null, WEIGHT, STRIKE, IS_CAP);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testNullLastKnownFixingDate() {
    new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL, PRICE_INDEX, null, MONTH_LAG, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, STRIKE, IS_CAP);
  }
  ...
  public void equalHash() {
    ...
    modified = new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE.minusDays(1), 1.0, NOTIONAL, PRICE_INDEX, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, STRIKE, IS_CAP);
    assertFalse(ZERO_COUPON_CAP_DEFINITION.equals(modified));
    modified = new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL, PRICE_INDEX, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE - 1, REFERENCE_END_DATE, WEIGHT, STRIKE, IS_CAP);
    assertFalse(ZERO_COUPON_CAP_DEFINITION.equals(modified));
    ...
    modified = new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL, PRICE_INDEX, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE, modifiedReferenceEndDate, WEIGHT, STRIKE, IS_CAP);
    assertFalse(ZERO_COUPON_CAP_DEFINITION.equals(modified));
    modified = new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 2.0, NOTIONAL, PRICE_INDEX, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, STRIKE, IS_CAP);
    assertFalse(ZERO_COUPON_CAP_DEFINITION.equals(modified));
    modified = new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL + 1.0, PRICE_INDEX, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, STRIKE, IS_CAP);
    assertFalse(ZERO_COUPON_CAP_DEFINITION.equals(modified));
    modified = new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL, PRICE_INDEX, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT + .1, STRIKE, IS_CAP);
    assertFalse(ZERO_COUPON_CAP_DEFINITION.equals(modified));
    modified = new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL, PRICE_INDEX, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, STRIKE + .01, IS_CAP);
    assertFalse(ZERO_COUPON_CAP_DEFINITION.equals(modified));
    modified = new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL, PRICE_INDEX, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, STRIKE, false);
    assertFalse(ZERO_COUPON_CAP_DEFINITION.equals(modified));
    modified = new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL, PRICE_INDEX, LAST_KNOWN_FIXING_DATE.minusDays(1), MONTH_LAG, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, STRIKE, IS_CAP);
    assertFalse(ZERO_COUPON_CAP_DEFINITION.equals(modified));
    modified = new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL, PRICE_INDEX, LAST_KNOWN_FIXING_DATE, MONTH_LAG - 1, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, STRIKE, IS_CAP);
    assertFalse(ZERO_COUPON_CAP_DEFINITION.equals(modified));
    final IndexPrice modifiedPriceIndex = new IndexPrice("US CPI x", Currency.USD);
    modified = new CapFloorInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL, modifiedPriceIndex, LAST_KNOWN_FIXING_DATE, MONTH_LAG, MATURITY, INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, STRIKE, IS_CAP);
    assertFalse(ZERO_COUPON_CAP_DEFINITION.equals(modified));
  }
  ...
  public void from() {
    ...
    CouponInflationZeroCouponInterpolationDefinition zeroCoupon = new CouponInflationZeroCouponInterpolationDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, 1.0, NOTIONAL, PRICE_INDEX, MONTH_LAG, REFERENCE_START_DATE[0], INDEX_START_VALUE, REFERENCE_END_DATE, WEIGHT, false);
