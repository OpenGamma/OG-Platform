...
public class AnalysisMarketDataJPYSets {
  ...
  private static final GeneratorYDCurve GENERATOR_INTERPOLATED_LINEAR = new GeneratorCurveYieldInterpolated(MATURITY_CALCULATOR, INTERPOLATOR_LINEAR);
  static {
    ...
    GENERATORS_UNITS[0][0] = new GeneratorYDCurve[] {GENERATOR_INTERPOLATED_LINEAR };
    GENERATORS_UNITS[0][1] = new GeneratorYDCurve[] {GENERATOR_INTERPOLATED_LINEAR };
    GENERATORS_UNITS[0][2] = new GeneratorYDCurve[] {GENERATOR_INTERPOLATED_LINEAR };
  ...
  public static Pair<MulticurveProviderDiscount, CurveBuildingBlockBundle> getMulticurveJPYOisL6(
    ...
    generators[0] = new GeneratorYDCurve[] {GENERATOR_INTERPOLATED_LINEAR };
    generators[1] = new GeneratorYDCurve[] {GENERATOR_INTERPOLATED_LINEAR };
  ...
  public static Pair<MulticurveProviderDiscount, CurveBuildingBlockBundle> getMulticurveJPYOisL6L3OneUnit(
    ...
    generators[0] = new GeneratorYDCurve[] {GENERATOR_INTERPOLATED_LINEAR, GENERATOR_INTERPOLATED_LINEAR, GENERATOR_INTERPOLATED_LINEAR };
