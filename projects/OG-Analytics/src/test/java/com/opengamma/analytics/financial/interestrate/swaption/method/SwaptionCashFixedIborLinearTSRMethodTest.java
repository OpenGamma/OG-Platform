...
public class SwaptionCashFixedIborLinearTSRMethodTest {
  ...
  public void presentValueLongShortParity() {
    CurrencyAmount pvLongTSR = METHOD_CASH_TSR.presentValue(SWAPTION_PAYER_LONG, SABR_BUNDLE);
    CurrencyAmount pvShortTSR = METHOD_CASH_TSR.presentValue(SWAPTION_PAYER_SHORT, SABR_BUNDLE);
