...
import com.opengamma.analytics.financial.credit.creditdefaultswap.pricing.legacy.RecRate01LegacyCreditDefaultSwap;
...
/**
 * Test of the implementation of the RecoveryRate calculations for a legacy CDS
 */
public class RecoveryRate01LegacyCreditDefaultSwapTest {
  ...
  @Test
  public void testRecoveryRate01Calculation() {

    // -------------------------------------------------------------------------------------

    if (outputResults) {
      System.out.println("Running RecoveryRate01 calculation test ...");
    }
    ...
    // The recovery rate bump to apply (expressed as a percentage)
    final double recoveryRateBump = 0.01;
    ...
    final RecRate01LegacyCreditDefaultSwap recRate01 = new RecRate01LegacyCreditDefaultSwap();
