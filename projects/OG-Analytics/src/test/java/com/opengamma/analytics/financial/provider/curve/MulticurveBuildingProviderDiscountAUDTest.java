 ...
 * @author marc
 */
public class MulticurveBuildingProviderDiscountAUDTest {
  ...
  static {
    ...
    FWD_ON_MAP.put(CURVE_NAME_DSC_AUD, INDEX_ON_AUD);
    FWD_IBOR_MAP.put(CURVE_NAME_FWD3_AUD, AUDBB3M);
    FWD_IBOR_MAP.put(CURVE_NAME_FWD6_AUD, AUDBB6M);
  }
  ...
  private static final ProviderDiscountBuildingRepository CURVE_BUILDING_REPOSITORY = new ProviderDiscountBuildingRepository(TOLERANCE_ROOT, TOLERANCE_ROOT, STEP_MAX);
  ...
  private static Pair<MulticurveProviderDiscount, CurveBuildingBlockBundle> makeCurvesFromDefinitions(final InstrumentDefinition<?>[][][] definitions, GeneratorYDCurve[][] curveGenerators,
      ...
      final AbstractInstrumentDerivativeVisitor<MulticurveProviderInterface, CurveSensitivityMarket> sensitivityCalculator, boolean withToday) {
