...
import com.opengamma.analytics.financial.provider.calculator.sabr.PresentValueCurveSensitivitySABRCapCalculator;
import com.opengamma.analytics.financial.provider.calculator.sabr.PresentValueSABRCapCalculator;
import com.opengamma.analytics.financial.provider.calculator.sabr.PresentValueSABRSensitivitySABRCapCalculator;
...
public class CapFloorIborSABRMethodTest {
  ...
  private static final ParameterSensitivitySABRCapCalculator PS_SS_C = new ParameterSensitivitySABRCapCalculator(PVCSSCC);
