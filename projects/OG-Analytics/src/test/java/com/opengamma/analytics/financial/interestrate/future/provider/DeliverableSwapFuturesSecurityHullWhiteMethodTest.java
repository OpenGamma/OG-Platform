...
public class DeliverableSwapFuturesSecurityHullWhiteMethodTest {
  ...
  @Test
  public void price() {
    AnnuityPaymentFixed cfe = CFEC.visit(SWAP_FUTURES_SECURITY.getUnderlyingSwap(), MULTICURVES);
    ...
    double priceComputed = METHOD_SWAP_FUT_HW.price(SWAP_FUTURES_SECURITY, HW_MULTICURVES);
  ...
  public void priceCurveSensitivity() {
    SimpleParameterSensitivity pcsExact = PS_MQ_C.calculateSensitivity(SWAP_FUTURES_SECURITY, HW_MULTICURVES, MULTICURVES.getAllNames());
    SimpleParameterSensitivity pcsFD = PS_MQ_FDC.calculateSensitivity(SWAP_FUTURES_SECURITY, HW_MULTICURVES);
