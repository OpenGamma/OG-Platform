...
//    System.out.println("\n");
    ...
    DiscreteVolatilityFunctionProvider dvfp = new DiscreateVolatilityFunctionProviderFromVolSurface(vsp);
...
//   System.out.println(penalty);
 //   System.out.println(p);
    CapletStrippingImp imp = new CapletStrippingImp(pricer, dvfp);
    final double[] vols = getAllCapVols();
    final int nVols = vols.length;
    final double[] errors = new double[nVols];
    Arrays.fill(errors, 1e-4); //1bps
