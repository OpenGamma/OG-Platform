...
public class BondFutureOptionPremiumTransactionTest {
  ...
  private static final BondFutureOptionPremiumSecurity FVU1_C120_SEC = FVU1_C120_SEC_DEFINITION.toDerivative(REFERENCE_DATE);
  // Option transaction
