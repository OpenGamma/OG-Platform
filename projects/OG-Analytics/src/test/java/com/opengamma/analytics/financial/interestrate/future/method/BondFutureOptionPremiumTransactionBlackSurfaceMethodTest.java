...
public class BondFutureOptionPremiumTransactionBlackSurfaceMethodTest {
  ...
  public void presentValueFromCurves() {
    CurrencyAmount pvCallComputed = METHOD_OPTION_TRANSACTION.presentValue(BOND_FUTURE_OPTION_TRA_CALL, DATA);
    double priceCall = METHOD_OPTION_SECURITY.optionPrice(BOND_FUTURE_OPTION_SEC_CALL, DATA);
    MultipleCurrencyAmount pvCallPremium = PVC.visit(BOND_FUTURE_OPTION_TRA_CALL.getPremium(), DATA);
    ...
    CurrencyAmount pvPutComputed = METHOD_OPTION_TRANSACTION.presentValue(BOND_FUTURE_OPTION_TRA_PUT, DATA);
    MultipleCurrencyAmount pvPutPremium = PVC.visit(BOND_FUTURE_OPTION_TRA_PUT.getPremium(), DATA);
    CurrencyAmount pvFut = METHOD_FUTURES.presentValue(BOND_FUT, DATA);
  ...
  public void presentValueFromFuturesPrice() {
    CurrencyAmount pvComputed = METHOD_OPTION_TRANSACTION.presentValue(BOND_FUTURE_OPTION_TRA_CALL, DATA_WITH_FUTURE);
    double priceCall = METHOD_OPTION_SECURITY.optionPrice(BOND_FUTURE_OPTION_SEC_CALL, DATA_WITH_FUTURE);
    MultipleCurrencyAmount pvPremium = PVC.visit(BOND_FUTURE_OPTION_TRA_CALL.getPremium(), DATA);
    ...
    double priceFutures = METHOD_FUTURES.price(BOND_FUT, DATA);
    CurrencyAmount pv2 = METHOD_OPTION_TRANSACTION.presentValue(BOND_FUTURE_OPTION_TRA_CALL, YieldCurveWithBlackCubeAndForwardBundle.from(DATA, priceFutures));
    CurrencyAmount pv3 = METHOD_OPTION_TRANSACTION.presentValue(BOND_FUTURE_OPTION_TRA_CALL, DATA);
