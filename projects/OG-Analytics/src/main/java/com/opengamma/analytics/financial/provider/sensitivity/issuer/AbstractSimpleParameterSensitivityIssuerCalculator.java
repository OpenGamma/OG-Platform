 ...
 */
public abstract class AbstractSimpleParameterSensitivityIssuerCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<IssuerProviderInterface, MulticurveSensitivity> _curveSensitivityCalculator;

  /**
   * The constructor from a curve sensitivity calculator.
   * @param curveSensitivityCalculator The calculator.
   */
  public AbstractSimpleParameterSensitivityIssuerCalculator(final InstrumentDerivativeVisitor<IssuerProviderInterface, MulticurveSensitivity> curveSensitivityCalculator) {
   ...
   */
  public SimpleParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final IssuerProviderInterface multicurves, final Set<String> curvesSet) {
   ...
   * @return The sensitivity (as a ParameterSensitivity).
   */
  public abstract SimpleParameterSensitivity pointToParameterSensitivity(final MulticurveSensitivity sensitivity, final IssuerProviderInterface multicurves, final Set<String> curvesSet);
