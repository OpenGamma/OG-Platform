...
public class EquityOption implements InstrumentDerivative, Serializable {
   ...
   */
  public EquityOption(final double timeToExpiry, final double timeToSettlement, final double strike, final boolean isCall, final Currency currency,
  ...
  public <S, T> T accept(final InstrumentDerivativeVisitor<S, T> visitor, final S data) {
    ...
    return visitor.visitEquityOption(this, data);
  }

  @Override
  public <T> T accept(final InstrumentDerivativeVisitor<?, T> visitor) {
    ArgumentChecker.notNull(visitor, "visitor");
    return visitor.visitEquityOption(this);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof EquityOption)) {
      return false;
    }
    final EquityOption other = (EquityOption) obj;
