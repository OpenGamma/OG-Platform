 ...
 */
@Deprecated
public class StandardQuantoCreditDefaultSwapDefinition extends StandardCreditDefaultSwapDefinition {
  ...
  public StandardQuantoCreditDefaultSwapDefinition(final BuySellProtection buySellProtection, final LegalEntity protectionBuyer, final LegalEntity protectionSeller, final LegalEntity referenceEntity,
  ...
  @Override
  public StandardQuantoCreditDefaultSwapDefinition withSpread(final double spread) {
    return new StandardQuantoCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(), getCurrency(), getDebtSeniority(),
  ...
  @Override
  public StandardQuantoCreditDefaultSwapDefinition withStartDate(final ZonedDateTime startDate) {
    return new StandardQuantoCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(), getCurrency(), getDebtSeniority(),
  ...
  @Override
  public StandardQuantoCreditDefaultSwapDefinition withMaturityDate(final ZonedDateTime maturityDate) {
    return new StandardQuantoCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(), getCurrency(), getDebtSeniority(),
