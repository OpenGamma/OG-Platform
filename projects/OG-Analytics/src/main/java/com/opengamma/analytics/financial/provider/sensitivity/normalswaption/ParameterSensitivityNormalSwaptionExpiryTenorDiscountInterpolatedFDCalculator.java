...
public class ParameterSensitivityNormalSwaptionExpiryTenorDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<NormalSwaptionProviderInterface, MultipleCurrencyAmount> _valueCalculator;
  /**
   ...
   */
  public ParameterSensitivityNormalSwaptionExpiryTenorDiscountInterpolatedFDCalculator(final InstrumentDerivativeVisitor<NormalSwaptionProviderInterface, MultipleCurrencyAmount> valueCalculator,
      final double shift) {
  ...
  public MultipleCurrencyParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, 
    ...
    final MultipleCurrencyAmount pvInit = instrument.accept(_valueCalculator, normalMulticurve);
    ...
    ArgumentChecker.isTrue(multicurveGeneric instanceof MulticurveProviderDiscount, 
    ...
    for (final Currency ccy : ccyDiscounting) {
      ...
      ArgumentChecker.isTrue(curveYield.getCurve() instanceof InterpolatedDoublesCurve, 
