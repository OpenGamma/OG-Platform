...
/**
 * Find a interpolant F(x) = exp( f(x) ) where f(x) is a Natural cubic spline {@link NaturalSplineInterpolator}. 
 */
public class LogNaturalCubicInterpolator1D extends PiecewisePolynomialInterpolator1D {
   ...
   * 
   */
  public LogNaturalCubicInterpolator1D() {
