 ...
 */
public abstract class AbstractSimpleParameterSensitivityMulticurveProviderCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<MulticurveProviderInterface, MulticurveSensitivity> _curveSensitivityCalculator;

  /**
   * The constructor from a curve sensitivity calculator.
   * @param curveSensitivityCalculator The calculator.
   */
  public AbstractSimpleParameterSensitivityMulticurveProviderCalculator(InstrumentDerivativeVisitor<MulticurveProviderInterface, MulticurveSensitivity> curveSensitivityCalculator) {
   ...
   */
  public SimpleParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final MulticurveProviderInterface multicurves, final Set<String> curvesSet) {
   ...
   * @return The sensitivity (as a ParameterSensitivity).
   */
  public abstract SimpleParameterSensitivity pointToParameterSensitivity(final MulticurveSensitivity sensitivity, final MulticurveProviderInterface multicurves, final Set<String> curvesSet);
