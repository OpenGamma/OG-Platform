 ...
 */
public class BlackStirFuturesSsviPriceConstantProvider implements BlackStirFuturesSsviPriceProvider {
   ...
   */
  public BlackStirFuturesSsviPriceConstantProvider(
  ...
  public BlackSTIRFuturesProviderInterface copy() {
    ...
    return new BlackStirFuturesSsviPriceConstantProvider(multicurveProvider, _volatilityAtm, _rho, _eta, _index);
  }
