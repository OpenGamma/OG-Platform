 ...
 */
public class HullWhiteProviderDiscountBuildingData {
   ...
   */
  private final GeneratorHullWhiteProviderDiscount _generator;
  /**
   ...
   */
  public HullWhiteProviderDiscountBuildingData(final InstrumentDerivative[] instruments, final GeneratorHullWhiteProviderDiscount generator) {
   ...
   */
  public GeneratorHullWhiteProviderDiscount getGeneratorMarket() {
    return _generator;
  }
