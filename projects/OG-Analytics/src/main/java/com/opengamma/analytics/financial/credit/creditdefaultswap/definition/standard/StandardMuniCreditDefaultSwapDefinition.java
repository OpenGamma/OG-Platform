 ...
 */
public class StandardMuniCreditDefaultSwapDefinition extends CreditDefaultSwapDefinition {
  ...
  public StandardMuniCreditDefaultSwapDefinition(
  ...
  public StandardMuniCreditDefaultSwapDefinition withMaturity(final ZonedDateTime maturityDate) {
    ...
    final StandardMuniCreditDefaultSwapDefinition modifiedCDS = new StandardMuniCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(),
  ...
  public StandardMuniCreditDefaultSwapDefinition withSpread(final double quotedSpread) {

    final StandardMuniCreditDefaultSwapDefinition modifiedCDS = new StandardMuniCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(),
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof StandardMuniCreditDefaultSwapDefinition)) {
      return false;
    }

    final StandardMuniCreditDefaultSwapDefinition other = (StandardMuniCreditDefaultSwapDefinition) obj;
