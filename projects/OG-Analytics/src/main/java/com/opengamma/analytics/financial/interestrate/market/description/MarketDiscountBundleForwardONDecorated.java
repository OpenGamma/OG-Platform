 ...
 */
public class MarketDiscountBundleForwardONDecorated extends MarketDiscountBundle {
   ...
   */
  public MarketDiscountBundleForwardONDecorated(MarketDiscountBundle market, IndexON index, YieldAndDiscountCurve curve) {
    super(market);
