...
/**
 * Implementation for caplet stripping. This can be used directly by supplying either a {@link VolatilitySurfaceProvider} or a {@link DiscreteVolatilityFunctionProvider} and (in the case of penalty
 * based
 * methods) a penalty matrix.
...
public class CapletStrippingImp {
  ...
  /**
   * If the number of model parameters equals the number of cap prices, this first tries to root-find for the cap
   * prices;
