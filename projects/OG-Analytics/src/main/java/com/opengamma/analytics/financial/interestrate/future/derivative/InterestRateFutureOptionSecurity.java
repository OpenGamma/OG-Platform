...
public abstract class InterestRateFutureOptionSecurity extends FuturesSecurity {
  ...
  public InterestRateFutureOptionSecurity(InterestRateFutureSecurity underlyingFuture,
    ...
    _underlyingFuture = ArgumentChecker.notNull(underlyingFuture, "underlying future");
    _expirationTime = ArgumentChecker.notNull(expirationTime, "expirationTime");
    _strike = ArgumentChecker.notNull(strike, "strike");
    _isCall = ArgumentChecker.notNull(isCall, "isCall");
  }
