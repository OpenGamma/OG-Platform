 ...
 */
public class ForexBlackFlatProvider implements ForexBlackFlatProviderInterface {
   ...
   */
  public ForexBlackFlatProvider(final MulticurveProviderInterface multicurves, final BlackForexTermStructureParameters volatility, final Pair<Currency, Currency> currencyPair) {
  ...
  @Override
  public ForexBlackFlatProvider copy() {
    MulticurveProviderInterface multicurveProvider = _multicurveProvider.copy();
    return new ForexBlackFlatProvider(multicurveProvider, _volatility, _currencyPair);
  }
