...
public class EnergyForwardDefinition extends CommodityForwardDefinition<EnergyForward> {
   ...
   */
  public EnergyForwardDefinition(final ZonedDateTime expiryDate, final ExternalId underlying, final double unitAmount, final ZonedDateTime firstDeliveryDate,
   ...
   * @return the forward
   */
  public static EnergyForwardDefinition withPhysicalSettlement(final ZonedDateTime expiryDate, final ExternalId underlying, final double unitAmount,
