...
public interface InstrumentDefinitionVisitor<DATA_TYPE, RESULT_TYPE> {
  ...
  RESULT_TYPE visitCouponIborAverageFlatCompoundingSpreadDefinition(CouponIborAverageFlatCompoundingSpreadDefinition payment, DATA_TYPE data);

  RESULT_TYPE visitCouponIborAverageFlatCompoundingSpreadDefinition(CouponIborAverageFlatCompoundingSpreadDefinition payment);
