 ...
 */
public final class CommodityFutureOptionVegaCalculator extends InstrumentDerivativeVisitorAdapter<StaticReplicationDataBundle, Double> {
  ...
  private CommodityFutureOptionVegaCalculator() {
  }
