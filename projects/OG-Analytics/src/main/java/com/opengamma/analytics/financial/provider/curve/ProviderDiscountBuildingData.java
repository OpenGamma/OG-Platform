 ...
 */
public class ProviderDiscountBuildingData {
   ...
   */
  private final GeneratorProviderDiscount _generator;
  /**
   ...
   */
  public ProviderDiscountBuildingData(final InstrumentDerivative[] instruments, final GeneratorProviderDiscount generator) {
   ...
   */
  public GeneratorProviderDiscount getGeneratorMarket() {
    return _generator;
  }
