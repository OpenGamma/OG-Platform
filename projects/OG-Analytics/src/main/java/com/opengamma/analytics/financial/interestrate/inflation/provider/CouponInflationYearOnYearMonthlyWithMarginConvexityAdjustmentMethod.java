...
/**
 * Pricing method for inflation Year on Year coupon with margin. The price is computed by index estimation, discounting and using a convexity adjustment.
 * See note "Inflation convexity adjustment" by Arroub Zine-eddine for details.
 */
public class CouponInflationYearOnYearMonthlyWithMarginConvexityAdjustmentMethod {
  ...
  public MultipleCurrencyAmount netAmount(final CouponInflationYearOnYearMonthlyWithMargin coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
   ...
   */
  public MultipleCurrencyAmount presentValue(final CouponInflationYearOnYearMonthlyWithMargin coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
    ArgumentChecker.notNull(coupon, "Coupon");
    ArgumentChecker.notNull(inflation, "Inflation");
   ...
   */
  public double indexEstimationStart(final CouponInflationYearOnYearMonthlyWithMargin coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
   ...
   */
  public double indexEstimationEnd(final CouponInflationYearOnYearMonthlyWithMargin coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
   ...
   */
  public MultipleCurrencyInflationSensitivity presentValueCurveSensitivity(final CouponInflationYearOnYearMonthlyWithMargin coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
    ArgumentChecker.notNull(coupon, "Coupon");
    ArgumentChecker.notNull(inflation, "Inflation");
    final double estimatedIndexStart = indexEstimationStart(coupon, inflation);
    final double estimatedIndexEnd = indexEstimationEnd(coupon, inflation);
