 ...
 *
 */
public class CommodityFutureOptionForwardDeltaCalculator extends InstrumentDerivativeVisitorAdapter<StaticReplicationDataBundle, Double> {
   ...
   *
   */
  public CommodityFutureOptionForwardDeltaCalculator() {
  }
