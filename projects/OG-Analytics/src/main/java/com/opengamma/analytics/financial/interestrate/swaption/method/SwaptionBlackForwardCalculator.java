 ...
 */
@Deprecated
public class SwaptionBlackForwardCalculator extends InstrumentDerivativeVisitorAdapter<YieldCurveBundle, Double> {

  /**
   * The unique instance of the calculator.
   */
  private static final SwaptionBlackForwardCalculator INSTANCE = new SwaptionBlackForwardCalculator();
   ...
   * Constructor.
   */
  SwaptionBlackForwardCalculator() {
  }
