...
public class StandardFixedRecoveryCreditDefaultSwapDefinition extends CreditDefaultSwapDefinition {
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof StandardFixedRecoveryCreditDefaultSwapDefinition)) {
      return false;
    }
    final StandardFixedRecoveryCreditDefaultSwapDefinition other = (StandardFixedRecoveryCreditDefaultSwapDefinition) obj;
    if (Double.doubleToLongBits(_quotedSpread) != Double.doubleToLongBits(other._quotedSpread)) {
      return false;
    }
    if (Double.doubleToLongBits(_upfrontAmount) != Double.doubleToLongBits(other._upfrontAmount)) {
      return false;
    }
    return true;
  }
