 ...
 */
public class DeliverableSwapFuturesTransaction implements InstrumentDerivative {

  /**
   * The underlying swap futures security.
   */
  private final DeliverableSwapFuturesSecurity _underlying;
  /**
  ...
  public DeliverableSwapFuturesTransaction(final DeliverableSwapFuturesSecurity underlying, final double referencePrice, final int quantity) {
   ...
   */
  public DeliverableSwapFuturesSecurity getUnderlying() {
    return _underlying;
  }
  ...
  public <S, T> T accept(final InstrumentDerivativeVisitor<S, T> visitor, final S data) {
    ...
    return visitor.visitDeliverableSwapFuturesTransaction(this, data);
  }

  @Override
  public <T> T accept(final InstrumentDerivativeVisitor<?, T> visitor) {
    ArgumentChecker.notNull(visitor, "visitor");
    return visitor.visitDeliverableSwapFuturesTransaction(this);
  }
  ...
  public boolean equals(Object obj) {
    ...
    DeliverableSwapFuturesTransaction other = (DeliverableSwapFuturesTransaction) obj;
