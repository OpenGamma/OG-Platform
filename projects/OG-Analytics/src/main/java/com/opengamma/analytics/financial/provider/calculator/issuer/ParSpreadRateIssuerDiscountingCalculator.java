 ...
 */
public final class ParSpreadRateIssuerDiscountingCalculator extends InstrumentDerivativeVisitorDelegate<ParameterIssuerProviderInterface, Double> {

  /**
   * The unique instance of the calculator.
   */
  private static final ParSpreadRateIssuerDiscountingCalculator INSTANCE = new ParSpreadRateIssuerDiscountingCalculator();

  /**
   * Gets the calculator instance.
   * @return The calculator.
   */
  public static ParSpreadRateIssuerDiscountingCalculator getInstance() {
    return INSTANCE;
  }
   ...
   * Private constructor.
   */
  private ParSpreadRateIssuerDiscountingCalculator() {
    super(new IssuerProviderAdapter<>(ParSpreadRateDiscountingCalculator.getInstance()));
  }
  ...
  public Double visitBondFixedTransaction(final BondFixedTransaction bond, final ParameterIssuerProviderInterface issuercurves) {
    return METHOD_BOND_TR.parSpreadYield(bond, issuercurves.getIssuerProvider());
  }
