...
public final class AnalyticsEnvironment implements ImmutableBean {
   ...
   *
   * @return the {@link AnalyticsEnvironment} from the {@link ThreadLocalAnalyticsEnvironment}, if not set return {@link #DEFAULT}
   * @see ThreadLocalAnalyticsEnvironment
   * @see #DEFAULT
   */
  public static AnalyticsEnvironment resolve() {
    AnalyticsEnvironment environment = ThreadLocalAnalyticsEnvironment.getInstance();
    if (environment != null) {
      return environment;
    }
    return DEFAULT;
   ...
   */
  public void init() {
    ThreadLocalAnalyticsEnvironment.init(this);
  }
