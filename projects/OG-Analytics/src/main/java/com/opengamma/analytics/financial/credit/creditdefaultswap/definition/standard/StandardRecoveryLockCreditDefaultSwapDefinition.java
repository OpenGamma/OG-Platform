...
public class StandardRecoveryLockCreditDefaultSwapDefinition extends CreditDefaultSwapDefinition {
  ...
  public StandardRecoveryLockCreditDefaultSwapDefinition(
    ...
    // Assign the member variables for the features specific to a standard Recovery Lock CDS
  ...
  // Builder method to allow the maturity of a standard Recovery Lock CDS object to be modified (used during calibration of the survival curve)

  public StandardRecoveryLockCreditDefaultSwapDefinition withMaturity(final ZonedDateTime maturityDate) {
    ...
    final StandardRecoveryLockCreditDefaultSwapDefinition modifiedCDS = new StandardRecoveryLockCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(),
  ...
  // Builder method to allow the premium leg coupon of a standard Recovery Lock CDS object to be modified (used during calibration of the survival curve)

  public StandardRecoveryLockCreditDefaultSwapDefinition withSpread(final double quotedSpread) {

    final StandardRecoveryLockCreditDefaultSwapDefinition modifiedCDS = new StandardRecoveryLockCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(),
  ...
  // Builder method to allow the recovery rate of a standard Recovery Lock CDS object to be modified (used during calibration of the survival curve)
