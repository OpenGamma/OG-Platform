 ...
 */
public final class PresentValueDiscountingProviderCalculator extends AbstractInstrumentDerivativeVisitor<MulticurveProviderInterface, MultipleCurrencyAmount> {

  /**
   * The unique instance of the calculator.
   */
  private static final PresentValueDiscountingProviderCalculator INSTANCE = new PresentValueDiscountingProviderCalculator();

  /**
   * Gets the calculator instance.
   * @return The calculator.
   */
  public static PresentValueDiscountingProviderCalculator getInstance() {
    return INSTANCE;
  }
   ...
   * Constructor.
   */
  private PresentValueDiscountingProviderCalculator() {
  }
