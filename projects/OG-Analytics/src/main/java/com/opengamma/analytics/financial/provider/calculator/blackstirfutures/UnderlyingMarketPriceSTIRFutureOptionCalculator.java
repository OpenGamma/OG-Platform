 ...
 * future options.
 */
public final class UnderlyingMarketPriceSTIRFutureOptionCalculator extends InstrumentDerivativeVisitorAdapter<BlackSTIRFuturesSmileProviderInterface, Double> {
  /**
  ...
  public Double visitInterestRateFutureOptionMarginTransaction(final InterestRateFutureOptionMarginTransaction futures, final BlackSTIRFuturesSmileProviderInterface black) {
    return METHOD_STIR_MARGIN.underlyingFuturesPrice(futures.getUnderlyingOption(), black);
  }
