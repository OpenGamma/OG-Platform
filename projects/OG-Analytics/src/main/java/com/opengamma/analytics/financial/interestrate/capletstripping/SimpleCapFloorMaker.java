 ...
 * 
 */
public abstract class SimpleCapFloorMaker {
   ...
   */
  public static CapFloor makeCap(final Currency ccy, final IborIndex index, int start, int end, final String discountCurve, final String indexCurve, final double strike, final boolean capFloor) {
    return new CapFloor(makeCapletStrip(ccy, index, start, end, discountCurve, indexCurve, strike, capFloor));
  }

  private static CapFloorIbor[] makeCapletStrip(final Currency ccy, final IborIndex index, int start, int end, final String discountCurve, final String indexCurve, final double strike,
