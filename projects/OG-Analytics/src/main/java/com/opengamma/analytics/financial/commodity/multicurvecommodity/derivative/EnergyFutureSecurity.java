...
public class EnergyFutureSecurity extends CommodityFutureSecurity {
  ...
  public EnergyFutureSecurity(final double lastTradingTime, final CommodityUnderlying underlying, final String unitName, final double unitAmount, final double noticeFirstTime,
  ...
  public <S, T> T accept(final InstrumentDerivativeVisitor<S, T> visitor, final S data) {
    ...
    return visitor.visitEnergyFutureSecurity(this, data);
  }
