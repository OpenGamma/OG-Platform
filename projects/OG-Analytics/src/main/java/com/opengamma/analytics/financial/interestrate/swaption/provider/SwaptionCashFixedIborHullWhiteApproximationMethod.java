 ...
 */
public final class SwaptionCashFixedIborHullWhiteApproximationMethod {

  /**
   * The method unique instance.
   */
  private static final SwaptionCashFixedIborHullWhiteApproximationMethod INSTANCE = new SwaptionCashFixedIborHullWhiteApproximationMethod();

  /**
   * Return the unique instance of the class.
   * @return The instance.
   */
  public static SwaptionCashFixedIborHullWhiteApproximationMethod getInstance() {
    return INSTANCE;
  }
   ...
   * Private constructor.
   */
  private SwaptionCashFixedIborHullWhiteApproximationMethod() {
  }
  ...
  public MultipleCurrencyAmount presentValue(final SwaptionCashFixedIbor swaption, final HullWhiteOneFactorProviderInterface hullWhite) {
    ...
    return MultipleCurrencyAmount.of(swaption.getCurrency(), pv * notional * dfIbor[0] * (swaption.isLong() ? 1.0 : -1.0));
  }
  ...
  private double swapRateAdjointAlpha(final double x, final double[] discountedCashFlowFixed, final double[] alphaFixed, final double[] discountedCashFlowIbor, final double[] alphaIbor,
      final double swapRateBar, final double[] derivativesBar, final double[] derivatives, final double[] alphaFixedBar, final double[] alphaIborBar) {
    final double[] f = new double[3];
