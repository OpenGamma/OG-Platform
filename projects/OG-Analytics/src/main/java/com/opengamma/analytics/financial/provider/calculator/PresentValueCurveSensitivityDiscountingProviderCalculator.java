 ...
 */
public final class PresentValueCurveSensitivityDiscountingProviderCalculator extends AbstractInstrumentDerivativeVisitor<MulticurveProviderInterface, MultipleCurrencyCurveSensitivityMarket> {

  /**
   * The unique instance of the calculator.
   */
  private static final PresentValueCurveSensitivityDiscountingProviderCalculator INSTANCE = new PresentValueCurveSensitivityDiscountingProviderCalculator();

  /**
   * Gets the calculator instance.
   * @return The calculator.
   */
  public static PresentValueCurveSensitivityDiscountingProviderCalculator getInstance() {
    return INSTANCE;
  }
   ...
   * Constructor.
   */
  private PresentValueCurveSensitivityDiscountingProviderCalculator() {
  }
  ...
  @Override
  public MultipleCurrencyCurveSensitivityMarket visit(final InstrumentDerivative instrument, final MulticurveProviderInterface multicurve) {
  ...
  @Override
  public MultipleCurrencyCurveSensitivityMarket visitCash(final Cash cash, final MulticurveProviderInterface multicurve) {
  ...
  @Override
  public MultipleCurrencyCurveSensitivityMarket visitFixedPayment(final PaymentFixed payment, final MulticurveProviderInterface multicurve) {
    return METHOD_PAY_FIXED.presentValueCurveSensitivity(payment, multicurve);
  }

  @Override
  public MultipleCurrencyCurveSensitivityMarket visitCouponFixed(final CouponFixed payment, final MulticurveProviderInterface multicurve) {
    return METHOD_CPN_FIXED.presentValueCurveSensitivity(payment, multicurve);
  }

  @Override
  public MultipleCurrencyCurveSensitivityMarket visitCouponIbor(final CouponIbor payment, final MulticurveProviderInterface multicurve) {
    return METHOD_CPN_IBOR.presentValueCurveSensitivity(payment, multicurve);
  }

  @Override
  public MultipleCurrencyCurveSensitivityMarket visitCouponIborSpread(final CouponIborSpread payment, final MulticurveProviderInterface multicurve) {
    return METHOD_CPN_IBOR_SPREAD.presentValueCurveSensitivity(payment, multicurve);
  }

  @Override
  public MultipleCurrencyCurveSensitivityMarket visitCouponIborGearing(final CouponIborGearing payment, final MulticurveProviderInterface multicurve) {
    return METHOD_CPN_IBOR_GEARING.presentValueCurveSensitivity(payment, multicurve);
  }

  @Override
  public MultipleCurrencyCurveSensitivityMarket visitCouponOIS(final CouponOIS payment, final MulticurveProviderInterface multicurve) {
    return METHOD_CPN_ON.presentValueCurveSensitivity(payment, multicurve);
  }

  @Override
  public MultipleCurrencyCurveSensitivityMarket visitForwardRateAgreement(final ForwardRateAgreement fra, final MulticurveProviderInterface multicurve) {
  ...
  @Override
  public MultipleCurrencyCurveSensitivityMarket visitGenericAnnuity(final Annuity<? extends Payment> annuity, final MulticurveProviderInterface multicurve) {
    ArgumentChecker.notNull(annuity, "Annuity");
    ArgumentChecker.notNull(multicurve, "multicurve");
    MultipleCurrencyCurveSensitivityMarket cs = visit(annuity.getNthPayment(0), multicurve);
  ...
  @Override
  public MultipleCurrencyCurveSensitivityMarket visitFixedCouponAnnuity(final AnnuityCouponFixed annuity, final MulticurveProviderInterface multicurve) {
  ...
  @Override
  public MultipleCurrencyCurveSensitivityMarket visitSwap(final Swap<?, ?> swap, final MulticurveProviderInterface multicurve) {
    final MultipleCurrencyCurveSensitivityMarket sensitivity1 = visit(swap.getFirstLeg(), multicurve);
    final MultipleCurrencyCurveSensitivityMarket sensitivity2 = visit(swap.getSecondLeg(), multicurve);
    return sensitivity1.plus(sensitivity2);
  }

  @Override
  public MultipleCurrencyCurveSensitivityMarket visitFixedCouponSwap(final SwapFixedCoupon<?> swap, final MulticurveProviderInterface multicurve) {
  ...
  @Override
  public MultipleCurrencyCurveSensitivityMarket visitForex(final Forex derivative, final MulticurveProviderInterface multicurves) {
