 ...
 */
public abstract class ParameterSensitivityHullWhiteMatrixAbstractCalculator {
   ...
   */
  public ParameterSensitivityHullWhiteMatrixAbstractCalculator(final InstrumentDerivativeVisitor<HullWhiteOneFactorProviderInterface, MulticurveSensitivity> curveSensitivityCalculator) {
