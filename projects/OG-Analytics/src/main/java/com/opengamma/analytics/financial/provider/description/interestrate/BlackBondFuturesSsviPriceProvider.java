...
/**
 * Implementation of Black implied volatility for bond futures with volatility given by a SSVI formula.
 */
public class BlackBondFuturesSsviPriceProvider implements BlackBondFuturesProviderInterface {
   ...
   */
  public BlackBondFuturesSsviPriceProvider(
  ...
  @Override
  public BlackBondFuturesSsviPriceProvider copy() {
    final IssuerProviderInterface multicurveProvider = _issuerProvider.copy();
    return new BlackBondFuturesSsviPriceProvider(multicurveProvider, _volatilityAtm, _rho, _eta, _legalEntity);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof BlackBondFuturesSsviPriceProvider)) {
      return false;
    }
    final BlackBondFuturesSsviPriceProvider other = (BlackBondFuturesSsviPriceProvider) obj;
