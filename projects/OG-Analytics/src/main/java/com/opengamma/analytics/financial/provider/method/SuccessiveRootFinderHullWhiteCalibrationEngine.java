 ...
 */
public class SuccessiveRootFinderHullWhiteCalibrationEngine<DATA_TYPE> extends SuccessiveRootFinderCalibrationEngine<DATA_TYPE> {
  ...
  @Override
  public void calibrate(DATA_TYPE data, MulticurveProviderInterface multicurves) {
    computeCalibrationPrice(data);
    getCalibrationObjective().setMulticurves(multicurves);
