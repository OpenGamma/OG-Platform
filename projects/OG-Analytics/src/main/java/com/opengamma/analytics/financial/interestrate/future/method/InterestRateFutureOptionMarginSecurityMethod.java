...
public abstract class InterestRateFutureOptionMarginSecurityMethod implements PricingMethod {
   ...
   */
  public abstract double optionPriceFromFuturePrice(final InterestRateFutureOptionMarginSecurity security, final YieldCurveBundle curves, final double priceFuture);
   ...
   * @return The security price.
   */
  public abstract double optionPrice(final InterestRateFutureOptionMarginSecurity security, final YieldCurveBundle curves);
