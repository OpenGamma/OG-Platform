 ...
 * @author marc
 */
public class ProviderDiscountFinderJacobian extends Function1D<DoubleMatrix1D, DoubleMatrix2D> {
   ...
   */
  private final ProviderDiscountBuildingData _data;
   ...
   */
  public ProviderDiscountFinderJacobian(final AbstractParameterSensitivityMatrixProviderCalculator parameterSensitivityCalculator, final ProviderDiscountBuildingData data) {
  ...
  public DoubleMatrix2D evaluate(DoubleMatrix1D x) {
    ...
    MulticurveProviderDiscount newCurves = _data.getGeneratorMarket().evaluate(x);
