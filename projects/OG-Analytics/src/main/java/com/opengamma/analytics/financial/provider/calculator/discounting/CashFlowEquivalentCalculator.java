 ...
 */
public class CashFlowEquivalentCalculator extends AbstractInstrumentDerivativeVisitor<MulticurveProviderInterface, AnnuityPaymentFixed> {
  ...
  @Override
  public AnnuityPaymentFixed visit(final InstrumentDerivative derivative, final MulticurveProviderInterface multicurves) {
  ...
  public AnnuityPaymentFixed visitGenericAnnuity(final Annuity<? extends Payment> annuity, final MulticurveProviderInterface multicurves) {
    ...
    for (final Payment p : annuity.getPayments()) {
      AnnuityPaymentFixed cfe = visit(p, multicurves);
  ...
  public AnnuityPaymentFixed visitSwap(final Swap<?, ?> swap, final MulticurveProviderInterface multicurves) {
    ...
    TreeMap<Double, Double> flow = new TreeMap<Double, Double>();
    AnnuityPaymentFixed cfeLeg1 = visit(swap.getFirstLeg(), multicurves);
    AnnuityPaymentFixed cfeLeg2 = visit(swap.getSecondLeg(), multicurves);
  ...
  public AnnuityPaymentFixed visitBondFixedSecurity(final BondFixedSecurity bond, final MulticurveProviderInterface multicurves) {
    ...
    TreeMap<Double, Double> flow = new TreeMap<Double, Double>();
    AnnuityPaymentFixed cfeNom = visit(bond.getNominal(), multicurves);
    AnnuityPaymentFixed cfeCpn = visit(bond.getCoupon(), multicurves);
