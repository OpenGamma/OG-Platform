 ...
 */
public class LegacySovereignCreditDefaultSwapDefinition extends CreditDefaultSwapDefinition {
  ...
  public LegacySovereignCreditDefaultSwapDefinition withMaturityDate(final ZonedDateTime maturityDate) {
    ...
    final LegacySovereignCreditDefaultSwapDefinition modifiedCDS = new LegacySovereignCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(),
  ...
  public boolean equals(final Object obj) {
    ...
    final LegacySovereignCreditDefaultSwapDefinition other = (LegacySovereignCreditDefaultSwapDefinition) obj;
