...
public class CouponInflationZeroCouponMonthly extends CouponInflation {
   ...
   */
  public CouponInflationZeroCouponMonthly(final Currency currency, final double paymentTime, final double paymentYearFraction, final double notional, final PriceIndex priceIndex,
