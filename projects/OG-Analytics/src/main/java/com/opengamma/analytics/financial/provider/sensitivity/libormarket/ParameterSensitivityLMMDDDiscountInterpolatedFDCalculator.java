...
public class ParameterSensitivityLMMDDDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<LiborMarketModelDisplacedDiffusionProviderInterface, MultipleCurrencyAmount> _valueCalculator;
  /**
   ...
   */
  public ParameterSensitivityLMMDDDiscountInterpolatedFDCalculator(final InstrumentDerivativeVisitor<LiborMarketModelDisplacedDiffusionProviderInterface, MultipleCurrencyAmount> valueCalculator,
      final double shift) {
