 ...
 */
public final class FuturesPriceBlackFlatBondFuturesCalculator extends InstrumentDerivativeVisitorAdapter<BlackBondFuturesFlatProviderInterface, Double> {

  /**
   * The unique instance of the calculator.
   */
  private static final FuturesPriceBlackFlatBondFuturesCalculator INSTANCE = new FuturesPriceBlackFlatBondFuturesCalculator();

  /**
   * Gets the calculator instance.
   * @return The calculator.
   */
  public static FuturesPriceBlackFlatBondFuturesCalculator getInstance() {
    return INSTANCE;
  }
   ...
   * Constructor.
   */
  private FuturesPriceBlackFlatBondFuturesCalculator() {
  }
  ...
  @Override
  public Double visitBondFuturesOptionMarginSecurity(final BondFuturesOptionMarginSecurity security, final BlackBondFuturesFlatProviderInterface black) {
