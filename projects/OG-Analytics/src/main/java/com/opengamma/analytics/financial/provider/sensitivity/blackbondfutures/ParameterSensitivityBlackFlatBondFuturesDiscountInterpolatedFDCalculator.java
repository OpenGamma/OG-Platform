...
public class ParameterSensitivityBlackFlatBondFuturesDiscountInterpolatedFDCalculator {
   ...
   */
  public MultipleCurrencyParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final BlackBondFuturesFlatProviderDiscount black) {
    ...
    for (final Currency ccy : ccyDiscounting) {
      ...
      for (int loopnode = 0; loopnode < nbNodePoint; loopnode++) {
        ...
        final BlackBondFuturesFlatProviderDiscount marketDscBumpedPlus = new BlackBondFuturesFlatProviderDiscount(
        ...
        final BlackBondFuturesFlatProviderDiscount marketDscBumpedMinus = new BlackBondFuturesFlatProviderDiscount(
    ...
    for (final IndexON index : indexON) {
      ...
      for (int loopnode = 0; loopnode < nbNodePoint; loopnode++) {
        ...
        final BlackBondFuturesFlatProviderDiscount marketFwdBumpedPlus = new BlackBondFuturesFlatProviderDiscount(
        ...
        final YieldAndDiscountCurve fwdBumpedMinus = new YieldCurve(curveInt.getName(),
            new InterpolatedDoublesCurve(curveInt.getXDataAsPrimitive(), yieldBumpedMinus, curveInt.getInterpolator(), true));
        final BlackBondFuturesFlatProviderDiscount marketFwdBumpedMinus = new BlackBondFuturesFlatProviderDiscount(
    ...
    for (final Pair<Object, LegalEntityFilter<LegalEntity>> ic : issuerCcies) {
      ...
      for (int loopnode = 0; loopnode < nbNodePoint; loopnode++) {
        ...
        final BlackBondFuturesFlatProviderDiscount providerIcBumpedPlus = new BlackBondFuturesFlatProviderDiscount(
        ...
        final YieldAndDiscountCurve icBumpedMinus = new YieldCurve(curveInt.getName(),
            new InterpolatedDoublesCurve(curveInt.getXDataAsPrimitive(), yieldBumpedMinus, curveInt.getInterpolator(), true));
        final BlackBondFuturesFlatProviderDiscount providerIcBumpedMinus = new BlackBondFuturesFlatProviderDiscount(
