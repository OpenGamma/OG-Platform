...
public class GammaIndexCreditDefaultSwap {
  ...
  public double getGammaParallelShiftAllObligorsIndexCreditDefaultSwap(final ZonedDateTime valuationDate, final IndexCreditDefaultSwapDefinition indexCDS, final ISDACurve[] yieldCurve,
    ...
    final double parallelGamma = 0.0;
  ...
  public double[] getGammaBucketedAllObligorsIndexCreditDefaultSwap(final ZonedDateTime valuationDate, final IndexCreditDefaultSwapDefinition indexCDS, final ISDACurve[] yieldCurve,
      final ZonedDateTime[] marketTenors, final double[][] marketSpreads, final double spreadBump, final SpreadBumpType spreadBumpType) {
    ...
    final int numberOfCreditSpreadTenors = marketTenors.length;

    final double[] bucketedGamma = new double[numberOfCreditSpreadTenors];
  ...
  public double[] getGammaParallelShiftIndividualObligorsIndexCreditDefaultSwap(final ZonedDateTime valuationDate, final IndexCreditDefaultSwapDefinition indexCDS, final ISDACurve[] yieldCurve,
      final ZonedDateTime[] marketTenors, final double[][] marketSpreads, final double spreadBump, final SpreadBumpType spreadBumpType) {
    ...
    final double[] parallelGamma = new double[numberOfObligors];
  ...
  public double[][] getGammaBucketedIndividualObligorsIndexCreditDefaultSwap(final ZonedDateTime valuationDate, final IndexCreditDefaultSwapDefinition indexCDS, final ISDACurve[] yieldCurve,
      final ZonedDateTime[] marketTenors, final double[][] marketSpreads, final double spreadBump, final SpreadBumpType spreadBumpType) {
    ...
    final double[][] gamma = new double[numberOfObligors][numberOfCreditSpreadTenors];
