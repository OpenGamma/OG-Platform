 ...
 */
public class ParameterSensitivityMatrixHullWhiteProviderCalculator extends AbstractParameterSensitivityMatrixHullWhiteProviderCalculator {

  /**
   * Constructor
   * @param curveSensitivityCalculator The curve sensitivity calculator.
   */
  public ParameterSensitivityMatrixHullWhiteProviderCalculator(InstrumentDerivativeVisitor<HullWhiteOneFactorProviderInterface, MulticurveSensitivity> curveSensitivityCalculator) {
