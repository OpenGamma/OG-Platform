...
public class SuccessiveLeastSquareLMMDDCalibrationEngine<DATA_TYPE extends ParameterProviderInterface> extends SuccessiveLeastSquareCalibrationEngineWithCalculators<DATA_TYPE> {
  ...
  public void addInstrument(final InstrumentDerivative instrument, final InstrumentDerivativeVisitor<DATA_TYPE, MultipleCurrencyAmount> calculator) {
    ...
    _instrumentIndex.add(Arrays.binarySearch(((SuccessiveLeastSquareLMMDDCalibrationObjective) getCalibrationObjective()).getLMMParameters().getIborTime(), swaption.getUnderlyingSwap().getSecondLeg()
  ...
  public void calibrate(DATA_TYPE data) {
    ...
    SuccessiveLeastSquareLMMDDCalibrationObjective objective = (SuccessiveLeastSquareLMMDDCalibrationObjective) getCalibrationObjective();
