 ...
 */
public final class ParSpreadMarketQuoteHullWhiteProviderCalculator extends AbstractInstrumentDerivativeVisitor<HullWhiteOneFactorProviderInterface, Double> {

  /**
   * The unique instance of the calculator.
   */
  private static final ParSpreadMarketQuoteHullWhiteProviderCalculator INSTANCE = new ParSpreadMarketQuoteHullWhiteProviderCalculator();

  /**
   * Gets the calculator instance.
   * @return The calculator.
   */
  public static ParSpreadMarketQuoteHullWhiteProviderCalculator getInstance() {
    return INSTANCE;
  }
   ...
   * Constructor.
   */
  private ParSpreadMarketQuoteHullWhiteProviderCalculator() {
  }
   ...
   */
  private static final ParSpreadMarketQuoteDiscountingProviderCalculator PVDC = ParSpreadMarketQuoteDiscountingProviderCalculator.getInstance();
