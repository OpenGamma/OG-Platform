 ...
 * @author marc
 */
public class ProviderDiscountFinderFunction extends Function1D<DoubleMatrix1D, DoubleMatrix1D> {
   ...
   */
  public ProviderDiscountFinderFunction(final InstrumentDerivativeVisitor<MulticurveProviderInterface, Double> calculator, ProviderDiscountBuildingData data) {
