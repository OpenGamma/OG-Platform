...
public class DecisionScheduleDerivative extends DecisionSchedule {
   ...
   */
  private final List<Map<Double, MulticurveSensitivity>> _impactAmountDerivative;
  ...
  public DecisionScheduleDerivative(double[] decisionTime, double[][] impactTime, double[][] impactAmount) {
    ...
    _impactAmountDerivative = new ArrayList<Map<Double, MulticurveSensitivity>>();
  }
   ...
   */
  public DecisionScheduleDerivative(double[] decisionTime, double[][] impactTime, double[][] impactAmount, List<Map<Double, MulticurveSensitivity>> impactAmountDerivative) {
    super(decisionTime, impactTime, impactAmount);
