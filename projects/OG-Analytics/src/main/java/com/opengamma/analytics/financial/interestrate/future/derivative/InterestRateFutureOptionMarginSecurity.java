 ...
 */
public class InterestRateFutureOptionMarginSecurity extends FuturesSecurity {
   ...
   */
  public InterestRateFutureOptionMarginSecurity(final InterestRateFutureSecurity underlyingFuture, final double expirationTime, final double strike,
