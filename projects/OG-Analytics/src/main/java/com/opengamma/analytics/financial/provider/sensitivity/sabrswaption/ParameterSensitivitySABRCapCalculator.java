 ...
 */
public class ParameterSensitivitySABRCapCalculator extends AbstractParameterSensitivitySABRCapProviderCalculator {

  /**
   * Constructor
   * @param curveSensitivityCalculator The curve sensitivity calculator.
   */
  public ParameterSensitivitySABRCapCalculator(InstrumentDerivativeVisitor<SABRCapProviderInterface, MultipleCurrencyMulticurveSensitivity> curveSensitivityCalculator) {
    super(curveSensitivityCalculator);
  }

  @Override
  public MultipleCurrencyParameterSensitivity pointToParameterSensitivity(final MultipleCurrencyMulticurveSensitivity sensitivity, final SABRCapProviderInterface multicurves,
