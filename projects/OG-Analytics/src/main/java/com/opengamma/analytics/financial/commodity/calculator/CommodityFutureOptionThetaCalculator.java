 ...
 */
public final class CommodityFutureOptionThetaCalculator extends InstrumentDerivativeVisitorAdapter<StaticReplicationDataBundle, Double> {
  ...
  private CommodityFutureOptionThetaCalculator() {
  }
