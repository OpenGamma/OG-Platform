...
public final class CouponIborSpreadDiscountingProviderMethod {
   ...
   */
  private static final CouponIborSpreadDiscountingProviderMethod INSTANCE = new CouponIborSpreadDiscountingProviderMethod();

  /**
   * Return the unique instance of the class.
   * @return The instance.
   */
  public static CouponIborSpreadDiscountingProviderMethod getInstance() {
    return INSTANCE;
  }
   ...
   * Private constructor.
   */
  private CouponIborSpreadDiscountingProviderMethod() {
  }
