 ...
 */
public final class PresentValueCurveSensitivityBlackSTIRFuturesCalculator extends InstrumentDerivativeVisitorAdapter<BlackSTIRFuturesSmileProviderInterface, MultipleCurrencyMulticurveSensitivity> {

  /**
   * The unique instance of the calculator.
   */
  private static final PresentValueCurveSensitivityBlackSTIRFuturesCalculator INSTANCE = new PresentValueCurveSensitivityBlackSTIRFuturesCalculator();

  /**
   * Gets the calculator instance.
   * @return The calculator.
   */
  public static PresentValueCurveSensitivityBlackSTIRFuturesCalculator getInstance() {
    return INSTANCE;
  }
   ...
   * Constructor.
   */
  private PresentValueCurveSensitivityBlackSTIRFuturesCalculator() {
  }
