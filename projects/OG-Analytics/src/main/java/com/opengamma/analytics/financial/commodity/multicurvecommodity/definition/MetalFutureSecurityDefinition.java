 ...
 * 
 */
public class MetalFutureSecurityDefinition extends CommodityFutureSecurityDefinition<MetalFutureSecurity> {
  ...
  public MetalFutureSecurity toDerivative(final ZonedDateTime date) {
    ...
    return new MetalFutureSecurity(lastTradingTime, getUnderlying(), getUnitName(), getUnitAmount(), noticeFirstTime, noticeLastTime, firstDeliveryTime, lastDeliveryTime, getSettlementType(),
  ...
  public <U, V> V accept(final InstrumentDefinitionVisitor<U, V> visitor, final U data) {
    ...
    return visitor.visitMetalFutureSecurityDefinition(this, data);
  }

  @Override
  public <V> V accept(final InstrumentDefinitionVisitor<?, V> visitor) {
    ArgumentChecker.notNull(visitor, "visitor");
    return visitor.visitMetalFutureSecurityDefinition(this);
  }
