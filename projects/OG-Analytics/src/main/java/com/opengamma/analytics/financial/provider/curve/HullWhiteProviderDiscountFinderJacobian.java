...
import com.opengamma.analytics.financial.provider.sensitivity.hullwhite.AbstractParameterSensitivityMatrixHullWhiteProviderCalculator;
...
public class HullWhiteProviderDiscountFinderJacobian extends Function1D<DoubleMatrix1D, DoubleMatrix2D> {
   ...
   */
  private final AbstractParameterSensitivityMatrixHullWhiteProviderCalculator _parameterSensitivityCalculator;
  /**
   ...
   */
  public HullWhiteProviderDiscountFinderJacobian(final AbstractParameterSensitivityMatrixHullWhiteProviderCalculator parameterSensitivityCalculator, final HullWhiteProviderDiscountBuildingData data) {
