 ...
 */
public abstract class SuccessiveRootFinderCalibrationEngineWithCalculators<DATA_TYPE extends ParameterProviderInterface> extends CalibrationEngineWithCalculators<DATA_TYPE> {
   ...
   */
  public SuccessiveRootFinderCalibrationEngineWithCalculators(final SuccessiveRootFinderCalibrationObjective calibrationObjective) {
