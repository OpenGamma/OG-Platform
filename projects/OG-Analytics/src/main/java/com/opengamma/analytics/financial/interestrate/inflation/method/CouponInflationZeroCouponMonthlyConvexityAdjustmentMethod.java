...
public class CouponInflationZeroCouponMonthlyConvexityAdjustmentMethod {
   ...
   */
  public MultipleCurrencyAmount netAmount(CouponInflationZeroCouponMonthly coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
   ...
   */
  public MultipleCurrencyAmount presentValue(CouponInflationZeroCouponMonthly coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
    Validate.notNull(coupon, "Coupon");
    Validate.notNull(inflation, "Inflation");
   ...
   */
  public double indexEstimation(CouponInflationZeroCouponMonthly coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
