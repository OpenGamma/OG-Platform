 ...
 * @author marc
 */
public class ProviderForwardFinderFunction extends Function1D<DoubleMatrix1D, DoubleMatrix1D> {
   ...
   */
  public ProviderForwardFinderFunction(final InstrumentDerivativeVisitor<MulticurveProviderInterface, Double> calculator, ProviderForwardBuildingData data) {
