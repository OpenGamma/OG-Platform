 ...
 */
public abstract class AbstractParameterSensitivitySABRCapProviderCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<SABRCapProviderInterface, MultipleCurrencyMulticurveSensitivity> _curveSensitivityCalculator;

  /**
   * The constructor from a curve sensitivity calculator, not null
   * @param curveSensitivityCalculator The calculator.
   */
  public AbstractParameterSensitivitySABRCapProviderCalculator(
      final InstrumentDerivativeVisitor<SABRCapProviderInterface, MultipleCurrencyMulticurveSensitivity> curveSensitivityCalculator) {
   ...
   */
  public MultipleCurrencyParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final SABRCapProviderInterface multicurves, final Set<String> curvesSet) {
   ...
   * @return The sensitivity (as a ParameterSensitivity).
   */
  public abstract MultipleCurrencyParameterSensitivity pointToParameterSensitivity(final MultipleCurrencyMulticurveSensitivity sensitivity, final SABRCapProviderInterface multicurves,
