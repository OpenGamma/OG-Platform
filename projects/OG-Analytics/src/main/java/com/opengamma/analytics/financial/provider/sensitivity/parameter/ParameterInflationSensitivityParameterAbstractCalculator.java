...
public abstract class ParameterInflationSensitivityParameterAbstractCalculator<DATA_TYPE extends ParameterInflationProviderInterface> {
   ...
   */
  public ParameterInflationSensitivityParameterAbstractCalculator(final InstrumentDerivativeVisitor<DATA_TYPE, MultipleCurrencyInflationSensitivity> curveSensitivityCalculator) {
