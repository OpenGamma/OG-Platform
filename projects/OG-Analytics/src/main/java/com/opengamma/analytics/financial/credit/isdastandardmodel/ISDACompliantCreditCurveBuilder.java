...
public interface ISDACompliantCreditCurveBuilder {
  ...
  * @param tradeDate The 'current' date
   ...
   * @return The credit curve
   */
  ISDACompliantCreditCurve calibrateCreditCurve(final LocalDate tradeDate, final LocalDate stepinDate, final LocalDate valueDate, final LocalDate startDate, final LocalDate endDate,
  ...
  * @param tradeDate The 'current' date
   ...
   * @return The credit curve
   */
  ISDACompliantCreditCurve calibrateCreditCurve(final LocalDate tradeDate, final LocalDate stepinDate, final LocalDate valueDate, final LocalDate startDate, final LocalDate[] endDates,
