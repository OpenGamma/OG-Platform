 ...
 */
public class SimpleParameterSensitivityParameterCalculator<DATA_TYPE extends ParameterProviderInterface> extends SimpleParameterSensitivityParameterAbstractCalculator<DATA_TYPE> {
