 ...
 * @author marc
 */
public class ProviderForwardBuildingData {
   ...
   */
  private final GeneratorProviderForward _generator;
  /**
   ...
   */
  public ProviderForwardBuildingData(final InstrumentDerivative[] instruments, final GeneratorProviderForward generator) {
   ...
   */
  public GeneratorProviderForward getGeneratorMarket() {
    return _generator;
  }
