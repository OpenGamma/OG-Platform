 ...
 */
public class GeneratorLegIbor extends GeneratorInstrument<GeneratorAttributeIR> {
   ...
   */
  public GeneratorLegIbor(String name, IborIndex indexIbor, Period paymentPeriod, int spotOffset, int paymentOffset,
