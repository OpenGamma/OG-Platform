...
public class CouponInflationYearOnYearMonthlyWithMarginConvexityAdjustmentMethod {
  ...
  public MultipleCurrencyAmount netAmount(CouponInflationYearOnYearMonthlyWithMargin coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
   ...
   */
  public MultipleCurrencyAmount presentValue(CouponInflationYearOnYearMonthlyWithMargin coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
    Validate.notNull(coupon, "Coupon");
    Validate.notNull(inflation, "Inflation");
   ...
   */
  public double indexEstimationStart(CouponInflationYearOnYearMonthlyWithMargin coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
   ...
   */
  public double indexEstimationEnd(CouponInflationYearOnYearMonthlyWithMargin coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
