 ...
 */
public abstract class AbstractParameterSensitivityParameterProviderCalculator<DATA_TYPE extends ParameterProviderInterface> {
   ...
   */
  public AbstractParameterSensitivityParameterProviderCalculator(final InstrumentDerivativeVisitor<DATA_TYPE, MultipleCurrencyMulticurveSensitivity> curveSensitivityCalculator) {
