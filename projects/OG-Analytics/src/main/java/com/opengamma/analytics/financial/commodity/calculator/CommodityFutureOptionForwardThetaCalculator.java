 ...
 *
 */
public class CommodityFutureOptionForwardThetaCalculator extends InstrumentDerivativeVisitorAdapter<StaticReplicationDataBundle, Double> {
   ...
   *
   */
  public CommodityFutureOptionForwardThetaCalculator() {
  }
