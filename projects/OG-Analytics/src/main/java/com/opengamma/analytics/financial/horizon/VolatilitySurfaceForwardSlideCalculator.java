...
public final class VolatilitySurfaceForwardSlideCalculator {
  private static final VolatilitySurfaceForwardSlideCalculator INSTANCE = new VolatilitySurfaceForwardSlideCalculator();

  public static VolatilitySurfaceForwardSlideCalculator getInstance() {
    return INSTANCE;
  }

  private VolatilitySurfaceForwardSlideCalculator() {
  }
