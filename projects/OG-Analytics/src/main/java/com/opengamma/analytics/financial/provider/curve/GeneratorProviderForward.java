 ...
 * @author marc
 */
public class GeneratorProviderForward extends Function1D<DoubleMatrix1D, MulticurveProviderInterface> {
   ...
   */
  public GeneratorProviderForward(final MulticurveProviderForward knownData, final LinkedHashMap<String, Currency> discountingMap, final LinkedHashMap<String, IborIndex> forwardIborMap,
