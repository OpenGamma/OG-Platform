 ...
 */
public abstract class ParameterSensitivityInflationMatrixProviderAbstractCalculator {
   ...
   */
  public DoubleMatrix1D calculateSensitivity(final InstrumentDerivative instrument, final InflationProviderInterface inflationCurves, final Set<String> curvesSet) {
   ...
   * @return The sensitivity (as a DoubleMatrix1D).
   */
  public abstract DoubleMatrix1D pointToParameterSensitivity(final InflationSensitivity sensitivity, final InflationProviderInterface inflation, final Set<String> curvesSet);
}
