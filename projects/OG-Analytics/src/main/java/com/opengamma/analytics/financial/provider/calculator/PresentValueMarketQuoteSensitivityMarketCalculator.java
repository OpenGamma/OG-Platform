 ...
 * @author marc
 */
public final class PresentValueMarketQuoteSensitivityMarketCalculator extends AbstractInstrumentDerivativeVisitor<MulticurveProviderInterface, Double> {

  /**
   * The unique instance of the calculator.
   */
  private static final PresentValueMarketQuoteSensitivityMarketCalculator INSTANCE = new PresentValueMarketQuoteSensitivityMarketCalculator();

  /**
   * Gets the calculator instance.
   * @return The calculator.
   */
  public static PresentValueMarketQuoteSensitivityMarketCalculator getInstance() {
    return INSTANCE;
  }
   ...
   * Constructor.
   */
  private PresentValueMarketQuoteSensitivityMarketCalculator() {
  }
