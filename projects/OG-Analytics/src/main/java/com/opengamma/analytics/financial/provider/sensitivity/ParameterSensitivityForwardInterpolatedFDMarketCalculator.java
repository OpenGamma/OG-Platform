 ...
 */
public class ParameterSensitivityForwardInterpolatedFDMarketCalculator {
   ...
   */
  public ParameterSensitivityForwardInterpolatedFDMarketCalculator(InstrumentDerivativeVisitor<MulticurveProviderInterface, MultipleCurrencyAmount> valueCalculator, final double shift) {
   ...
   */
  public ParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final MulticurveProviderForward market) {
