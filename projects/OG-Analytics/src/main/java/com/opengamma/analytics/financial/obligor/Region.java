...
public final class Region implements ImmutableBean, Serializable {
  ...
  public static Region of(final String name) {
    return new Region(name, null, null);
  }
   ...
   * @return The region
   */
  public static Region of(final String name, final Currency currency) {
    ArgumentChecker.notNull(currency, "currency");
    return new Region(name, null, Collections.singleton(currency));
  }
  ...
  public static Region of(final String name, final Country country, final Currency currency) {
    ...
    ArgumentChecker.notNull(currency, "currency");
    return new Region(name, Collections.singleton(country), Collections.singleton(currency));
  }
   ...
   * @return The region
   */
  public static Region of(final String name, final Set<Currency> currencies) {
    ArgumentChecker.notNull(currencies, "currencies");
    return new Region(name, null, currencies);
  }
  ...
  private Region(
    ...
    this._name = name;
    this._countries = (countries != null ? ImmutableSet.copyOf(countries) : null);
    this._currencies = (currencies != null ? ImmutableSet.copyOf(currencies) : null);
  }
