 ...
 */
public class ForexBlackVannaVolgaProvider implements ForexBlackVannaVolgaProviderInterface {
   ...
   */
  public ForexBlackVannaVolgaProvider(final MulticurveProviderInterface multicurves, final SmileDeltaTermStructureParameters smile, final Pair<Currency, Currency> currencyPair) {
  ...
  @Override
  public ForexBlackVannaVolgaProvider copy() {
    MulticurveProviderInterface multicurveProvider = _multicurveProvider.copy();
    return new ForexBlackVannaVolgaProvider(multicurveProvider, _smile, _currencyPair);
  }
