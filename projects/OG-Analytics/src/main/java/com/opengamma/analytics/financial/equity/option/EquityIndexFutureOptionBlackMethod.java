...
public final class EquityIndexFutureOptionBlackMethod {
   ...
   */
  public static EquityIndexFutureOptionBlackMethod getInstance() {
    return INSTANCE;
  }
   ...
   * Private constructor
   */
  private EquityIndexFutureOptionBlackMethod() {
  }
   ...
   */
  public double forwardPrice(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
    ...
    final double notional = derivative.getPointValue();
   ...
   */
  public double discountToSettlement(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
    final double df = marketData.getDiscountCurve().getDiscountFactor(derivative.getUnderlying().getTimeToSettlement());
    return df;
  }
   ...
   */
  public double forwardIndexValue(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
    ArgumentChecker.notNull(derivative, "derivative was null. Expecting EquityIndexFutureOption");
    ArgumentChecker.notNull(marketData, "market was null. Expecting StaticReplicationDataBundle");
    final double expiry = derivative.getExpiry();
    final double forward = marketData.getForwardCurve().getForward(expiry);
   ...
   */
  public double presentValue(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
   ...
   * @return The sensitivity of the present value wrt the discounting rate
   */
  public double rhoBlackScholes(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
   ...
   */
  public double deltaWrtForward(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
   ...
   */
  public double deltaWrtSpot(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
   ...
   */
  public double forwardGamma(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
    ArgumentChecker.notNull(derivative, "derivative was null. Expecting EquityIndexFutureOption");
    ArgumentChecker.notNull(marketData, "market was null. Expecting StaticReplicationDataBundle");
    final double expiry = derivative.getExpiry();
    final double strike = derivative.getStrike();
   ...
   */
  public double gammaWrtForward(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
   ...
   */
  public double gammaWrtSpot(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
   ...
   */
  public double vega(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
    ArgumentChecker.notNull(derivative, "derivative was null. Expecting EquityIndexFutureOption");
    ArgumentChecker.notNull(marketData, "market was null. Expecting StaticReplicationDataBundle");
    final double expiry = derivative.getExpiry();
    final double strike = derivative.getStrike();
   ...
   */
  public double impliedVol(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
    ArgumentChecker.notNull(derivative, "derivative was null. Expecting EquityIndexFutureOption");
    ArgumentChecker.notNull(marketData, "market was null. Expecting StaticReplicationDataBundle");
    final double expiry = derivative.getExpiry();
    final double strike = derivative.getStrike();
   ...
   */
  public double forwardVomma(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
    ArgumentChecker.notNull(derivative, "derivative was null. Expecting EquityIndexFutureOption");
    ArgumentChecker.notNull(marketData, "market was null. Expecting StaticReplicationDataBundle");
    final double expiry = derivative.getExpiry();
    final double strike = derivative.getStrike();
   ...
   */
  public double vomma(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
   ...
   *          $\frac{\partial^2 (PV)}{\partial \sigma^2}$
   */
  public double spotVolga(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
   ...
   */
  public double forwardVanna(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
    ArgumentChecker.notNull(derivative, "derivative was null. Expecting EquityIndexFutureOption");
    ArgumentChecker.notNull(marketData, "market was null. Expecting StaticReplicationDataBundle");
    final double expiry = derivative.getExpiry();
    final double strike = derivative.getStrike();
   ...
   */
  public double vannaWrtForward(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
   ...
   */
  public double vannaWrtSpot(final EquityIndexFutureOption derivative, final StaticReplicationDataBundle marketData) {
