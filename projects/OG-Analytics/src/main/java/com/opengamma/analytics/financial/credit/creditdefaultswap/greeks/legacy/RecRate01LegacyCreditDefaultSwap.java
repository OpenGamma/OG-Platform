 ...
 */
public class RecRate01LegacyCreditDefaultSwap {
  ...
  public double getRecoveryRate01CreditDefaultSwap(
    ...
    LegacyCreditDefaultSwapDefinition bumpedCDS = cds.withRecoveryRate(bumpedRecoveryRate);
    ...
    final double bumpedPresentValue = creditDefaultSwap.getPresentValueCreditDefaultSwap(valuationDate, bumpedCDS, yieldCurve, calibratedHazardRateCurve, priceType);
  ...
  private double getBumpedRecoveryRate(final LegacyCreditDefaultSwapDefinition cds, final double recoveryRateBump, final RecoveryRateBumpType recoveryRateBumpType) {
