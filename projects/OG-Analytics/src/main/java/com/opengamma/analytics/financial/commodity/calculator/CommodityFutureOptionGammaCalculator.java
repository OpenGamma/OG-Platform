 ...
 */
public final class CommodityFutureOptionGammaCalculator extends InstrumentDerivativeVisitorAdapter<StaticReplicationDataBundle, Double> {
  ...
  private CommodityFutureOptionGammaCalculator() {
  }
