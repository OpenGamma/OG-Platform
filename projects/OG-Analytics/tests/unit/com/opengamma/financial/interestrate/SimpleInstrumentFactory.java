...
public abstract class SimpleInstrumentFactory {
  ...
  public static InterestRateDerivative makeCash(final double time, final String fundCurveName, final double rate,
      final double notional) {
    return new Cash(DUMMY_CUR, time, notional, rate, fundCurveName);
  }

  public static InterestRateDerivative makeLibor(final double time, final String indexCurveName, final double rate,
      final double notional) {
   ...
   * @return A FRA
   */
  public static InterestRateDerivative makeFRA(final double time, final SimpleFrequency paymentFreq, final String fundCurveName,
  ...
  private static OISSwap makeSinglePaymentOISSwap(final double time, final String fundingCurveName,
      final String indexCurveName, final double rate, final double notional) {
  ...
  public static FixedFloatSwap makeSwap(final double time, final SimpleFrequency floatLegFreq, final SimpleFrequency fixedLegFreq, final String fundingCurveName,
      final String liborCurveName, final double rate, final double notional) {
   ...
   * @return A FRN
   */
  public static FloatingRateNote makeFRN(final CurrencyAmount notional, final int nYears, SimpleFrequency freq, final String discountCurve,
