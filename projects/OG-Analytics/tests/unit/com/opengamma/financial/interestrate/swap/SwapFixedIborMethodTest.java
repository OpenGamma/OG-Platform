...
public class SwapFixedIborMethodTest {
  ...
  private static final ZZZSwapFixedIborDefinition SWAP_DEFINITION_PAYER = ZZZSwapFixedIborDefinition.from(SETTLEMENT_DATE, CMS_INDEX, NOTIONAL, RATE, FIXED_IS_PAYER);
  // to derivatives
