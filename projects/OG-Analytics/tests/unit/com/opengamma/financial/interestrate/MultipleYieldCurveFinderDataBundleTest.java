...
public class MultipleYieldCurveFinderDataBundleTest {
  ...
  static {
    ...
    for (int i = 0; i < n; i++) {
      ...
      DERIVATIVES.add(new Cash(CUR, t1, Math.random(), CURVE_NAME1));
      DERIVATIVES.add(new Cash(CUR, t2, Math.random(), CURVE_NAME2));
      TIMES1[i] = t1;
      TIMES2[i] = t2;
      PAR_RATES[i] = 0.05;
      PAR_RATES[n + i] = 0.05;
  ...
  public void testEqualsAndHashCode() {
    ...
    derivatives.set(0, new Cash(CUR, 1000, 0.05, CURVE_NAME1));
