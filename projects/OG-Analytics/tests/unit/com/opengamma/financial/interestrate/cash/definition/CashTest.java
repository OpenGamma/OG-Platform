...
public class CashTest {
  ...
  public void testNullCurrency1() {
    new Cash(null, T, R, CURVE_NAME);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testNullCurrency2() {
    new Cash(null, T, R, TRADE_T, FRACTION, CURVE_NAME);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testNegativeTime1() {
    new Cash(CCY, -T, R, CURVE_NAME);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testNegativeTime2() {
    new Cash(CCY, -T, R, TRADE_T, FRACTION, CURVE_NAME);
  }
  ...
  public void testNullName1() {
    new Cash(CCY, T, R, null);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testNullName2() {
    new Cash(CCY, T, R, TRADE_T, FRACTION, null);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testBadTradeTime() {
    new Cash(CCY, T, R, T + 1, FRACTION, null);
  }
  ...
  public void test() {
    ...
    final Cash cash = new Cash(CCY, time, rate, CURVE_NAME);
    ...
    Cash other = new Cash(CCY, time, rate, CURVE_NAME);
    assertEquals(other, cash);
    assertEquals(other.hashCode(), cash.hashCode());
    other = new Cash(CCY, time, rate, 0.0, time, CURVE_NAME);
    assertEquals(other, cash);
    other = new Cash(Currency.CAD, time, rate, CURVE_NAME);
    assertFalse(other.equals(cash));
    other = new Cash(CCY, time, rate, 0.0, time, CURVE_NAME);
    assertEquals(other, cash);
    other = new Cash(CCY, time + 1, rate, CURVE_NAME);
    assertFalse(other.equals(cash));
    other = new Cash(CCY, time, 0.04, CURVE_NAME);
    assertFalse(other.equals(cash));
    other = new Cash(CCY, time, rate, "");
    assertFalse(other.equals(cash));
    other = new Cash(CCY, time, rate, 0.0, 7 / 365., CURVE_NAME);
    assertFalse(other.equals(cash));
    other = new Cash(CCY, time, rate, 1 / 365., time, CURVE_NAME);
    assertFalse(other.equals(cash));
    other = new Cash(CCY, time, rate, 0, time, CURVE_NAME);
    assertEquals(other, cash);
  }
