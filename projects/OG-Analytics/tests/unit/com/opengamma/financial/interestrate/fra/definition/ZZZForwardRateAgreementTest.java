 ...
 */
public class ZZZForwardRateAgreementTest {
  ...
  private static final ZZZForwardRateAgreement FRA = new ZZZForwardRateAgreement(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, ACCRUAL_FACTOR_PAYMENT, NOTIONAL, INDEX, FIXING_TIME, FIXING_PERIOD_START_TIME,
      FIXING_PERIOD_END_TIME, ACCRUAL_FACTOR_FIXING, FRA_RATE, FORWARD_CURVE_NAME);

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testNullCurrency() {
    new ZZZForwardRateAgreement(null, PAYMENT_TIME, FUNDING_CURVE_NAME, ACCRUAL_FACTOR_PAYMENT, NOTIONAL, INDEX, FIXING_TIME, FIXING_PERIOD_START_TIME, FIXING_PERIOD_END_TIME, ACCRUAL_FACTOR_FIXING,
        FRA_RATE, FORWARD_CURVE_NAME);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testNullFundingCurve() {
    new ZZZForwardRateAgreement(CUR, PAYMENT_TIME, null, ACCRUAL_FACTOR_PAYMENT, NOTIONAL, INDEX, FIXING_TIME, FIXING_PERIOD_START_TIME, FIXING_PERIOD_END_TIME, ACCRUAL_FACTOR_FIXING, FRA_RATE,
        FORWARD_CURVE_NAME);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testNullIndex() {
    new ZZZForwardRateAgreement(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, ACCRUAL_FACTOR_PAYMENT, NOTIONAL, null, FIXING_TIME, FIXING_PERIOD_START_TIME, FIXING_PERIOD_END_TIME, ACCRUAL_FACTOR_FIXING,
        FRA_RATE, FORWARD_CURVE_NAME);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testNullForwardCurve() {
    new ZZZForwardRateAgreement(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, ACCRUAL_FACTOR_PAYMENT, NOTIONAL, INDEX, FIXING_TIME, FIXING_PERIOD_START_TIME, FIXING_PERIOD_END_TIME, ACCRUAL_FACTOR_FIXING,
        FRA_RATE, null);
  }
  ...
  public void equalHash() {
    ...
    ZZZForwardRateAgreement modifiedFRA;
    modifiedFRA = new ZZZForwardRateAgreement(CUR, PAYMENT_TIME + 1.0, FUNDING_CURVE_NAME, ACCRUAL_FACTOR_PAYMENT, NOTIONAL, INDEX, FIXING_TIME, FIXING_PERIOD_START_TIME, FIXING_PERIOD_END_TIME,
        ACCRUAL_FACTOR_FIXING, FRA_RATE, FORWARD_CURVE_NAME);
    assertEquals(modifiedFRA.equals(FRA), false);
    modifiedFRA = new ZZZForwardRateAgreement(CUR, PAYMENT_TIME, FORWARD_CURVE_NAME, ACCRUAL_FACTOR_PAYMENT, NOTIONAL, INDEX, FIXING_TIME, FIXING_PERIOD_START_TIME, FIXING_PERIOD_END_TIME,
        ACCRUAL_FACTOR_FIXING, FRA_RATE, FORWARD_CURVE_NAME);
    assertEquals(modifiedFRA.equals(FRA), false);
    modifiedFRA = new ZZZForwardRateAgreement(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, ACCRUAL_FACTOR_PAYMENT + 1.0, NOTIONAL, INDEX, FIXING_TIME, FIXING_PERIOD_START_TIME, FIXING_PERIOD_END_TIME,
        ACCRUAL_FACTOR_FIXING, FRA_RATE, FORWARD_CURVE_NAME);
    assertEquals(modifiedFRA.equals(FRA), false);
    modifiedFRA = new ZZZForwardRateAgreement(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, ACCRUAL_FACTOR_PAYMENT, NOTIONAL + 1.0, INDEX, FIXING_TIME, FIXING_PERIOD_START_TIME, FIXING_PERIOD_END_TIME,
        ACCRUAL_FACTOR_FIXING, FRA_RATE, FORWARD_CURVE_NAME);
    assertEquals(modifiedFRA.equals(FRA), false);
    modifiedFRA = new ZZZForwardRateAgreement(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, ACCRUAL_FACTOR_PAYMENT, NOTIONAL + 1.0, INDEX, FIXING_TIME, FIXING_PERIOD_START_TIME, FIXING_PERIOD_END_TIME,
        ACCRUAL_FACTOR_FIXING, FRA_RATE, FORWARD_CURVE_NAME);
    assertEquals(modifiedFRA.equals(FRA), false);
    modifiedFRA = new ZZZForwardRateAgreement(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, ACCRUAL_FACTOR_PAYMENT, NOTIONAL, INDEX, FIXING_TIME - 0.01, FIXING_PERIOD_START_TIME, FIXING_PERIOD_END_TIME,
        ACCRUAL_FACTOR_FIXING, FRA_RATE, FORWARD_CURVE_NAME);
    assertEquals(modifiedFRA.equals(FRA), false);
    modifiedFRA = new ZZZForwardRateAgreement(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, ACCRUAL_FACTOR_PAYMENT, NOTIONAL, INDEX, FIXING_TIME, FIXING_PERIOD_START_TIME - 0.001, FIXING_PERIOD_END_TIME,
        ACCRUAL_FACTOR_FIXING, FRA_RATE, FORWARD_CURVE_NAME);
    assertEquals(modifiedFRA.equals(FRA), false);
    modifiedFRA = new ZZZForwardRateAgreement(CUR, PAYMENT_TIME, FUNDING_CURVE_NAME, ACCRUAL_FACTOR_PAYMENT, NOTIONAL, INDEX, FIXING_TIME, FIXING_PERIOD_START_TIME, FIXING_PERIOD_END_TIME + 0.01,
        ACCRUAL_FACTOR_FIXING, FRA_RATE, FORWARD_CURVE_NAME);
    assertEquals(modifiedFRA.equals(FRA), false);
