...
import com.opengamma.financial.interestrate.TestUtils;
...
public class SwaptionPhysicalFixedIborHullWhiteMethodTest {
  ...
  public void monteCarlo() {
    ...
    CurrencyAmount pvReceiverLongMC = methodMC.presentValue(SWAPTION_RECEIVER_LONG, CUR, curve, BUNDLE_HW);
    double pvSwap = PVC.visit(SWAP_RECEIVER, CURVES);
  ...
  public void presentValueCurveSensitivity() {
    ...
    List<DoublesPair> fdSense = FDCurveSensitivityCalculator.curveSensitvityFDCalculator(SWAPTION_PAYER_LONG, METHOD_HW, BUNDLE_HW,
        CURVES_NAME[0], nodeTimesDisc, 1e-8);
  ...
  public void performance() {
    ...
    startTime = System.currentTimeMillis();
    for (int looptest = 0; looptest < nbTest; looptest++) {
      pvPayerLongMC = METHOD_HW_MONTECARLO.presentValue(SWAPTION_PAYER_LONG, CUR, curve, BUNDLE_HW);
    }
    endTime = System.currentTimeMillis();
