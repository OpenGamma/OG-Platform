...
public class BondForwardDirtyPriceCalculatorTest {
  ...
  private static final BondForward FORWARD1 = new BondForward(new Bond(new double[] {1, 2, 3, 4, 5, 6}, 0.05, CURVE_NAME), 0.5);
  private static final BondForward FORWARD2 = new BondForward(new Bond(new double[] {1, 2, 3, 4, 5, 6}, 0.05, CURVE_NAME), 3.5);
  ...
  public void test() {
    ...
    assertEquals(CALCULATOR.calculate(FORWARD1, DIRTY_PRICE, FUNDING_RATE), valueWithoutExpiredCoupons, EPS);
    ...
    assertEquals(CALCULATOR.calculate(FORWARD2, DIRTY_PRICE, FUNDING_RATE), valueWithoutExpiredCoupons - expiredCouponValue, EPS);
