...
public class FFTPricerTest {
  ...
  public void test() {
    ...
    double[][] strikeNprice = pricer.price(FORWARD, T, DF, isCall, CEF, nStrikes, deltaMoneyness, alpha, tol, SIGMA);
  ...
  public void testDirect() {
    ...
    final EuropeanCallFT callFT = new EuropeanCallFT(CEF, T);
    ...
    double integral = integrator.integrate(f, 0.0, 100.0) / Math.PI;
  ...
  public void testEuropeanCallFT() {
    ...
    EuropeanCallFT callFT = new EuropeanCallFT(CEF, T);
    for (int i = 0; i < 101; i++) {
