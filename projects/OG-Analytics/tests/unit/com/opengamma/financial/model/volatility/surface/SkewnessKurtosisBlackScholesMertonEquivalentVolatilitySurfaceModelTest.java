...
public class SkewnessKurtosisBlackScholesMertonEquivalentVolatilitySurfaceModelTest {
  ...
  private static final SkewKurtosisOptionDataBundle DATA = new SkewKurtosisOptionDataBundle(new YieldCurve(ConstantDoublesCurve.from(0.02)), 0.02, new ConstantVolatilitySurface(SIGMA), 100, DATE, 0,
      3);
