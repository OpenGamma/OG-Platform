...
public class LogOptionDefinitionTest {
  ...
  private static final StandardOptionDataBundle DATA = new StandardOptionDataBundle(new ConstantYieldCurve(0.05), 0.05, new ConstantVolatilitySurface(0.1), STRIKE, DATE);
