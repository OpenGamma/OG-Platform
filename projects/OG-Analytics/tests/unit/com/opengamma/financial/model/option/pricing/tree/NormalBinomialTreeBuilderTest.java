...
public class NormalBinomialTreeBuilderTest {
  ...
  private static final GeneralNormalOptionDataBundle DATA = new GeneralNormalOptionDataBundle(YIELD_CURVE, DRIFTLESS, new VolatilitySurface(
  ...
  public void testPriceTimeDependent() {
    final GeneralNormalOptionDataBundle data = new GeneralNormalOptionDataBundle(YIELD_CURVE, DRIFTLESS, new VolatilitySurface(FunctionalDoublesSurface
