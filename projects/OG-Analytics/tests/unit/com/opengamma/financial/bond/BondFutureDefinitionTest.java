...
public class BondFutureDefinitionTest {
  ...
  private static final BondDefinition BOND_DEFINITION1 = new BondDefinition(NOMINAL_DATES, SETTLEMENT_DATES, COUPON, NOTIONAL, COUPONS_PER_YEAR, BOND_CONVENTION);
