...
public class ShiftedLognormalVolModelTest {
  ...
  public void testFlatSurfaceReproducesVolAndZeroShift() {
    final ShiftedLognormalVolModel logBlack = new ShiftedLognormalVolModel(forward, expiry1, VOLSURFACE, 0.4, 0.8); //, 0.26, 0.01, testSolver);
  ...
  public void testConstantDoublesSurface() {
    final ShiftedLognormalVolModel logBlack = new ShiftedLognormalVolModel(forward, expiry5, new VolatilitySurface(ConstantDoublesSurface.from(0.25)), 0.4, 0.8);
  ...
  public void testOnSmileySurface() {
    ...
    final ShiftedLognormalVolModel logBlack = new ShiftedLognormalVolModel(forward, expiry5, VOLSURFACE, 0.4, 0.41, 0.26, 0.01, testSolver);
  ...
  public void testPricingAndImpVol() {
    final ShiftedLognormalVolModel shiftedBlack = new ShiftedLognormalVolModel(forward, expiry5, VOLSURFACE, 0.4, 0.41);

    assertEquals(shiftedBlack.getVol(), 0.22306620890629011, 1e-8);
    assertEquals(shiftedBlack.getShift(), 0.09950883623451598, 1e-8);

    final double highStrike = 5.0;
    final double lowStrike = 1e-4;
