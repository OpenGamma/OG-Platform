 ...
 * 
 */
public class VarianceSwapRatesSensitivityTest2 {

  private static VarianceSwapRatesSensitivityCalculator2 deltaCalculator = VarianceSwapRatesSensitivityCalculator2.getInstance();
  // Tests ------------------------------------------
  ...
  public void testForwardSensitivityForDeltaStrikeParameterisation() {
    ...
    final VarianceSwapDataBundle2<?> DELTA_MARKET = new VarianceSwapDataBundle2<Delta>(DELTA_VOL_SURFACE, FUNDING, FORWARD_CURVE);
  ...
  final VarianceSwapStaticReplication2<?> pricer_without_cutoff = new VarianceSwapStaticReplicationStrike();
  ...
  private static final VarianceSwapDataBundle2 MARKET = new VarianceSwapDataBundle2(VOL_SURFACE, FUNDING, FORWARD_CURVE);
