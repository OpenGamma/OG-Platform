...
import com.opengamma.financial.schedule.EndOfMonthSemiAnnualScheduleCalculator;
import com.opengamma.util.time.DateUtil;

/**
 * 
 */
public class EndOfMonthSemiAnnualScheduleCalculatorTest {
  private static final EndOfMonthSemiAnnualScheduleCalculator CALCULATOR = new EndOfMonthSemiAnnualScheduleCalculator();
  ...
  public void testShortSeries() {
    final LocalDate start1 = LocalDate.of(2010, 3, 31);
    ...
    final ZonedDateTime start2 = DateUtil.getUTCDate(2010, 3, 1);
    ...
    assertEquals(schedule2.length, 1);
    assertEquals(schedule2[0], DateUtil.getUTCDate(2010, 3, 31));
  }
  ...
  public void test2() {
    ...
    final ZonedDateTime[] expected = new ZonedDateTime[] {DateUtil.getUTCDate(1994, 8, 31), DateUtil.getUTCDate(1995, 2, 28), DateUtil.getUTCDate(1995, 8, 31), DateUtil.getUTCDate(1996, 2, 29),
        DateUtil.getUTCDate(1996, 8, 31), DateUtil.getUTCDate(1997, 2, 28), DateUtil.getUTCDate(1997, 8, 31), DateUtil.getUTCDate(1998, 2, 28), DateUtil.getUTCDate(1998, 8, 31),
        DateUtil.getUTCDate(1999, 2, 28), DateUtil.getUTCDate(1999, 8, 31), DateUtil.getUTCDate(2000, 2, 29), DateUtil.getUTCDate(2000, 8, 31), DateUtil.getUTCDate(2001, 2, 28),
        DateUtil.getUTCDate(2001, 8, 31), DateUtil.getUTCDate(2002, 2, 28), DateUtil.getUTCDate(2002, 8, 31), DateUtil.getUTCDate(2003, 2, 28), DateUtil.getUTCDate(2003, 8, 31),
        DateUtil.getUTCDate(2004, 2, 29), DateUtil.getUTCDate(2004, 8, 31)};
    ...
    final ZonedDateTime[] backward = new ZonedDateTime[] {DateUtil.getUTCDate(1994, 8, 31), DateUtil.getUTCDate(1995, 2, 28), DateUtil.getUTCDate(1995, 8, 31), DateUtil.getUTCDate(1996, 2, 29),
        DateUtil.getUTCDate(1996, 8, 31), DateUtil.getUTCDate(1997, 2, 28), DateUtil.getUTCDate(1997, 8, 31), DateUtil.getUTCDate(1998, 2, 28), DateUtil.getUTCDate(1998, 8, 31),
        DateUtil.getUTCDate(1999, 2, 28), DateUtil.getUTCDate(1999, 8, 31), DateUtil.getUTCDate(2000, 2, 29), DateUtil.getUTCDate(2000, 8, 31), DateUtil.getUTCDate(2001, 2, 28),
        DateUtil.getUTCDate(2001, 8, 31), DateUtil.getUTCDate(2002, 2, 28), DateUtil.getUTCDate(2002, 8, 31), DateUtil.getUTCDate(2003, 2, 28), DateUtil.getUTCDate(2003, 8, 31),
        DateUtil.getUTCDate(2004, 2, 29), DateUtil.getUTCDate(2004, 8, 31)};
    result = CALCULATOR.getSchedule(start1, end1, true);
    assertArrayEquals(backward, result);
    final ZonedDateTime[] forward = new ZonedDateTime[] {DateUtil.getUTCDate(1994, 6, 30), DateUtil.getUTCDate(1994, 12, 31), DateUtil.getUTCDate(1995, 6, 30), DateUtil.getUTCDate(1995, 12, 31),
        DateUtil.getUTCDate(1996, 6, 30), DateUtil.getUTCDate(1996, 12, 31), DateUtil.getUTCDate(1997, 6, 30), DateUtil.getUTCDate(1997, 12, 31), DateUtil.getUTCDate(1998, 6, 30),
        DateUtil.getUTCDate(1998, 12, 31), DateUtil.getUTCDate(1999, 6, 30), DateUtil.getUTCDate(1999, 12, 31), DateUtil.getUTCDate(2000, 6, 30), DateUtil.getUTCDate(2000, 12, 31),
        DateUtil.getUTCDate(2001, 6, 30), DateUtil.getUTCDate(2001, 12, 31), DateUtil.getUTCDate(2002, 6, 30), DateUtil.getUTCDate(2002, 12, 31), DateUtil.getUTCDate(2003, 6, 30),
        DateUtil.getUTCDate(2003, 12, 31), DateUtil.getUTCDate(2004, 6, 30)};
    result = CALCULATOR.getSchedule(start1, end1, false);
    assertArrayEquals(forward, result);
  }
}
