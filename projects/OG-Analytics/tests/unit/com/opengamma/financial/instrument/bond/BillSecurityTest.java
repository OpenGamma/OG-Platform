...
public class BillSecurityTest {
  ...
  private final static BillSecurity BILL_SEC = new BillSecurity(EUR, SETTLE_TIME, END_TIME, NOTIONAL, YIELD_CONVENTION, ACT360, ISSUER_BEL, DSC_NAME);

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullCurrency() {
    new BillSecurity(null, SETTLE_TIME, END_TIME, NOTIONAL, YIELD_CONVENTION, ACT360, ISSUER_BEL, DSC_NAME);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullYield() {
    new BillSecurity(EUR, SETTLE_TIME, END_TIME, NOTIONAL, null, ACT360, ISSUER_BEL, DSC_NAME);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullDayCount() {
    new BillSecurity(EUR, SETTLE_TIME, END_TIME, NOTIONAL, YIELD_CONVENTION, null, ISSUER_BEL, DSC_NAME);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullISSUEUR() {
    new BillSecurity(EUR, SETTLE_TIME, END_TIME, NOTIONAL, YIELD_CONVENTION, ACT360, null, DSC_NAME);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void nullDsc() {
    new BillSecurity(EUR, SETTLE_TIME, END_TIME, NOTIONAL, YIELD_CONVENTION, ACT360, ISSUER_BEL, null);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void notionalPositive() {
    new BillSecurity(EUR, SETTLE_TIME, END_TIME, -NOTIONAL, YIELD_CONVENTION, ACT360, ISSUER_BEL, DSC_NAME);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void times() {
    new BillSecurity(EUR, END_TIME, SETTLE_TIME, NOTIONAL, YIELD_CONVENTION, ACT360, ISSUER_BEL, DSC_NAME);
  }
  ...
  public void getters() {
    ...
    assertEquals("Bill Security: getter", ACT360, BILL_SEC.getDayCount());
  ...
  public void equalHash() {
    ...
    BillSecurity other = new BillSecurity(EUR, SETTLE_TIME, END_TIME, NOTIONAL, YIELD_CONVENTION, ACT360, ISSUER_BEL, DSC_NAME);
    ...
    modified = new BillSecurity(Currency.USD, SETTLE_TIME, END_TIME, NOTIONAL, YIELD_CONVENTION, ACT360, ISSUER_BEL, DSC_NAME);
    assertFalse("Bill Security: equal-hash code", BILL_SEC.equals(modified));
    modified = new BillSecurity(EUR, SETTLE_TIME + 0.01, END_TIME, NOTIONAL, YIELD_CONVENTION, ACT360, ISSUER_BEL, DSC_NAME);
    assertFalse("Bill Security: equal-hash code", BILL_SEC.equals(modified));
    modified = new BillSecurity(EUR, SETTLE_TIME, END_TIME + 0.01, NOTIONAL, YIELD_CONVENTION, ACT360, ISSUER_BEL, DSC_NAME);
    assertFalse("Bill Security: equal-hash code", BILL_SEC.equals(modified));
    modified = new BillSecurity(EUR, SETTLE_TIME, END_TIME, NOTIONAL + 1.0, YIELD_CONVENTION, ACT360, ISSUER_BEL, DSC_NAME);
    assertFalse("Bill Security: equal-hash code", BILL_SEC.equals(modified));
    modified = new BillSecurity(EUR, SETTLE_TIME, END_TIME, NOTIONAL, YieldConventionFactory.INSTANCE.getYieldConvention("DISCOUNT"), ACT360, ISSUER_BEL, DSC_NAME);
    assertFalse("Bill Security: equal-hash code", BILL_SEC.equals(modified));
    modified = new BillSecurity(EUR, SETTLE_TIME, END_TIME, NOTIONAL, YIELD_CONVENTION, DayCountFactory.INSTANCE.getDayCount("Actual/365"), ISSUER_BEL, DSC_NAME);
    assertFalse("Bill Security: equal-hash code", BILL_SEC.equals(modified));
    modified = new BillSecurity(EUR, SETTLE_TIME, END_TIME, NOTIONAL, YIELD_CONVENTION, ACT360, ISSUER_GER, DSC_NAME);
    assertFalse("Bill Security: equal-hash code", BILL_SEC.equals(modified));
    modified = new BillSecurity(EUR, SETTLE_TIME, END_TIME, NOTIONAL, YIELD_CONVENTION, ACT360, ISSUER_BEL, ISSUER_BEL);
    assertFalse("Bill Security: equal-hash code", BILL_SEC.equals(modified));
  }
