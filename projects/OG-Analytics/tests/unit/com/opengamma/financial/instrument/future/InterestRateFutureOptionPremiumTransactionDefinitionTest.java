...
public class InterestRateFutureOptionPremiumTransactionDefinitionTest {
  ...
  private static final InterestRateFutureSecurityDefinition EDU2 = new InterestRateFutureSecurityDefinition(LAST_TRADING_DATE, IBOR_INDEX, NOTIONAL, FUTURE_FACTOR, NAME);
  ...
  private static final ZonedDateTime PREMIUM_DATE = DateUtil.getUTCDate(2011, 5, 12);
