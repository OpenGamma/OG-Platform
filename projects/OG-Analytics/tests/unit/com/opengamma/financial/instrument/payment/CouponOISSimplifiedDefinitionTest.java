...
public class CouponOISSimplifiedDefinitionTest {
  ...
  public void equalHash() {
    ...
    modified = new CouponOISSimplifiedDefinition(EUR_CUR, PAYMENT_DATE, START_ACCRUAL_DATE, END_ACCRUAL_DATE, PAYMENT_YEAR_FRACTION, NOTIONAL, new IndexOIS(EUR_OIS_NAME, EUR_CUR, EUR_DAY_COUNT, 27,
