...
public class InterestRateFuturesSecurityDefinitionTest {
  ...
  public void constructor() {
    InterestRateFutureDefinition constructor1 = new InterestRateFutureDefinition(LAST_TRADING_DATE, IBOR_INDEX, REFERENCE_PRICE, NOTIONAL, FUTURE_FACTOR, "RateFuture " + IBOR_INDEX.getName());
  ...
  public void toDerivative() {
    ...
    InterestRateFuture ERU2 = new InterestRateFuture(LAST_TRADING_TIME, IBOR_INDEX, FIXING_START_TIME, FIXING_END_TIME, FIXING_ACCRUAL, REFERENCE_PRICE, NOTIONAL, FUTURE_FACTOR, NAME,
