...
import com.opengamma.analytics.math.interpolation.MultiquadraticRadialBasisFunction;
import com.opengamma.analytics.math.interpolation.RadialBasisFunction;
...
public class SmoothSurfaceTest {
  ...
  public void fit(final List<Pair<double[], Double>> data, final Function1D<Double, Double> basisFunction, final boolean isNormalized, final List<double[]> nodePos, final double lambda) {
    ...
    //final VectorMinimizer minimizer = new ConjugateGradientVectorMinimizer(lineMinimizer, 1e-3, 1000);
    //
    ...
    //final DoubleMatrix1D res = minimzer.minimize(fom, new DoubleMatrix1D(start));
