...
import com.opengamma.analytics.financial.schedule.EndOfMonthSemiAnnualScheduleCalculator;
...
public class EndOfMonthSemiAnnualScheduleCalculatorTest {
  ...
  public void testShortSeries() {
    ...
    final ZonedDateTime start2 = DateUtils.getUTCDate(2010, 3, 1);
    ...
    assertEquals(schedule2.length, 1);
    assertEquals(schedule2[0], DateUtils.getUTCDate(2010, 3, 31));
  }
