...
import com.opengamma.analytics.financial.interestrate.payments.method.CapFloorIborInArrearsGenericReplicationMethod;
import com.opengamma.analytics.financial.interestrate.payments.method.CapFloorIborSABRExtrapolationRightMethod;
import com.opengamma.analytics.financial.interestrate.payments.method.CouponIborInArrearsReplicationMethod;
...
public class CapFloorIborInArrearsReplicationMethodTest {
  ...
  private static final CouponIborSpread COUPON_IBOR = (CouponIborSpread) COUPON_IBOR_DEFINITION.toDerivative(REFERENCE_DATE, CURVES_NAME);
