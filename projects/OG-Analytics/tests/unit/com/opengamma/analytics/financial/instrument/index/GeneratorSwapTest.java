...
public class GeneratorSwapTest {
  ...
  private static final GeneratorSwapFixedIbor GENERATOR_FROM_INDEX = new GeneratorSwapFixedIbor(FIXED_LEG_PERIOD, DAY_COUNT_FIXED, IBOR_INDEX);
  ...
  private static final GeneratorSwapFixedIbor GENERATOR_GENERIC = new GeneratorSwapFixedIbor(FIXED_LEG_PERIOD, DAY_COUNT_FIXED, IBOR_INDEX, BUSINESS_DAY_2, IS_EOM_2, SPOT_LAG_2);
  ...
  public void getter() {
    ...
    assertEquals("GeneratorSwap: getter", GENERATOR_FROM_INDEX, new GeneratorSwapFixedIbor(FIXED_LEG_PERIOD, DAY_COUNT_FIXED, IBOR_INDEX, BUSINESS_DAY, IS_EOM, SPOT_LAG));
  ...
  public void equalHash() {
    ...
    GeneratorSwapFixedIbor generatorDuplicate = new GeneratorSwapFixedIbor(FIXED_LEG_PERIOD, DAY_COUNT_FIXED, IBOR_INDEX);
    ...
    generatorModified = new GeneratorSwapFixedIbor(otherPeriod, DAY_COUNT_FIXED, IBOR_INDEX);
    assertFalse(GENERATOR_FROM_INDEX.equals(generatorModified));
    generatorModified = new GeneratorSwapFixedIbor(FIXED_LEG_PERIOD, DAY_COUNT_IBOR, IBOR_INDEX);
    assertFalse(GENERATOR_FROM_INDEX.equals(generatorModified));
    IborIndex otherIborIndex = new IborIndex(CUR, IBOR_TENOR, SPOT_LAG, CALENDAR, DAY_COUNT_IBOR, BUSINESS_DAY, !IS_EOM);
    generatorModified = new GeneratorSwapFixedIbor(FIXED_LEG_PERIOD, DAY_COUNT_FIXED, otherIborIndex);
    assertFalse(GENERATOR_FROM_INDEX.equals(generatorModified));
