...
public class GeneratorIborONTest {
  ...
  private static final IndexON FEDFUND = new FEDFUND(NYC);
  private static final IborIndex USDLIBOR3M = IndexIborTestsMaster.getInstance().getIndex("USDLIBOR3M", NYC);
