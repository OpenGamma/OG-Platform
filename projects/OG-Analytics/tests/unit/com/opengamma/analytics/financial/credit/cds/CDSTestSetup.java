...
public class CDSTestSetup {
  ...
  public static void setupIsdaTestData() {
      ...
      ZonedDateTime protectionStartDate = ZonedDateTime.of(2008, 2, 8, 0, 0, 0, 0, TimeZone.UTC);
      ZonedDateTime maturity = ZonedDateTime.of(2008, 2, 13, 0, 0, 0, 0, TimeZone.UTC);
