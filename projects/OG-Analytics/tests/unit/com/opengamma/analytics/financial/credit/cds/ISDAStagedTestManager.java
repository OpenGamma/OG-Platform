...
public class ISDAStagedDataManager {
  ...
  private static String stagedXmlDirectory = "isda_test_grids_xml";
  ...
  public ISDAStagedCurve loadStagedCurveForGrid(final String gridFilename) throws IOException, JAXBException {
    ...
    try {
      ...
      final String path = resourceDirectory + File.separator + stagedCurveDirectory + File.separator + matcher.group(1) + "_" + matcher.group(2) + ".xml";
  ...
  public ISDAStagedCurve loadStagedHazardCurveForGrid(final String gridFilename, final int testCaseIndex) throws IOException, JAXBException {
    ...
    try {
      ...
      final String path = resourceDirectory + File.separator + stagedCurveDirectory + File.separator
        + matcher.group(1) + "_" + matcher.group(2) + "_case" + testCaseIndex + ".xml";
      is = getClass().getClassLoader().getResourceAsStream(path);
  ...
  public ISDAStagedTest loadStagedTestForGrid(final String gridFilename) throws IOException, JAXBException {
    ...
    try {
      ...
      final String path = resourceDirectory + File.separator + stagedXmlDirectory + File.separator
        + stagedXmlBaseFileName + matcher.group(1) + "_" + testDate.toString(stagedFormatter) + ".xml";
      is = getClass().getClassLoader().getResourceAsStream(path);
  ...
  public static InputStream getFileInputStream(String fileName) {
    return ISDAStagedDataManager.class.getClassLoader().getResourceAsStream(fileName);
  }
