...
public class CDSApproxISDAMethodTest extends CDSTestSetup {
  ...
  public void testComparisonWithSimpleCalculation() {
    ...
    final CurrencyAmount result = method.presentValue(_simpleTestCDS, _simpleTestCurveBundle, _simpleTestPricingDate, _simpleTestStepinDate);
  ...
  public void testPresentValue7200() {
    ...
    final CDSApproxISDAMethod method = new CDSApproxISDAMethod();
    final CurrencyAmount result = method.presentValue(_isdaTestCDS, _isdaTestCurveBundle, _isdaTestPricingDate, _isdaTestStepinDate);
