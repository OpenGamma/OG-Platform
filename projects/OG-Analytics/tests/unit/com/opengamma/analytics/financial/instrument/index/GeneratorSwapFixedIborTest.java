...
public class GeneratorSwapFixedIborTest {
  ...
  public void getter() {
    ...
    assertEquals("GeneratorSwap: getter", GENERATOR_FROM_INDEX, new GeneratorSwapFixedIbor("Swap Generator", FIXED_LEG_PERIOD, DAY_COUNT_FIXED, IBOR_INDEX, BUSINESS_DAY, IS_EOM, SPOT_LAG));
  ...
  public void equalHash() {
    ...
    GeneratorSwapFixedIbor generatorDuplicate = new GeneratorSwapFixedIbor("Swap Generator", FIXED_LEG_PERIOD, DAY_COUNT_FIXED, IBOR_INDEX);
    ...
    generatorModified = new GeneratorSwapFixedIbor("Swap Generator", FIXED_LEG_PERIOD, DAY_COUNT_FIXED, otherIborIndex);
    assertFalse(GENERATOR_FROM_INDEX.equals(generatorModified));
