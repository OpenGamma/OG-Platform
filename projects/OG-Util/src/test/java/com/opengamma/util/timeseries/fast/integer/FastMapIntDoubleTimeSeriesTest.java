...
public class FastMapIntDoubleTimeSeriesTest extends IntDoubleTimeSeriesTest {

  @Override
  protected DoubleTimeSeries<Integer> createEmptyTimeSeries() {
    return new FastMapIntDoubleTimeSeries(DateTimeNumericEncoding.TIME_EPOCH_MILLIS);
  }
  ...
  protected DoubleTimeSeries<Integer> createTimeSeries(final Integer[] times, final double[] values) {
    ...
    return new FastMapIntDoubleTimeSeries(DateTimeNumericEncoding.TIME_EPOCH_MILLIS, primTimes, values);
  }

  @Override
  protected DoubleTimeSeries<Integer> createTimeSeries(final List<Integer> times, final List<Double> values) {
    return new FastMapIntDoubleTimeSeries(DateTimeNumericEncoding.TIME_EPOCH_MILLIS, times, values);
  }

  @Override
  protected DoubleTimeSeries<Integer> createTimeSeries(final DoubleTimeSeries<Integer> dts) {
    return new FastMapIntDoubleTimeSeries((FastIntDoubleTimeSeries) dts);
  }
