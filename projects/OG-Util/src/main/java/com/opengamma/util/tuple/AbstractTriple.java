...
public final class AbstractTriple<A, B, C>
   ...
   */
  public static <A, B, C> AbstractTriple<A, B, C> of(A first, B second, C third) {
    return new AbstractTriple<A, B, C>(first, second, third);
  }
   ...
   */
  @Deprecated
  public AbstractTriple(A first, B second, C third) {
    _first = first;
    _second = second;
    _third = third;
  }
   ...
   */
  @Override
  public int compareTo(AbstractTriple<A, B, C> other) {
  ...
  public static AbstractTriple.Meta meta() {
    return AbstractTriple.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(AbstractTriple.Meta.INSTANCE);
  }

  @SuppressWarnings("unchecked")
  @Override
  public AbstractTriple.Meta<A, B, C> metaBean() {
    return AbstractTriple.Meta.INSTANCE;
  }
  ...
  @Override
  public AbstractTriple<A, B, C> clone() {
    return this;
  }
  ...
  public static final class Meta<A, B, C> extends DirectMetaBean {
    ...
    @Override
    public AbstractTriple.Builder builder() {
      return new AbstractTriple.Builder();
    }

    @SuppressWarnings("rawtypes")
    @Override
    public Class<? extends AbstractTriple> beanType() {
      return AbstractTriple.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName) {
        case "first":
          return ((AbstractTriple) bean).getFirst();
        case "second":
          return ((AbstractTriple) bean).getSecond();
        case "third":
          return ((AbstractTriple) bean).getThird();
      }
  ...
  private static final class Builder extends BasicImmutableBeanBuilder<AbstractTriple> {
     ...
     */
    private Builder() {
      super(AbstractTriple.Meta.INSTANCE);
    }
    ...
    @Override
    public AbstractTriple build() {
      return new AbstractTriple(_first, _second, _third);
    }
