 ...
 * Arbitrary {@link Throwable} instances aren't serializable but error details need to be passed around. This
...
public final class ThrowableDetails implements ImmutableBean {
  ...
  /** The throwable's message or it's class name if there is no message. */
  @PropertyDefinition(validate = "notNull")
   ...
   * @return  details of the throwable
   */
  ...
  private ThrowableDetails(Class<? extends Throwable> type, String message, String stackTrace) {
    _type = ArgumentChecker.notNull(type, "type");
    _message = ArgumentChecker.notNull(message, "message");
    _stackTrace = ArgumentChecker.notNull(stackTrace, "stackTrace");
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the throwable's message or it's class name if there is no message.
   * @return the value of the property, not null
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the throwable's stack trace.
   * @return the value of the property, not null
   */
