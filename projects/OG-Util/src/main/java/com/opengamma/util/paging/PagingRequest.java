...
public final class PagingRequest implements ImmutableBean {
  ...
  public static final class Builder extends BasicImmutableBeanBuilder<PagingRequest> {
     ...
     */
    private Builder() {
      super(PagingRequest.Meta.INSTANCE);
    }
     ...
     */
    private Builder(PagingRequest beanToCopy) {
      super(PagingRequest.Meta.INSTANCE);
      this._firstItem = beanToCopy.getFirstItem();
      this._pagingSize = beanToCopy.getPagingSize();
    }
    ...
    public String toString() {
      ...
      buf.append("firstItem").append('=').append(_firstItem).append(',').append(' ');
      buf.append("pagingSize").append('=').append(_pagingSize);
      buf.append('}');
      return buf.toString();
    }
