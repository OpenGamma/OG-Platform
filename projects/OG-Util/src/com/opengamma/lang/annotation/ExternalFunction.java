...
/**
 * Annotation to signal that a method should be exposed through
...
public @interface ExternalFunction {
  ...
  /**
   * The name of the function exposed to Excel.
   * If not specified here, a name will be created from the method name
   */
  String name() default "";
