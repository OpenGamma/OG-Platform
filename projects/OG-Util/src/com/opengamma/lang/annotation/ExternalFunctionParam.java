...
/**
 * Annotation to signal that a method parameter should be exposed through an external language such as Excel or R.
 */
@Retention(RetentionPolicy.RUNTIME)
@Target({ ElementType.PARAMETER })
public @interface ExternalFunctionParam {
  /**
   * The name of the parameter exposed to Excel. If not specified here, a name will be created from the parameter order (e.g. first param = a,
   * second = b, etc.
   */
  String name() default "";
