 ...
 * 
 */
public abstract class AbstractFastObjectTimeSeries<FAST_DATE_T, T> implements ObjectTimeSeries<FAST_DATE_T, T>, FastObjectTimeSeries<FAST_DATE_T, T> {
  ...
  public abstract FastObjectTimeSeries<FAST_DATE_T, T> unionOperate(final FastLongObjectTimeSeries<T> other, final BinaryOperator<T> operator);
  
  public abstract FastObjectTimeSeries<FAST_DATE_T, T> unionOperate(final FastIntObjectTimeSeries<T> other, final BinaryOperator<T> operator);
