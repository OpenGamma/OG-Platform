...
public final class ExternalIdBundleBuilder extends AbstractFudgeBuilder implements FudgeBuilder<ExternalIdBundle> {
  ...
  public static void toFudgeMsg(final FudgeSerializer serializer, final ExternalIdBundle object, final MutableFudgeMsg msg) {
    for (ExternalId externalId : object) {
      addToMessage(msg, ID_FIELD_NAME, ExternalIdBuilder.toFudgeMsg(serializer, externalId));
    }
  }
