...
public class ViewTest {
  ...
  public void testGraphRebuild () {
    ...
    final ViewEvaluationModel dummy = new ViewEvaluationModel (originalModel.getDependencyGraphsByConfiguration(), originalModel.getPortfolio(), originalModel.getFunctionInitId()) {
      @Override
