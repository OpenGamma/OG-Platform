 ...
 */
public class DbFunctionCostsMasterTest {
  ...
  public static Object[] factory_tests() {
    ...
    for (Object[] objects : tests) {
      result.add(new DbFunctionCostsMasterTests(objects[0].toString(), objects[1].toString()));
    }
    return result.toArray();
  }

  @Test
  public static class DbFunctionCostsMasterTests extends DBTest {

    private static final Logger s_logger = LoggerFactory.getLogger(DbFunctionCostsMasterTests.class);

    private DbFunctionCostsMaster _costsMaster;

    public DbFunctionCostsMasterTests(String databaseType, String databaseVersion) {
