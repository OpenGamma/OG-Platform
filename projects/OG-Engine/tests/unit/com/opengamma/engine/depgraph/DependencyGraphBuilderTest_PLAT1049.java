...
public class DependencyGraphBuilderTest_PLAT1049 {
  ...
  private static class DepGraphTestHelper extends com.opengamma.engine.depgraph.DepGraphTestHelper {

    public DependencyGraphBuilderPLAT1049 getBuilder1049(final FunctionPriority prioritizer) {
      final DependencyGraphBuilder builder = getBuilder(prioritizer);
  ...
  private void blockOnTask(final DependencyGraphBuilderPLAT1049 builder, final ResolvedValueProducer task, final String expected) {
  ...
  private void expectFailure(final DependencyGraphBuilderPLAT1049 builder, final ResolvedValueProducer task) {
    blockOnTask(builder, task, "FAILED");
  }

  private void expectCompletion(final DependencyGraphBuilderPLAT1049 builder, final ResolvedValueProducer task) {
