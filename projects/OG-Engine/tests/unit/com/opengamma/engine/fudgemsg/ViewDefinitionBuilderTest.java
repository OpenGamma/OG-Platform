...
public class ViewDefinitionBuilderTest extends AbstractBuilderTestCase {
  ...
  private ViewDefinition getTestViewDefinition() {
    ...
    //TODO ValueProperties nearlyAllConstraints = ValueProperties.all().withoutAny("SomePropName");
  ...
  //TODO calcConfig1.addPortfolioRequirement("SomeOtherSecType", "YetAnotherOutput", nearlyAllConstraints);
