...
public class ViewComputationJobTest {
  ...
  public void testWaitForMarketData() throws InterruptedException {
    ...
    TestViewResultListener resultListener = new TestViewResultListener();
    client.setResultListener(resultListener);
    ViewCycleExecutionOptions cycleExecutionOptions = ViewCycleExecutionOptions.builder().setValuationTime(Instant.now()).setMarketDataSpecification(MarketData.live()).create();
  ...
  public void testChangeMarketDataProviderBetweenCycles() throws InterruptedException {
    ...
    ViewCycleExecutionOptions.Builder builder = ViewCycleExecutionOptions.builder().setValuationTime(valuationTime);
    ViewCycleExecutionOptions cycle1 = builder.setMarketDataSpecification(MarketData.live(SOURCE_1_NAME)).create();
    ViewCycleExecutionOptions cycle2 = builder.setMarketDataSpecification(MarketData.live(SOURCE_2_NAME)).create();
