...
import com.opengamma.engine.exec.CompleteGraphFragment;
...
import com.opengamma.engine.exec.MultipleNodeExecutor;
import com.opengamma.engine.exec.MutableGraphFragment;
import com.opengamma.engine.exec.MutableGraphFragmentContext;
...
public class ExecutionPlanTest {
  ...
  private GraphFragmentContext createGraphFragmentContext() {
    final GraphFragmentContext context = new GraphFragmentContext(createExecutor(), createDependencyGraph(), new LinkedBlockingQueue<ExecutionResult>(), createLogModeSource());
    return context;
  }
