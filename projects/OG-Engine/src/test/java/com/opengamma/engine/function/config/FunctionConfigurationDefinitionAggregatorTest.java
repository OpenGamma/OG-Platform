...
public class FunctionConfigurationDefinitionAggregatorTest {
  ...
  public void resolveFunctionDefinition() {
    ...
    assertEquals(getExpectedFunctions(), ImmutableSet.copyOf(configurationSource.getFunctionConfiguration().getFunctions()));
  }
  ...
  public void cyclicReference() {
    ...
    assertEquals(expectedFunc, ImmutableSet.copyOf(configurationSource.getFunctionConfiguration().getFunctions()));
