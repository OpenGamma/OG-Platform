...
public class IdentifierLookupResponse extends com.opengamma.engine.view.cache.msg.CacheMessage implements java.io.Serializable {
  ...
  public static IdentifierLookupResponse fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (org.fudgemsg.FudgeField field : types) {
      ...
      try {
        return (com.opengamma.engine.view.cache.msg.IdentifierLookupResponse)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializer.class, org.fudgemsg.FudgeMsg.class).invoke (null, deserializer, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
