...
public class Invocations extends com.opengamma.engine.view.calcnode.msg.RemoteCalcNodeMessage implements java.io.Serializable {
  ...
  public static class PerConfiguration implements java.io.Serializable {
    ...
    public static class PerFunction implements java.io.Serializable {
      ...
      public static PerFunction fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
        ...
        for (org.fudgemsg.FudgeField field : types) {
          ...
          try {
            return (com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializer.class, org.fudgemsg.FudgeMsg.class).invoke (null, deserializer, fudgeMsg);
          }
          catch (Throwable t) {
            // no-action
          }
    ...
    protected PerConfiguration (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
      ...
      for (org.fudgemsg.FudgeField fudge1 : fudgeFields) {
        try {
          ...
          fudge2 = com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction.fromFudgeMsg (deserializer, fudgeMsg.getFieldValue (org.fudgemsg.FudgeMsg.class, fudge1));
    ...
    public void toFudgeMsg (final org.fudgemsg.mapping.FudgeSerializer serializer, final org.fudgemsg.MutableFudgeMsg msg) {
      ...
      if (_function != null)  {
        for (com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction fudge1 : _function) {
          final org.fudgemsg.MutableFudgeMsg fudge2 = org.fudgemsg.mapping.FudgeSerializer.addClassHeader (serializer.newMessage (), fudge1.getClass (), com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction.class);
    ...
    public static PerConfiguration fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
      ...
      for (org.fudgemsg.FudgeField field : types) {
        ...
        try {
          return (com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializer.class, org.fudgemsg.FudgeMsg.class).invoke (null, deserializer, fudgeMsg);
        }
        catch (Throwable t) {
          // no-action
        }
  ...
  protected Invocations (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (org.fudgemsg.FudgeField fudge1 : fudgeFields) {
      try {
        ...
        fudge2 = com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.fromFudgeMsg (deserializer, fudgeMsg.getFieldValue (org.fudgemsg.FudgeMsg.class, fudge1));
  ...
  public void toFudgeMsg (final org.fudgemsg.mapping.FudgeSerializer serializer, final org.fudgemsg.MutableFudgeMsg msg) {
    ...
    if (_configuration != null)  {
      for (com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration fudge1 : _configuration) {
        final org.fudgemsg.MutableFudgeMsg fudge2 = org.fudgemsg.mapping.FudgeSerializer.addClassHeader (serializer.newMessage (), fudge1.getClass (), com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.class);
        fudge1.toFudgeMsg (serializer, fudge2);
  ...
  public static Invocations fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (org.fudgemsg.FudgeField field : types) {
      ...
      try {
        return (com.opengamma.engine.view.calcnode.msg.Invocations)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializer.class, org.fudgemsg.FudgeMsg.class).invoke (null, deserializer, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
