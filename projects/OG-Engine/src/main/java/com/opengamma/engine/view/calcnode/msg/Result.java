...
public class Result extends com.opengamma.engine.view.calcnode.msg.RemoteCalcNodeMessage implements java.io.Serializable {
  ...
  protected Result (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    try {
      _result = deserializer.fieldValueToObject (com.opengamma.engine.view.calcnode.CalculationJobResult.class, fudgeField);
    }
    ...
    if (fudgeField != null)  {
      try {
        ...
        fudge1 = com.opengamma.engine.view.calcnode.msg.Ready.fromFudgeMsg (deserializer, fudgeMsg.getFieldValue (org.fudgemsg.FudgeMsg.class, fudgeField));
        setReady (fudge1);
      }
      catch (IllegalArgumentException e) {
  ...
  public void toFudgeMsg (final org.fudgemsg.mapping.FudgeSerializer serializer, final org.fudgemsg.MutableFudgeMsg msg) {
    ...
    if (_result != null)  {
      serializer.addToMessageWithClassHeaders (msg, RESULT_KEY, null, _result, com.opengamma.engine.view.calcnode.CalculationJobResult.class);
    }
    if (_ready != null)  {
      final org.fudgemsg.MutableFudgeMsg fudge1 = org.fudgemsg.mapping.FudgeSerializer.addClassHeader (serializer.newMessage (), _ready.getClass (), com.opengamma.engine.view.calcnode.msg.Ready.class);
  ...
  public static Result fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (org.fudgemsg.FudgeField field : types) {
      ...
      try {
        return (com.opengamma.engine.view.calcnode.msg.Result)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializer.class, org.fudgemsg.FudgeMsg.class).invoke (null, deserializer, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
