        ...
        if (position.getSecurity() == null) {
          ...
          if (security == null) {
            ...
            for (Trade trade : position.getTrades()) {
              final ComputationTarget resolvedTradeTarget = getRecursiveResolver().resolve(new ComputationTargetSpecification(ComputationTargetType.TRADE, trade.getUniqueIdentifier()));
