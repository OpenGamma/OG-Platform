 ...
 */
public class ViewCycleManagerImpl implements ViewCycleManager {
  ...
  public ViewCycleReferenceImpl createViewCycle(UniqueIdentifier cycleId, UniqueIdentifier processId,
      ViewProcessContext processContext, CompiledViewDefinitionImpl evaluationModel, ViewCycleExecutionOptions executionOptions) {
