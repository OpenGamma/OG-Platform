...
public enum ResultOutputMode {
  ...
  TERMINAL_OUTPUTS {
    ...
    @Override
    public boolean shouldOutputFromNode(DependencyNode dependencyNode) {
      return dependencyNode.getTerminalOutputValues().size() > 0;
    }
   ...
   * @return  <code>true</code> if any outputs are produced that should be included in the results, <code>false</code>
   *          otherwise.
   */
