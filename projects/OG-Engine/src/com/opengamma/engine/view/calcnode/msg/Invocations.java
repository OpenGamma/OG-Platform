...
public class Invocations extends com.opengamma.engine.view.calcnode.msg.RemoteCalcNodeMessage implements java.io.Serializable {
  ...
  public static class PerConfiguration implements java.io.Serializable {
    ...
    public static class PerFunction implements java.io.Serializable {
      ...
      protected PerFunction (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
      ...
      public static PerFunction fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
        ...
        for (org.fudgemsg.FudgeField field : types) {
          ...
          try {
            return (com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializationContext.class, org.fudgemsg.FudgeMsg.class).invoke (null, fudgeContext, fudgeMsg);
          }
          catch (Throwable t) {
            // no-action
          }
        }
        return new PerFunction (fudgeContext, fudgeMsg);
      }
    ...
    private java.util.List<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> _function;
    public static final String FUNCTION_KEY = "function";
    public PerConfiguration (String configuration, java.util.Collection<? extends com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> function) {
      ...
      if (function == null) throw new NullPointerException ("'function' cannot be null");
        ...
        final java.util.List<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> fudge0 = new java.util.ArrayList<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> (function);
        if (function.size () == 0) throw new IllegalArgumentException ("'function' cannot be an empty list");
        for (java.util.ListIterator<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> fudge1 = fudge0.listIterator (); fudge1.hasNext (); ) {
          com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction fudge2 = fudge1.next ();
          if (fudge2 == null) throw new NullPointerException ("List element of 'function' cannot be null");
          fudge1.set ((com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction)fudge2.clone ());
        }
        _function = fudge0;
      }
    }
    protected PerConfiguration (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
      org.fudgemsg.FudgeField fudgeField;
      ...
      _function = new java.util.ArrayList<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> (fudgeFields.size ());
      for (org.fudgemsg.FudgeField fudge1 : fudgeFields) {
        try {
          ...
          fudge2 = com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction.fromFudgeMsg (fudgeContext, fudgeMsg.getFieldValue (org.fudgemsg.FudgeMsg.class, fudge1));
    ...
    protected PerConfiguration (final PerConfiguration source) {
      ...
      if (source._function == null) _function = null;
        ...
        final java.util.List<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> fudge0 = new java.util.ArrayList<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> (source._function);
        for (java.util.ListIterator<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> fudge1 = fudge0.listIterator (); fudge1.hasNext (); ) {
          com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction fudge2 = fudge1.next ();
          fudge1.set ((com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction)fudge2.clone ());
        }
    ...
    public static PerConfiguration fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
      final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
      for (org.fudgemsg.FudgeField field : types) {
        final String className = (String)field.getValue ();
        if ("com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration".equals (className)) break;
        try {
          return (com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializationContext.class, org.fudgemsg.FudgeMsg.class).invoke (null, fudgeContext, fudgeMsg);
        }
        catch (Throwable t) {
          // no-action
        }
      }
      return new PerConfiguration (fudgeContext, fudgeMsg);
    }
    ...
    public java.util.List<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> getFunction () {
      return java.util.Collections.unmodifiableList (_function);
    }
    public void setFunction (com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction function) {
      if (function == null) throw new NullPointerException ("'function' cannot be null");
      else {
        _function = new java.util.ArrayList<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> (1);
        addFunction (function);
      }
    }
    public void setFunction (java.util.Collection<? extends com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> function) {
      if (function == null) throw new NullPointerException ("'function' cannot be null");
      else {
        final java.util.List<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> fudge0 = new java.util.ArrayList<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> (function);
        if (function.size () == 0) throw new IllegalArgumentException ("'function' cannot be an empty list");
    ...
    public void addFunction (com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction function) {
      if (function == null) throw new NullPointerException ("'function' cannot be null");
      if (_function == null) _function = new java.util.ArrayList<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction> ();
      _function.add ((com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.PerFunction)function.clone ());
    }
    public String toString () {
      return org.apache.commons.lang.builder.ToStringBuilder.reflectionToString(this, org.apache.commons.lang.builder.ToStringStyle.SHORT_PREFIX_STYLE);
    }
  }
  private java.util.List<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> _configuration;
  public static final String CONFIGURATION_KEY = "configuration";
  public Invocations (java.util.Collection<? extends com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> configuration) {
    if (configuration == null) throw new NullPointerException ("'configuration' cannot be null");
    else {
      final java.util.List<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> fudge0 = new java.util.ArrayList<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> (configuration);
      if (configuration.size () == 0) throw new IllegalArgumentException ("'configuration' cannot be an empty list");
      for (java.util.ListIterator<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> fudge1 = fudge0.listIterator (); fudge1.hasNext (); ) {
        com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration fudge2 = fudge1.next ();
        if (fudge2 == null) throw new NullPointerException ("List element of 'configuration' cannot be null");
        fudge1.set ((com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration)fudge2.clone ());
      }
      _configuration = fudge0;
    }
  }
  protected Invocations (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    _configuration = new java.util.ArrayList<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> (fudgeFields.size ());
    for (org.fudgemsg.FudgeField fudge1 : fudgeFields) {
      try {
        final com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration fudge2;
        fudge2 = com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration.fromFudgeMsg (fudgeContext, fudgeMsg.getFieldValue (org.fudgemsg.FudgeMsg.class, fudge1));
  ...
  protected Invocations (final Invocations source) {
    ...
    if (source._configuration == null) _configuration = null;
      ...
      final java.util.List<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> fudge0 = new java.util.ArrayList<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> (source._configuration);
      for (java.util.ListIterator<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> fudge1 = fudge0.listIterator (); fudge1.hasNext (); ) {
        com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration fudge2 = fudge1.next ();
        fudge1.set ((com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration)fudge2.clone ());
      }
  ...
  public static Invocations fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.engine.view.calcnode.msg.Invocations".equals (className)) break;
      try {
        return (com.opengamma.engine.view.calcnode.msg.Invocations)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializationContext.class, org.fudgemsg.FudgeMsg.class).invoke (null, fudgeContext, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
    }
    return new Invocations (fudgeContext, fudgeMsg);
  }
  public java.util.List<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> getConfiguration () {
    return java.util.Collections.unmodifiableList (_configuration);
  }
  public void setConfiguration (com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration configuration) {
    if (configuration == null) throw new NullPointerException ("'configuration' cannot be null");
    else {
      _configuration = new java.util.ArrayList<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> (1);
      addConfiguration (configuration);
    }
  }
  public void setConfiguration (java.util.Collection<? extends com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> configuration) {
    if (configuration == null) throw new NullPointerException ("'configuration' cannot be null");
    else {
      final java.util.List<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> fudge0 = new java.util.ArrayList<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> (configuration);
      if (configuration.size () == 0) throw new IllegalArgumentException ("'configuration' cannot be an empty list");
  ...
  public void addConfiguration (com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration configuration) {
    if (configuration == null) throw new NullPointerException ("'configuration' cannot be null");
    if (_configuration == null) _configuration = new java.util.ArrayList<com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration> ();
    _configuration.add ((com.opengamma.engine.view.calcnode.msg.Invocations.PerConfiguration)configuration.clone ());
  }
  public String toString () {
    return org.apache.commons.lang.builder.ToStringBuilder.reflectionToString(this, org.apache.commons.lang.builder.ToStringStyle.SHORT_PREFIX_STYLE);
  }
