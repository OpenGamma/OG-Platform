...
// Created from com/opengamma/engine/view/calcnode/msg/Init.proto:9(10)
...
public class Init extends com.opengamma.engine.view.calcnode.msg.RemoteCalcNodeMessage implements java.io.Serializable {
  ...
  protected Init (final org.fudgemsg.FudgeMsg fudgeMsg) {
    super (fudgeMsg);
  ...
  public static Init fromFudgeMsg (final org.fudgemsg.FudgeMsg fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.engine.view.calcnode.msg.Init".equals (className)) break;
      try {
        return (com.opengamma.engine.view.calcnode.msg.Init)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeMsg.class).invoke (null, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
    }
    return new Init (fudgeMsg);
  }
