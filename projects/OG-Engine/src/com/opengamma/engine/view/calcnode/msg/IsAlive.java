...
public class IsAlive extends com.opengamma.engine.view.calcnode.msg.RemoteCalcNodeMessage implements java.io.Serializable {
  public void accept (RemoteCalcNodeMessageVisitor visitor) { visitor.visitIsAliveMessage (this); }
  ...
  public IsAlive (java.util.Collection<? extends com.opengamma.engine.view.calcnode.CalculationJobSpecification> job) {
  ...
  protected IsAlive (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (org.fudgemsg.FudgeField fudge1 : fudgeFields) {
      try {
        ...
        fudge2 = deserializer.fieldValueToObject (com.opengamma.engine.view.calcnode.CalculationJobSpecification.class, fudge1);
        _job.add (fudge2);
      }
      catch (IllegalArgumentException e) {
        throw new IllegalArgumentException ("Fudge message is not a IsAlive - field 'job' is not CalculationJobSpecification message", e);
      }
    }
  }
  protected IsAlive (final IsAlive source) {
    super (source);
  ...
  public IsAlive clone () {
    return new IsAlive (this);
  }
  ...
  public void toFudgeMsg (final org.fudgemsg.mapping.FudgeSerializer serializer, final org.fudgemsg.MutableFudgeMsg msg) {
    ...
    if (_job != null)  {
      for (com.opengamma.engine.view.calcnode.CalculationJobSpecification fudge1 : _job) {
        serializer.addToMessageWithClassHeaders (msg, JOB_KEY, null, fudge1, com.opengamma.engine.view.calcnode.CalculationJobSpecification.class);
      }
    }
  }
  public static IsAlive fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.engine.view.calcnode.msg.IsAlive".equals (className)) break;
      try {
        return (com.opengamma.engine.view.calcnode.msg.IsAlive)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializer.class, org.fudgemsg.FudgeMsg.class).invoke (null, deserializer, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
    }
    return new IsAlive (deserializer, fudgeMsg);
  }
