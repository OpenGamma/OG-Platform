 ...
 */
package com.opengamma.engine.view.calcnode.jmx;
...
import com.opengamma.engine.view.calcnode.SimpleCalculationNodeFactory;
 ...
 */
public class SimpleCalculationNodeInvocationContainer<T extends com.opengamma.engine.view.calcnode.SimpleCalculationNodeInvocationContainer> implements SimpleCalculationNodeInvocationContainerMBean {
  ...
  public static void registerMBeans(final com.opengamma.engine.view.calcnode.SimpleCalculationNodeInvocationContainer container, final SimpleCalculationNodeFactory nodeFactory,
      final MBeanServer server) throws JMException {
    new SimpleCalculationNodeInvocationContainer<com.opengamma.engine.view.calcnode.SimpleCalculationNodeInvocationContainer>(container, nodeFactory).registerMBean(server);
  }
