...
/**
 * Provides access to a snapshot of the basic state involved in the computation of an individual view calculation
 * configuration. 
 */
public interface CompiledViewCalculationConfiguration {
  ...
  /**
   * Gets the set of terminal output {@link ValueSpecifications} for the calculation configuration.
   * 
   * @return the set of terminal output {@link ValueSpecifications} for the calculation configuration, not {@code null}
   */
