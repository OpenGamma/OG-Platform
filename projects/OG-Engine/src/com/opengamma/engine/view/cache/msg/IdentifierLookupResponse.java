...
public class IdentifierLookupResponse extends com.opengamma.engine.view.cache.msg.CacheMessage implements java.io.Serializable {
  ...
  protected IdentifierLookupResponse (final org.fudgemsg.FudgeFieldContainer fudgeMsg) {
    super (fudgeMsg);
  ...
  public static IdentifierLookupResponse fromFudgeMsg (final org.fudgemsg.FudgeFieldContainer fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.engine.view.cache.msg.IdentifierLookupResponse".equals (className)) break;
      try {
        return (com.opengamma.engine.view.cache.msg.IdentifierLookupResponse)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeFieldContainer.class).invoke (null, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
