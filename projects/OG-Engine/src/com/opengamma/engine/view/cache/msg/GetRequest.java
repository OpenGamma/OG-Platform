...
public class GetRequest extends com.opengamma.engine.view.cache.msg.CacheMessage implements java.io.Serializable {
  ...
  public GetRequest (com.opengamma.id.UniqueIdentifier viewProcessId, String calculationConfigurationName, long snapshotTimestamp, java.util.Collection<? extends Long> identifier) {
  ...
  public GetRequest (Long correlationId, com.opengamma.id.UniqueIdentifier viewProcessId, String calculationConfigurationName, long snapshotTimestamp, java.util.Collection<? extends Long> identifier) {
    super (correlationId);
    if (viewProcessId == null) throw new NullPointerException ("'viewProcessId' cannot be null");
    else {
      _viewProcessId = viewProcessId;
