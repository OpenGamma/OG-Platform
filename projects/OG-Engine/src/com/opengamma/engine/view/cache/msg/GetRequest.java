...
public class GetRequest extends com.opengamma.engine.view.cache.msg.CacheMessage implements java.io.Serializable {
  ...
  protected GetRequest (final org.fudgemsg.FudgeFieldContainer fudgeMsg) {
    super (fudgeMsg);
  ...
  public static GetRequest fromFudgeMsg (final org.fudgemsg.FudgeFieldContainer fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.engine.view.cache.msg.GetRequest".equals (className)) break;
      try {
        return (com.opengamma.engine.view.cache.msg.GetRequest)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeFieldContainer.class).invoke (null, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
