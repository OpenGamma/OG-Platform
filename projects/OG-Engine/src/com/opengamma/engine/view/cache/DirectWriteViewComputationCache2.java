...
/**
 * An implementation of {@link DeferredViewComputationCache2} that always writes to the underlying immediately.
 */
public class DirectWriteViewComputationCache2 implements DeferredViewComputationCache2 {

  private final ViewComputationCache _underlying;

  public DirectWriteViewComputationCache2(final ViewComputationCache underlying) {
