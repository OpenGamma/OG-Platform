...
public class CalculationJobBuilder implements FudgeBuilder<CalculationJob> {
  ...
  private static final String FUNCTION_INITIALIZATION_TIMESTAMP_FIELD_NAME = "functionInit";
  ...
  public MutableFudgeFieldContainer buildMessage(FudgeSerializationContext context, CalculationJob object) {
    ...
    msg.add(FUNCTION_INITIALIZATION_TIMESTAMP_FIELD_NAME, object.getFunctionInitializationTimestamp());
  ...
  public CalculationJob buildObject(FudgeDeserializationContext context, FudgeFieldContainer message) {
    ...
    final long functionInitializationTimestamp = message.getLong(FUNCTION_INITIALIZATION_TIMESTAMP_FIELD_NAME);
    ...
    return new CalculationJob(jobSpec, functionInitializationTimestamp, requiredJobIds, jobItems, cacheSelectFilter);
  }
