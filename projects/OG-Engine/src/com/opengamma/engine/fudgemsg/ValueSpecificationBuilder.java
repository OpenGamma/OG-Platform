...
public class ValueSpecificationBuilder implements FudgeBuilder<ValueSpecification> {
  ...
  public MutableFudgeMsg buildMessage(FudgeSerializer serializer, ValueSpecification object) {
    ...
    ComputationTargetSpecificationBuilder.addMessageFields(serializer, msg, object.getTargetSpecification());
  ...
  public ValueSpecification buildObject(FudgeDeserializer deserializer, FudgeMsg message) {
    ...
    final ComputationTargetSpecification targetSpecification = ComputationTargetSpecificationBuilder.buildObjectImpl(deserializer, message);
