...
/**
 * Original version of the dependency graph builder, pre PLAT-1049.
 * 
 * @deprecated Here for reference while PLAT-1049 is worked on 
 */
@Deprecated
public class DependencyGraphBuilderOriginal {
