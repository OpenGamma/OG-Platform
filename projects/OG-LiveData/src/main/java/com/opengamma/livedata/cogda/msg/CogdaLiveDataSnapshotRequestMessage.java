...
public class CogdaLiveDataSnapshotRequestMessage extends CogdaLiveDataCommandMessage {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code CogdaLiveDataSnapshotRequestMessage}.
  ...
  @Override
  public CogdaLiveDataSnapshotRequestMessage.Meta metaBean() {
    return CogdaLiveDataSnapshotRequestMessage.Meta.INSTANCE;
  }
  ...
  public String toString() {
    ...
    buf.append("CogdaLiveDataSnapshotRequestMessage{");
    int len = buf.length();
    toString(buf);
    if (buf.length() > len) {
  ...
  public static class Meta extends CogdaLiveDataCommandMessage.Meta {
    ...
    @Override
    public BeanBuilder<? extends CogdaLiveDataSnapshotRequestMessage> builder() {
      return new DirectBeanBuilder<CogdaLiveDataSnapshotRequestMessage>(new CogdaLiveDataSnapshotRequestMessage());
    }

    @Override
    public Class<? extends CogdaLiveDataSnapshotRequestMessage> beanType() {
      return CogdaLiveDataSnapshotRequestMessage.class;
    }
