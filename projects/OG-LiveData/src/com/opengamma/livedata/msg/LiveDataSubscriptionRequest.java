...
public class LiveDataSubscriptionRequest implements java.io.Serializable {
  ...
  protected LiveDataSubscriptionRequest (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    try {
      _user = fudgeContext.fieldValueToObject (com.opengamma.livedata.UserPrincipal.class, fudgeField);
    }
    ...
    for (org.fudgemsg.FudgeField fudge1 : fudgeFields) {
      try {
        ...
        fudge2 = fudgeContext.fieldValueToObject (com.opengamma.livedata.LiveDataSpecification.class, fudge1);
  ...
  public static LiveDataSubscriptionRequest fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.livedata.msg.LiveDataSubscriptionRequest".equals (className)) break;
      try {
        return (com.opengamma.livedata.msg.LiveDataSubscriptionRequest)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializationContext.class, org.fudgemsg.FudgeMsg.class).invoke (null, fudgeContext, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
