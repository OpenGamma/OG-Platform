...
public class ResolveResponse implements java.io.Serializable {
  ...
  protected ResolveResponse (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
  ...
  public void toFudgeMsg (final org.fudgemsg.mapping.FudgeSerializationContext fudgeContext, final org.fudgemsg.MutableFudgeMsg msg) {
    if (_resolvedSpecification != null)  {
      fudgeContext.addToMessageWithClassHeaders (msg, RESOLVED_SPECIFICATION_KEY, null, _resolvedSpecification, com.opengamma.livedata.LiveDataSpecification.class);
    }
  }
  public static ResolveResponse fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.livedata.msg.ResolveResponse".equals (className)) break;
      try {
        return (com.opengamma.livedata.msg.ResolveResponse)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializationContext.class, org.fudgemsg.FudgeMsg.class).invoke (null, fudgeContext, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
