...
public class NormalizationResponse implements java.io.Serializable {
  ...
  public NormalizationResponse (long correlationId, java.util.Collection<? extends com.opengamma.livedata.LiveDataSpecification> liveDataSpecification, java.util.Collection<? extends org.fudgemsg.FudgeMsg> values) {
  ...
  protected NormalizationResponse (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    org.fudgemsg.FudgeField fudgeField;
    java.util.List<org.fudgemsg.FudgeField> fudgeFields;
    fudgeField = fudgeMsg.getByName (CORRELATION_ID_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a NormalizationResponse - field 'correlationId' is not present");
    try {
      _correlationId = fudgeMsg.getFieldValue (Long.class, fudgeField);
    }
    catch (IllegalArgumentException e) {
      throw new IllegalArgumentException ("Fudge message is not a NormalizationResponse - field 'correlationId' is not long", e);
    }
    fudgeFields = fudgeMsg.getAllByName (LIVE_DATA_SPECIFICATION_KEY);
    if (fudgeFields.size () == 0) throw new IllegalArgumentException ("Fudge message is not a NormalizationResponse - field 'liveDataSpecification' is not present");
    ...
    for (org.fudgemsg.FudgeField fudge1 : fudgeFields) {
      try {
        ...
        throw new IllegalArgumentException ("Fudge message is not a NormalizationResponse - field 'liveDataSpecification' is not LiveDataSpecification message", e);
      }
    }
    fudgeFields = fudgeMsg.getAllByName (VALUES_KEY);
    if (fudgeFields.size () == 0) throw new IllegalArgumentException ("Fudge message is not a NormalizationResponse - field 'values' is not present");
    ...
    for (org.fudgemsg.FudgeField fudge2 : fudgeFields) {
      try {
        ...
        throw new IllegalArgumentException ("Fudge message is not a NormalizationResponse - field 'values' is not anonymous/unknown message", e);
      }
    }
  }
  protected NormalizationResponse (final NormalizationResponse source) {
  ...
  public NormalizationResponse clone () {
    return new NormalizationResponse (this);
  }
  ...
  public static NormalizationResponse fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.livedata.msg.NormalizationResponse".equals (className)) break;
      try {
        return (com.opengamma.livedata.msg.NormalizationResponse)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializer.class, org.fudgemsg.FudgeMsg.class).invoke (null, deserializer, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
    }
    return new NormalizationResponse (deserializer, fudgeMsg);
  }
