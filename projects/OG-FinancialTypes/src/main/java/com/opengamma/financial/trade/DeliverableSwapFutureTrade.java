 ...
 */
@BeanDefinition
public class DeliverableSwapFutureTrade extends TradeWrapper<DeliverableSwapFutureSecurity> implements ImmutableBean {
  ...
  public DeliverableSwapFutureTrade(Trade trade) {
    ...
    super(DeliverableSwapFutureSecurity.class, trade);
    _trade = trade;
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Trade> _trade = DirectMetaProperty.ofImmutable(
        this, "trade", DeliverableSwapFutureTrade.class, Trade.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 110621028:  // trade
          return ((DeliverableSwapFutureTrade) bean).getTrade();
      }
   ...
   */
  public static class Builder extends DirectFieldsBeanBuilder<DeliverableSwapFutureTrade> {
     ...
     */
    protected Builder(DeliverableSwapFutureTrade beanToCopy) {
