...
public class EnergyFutureSecurity extends CommodityFutureSecurity {
  ...
  public EnergyFutureSecurity(Expiry expiry, String tradingExchange, String settlementExchange, Currency currency, double unitAmount, String category) {
  ...
  public EnergyFutureSecurity clone() {
    return (EnergyFutureSecurity) super.clone();
  }
  ...
  public String toString() {
    ...
    buf.append("EnergyFutureSecurity{");
    int len = buf.length();
    toString(buf);
    if (buf.length() > len) {
  ...
  public static class Meta extends CommodityFutureSecurity.Meta {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -771625640:  // underlyingId
          return ((EnergyFutureSecurity) bean).getUnderlyingId();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -771625640:  // underlyingId
          ((EnergyFutureSecurity) bean).setUnderlyingId((ExternalId) newValue);
          return;
      }
