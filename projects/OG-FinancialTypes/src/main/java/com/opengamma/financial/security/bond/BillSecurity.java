...
public class BillSecurity extends FinancialSecurity {
   ...
   */
  @PropertyDefinition(validate = "notNull")
  private ZonedDateTime _issuanceDate;
   ...
   * @param issuanceDate The issuance date, not null
   ...
   */
  public BillSecurity(final Currency currency, final Expiry maturityDate, final ZonedDateTime issuanceDate, final double minimumIncrement, final int daysToSettle,
  ...
  /**
   * Gets the the {@code issuanceDate} property.
   * @return the property, not null
   */
  public final Property<ZonedDateTime> issuanceDate() {
    return metaBean().issuanceDate().createProperty(this);
  }
  ...
  public int hashCode() {
    ...
    hash += hash * 31 + JodaBeanUtils.hashCode(getIssuanceDate());
  ...
  protected void toString(final StringBuilder buf) {
    ...
    buf.append("issuanceDate").append('=').append(JodaBeanUtils.toString(getIssuanceDate())).append(',').append(' ');
  ...
  public static class Meta extends FinancialSecurity.Meta {
    ...
    /**
     * The meta-property for the {@code issuanceDate} property.
     */
    private final MetaProperty<ZonedDateTime> _issuanceDate = DirectMetaProperty.ofReadWrite(
        this, "issuanceDate", BillSecurity.class, ZonedDateTime.class);
    /**
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<ZonedDateTime> issuanceDate() {
      return _issuanceDate;
    }
    ...
    protected Object propertyGet(final Bean bean, final String propertyName, final boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case 1354535593:  // issuanceDate
          return ((BillSecurity) bean).getIssuanceDate();
        case 1160465153:  // minimumIncrement
    ...
    protected void propertySet(final Bean bean, final String propertyName, final Object newValue, final boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -414641441:  // maturityDate
          ...
          return;
        case 1354535593:  // issuanceDate
          ((BillSecurity) bean).setIssuanceDate((ZonedDateTime) newValue);
          return;
        case 1160465153:  // minimumIncrement
