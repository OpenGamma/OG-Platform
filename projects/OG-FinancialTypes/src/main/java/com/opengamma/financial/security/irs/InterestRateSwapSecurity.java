...
public final class InterestRateSwapSecurity extends FinancialSecurity {
  ...
  public String toString() {
    ...
    buf.append("InterestRateSwapSecurity{");
    int len = buf.length();
    toString(buf);
    if (buf.length() > len) {
  ...
  protected void toString(StringBuilder buf) {
    super.toString(buf);
    buf.append("notionalExchange").append('=').append(JodaBeanUtils.toString(getNotionalExchange())).append(',').append(' ');
    ...
    buf.append("legs").append('=').append(JodaBeanUtils.toString(getLegs())).append(',').append(' ');
  }
