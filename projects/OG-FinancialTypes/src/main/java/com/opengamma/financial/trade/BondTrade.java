...
@BeanDefinition
public final class BondTrade extends TradeWrapper<BondSecurity> implements Trade, ImmutableBean {
  ...
  */
  ...
  public BondTrade(Trade trade) {
    ...
    super(BondSecurity.class, trade);
    _trade = trade;
  }
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code BondTrade}.
   * @return the meta-bean, not null
   */
  public static BondTrade.Meta meta() {
    return BondTrade.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(BondTrade.Meta.INSTANCE);
  }
   ...
   */
  public static BondTrade.Builder builder() {
    return new BondTrade.Builder();
  }

  @Override
  public BondTrade.Meta metaBean() {
    return BondTrade.Meta.INSTANCE;
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Trade> _trade = DirectMetaProperty.ofImmutable(
        this, "trade", BondTrade.class, Trade.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BondTrade.Builder builder() {
      return new BondTrade.Builder();
    }

    @Override
    public Class<? extends BondTrade> beanType() {
      return BondTrade.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 110621028:  // trade
          return ((BondTrade) bean).getTrade();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code BondTrade}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<BondTrade> {
     ...
     */
    private Builder(BondTrade beanToCopy) {
