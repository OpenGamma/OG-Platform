 ...
 */
@BeanDefinition
public class BondFutureTrade extends TradeWrapper<BondFutureSecurity> implements ImmutableBean {
  ...
  public BondFutureTrade(Trade trade) {
    ...
    super(BondFutureSecurity.class, trade);
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Trade> _trade = DirectMetaProperty.ofImmutable(
        this, "trade", BondFutureTrade.class, Trade.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 110621028:  // trade
          return ((BondFutureTrade) bean).getTrade();
      }
   ...
   */
  public static class Builder extends DirectFieldsBeanBuilder<BondFutureTrade> {
     ...
     */
    protected Builder(BondFutureTrade beanToCopy) {
