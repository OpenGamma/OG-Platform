 ...
 */
@BeanDefinition
public class InterestRateSwapTrade extends TradeWrapper<InterestRateSwapSecurity> implements ImmutableBean {
  ...
  public InterestRateSwapTrade(Trade trade) {
    ...
    super(InterestRateSwapSecurity.class, trade);
    _trade = trade;
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Trade> _trade = DirectMetaProperty.ofImmutable(
        this, "trade", InterestRateSwapTrade.class, Trade.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 110621028:  // trade
          return ((InterestRateSwapTrade) bean).getTrade();
      }
   ...
   */
  public static class Builder extends DirectFieldsBeanBuilder<InterestRateSwapTrade> {
     ...
     */
    protected Builder(InterestRateSwapTrade beanToCopy) {
