...
public final class FixedInterestRateSwapLeg extends InterestRateSwapLeg {
   ...
   * @return the property, not null
   */
  public Property<CompoundingMethod> compoundingMethod() {
  ...
  public static final class Meta extends InterestRateSwapLeg.Meta {
    ...
    private final MetaProperty<CompoundingMethod> _compoundingMethod = DirectMetaProperty.ofReadWrite(
        this, "compoundingMethod", FixedInterestRateSwapLeg.class, CompoundingMethod.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1376171496:  // compoundingMethod
          return ((FixedInterestRateSwapLeg) bean).getCompoundingMethod();
        case -697920873:  // schedule
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case 2039569265:  // convention
          ...
          return;
        case -1376171496:  // compoundingMethod
          ((FixedInterestRateSwapLeg) bean).setCompoundingMethod((CompoundingMethod) newValue);
          return;
        case -697920873:  // schedule
    ...
    protected void validate(Bean bean) {
      ...
      JodaBeanUtils.notNull(((FixedInterestRateSwapLeg) bean)._compoundingMethod, "compoundingMethod");
      JodaBeanUtils.notNull(((FixedInterestRateSwapLeg) bean)._schedule, "schedule");
      super.validate(bean);
    }
