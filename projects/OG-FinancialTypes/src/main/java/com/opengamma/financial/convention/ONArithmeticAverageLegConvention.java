 ...
 */
@BeanDefinition
public class ONArithmeticAverageLegConvention extends Convention {
  ...
  static {
    JodaBeanUtils.registerMetaBean(ONArithmeticAverageLegConvention.Meta.INSTANCE);
  }
  ...
  public static class Meta extends Convention.Meta {
    ...
    public BeanBuilder<? extends ONArithmeticAverageLegConvention> builder() {
      return new DirectBeanBuilder<ONArithmeticAverageLegConvention>(new ONArithmeticAverageLegConvention());
    }
