...
public class HibernateUserManagerTest {
  ...
  public static Object[] factory_tests() {
    ...
    for (Object[] objects : tests) {
      result.add(new HibernateUserManagerTests(objects[0].toString(), objects[1].toString()));
    }
    return result.toArray();
  }

  @Test
  public static class HibernateUserManagerTests extends TransactionalHibernateTest {

    private HibernateUserManager _userManager;

    public HibernateUserManagerTests(String databaseType, final String databaseVersion) {
