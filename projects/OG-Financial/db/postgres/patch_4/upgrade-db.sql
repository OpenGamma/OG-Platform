-- make script barf if data about to be deleted
alter table sec_bond
  add column security_id bigint not null;
...
-- drop all and recreate (as not in production yet)
drop table sec_swap;
drop table sec_fra;
drop table sec_cash;
drop table sec_futurebundleidentifier;
drop table sec_futurebundle;
drop table sec_future;
drop table sec_bond;
drop table sec_coupontype;
drop table sec_guaranteetype;
drop table sec_yieldconvention;
drop table sec_market;
drop table sec_issuertype;
drop table sec_businessdayconvention;
drop table sec_daycount;
drop table sec_frequency;
drop table sec_option;
drop table sec_equity;
drop table sec_gics;
drop table sec_exchange;
drop table sec_identifier_association;
drop table sec_unit;
drop table sec_cashrate;
drop table sec_bondfuturetype;
drop table sec_commodityfuturetype;
drop table sec_currency;
