...
/**
 * Calculates the present value of bond futures and interest rate futures
 * using curves constructed using the discounting method.
 */
public class FutureTradeDiscountingPVFunction extends FutureTradeDiscountingFunction {
   ...
   */
  public FutureTradeDiscountingPVFunction() {
    super(PRESENT_VALUE);
  }
