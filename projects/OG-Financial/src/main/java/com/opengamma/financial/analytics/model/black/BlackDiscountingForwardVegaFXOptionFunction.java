...
import com.opengamma.analytics.financial.provider.calculator.blackforex.ForwardVegaForexBlackSmileCalculator;
...
/**
 * Calculates the forward vega of FX options using a Black surface and
  ...
  public CompiledFunctionDefinition compile(final FunctionCompilationContext context, final Instant atInstant) {
    return new BlackDiscountingCompiledFunction(getTargetToDefinitionConverter(context), getDefinitionToDerivativeConverter(context), false) {
      ...
      protected Set<ComputedValue> getValues(final FunctionExecutionContext executionContext, final FunctionInputs inputs,
        ...
        final ValueSpecification spec = new ValueSpecification(FORWARD_VEGA, target.toSpecification(), properties);
