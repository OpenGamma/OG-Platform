...
public class InflationIssuerCurveTypeConfiguration extends CurveTypeConfiguration {
   ...
   */
  @Deprecated
  public InflationIssuerCurveTypeConfiguration(final String issuerName, final String underlyingReference) {
    super();
   ...
   */
  public InflationIssuerCurveTypeConfiguration(final Set<Object> keys, final Set<LegalEntityFilter<LegalEntity>> filters) {
    super();
  ...
  public static class Meta extends CurveTypeConfiguration.Meta {
    ...
    private final MetaProperty<Set<Object>> _keys = DirectMetaProperty.ofReadWrite(
        this, "keys", InflationIssuerCurveTypeConfiguration.class, (Class) Set.class);
    /**
    ...
    private final MetaProperty<LegalEntityCombiningFilter> _filters = DirectMetaProperty.ofReadWrite(
        this, "filters", InflationIssuerCurveTypeConfiguration.class, LegalEntityCombiningFilter.class);
    /**
    ...
    private final MetaProperty<String> _issuerName = DirectMetaProperty.ofReadWrite(
        this, "issuerName", InflationIssuerCurveTypeConfiguration.class, String.class);
    /**
    ...
    private final MetaProperty<String> _underlyingReference = DirectMetaProperty.ofReadWrite(
        this, "underlyingReference", InflationIssuerCurveTypeConfiguration.class, String.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3288564:  // keys
          return ((InflationIssuerCurveTypeConfiguration) bean).getKeys();
        case -854547461:  // filters
          return ((InflationIssuerCurveTypeConfiguration) bean).getFilters();
        case 1459772644:  // issuerName
          return ((InflationIssuerCurveTypeConfiguration) bean).getIssuerName();
        case -1415245714:  // underlyingReference
          return ((InflationIssuerCurveTypeConfiguration) bean).getUnderlyingReference();
      }
    ...
    protected void propertySet(Bean bean, String propertyName, Object newValue, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3288564:  // keys
          ((InflationIssuerCurveTypeConfiguration) bean).setKeys((Set<Object>) newValue);
          return;
        case -854547461:  // filters
          ((InflationIssuerCurveTypeConfiguration) bean).setFilters((LegalEntityCombiningFilter) newValue);
          return;
        case 1459772644:  // issuerName
          ((InflationIssuerCurveTypeConfiguration) bean).setIssuerName((String) newValue);
          return;
        case -1415245714:  // underlyingReference
          ((InflationIssuerCurveTypeConfiguration) bean).setUnderlyingReference((String) newValue);
          return;
      }
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((InflationIssuerCurveTypeConfiguration) bean)._keys, "keys");
      JodaBeanUtils.notNull(((InflationIssuerCurveTypeConfiguration) bean)._filters, "filters");
      super.validate(bean);
    }
