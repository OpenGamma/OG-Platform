 ...
 */
public class BlackDiscountingImpliedVolatilityFunction extends BlackDiscountingFunction {
  ...
  /**
   * Sets the value requirement to {@link ValueRequirementNames#IMPLIED_VOLATILITY}
   */
  public BlackDiscountingImpliedVolatilityFunction() {
    super(IMPLIED_VOLATILITY);
  }
