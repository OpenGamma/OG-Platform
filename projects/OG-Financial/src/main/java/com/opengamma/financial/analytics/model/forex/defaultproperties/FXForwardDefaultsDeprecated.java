...
public class FXForwardDefaultsDeprecated extends DefaultPropertyFunction {
  ...
  protected void getDefaults(final PropertyDefaults defaults) {
    for (final String valueRequirement : VALUE_REQUIREMENTS) {
      ...
      defaults.addValuePropertyName(valueRequirement, FXForwardFunctionDeprecated.PROPERTY_PAY_FORWARD_CURVE);
      defaults.addValuePropertyName(valueRequirement, FXForwardFunctionDeprecated.PROPERTY_PAY_CURVE_CALCULATION_METHOD);
      defaults.addValuePropertyName(valueRequirement, ValuePropertyNames.RECEIVE_CURVE);
      defaults.addValuePropertyName(valueRequirement, FXForwardFunctionDeprecated.PROPERTY_RECEIVE_FORWARD_CURVE);
      defaults.addValuePropertyName(valueRequirement, FXForwardFunctionDeprecated.PROPERTY_RECEIVE_CURVE_CALCULATION_METHOD);
    }
  }
  ...
  protected Set<String> getDefaultValue(final FunctionCompilationContext context, final ComputationTarget target, final ValueRequirement desiredValue, final String propertyName) {
    ...
    if (FXForwardFunctionDeprecated.PROPERTY_PAY_FORWARD_CURVE.equals(propertyName)) {
      return Collections.singleton(_payForwardCurveName);
    }
    if (FXForwardFunctionDeprecated.PROPERTY_PAY_CURVE_CALCULATION_METHOD.equals(propertyName)) {
    ...
    if (FXForwardFunctionDeprecated.PROPERTY_RECEIVE_FORWARD_CURVE.equals(propertyName)) {
      return Collections.singleton(_receiveForwardCurveName);
    }
    if (FXForwardFunctionDeprecated.PROPERTY_RECEIVE_CURVE_CALCULATION_METHOD.equals(propertyName)) {
