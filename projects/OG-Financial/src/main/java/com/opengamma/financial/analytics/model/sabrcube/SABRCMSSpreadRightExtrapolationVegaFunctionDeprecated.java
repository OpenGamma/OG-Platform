...
/**
 * @deprecated Use the version that does not refer to funding or forward curve
 * @see SABRCMSSpreadRightExtrapolationVegaFunction
 */
@Deprecated
public class SABRCMSSpreadRightExtrapolationVegaFunctionDeprecated extends SABRVegaFunctionDeprecated {
  ...
  protected ValueProperties getSensitivityProperties(final ComputationTarget target, final String currency, final ValueRequirement desiredValue) {
    ...
    return ValueProperties.builder()
        ...
        .with(SABRRightExtrapolationFunctionDeprecated.PROPERTY_CUTOFF_STRIKE, cutoff)
        .with(SABRRightExtrapolationFunctionDeprecated.PROPERTY_TAIL_THICKNESS_PARAMETER, mu)
  ...
  protected ValueProperties getResultProperties(final ValueProperties properties, final String currency) {
    return properties.copy()
        ...
        .withAny(SABRRightExtrapolationFunctionDeprecated.PROPERTY_CUTOFF_STRIKE)
        .withAny(SABRRightExtrapolationFunctionDeprecated.PROPERTY_TAIL_THICKNESS_PARAMETER)
