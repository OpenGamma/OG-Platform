 ...
 *
 */
public class EquityFutureOptionBAWPVFunction extends EquityFutureOptionBAWFunction {

  public EquityFutureOptionBAWPVFunction() {
  ...
  protected Set<ComputedValue> computeValues(final InstrumentDerivative derivative, final StaticReplicationDataBundle market, final FunctionInputs inputs,
    ...
    final double pv = derivative.accept(EqyOptBaroneAdesiWhaleyPresentValueCalculator.getInstance(), market);
