...
public class EquityDividendYieldValueDeltaFuturesFunction extends EquityDividendYieldFuturesFunction<Double> {
   ...
   */
  public EquityDividendYieldValueDeltaFuturesFunction(String closingPriceField, String costOfCarryField, String resolutionKey) {
    super(ValueRequirementNames.VALUE_DELTA, DividendYieldFuturesCalculator.SpotDeltaCalculator.getInstance(), closingPriceField, costOfCarryField, resolutionKey);
  }
}
