...
public class SwapStrip extends CurveStrip {
  ...
  public SwapStrip(final Tenor startTenor, final Tenor maturityTenor, final ExternalId payLegConvention, final ExternalId receiveLegConvention,
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code SwapStrip}.
   * @return the meta-bean, not null
   */
  public static SwapStrip.Meta meta() {
    return SwapStrip.Meta.INSTANCE;
  }
  static {
    JodaBeanUtils.registerMetaBean(SwapStrip.Meta.INSTANCE);
  }

  @Override
  public SwapStrip.Meta metaBean() {
    return SwapStrip.Meta.INSTANCE;
  }
  ...
  public static class Meta extends CurveStrip.Meta {
    ...
    private final MetaProperty<Tenor> _startTenor = DirectMetaProperty.ofReadWrite(
        this, "startTenor", SwapStrip.class, Tenor.class);
    /**
    ...
    private final MetaProperty<Tenor> _maturityTenor = DirectMetaProperty.ofReadWrite(
        this, "maturityTenor", SwapStrip.class, Tenor.class);
    /**
    ...
    private final MetaProperty<ExternalId> _payLegConvention = DirectMetaProperty.ofReadWrite(
        this, "payLegConvention", SwapStrip.class, ExternalId.class);
    /**
    ...
    private final MetaProperty<ExternalId> _receiveLegConvention = DirectMetaProperty.ofReadWrite(
        this, "receiveLegConvention", SwapStrip.class, ExternalId.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends SwapStrip> builder() {
      return new DirectBeanBuilder<SwapStrip>(new SwapStrip());
    }

    @Override
    public Class<? extends SwapStrip> beanType() {
      return SwapStrip.class;
    }
