 ...
 */
public abstract class PositionDefaultCurrencyFunction extends DefaultCurrencyFunction {

  protected PositionDefaultCurrencyFunction(final boolean permitWithout, final String valueName) {
    super(ComputationTargetType.POSITION, permitWithout, valueName);
  }

  protected PositionDefaultCurrencyFunction(final boolean permitWithout, final String... valueNames) {
    super(ComputationTargetType.POSITION, permitWithout, valueNames);
  }
   ...
   */
  public static class Strict extends PositionDefaultCurrencyFunction {
   ...
   */
  public static class Permissive extends PositionDefaultCurrencyFunction {
