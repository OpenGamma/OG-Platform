...
/**
 * Calculates the value gamma of a commodity future option using the Bjerksund Stensland gamma.
 */
public class CommodityFutureOptionBjerksundStenslandValueGammaFunction extends CommodityFutureOptionBjerksundStenslandFunction {
