 ...
 */
@BeanDefinition
public class LegacyCDSSecurity extends CreditDefaultSwapSecurity {
  ...
  LegacyCDSSecurity() { // For Fudge builder
    super();
  }
  ...
  public LegacyCDSSecurity(final boolean isBuy, final ExternalId protectionSeller, final ExternalId protectionBuyer, final ExternalId referenceEntity, //CSIGNORE
      ...
      final boolean protectionStart, final CDSType cdsType, final double parSpread) {
    super(isBuy, protectionSeller, protectionBuyer, referenceEntity, debtSeniority, restructuringClause, calendarId, startDate,
  ...
  public static class Meta extends CreditDefaultSwapSecurity.Meta {
    ...
    private final MetaProperty<Double> _parSpread = DirectMetaProperty.ofReadWrite(
        this, "parSpread", LegacyCDSSecurity.class, Double.TYPE);
    /**
     * The meta-properties.
     */
