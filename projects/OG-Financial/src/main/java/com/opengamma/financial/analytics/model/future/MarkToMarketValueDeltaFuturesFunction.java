...
public class MarkToMarketValueDeltaFuturesFunction extends MarkToMarketFuturesFunction<Double> {
   ...
   */
  public MarkToMarketValueDeltaFuturesFunction(String closingPriceField, String costOfCarryField, String resolutionKey) {
    super(ValueRequirementNames.VALUE_DELTA, MarkToMarketFuturesCalculator.SpotDeltaCalculator.getInstance(), closingPriceField, costOfCarryField, resolutionKey);
  }
}
