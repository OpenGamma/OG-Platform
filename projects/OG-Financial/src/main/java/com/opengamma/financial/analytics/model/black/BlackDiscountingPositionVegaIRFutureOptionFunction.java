...
public class BlackDiscountingPositionVegaIRFutureOptionFunction extends BlackDiscountingIRFutureOptionFunction {
  ...
  /**
   * Sets the value requirement to {@link ValueRequirementNames#POSITION_VEGA}
   */
  ...
  public CompiledFunctionDefinition compile(final FunctionCompilationContext context, final Instant atInstant) {
    return new BlackDiscountingCompiledFunction(getTargetToDefinitionConverter(context), getDefinitionToDerivativeConverter(context), true) {
      ...
      protected Set<ComputedValue> getValues(final FunctionExecutionContext executionContext, final FunctionInputs inputs,
        ...
        final ValueSpecification spec = new ValueSpecification(POSITION_VEGA, target.toSpecification(), properties);
