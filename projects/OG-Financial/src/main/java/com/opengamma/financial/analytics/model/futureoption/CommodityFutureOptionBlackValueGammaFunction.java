...
/**
 * Calculates the value gamma of a commodity future option using the Black gamma.
 */
public class CommodityFutureOptionBlackValueGammaFunction extends CommodityFutureOptionBlackFunction {
