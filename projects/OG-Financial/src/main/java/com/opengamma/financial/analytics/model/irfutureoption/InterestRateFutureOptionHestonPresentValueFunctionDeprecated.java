 ...
 */
@Deprecated
public class InterestRateFutureOptionHestonPresentValueFunctionDeprecated extends AbstractFunction.NonCompiledInvoker {
  ...
  public InterestRateFutureOptionHestonPresentValueFunctionDeprecated(final String forwardCurveName, final String fundingCurveName, final String surfaceName) {
