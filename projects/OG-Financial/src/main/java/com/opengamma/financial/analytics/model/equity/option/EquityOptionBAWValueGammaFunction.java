...
/**
 * Calculates the value gamma of an equity index or equity option using the Barone-Adesi Whaley gamma.
 */
public class EquityOptionBAWValueGammaFunction extends EquityOptionBAWFunction {
