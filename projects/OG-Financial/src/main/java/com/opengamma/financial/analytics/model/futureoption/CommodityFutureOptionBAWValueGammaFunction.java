...
/**
 * Calculates the value gamma of a commodity future option using the Barone-Adesi Whaley gamma.
 */
public class CommodityFutureOptionBAWValueGammaFunction extends CommodityFutureOptionBAWFunction {
   ...
   * Default constructor
   */
  public CommodityFutureOptionBAWValueGammaFunction() {
  ...
  protected Set<ComputedValue> computeValues(final InstrumentDerivative derivative, final StaticReplicationDataBundle market, final FunctionInputs inputs,
    ...
    final double delta = (Double) gammaObject;
    final double valueGamma = CALCULATOR.valueGreek(derivative, market, delta);
