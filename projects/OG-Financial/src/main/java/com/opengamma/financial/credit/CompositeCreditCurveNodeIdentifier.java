 ...
 */
public final class CompositeCreditCurveNodeIdentifier extends CreditCurveNodeIdentifier {

  /**
   * The scheme to use in external identifiers
   */
  public static final ExternalScheme CREDIT_CURVE_SCHEME = ExternalScheme.of("COMPOSITE_CREDIT_CURVE_NODE");
  ...
  public static CreditCurveNodeIdentifier of(final String ticker,
     ...
     return new CompositeCreditCurveNodeIdentifier(ticker, redCode, currency, term, seniority, restructuringClause);
  }
   ...
   */
  private CompositeCreditCurveNodeIdentifier(final String ticker,
                                             final String redCode,
                                             final Currency currency,
                                             final Period term,
                                             final String seniority,
