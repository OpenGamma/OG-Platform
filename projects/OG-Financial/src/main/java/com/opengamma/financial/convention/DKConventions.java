...
public class DKConventions {
  ...
  public static void addFixedIncomeInstrumentConventions(final ConventionBundleMaster conventionMaster) {
    ...
    for (int i = 1; i < 3; i++) {
      ...
      utils.addConventionBundle(ExternalIdBundle.of(tullett, simple), name, act360, following, DateUtils.periodOfDays(i * 7), 2, false, dk);
    }
    ...
    for (int i = 1; i < 12; i++) {
      ...
      final ExternalId simple = simpleNameSecurityId(name);
      utils.addConventionBundle(ExternalIdBundle.of(tullett, simple), name, act360, following, DateUtils.periodOfMonths(i), 2, false, dk);
    }

    utils.addConventionBundle(ExternalIdBundle.of(tullettPrebonSecurityId("ASLIBDKK12L"), simpleNameSecurityId("DKK CIBOR 1y")),
        "DKK CIBOR 1y", act360, following, DateUtils.periodOfYears(1), 2, false, dk);
    ...
    utils.addConventionBundle(ExternalIdBundle.of(bloombergTickerSecurityId("DETNT/N Index"), simpleNameSecurityId("DKK T/N")),
        "DKK T/N", act360, following, DateUtils.periodOfDays(1), 1, false, dk, publicationLagON);
    // OIS-like swap
