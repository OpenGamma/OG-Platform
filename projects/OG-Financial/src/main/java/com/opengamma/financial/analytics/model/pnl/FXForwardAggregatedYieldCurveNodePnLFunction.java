 ...
 *
 */
public class FXForwardAggregatedYieldCurveNodePnLFunction extends AbstractFunction {

  private static final Logger s_logger = LoggerFactory.getLogger(FXForwardAggregatedYieldCurveNodePnLFunction.class);
