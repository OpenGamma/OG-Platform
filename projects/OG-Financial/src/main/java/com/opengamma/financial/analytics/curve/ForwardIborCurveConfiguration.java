...
public class ForwardIborCurveConfiguration extends CurveConfiguration {
  ...
  /* package */ForwardIborCurveConfiguration() {
  }

  public ForwardIborCurveConfiguration(final String curveName, final String calculationConfigurationName) {
   ...
   */
  public static ForwardIborCurveConfiguration.Meta meta() {
    return ForwardIborCurveConfiguration.Meta.INSTANCE;
  }
  static {
    JodaBeanUtils.registerMetaBean(ForwardIborCurveConfiguration.Meta.INSTANCE);
  }

  @Override
  public ForwardIborCurveConfiguration.Meta metaBean() {
    return ForwardIborCurveConfiguration.Meta.INSTANCE;
  }
  ...
  public static class Meta extends CurveConfiguration.Meta {
    ...
    private final MetaProperty<String> _curveName = DirectMetaProperty.ofReadWrite(
        this, "curveName", ForwardIborCurveConfiguration.class, String.class);
    /**
    ...
    private final MetaProperty<String> _calculationConfigurationName = DirectMetaProperty.ofReadWrite(
        this, "calculationConfigurationName", ForwardIborCurveConfiguration.class, String.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends ForwardIborCurveConfiguration> builder() {
      return new DirectBeanBuilder<ForwardIborCurveConfiguration>(new ForwardIborCurveConfiguration());
    }

    @Override
    public Class<? extends ForwardIborCurveConfiguration> beanType() {
      return ForwardIborCurveConfiguration.class;
    }
