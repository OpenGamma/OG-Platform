...
public class FXForwardYCNSFunctionDeprecated extends AbstractFunction.NonCompiledInvoker {
  ...
  public Set<ComputedValue> execute(final FunctionExecutionContext executionContext, final FunctionInputs inputs, final ComputationTarget target, final Set<ValueRequirement> desiredValues) {
    ...
    final String payForwardCurveName = desiredValue.getConstraint(FXForwardFunctionDeprecated.PROPERTY_PAY_FORWARD_CURVE);
    final String payCurveCalculationMethod = desiredValue.getConstraint(FXForwardFunctionDeprecated.PROPERTY_PAY_CURVE_CALCULATION_METHOD);
    final String receiveCurveName = desiredValue.getConstraint(ValuePropertyNames.RECEIVE_CURVE);
    final String receiveForwardCurveName = desiredValue.getConstraint(FXForwardFunctionDeprecated.PROPERTY_RECEIVE_FORWARD_CURVE);
    final String receiveCurveCalculationMethod = desiredValue.getConstraint(FXForwardFunctionDeprecated.PROPERTY_RECEIVE_CURVE_CALCULATION_METHOD);
  ...
  public Set<ValueRequirement> getRequirements(final FunctionCompilationContext context, final ComputationTarget target, final ValueRequirement desiredValue) {
    ...
    final Set<String> payForwardCurveNames = constraints.getValues(FXForwardFunctionDeprecated.PROPERTY_PAY_FORWARD_CURVE);
    if (payForwardCurveNames == null || payForwardCurveNames.size() != 1) {
      return null;
    }
    final Set<String> receiveForwardCurveNames = constraints.getValues(FXForwardFunctionDeprecated.PROPERTY_RECEIVE_FORWARD_CURVE);
    if (receiveForwardCurveNames == null || receiveForwardCurveNames.size() != 1) {
      return null;
    }
    final Set<String> payCurveCalculationMethods = constraints.getValues(FXForwardFunctionDeprecated.PROPERTY_PAY_CURVE_CALCULATION_METHOD);
    if (payCurveCalculationMethods == null || payCurveCalculationMethods.size() != 1) {
      return null;
    }
    final Set<String> receiveCurveCalculationMethods = constraints.getValues(FXForwardFunctionDeprecated.PROPERTY_RECEIVE_CURVE_CALCULATION_METHOD);
    ...
    final ValueRequirement spotRequirement = ConventionBasedFXRateFunction.getSpotRateRequirement(payCurrency, receiveCurrency);
  ...
  private ValueProperties getResultProperties() {
    return createValueProperties()
        ...
        .withAny(FXForwardFunctionDeprecated.PROPERTY_RECEIVE_CURVE_CALCULATION_METHOD).get();
  }
  ...
  private ValueProperties getResultProperties(final String currency, final String curveName, final String payCurveName, final String payForwardCurveName,
    ...
    return createValueProperties()
        ...
        .with(FXForwardFunctionDeprecated.PROPERTY_RECEIVE_CURVE_CALCULATION_METHOD, receiveCurveCalculationMethod).get();
  }
