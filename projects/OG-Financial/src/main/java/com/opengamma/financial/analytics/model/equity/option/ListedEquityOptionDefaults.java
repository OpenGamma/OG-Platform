...
/**
 * Populates {@link ListedEquityOptionFunction} with defaults. 
 * Basic configuration for clients that use one forward curve/config pair and one discounting curve/curve pair.<p>
 * If you wish to extend this class, compare to {@link EquityOptionInterpolatedBlackLognormalDefaults}. 
 * Unlike that Function, which populates fields for the EquityOptionFunction family, this one doesn't set volatility surface properties.
 */
