...
/**
 * Calculates the value gamma of an equity index or equity option using the Black gamma.
 */
public class EquityOptionBlackValueGammaFunction extends EquityOptionBlackFunction {
   ...
   * Default constructor
   */
  public EquityOptionBlackValueGammaFunction() {
  ...
  public Set<ValueRequirement> getRequirements(final FunctionCompilationContext context, final ComputationTarget target, final ValueRequirement desiredValue) {
    ...
    final ValueProperties properties = desiredValue.getConstraints().copy()
        ...
        .get();
    requirements.add(new ValueRequirement(ValueRequirementNames.GAMMA, target.toSpecification(), properties));
    return requirements;
  }
