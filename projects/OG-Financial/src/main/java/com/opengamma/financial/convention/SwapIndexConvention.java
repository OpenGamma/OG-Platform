...
public class SwapIndexConvention extends Convention {
  ...
  @PropertyDefinition(validate = "notNull")
  private String _swapConventionName;
  ...
  public SwapIndexConvention(final String name, final ExternalIdBundle externalIdBundle, final LocalTime fixingTime, final String swapConventionName) {
    super(name, externalIdBundle);
    setFixingTime(fixingTime);
    setSwapConventionName(swapConventionName);
  }
  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
  ...
  protected Object propertyGet(String propertyName, boolean quiet) {
    switch (propertyName.hashCode()) {
      ...
      case -1429059057:  // swapConventionName
        return getSwapConventionName();
    }
  ...
  protected void propertySet(String propertyName, Object newValue, boolean quiet) {
    switch (propertyName.hashCode()) {
      case 1255686170:  // fixingTime
        ...
        return;
      case -1429059057:  // swapConventionName
        setSwapConventionName((String) newValue);
        return;
    }
  ...
  protected void validate() {
    ...
    JodaBeanUtils.notNull(_swapConventionName, "swapConventionName");
    super.validate();
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(getFixingTime(), other.getFixingTime()) &&
          JodaBeanUtils.equal(getSwapConventionName(), other.getSwapConventionName()) &&
          super.equals(obj);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash += hash * 31 + JodaBeanUtils.hashCode(getSwapConventionName());
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the swapConventionName.
   * @return the value of the property, not null
   */
  public String getSwapConventionName() {
    return _swapConventionName;
  }

  /**
   * Sets the swapConventionName.
   * @param swapConventionName  the new value of the property, not null
   */
  public void setSwapConventionName(String swapConventionName) {
    JodaBeanUtils.notNull(swapConventionName, "swapConventionName");
    this._swapConventionName = swapConventionName;
  }

  /**
   * Gets the the {@code swapConventionName} property.
   * @return the property, not null
   */
  public final Property<String> swapConventionName() {
    return metaBean().swapConventionName().createProperty(this);
  }
  ...
  public static class Meta extends Convention.Meta {
    ...
    /**
     * The meta-property for the {@code swapConventionName} property.
     */
    private final MetaProperty<String> _swapConventionName = DirectMetaProperty.ofReadWrite(
        this, "swapConventionName", SwapIndexConvention.class, String.class);
    /**
     * The meta-properties.
     */
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<String> swapConventionName() {
      return _swapConventionName;
    }
