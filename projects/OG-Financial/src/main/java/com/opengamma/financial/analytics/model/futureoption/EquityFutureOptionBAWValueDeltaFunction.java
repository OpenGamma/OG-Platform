...
/**
 * Calculates the value delta of a equity future option using the Barone-Adesi Whaley delta.
 */
public class EquityFutureOptionBAWValueDeltaFunction extends EquityFutureOptionBAWFunction {
   ...
   * Default constructor
   */
  public EquityFutureOptionBAWValueDeltaFunction() {
