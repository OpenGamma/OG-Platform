...
public class OvernightIndexConvention extends Convention {
  ...
  protected void validate() {
    ...
    JodaBeanUtils.notNull(_publicationLag, "publicationLag");
   ...
   * @param publicationLag  the new value of the property, not null
   */
  public void setPublicationLag(int publicationLag) {
    JodaBeanUtils.notNull(publicationLag, "publicationLag");
