...
public class EquityFutureOptionBlackLognormalDefaults extends DefaultPropertyFunction {
  ...
  public EquityFutureOptionBlackLognormalDefaults(final String priority, final String... defaultsPerCurrency) {
  ...
  public boolean canApplyTo(final FunctionCompilationContext context, final ComputationTarget target) {
    ...
    final String currency = ((EquityIndexFutureOptionSecurity) security).getCurrency().getCode();
