...
/**
 * Calculates the value delta of an equity index or equity option using the Barone-Adesi Whaley delta.
 */
public class EquityOptionBAWValueDeltaFunction extends EquityOptionBAWFunction {
   ...
   * Default constructor
   */
  public EquityOptionBAWValueDeltaFunction() {
