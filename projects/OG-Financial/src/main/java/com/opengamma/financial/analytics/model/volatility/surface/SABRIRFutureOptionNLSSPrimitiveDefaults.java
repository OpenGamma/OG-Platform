 ...
 *
 */
public class SABRIRFutureOptionNLSSPrimitiveDefaults extends SABRIRFutureOptionNLSSDefaults {

  public SABRIRFutureOptionNLSSPrimitiveDefaults(final String priority, final String xInterpolatorName, final String yInterpolatorName, final String leftXExtrapolatorName,
    ...
    super(priority, xInterpolatorName, yInterpolatorName, leftXExtrapolatorName, rightXExtrapolatorName, leftYExtrapolatorName, rightYExtrapolatorName, useFixedAlpha,
        useFixedBeta, useFixedRho, useFixedNu, alpha, beta, rho, nu, error, ComputationTargetType.PRIMITIVE);
  }
