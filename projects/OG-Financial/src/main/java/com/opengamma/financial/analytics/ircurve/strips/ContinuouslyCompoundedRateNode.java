 ...
 */
@BeanDefinition
public class ContinuouslyCompoundedRateNode extends CurveNode {
   ...
   * @param name The name
   */
  public ContinuouslyCompoundedRateNode(final String curveNodeIdMapperName, final Tenor tenor, final String name) {
  ...
  public <T> T accept(final CurveNodeVisitor<T> visitor) {
    ...
    return visitor.visitContinuouslyCompoundedRateNode(this);
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code ContinuouslyCompoundedRateNode}.
  ...
  @Override
  public ContinuouslyCompoundedRateNode.Meta metaBean() {
    return ContinuouslyCompoundedRateNode.Meta.INSTANCE;
  }
  ...
  public static class Meta extends CurveNode.Meta {
    ...
    private final MetaProperty<Tenor> _tenor = DirectMetaProperty.ofReadWrite(
        this, "tenor", ContinuouslyCompoundedRateNode.class, Tenor.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends ContinuouslyCompoundedRateNode> builder() {
      return new DirectBeanBuilder<ContinuouslyCompoundedRateNode>(new ContinuouslyCompoundedRateNode());
    }

    @Override
    public Class<? extends ContinuouslyCompoundedRateNode> beanType() {
      return ContinuouslyCompoundedRateNode.class;
    }
