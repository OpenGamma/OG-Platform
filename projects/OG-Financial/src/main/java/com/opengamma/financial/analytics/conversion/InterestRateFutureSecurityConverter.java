...
public class InterestRateFutureSecurityConverter extends FinancialSecurityVisitorAdapter<InstrumentDefinition<?>> {
  ...
  @Override
  public InterestRateFutureTransactionDefinition visitInterestRateFutureSecurity(final InterestRateFutureSecurity security) {
    ...
    return new InterestRateFutureTransactionDefinition(lastTradeDate, 0.0, lastTradeDate, iborIndex, notional, paymentAccrualFactor, 1, security.getName());
  }
