 ...
 */
public abstract class ConfigItemTarget implements UniqueIdentifiable {

  /**
   * The computation target type corresponding to a configuration item.
   */
  public static final ComputationTargetType TYPE = ComputationTargetType.of(YieldCurveDefinition.class); //.or(other types as needed)
