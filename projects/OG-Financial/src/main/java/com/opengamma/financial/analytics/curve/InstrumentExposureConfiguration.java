...
public class InstrumentExposureConfiguration extends DirectBean implements Serializable {
  ...
  private Map<CurveConfigurationSpecification, Collection<CurveConfigurationVisitor<?>>> _configurationsForTargets;


  /* package*/InstrumentExposureConfiguration() {
  }

  public InstrumentExposureConfiguration(final Map<CurveConfigurationSpecification, Collection<CurveConfigurationVisitor<?>>> configurationsForTargets) {
    setConfigurationsForTargets(configurationsForTargets);
  }
  ...
  protected void propertySet(String propertyName, Object newValue, boolean quiet) {
    switch (propertyName.hashCode()) {
      case -992172522:  // configurationsForTargets
        setConfigurationsForTargets((Map<CurveConfigurationSpecification, Collection<CurveConfigurationVisitor<?>>>) newValue);
        return;
    }
   ...
   */
  public Map<CurveConfigurationSpecification, Collection<CurveConfigurationVisitor<?>>> getConfigurationsForTargets() {
   ...
   */
  public void setConfigurationsForTargets(Map<CurveConfigurationSpecification, Collection<CurveConfigurationVisitor<?>>> configurationsForTargets) {
   ...
   */
  public final Property<Map<CurveConfigurationSpecification, Collection<CurveConfigurationVisitor<?>>>> configurationsForTargets() {
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Map<CurveConfigurationSpecification, Collection<CurveConfigurationVisitor<?>>>> _configurationsForTargets = DirectMetaProperty.ofReadWrite(
     ...
     */
    public final MetaProperty<Map<CurveConfigurationSpecification, Collection<CurveConfigurationVisitor<?>>>> configurationsForTargets() {
      return _configurationsForTargets;
    }
