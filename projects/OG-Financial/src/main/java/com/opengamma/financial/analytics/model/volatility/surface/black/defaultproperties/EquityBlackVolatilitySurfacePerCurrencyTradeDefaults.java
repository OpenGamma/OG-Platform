 ...
 *
 */
public class EquityBlackVolatilitySurfacePerCurrencyTradeDefaults extends EquityBlackVolatilitySurfaceDefaults {

  /**
   * @param priority The priority of these defaults
   * @param defaultsPerTicker The default values per ticker
   */
  public EquityBlackVolatilitySurfacePerCurrencyTradeDefaults(final String priority, final String... defaultsPerTicker) {
  ...
  protected String getId(final ComputationTarget target) {
    return FinancialSecurityUtils.getCurrency(target.getTrade().getSecurity()).getCode();
  }
}
