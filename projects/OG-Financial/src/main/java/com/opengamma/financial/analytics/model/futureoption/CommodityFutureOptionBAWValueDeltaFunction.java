...
/**
 * Calculates the value delta of a commodity future option using the Barone-Adesi Whaley delta.
 */
public class CommodityFutureOptionBAWValueDeltaFunction extends CommodityFutureOptionBAWFunction {
   ...
   * Default constructor
   */
  public CommodityFutureOptionBAWValueDeltaFunction() {
