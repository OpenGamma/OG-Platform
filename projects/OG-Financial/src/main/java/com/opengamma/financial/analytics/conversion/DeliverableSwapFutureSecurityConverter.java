...
public class DeliverableSwapFutureSecurityConverter extends FinancialSecurityVisitorAdapter<InstrumentDefinition<?>> {
  ...
  @Override
  public DeliverableSwapFuturesSecurityDefinition visitDeliverableSwapFutureSecurity(final DeliverableSwapFutureSecurity security) {
    ...
    return new DeliverableSwapFuturesSecurityDefinition(lastTradingDate, (SwapFixedIborDefinition) underlyingSwap, notional);
  }
}
