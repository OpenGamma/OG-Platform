...
/**
 * @deprecated Use the version of the function that doesn't refer to funding and forward curve properties
 * @see InterestRateFutureCurveSpecificFunction
 */
@Deprecated
public abstract class InterestRateFutureCurveSpecificFunctionDeprecated extends AbstractFunction.NonCompiledInvoker {
  private final String _valueRequirement;
  private InterestRateFutureTradeConverter _converter;
  private FixedIncomeConverterDataProvider _dataConverter;

  public InterestRateFutureCurveSpecificFunctionDeprecated(final String valueRequirement) {
  ...
  public Set<ComputedValue> execute(final FunctionExecutionContext executionContext, final FunctionInputs inputs, final ComputationTarget target, final Set<ValueRequirement> desiredValues) {
    ...
    final InstrumentDerivative irFuture = _dataConverter.convert(trade.getSecurity(), irFutureDefinition, now, new String[] {fundingCurveName, forwardCurveName }, timeSeries);
