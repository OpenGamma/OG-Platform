 ...
 *
 */
public class EquityBlackVolatilitySurfacePerEquitySecurityDefaults extends EquityBlackVolatilitySurfaceDefaults {

  /**
   * @param priority The priority of these defaults
   * @param defaultsPerTicker The default values for each ticker
   */
  public EquityBlackVolatilitySurfacePerEquitySecurityDefaults(final String priority, final String... defaultsPerTicker) {
    super(ComputationTargetType.SECURITY, priority, defaultsPerTicker);
  }
