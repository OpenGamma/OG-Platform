...
/**
 * Calculates the value gamma of a equity future option using the Barone-Adesi Whaley gamma.
 */
public class EquityFutureOptionBAWValueGammaFunction extends EquityFutureOptionBAWFunction {
   ...
   * Default constructor
   */
  public EquityFutureOptionBAWValueGammaFunction() {
