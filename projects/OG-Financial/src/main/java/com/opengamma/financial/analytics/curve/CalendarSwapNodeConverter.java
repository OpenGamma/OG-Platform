...
public class CalendarSwapNodeConverter extends CurveNodeVisitorAdapter<InstrumentDefinition<?>> {
   ...
   */
  public CalendarSwapNodeConverter(final ConventionSource conventionSource, final HolidaySource holidaySource, final RegionSource regionSource,
  ...
  public InstrumentDefinition<?> visitCalendarSwapNode(final CalendarSwapNode calendarSwapNode) {
    ...
    return NodeConverterUtils.getSwapCalendarDefinition(payLegConvention, receiveLegConvention, unadjustedStartDate, calendarSwapNode.getCalendarDateStartNumber(),
        calendarSwapNode.getCalendarDateEndNumber(), calendarStartEndDate, _regionSource, _holidaySource, _conventionSource, _marketData, _dataId, _valuationTime);
  }
