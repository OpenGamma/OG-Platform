 ...
 */
@Deprecated
public class SABRRightExtrapolationYCNSFunctionDeprecated extends SABRYCNSFunctionDeprecated {
  ...
  protected ValueProperties getResultProperties(final Currency currency) {
    return createValueProperties()
        ...
        .with(ValuePropertyNames.CALCULATION_METHOD, SABRFunctionDeprecated.SABR_RIGHT_EXTRAPOLATION)
