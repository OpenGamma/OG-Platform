 ...
 */
public class EquityOptionPerTickerDefaults extends DefaultPropertyFunction {
  /** The logger */
  private static final Logger s_logger = LoggerFactory.getLogger(EquityOptionPerTickerDefaults.class);
   ...
   */
  public EquityOptionPerTickerDefaults(final String priority, final String... perEquityConfig) {
