...
/**
 * Calculates the value delta of a commodity future option using the Bjerksund Stensland delta.
 */
public class CommodityFutureOptionBjerksundStenslandValueDeltaFunction extends CommodityFutureOptionBjerksundStenslandFunction {
