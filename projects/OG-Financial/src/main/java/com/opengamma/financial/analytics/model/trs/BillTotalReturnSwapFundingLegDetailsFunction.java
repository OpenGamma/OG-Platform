 ...
 */
public class BillTotalReturnSwapFundingLegDetailsFunction extends BillTotalReturnSwapFunction {

  /**
   * Sets the value requirement to {@link ValueRequirementNames#FUNDING_LEG_DETAILS}.
   */
  public BillTotalReturnSwapFundingLegDetailsFunction() {
    super(FUNDING_LEG_DETAILS);
  }

  @Override
  public CompiledFunctionDefinition compile(final FunctionCompilationContext context, final Instant atInstant) {
    return new BillTotalReturnSwapCompiledFunction(getTargetToDefinitionConverter(context), getDefinitionToDerivativeConverter(context), false) {
      ...
      public Set<ComputedValue> execute(final FunctionExecutionContext executionContext, final FunctionInputs inputs, final ComputationTarget target,
        ...
        final BillTotalReturnSwapDefinition trsDefinition = (BillTotalReturnSwapDefinition) getTargetToDefinitionConverter(context).convert(trade);
        final AnnuityDefinition<? extends PaymentDefinition> definition = trsDefinition.getFundingLeg();
        final Annuity<? extends Payment> derivative = ((BillTotalReturnSwap) getDerivative(target, now, timeSeries, trsDefinition)).getFundingLeg();
        ...
        final List<Set<Tenor>> indexTenors = definition.accept(AnnuityIndexTenorsVisitor.getInstance(), now);
