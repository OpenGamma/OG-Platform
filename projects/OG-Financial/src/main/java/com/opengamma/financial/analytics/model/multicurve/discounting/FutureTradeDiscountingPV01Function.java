...
/**
 * Calculates the PV01 of bond futures and interest rate futures
 * using curves constructed using the discounting method.
 */
public class FutureTradeDiscountingPV01Function extends FutureTradeDiscountingFunction {
  /** The PV01 calculator */
   ...
   */
  public FutureTradeDiscountingPV01Function() {
    super(PV01);
  }
