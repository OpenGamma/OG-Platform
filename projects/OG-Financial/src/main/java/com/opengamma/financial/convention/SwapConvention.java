...
public class SwapConvention extends Convention {
  ...
  public SwapConvention(final String name, final ExternalIdBundle externalIdBundle, final String payLegConventionName, final String receiveLegConventionName) {
    ...
    setFixedLegConventionName(payLegConventionName);
    setFloatingLegConventionName(receiveLegConventionName);
  }
  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   ...
   */
  public void setRecieveLegConventionName(String recieveLegConventionName) {
