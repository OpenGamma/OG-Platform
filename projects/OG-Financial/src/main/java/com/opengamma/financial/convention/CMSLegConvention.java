...
public class CMSLegConvention extends Convention {
  ...
  public CMSLegConvention(final String name, final ExternalIdBundle externalIdBundle, final ExternalId swapIndexConvention, final Tenor paymentTenor, final boolean isAdvanceFixing) {
