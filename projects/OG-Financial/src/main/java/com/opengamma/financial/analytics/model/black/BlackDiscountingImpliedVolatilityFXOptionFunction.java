...
/**
 * Calculates the implied volatility of FX options using a Black surface and
 * curves constructed using the discounting method.
 */
public class BlackDiscountingImpliedVolatilityFXOptionFunction extends BlackDiscountingFXOptionFunction {
  ...
  private static final InstrumentDerivativeVisitor<BlackForexSmileProviderInterface, Double> CALCULATOR =
      ImpliedVolatilityForexBlackSmileCalculator.getInstance();

  /**
   * Sets the value requirement to {@link ValueRequirementNames#SECURITY_IMPLIED_VOLATILITY}
   */
  public BlackDiscountingImpliedVolatilityFXOptionFunction() {
