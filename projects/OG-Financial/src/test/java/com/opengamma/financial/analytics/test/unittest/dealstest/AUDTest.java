...
import com.opengamma.financial.analytics.test.IRSwapTradeParserTest;
...
/**
 * Unit tests for AUD cme deals
 */
@Test(groups = TestGroup.UNIT)
public class AUDTest {
  
private static final Logger s_logger = LoggerFactory.getLogger(AUDTest.class);
private static final String CURRENCY="AUD";

private static final String ON_NAME="AUD_AONIA_1D_ERS";
private static final String THREE_MONTH_NAME="AUD_BBSW_3M_ERS";
private static final String SIX_MONTH_NAME="AUD_BBSW_6M_ERS";
...
final static Currency ccy=Currency.AUD;
...
private static final PresentValueCalculator PVC = PresentValueCalculator.getInstance();
  ...
  public void test() throws Exception {
    ...
    Resource resourceDeal = ResourceUtils.createResource("classpath:com/opengamma/financial/analytics/test/Trades14Oct.csv"); 
    List<IRSwapSecurity> trades = tradeParser.parseCSVFile(resourceDeal.getURL());
