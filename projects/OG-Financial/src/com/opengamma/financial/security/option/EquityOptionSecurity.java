...
public class EquityOptionSecurity extends com.opengamma.financial.security.FinancialSecurity implements java.io.Serializable {
  ...
  protected EquityOptionSecurity (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    try {
      ...
      throw new IllegalArgumentException ("Fudge message is not a EquityOptionSecurity - field 'optionType' is not OptionType enum", e);
    }
    fudgeField = fudgeMsg.getByName (STRIKE_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a EquityOptionSecurity - field 'strike' is not present");
    try {
      _strike = fudgeMsg.getFieldValue (Double.class, fudgeField);
    }
    catch (IllegalArgumentException e) {
      throw new IllegalArgumentException ("Fudge message is not a EquityOptionSecurity - field 'strike' is not double", e);
    }
    fudgeField = fudgeMsg.getByName (CURRENCY_KEY);
    if (fudgeField == null) throw new IllegalArgumentException ("Fudge message is not a EquityOptionSecurity - field 'currency' is not present");
    try {
      _currency = fudgeMsg.getFieldValue (com.opengamma.util.money.Currency.class, fudgeField);
    }
    catch (IllegalArgumentException e) {
      throw new IllegalArgumentException ("Fudge message is not a EquityOptionSecurity - field 'currency' is not Currency typedef", e);
    }
  ...
  public EquityOptionSecurity (com.opengamma.id.UniqueId uniqueId, String name, String securityType, com.opengamma.id.IdentifierBundle identifiers, com.opengamma.financial.security.option.OptionType optionType, double strike, com.opengamma.util.money.Currency currency, com.opengamma.id.Identifier underlyingIdentifier, com.opengamma.financial.security.option.ExerciseType exerciseType, com.opengamma.util.time.Expiry expiry, double pointValue, String exchange) {
