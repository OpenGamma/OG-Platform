...
public class FXBarrierOptionSecurity extends com.opengamma.financial.security.FinancialSecurity implements java.io.Serializable {
  ...
  public FXBarrierOptionSecurity (com.opengamma.id.UniqueId uniqueId, String name, String securityType, com.opengamma.id.IdentifierBundle identifiers, com.opengamma.util.money.Currency putCurrency, com.opengamma.util.money.Currency callCurrency, double putAmount, double callAmount, com.opengamma.util.time.Expiry expiry, javax.time.calendar.ZonedDateTime settlementDate, com.opengamma.financial.security.option.BarrierType barrierType, com.opengamma.financial.security.option.BarrierDirection barrierDirection, com.opengamma.financial.security.option.MonitoringType monitoringType, com.opengamma.financial.security.option.SamplingFrequency samplingFrequency, double barrierLevel, boolean isLong) {
