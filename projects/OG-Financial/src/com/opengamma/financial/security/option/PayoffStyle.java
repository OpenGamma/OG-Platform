...
// Created from com/opengamma/financial/security/option/PayoffStyle.proto:9(19)
...
public abstract class PayoffStyle implements java.io.Serializable {
  ...
  protected PayoffStyle (final org.fudgemsg.FudgeMsg fudgeMsg) {
  }
  ...
  public static PayoffStyle fromFudgeMsg (final org.fudgemsg.FudgeMsg fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.financial.security.option.PayoffStyle".equals (className)) break;
      try {
        return (com.opengamma.financial.security.option.PayoffStyle)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeMsg.class).invoke (null, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
