...
public class NonDeliverableFXForwardSecurity extends FinancialSecurity {
  ...
  public NonDeliverableFXForwardSecurity(Currency payCurrency, double payAmount, Currency receiveCurrency, double receiveAmount, ZonedDateTime forwardDate, ExternalId region) {
    super(SECURITY_TYPE);
