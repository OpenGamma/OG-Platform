...
public class CommodityNotional extends com.opengamma.financial.security.swap.Notional implements java.io.Serializable {
  ...
  protected CommodityNotional (final org.fudgemsg.FudgeMsg fudgeMsg) {
    super (fudgeMsg);
  }
  ...
  public static CommodityNotional fromFudgeMsg (final org.fudgemsg.FudgeMsg fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.financial.security.swap.CommodityNotional".equals (className)) break;
      try {
        return (com.opengamma.financial.security.swap.CommodityNotional)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeMsg.class).invoke (null, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
