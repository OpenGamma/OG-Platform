...
// Created from com/opengamma/financial/security/swap/Notional.proto:33(10)
...
public class InterestRateNotional extends com.opengamma.financial.security.swap.Notional implements java.io.Serializable {
  ...
  protected InterestRateNotional (final org.fudgemsg.FudgeMsg fudgeMsg) {
    super (fudgeMsg);
  ...
  public static InterestRateNotional fromFudgeMsg (final org.fudgemsg.FudgeMsg fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.financial.security.swap.InterestRateNotional".equals (className)) break;
      try {
        return (com.opengamma.financial.security.swap.InterestRateNotional)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeMsg.class).invoke (null, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
