...
public class ForwardSwapSecurity extends com.opengamma.financial.security.swap.SwapSecurity implements java.io.Serializable {
  ...
  protected ForwardSwapSecurity (final org.fudgemsg.FudgeFieldContainer fudgeMsg) {
    super (fudgeMsg);
    ...
    try {
      _forwardStartDate = com.opengamma.financial.security.DateTimeWithZone.fromFudgeMsg (fudgeMsg.getFieldValue (org.fudgemsg.FudgeFieldContainer.class, fudgeField));
    }
  ...
  public void toFudgeMsg (final org.fudgemsg.FudgeMsgFactory fudgeContext, final org.fudgemsg.MutableFudgeFieldContainer msg) {
    ...
    if (_forwardStartDate != null)  {
      final org.fudgemsg.MutableFudgeFieldContainer fudge1 = org.fudgemsg.mapping.FudgeSerializationContext.addClassHeader (fudgeContext.newMessage (), _forwardStartDate.getClass (), com.opengamma.financial.security.DateTimeWithZone.class);
      _forwardStartDate.toFudgeMsg (fudgeContext, fudge1);
      msg.add (FORWARD_START_DATE_KEY, null, fudge1);
    }
  }
  public static ForwardSwapSecurity fromFudgeMsg (final org.fudgemsg.FudgeFieldContainer fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.financial.security.swap.ForwardSwapSecurity".equals (className)) break;
      try {
        return (com.opengamma.financial.security.swap.ForwardSwapSecurity)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeFieldContainer.class).invoke (null, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
