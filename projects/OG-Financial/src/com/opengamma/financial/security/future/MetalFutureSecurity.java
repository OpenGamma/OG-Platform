...
public class MetalFutureSecurity extends com.opengamma.financial.security.future.CommodityFutureSecurity implements java.io.Serializable {
  ...
  protected MetalFutureSecurity (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField != null)  {
      try {
        ...
        throw new IllegalArgumentException ("Fudge message is not a MetalFutureSecurity - field 'underlyingIdentifier' is not ExternalId message", e);
      }
    }
  }
  public MetalFutureSecurity (com.opengamma.id.UniqueId uniqueId, String name, String securityType, com.opengamma.id.ExternalIdBundle identifiers, com.opengamma.util.time.Expiry expiry, String tradingExchange, String settlementExchange, com.opengamma.util.money.Currency currency, double unitAmount, String commodityType, Double unitNumber, String unitName, com.opengamma.id.ExternalId underlyingIdentifier) {
  ...
  protected MetalFutureSecurity (final MetalFutureSecurity source) {
    super (source);
  ...
  public MetalFutureSecurity clone () {
    return new MetalFutureSecurity (this);
  }
  ...
  public static MetalFutureSecurity fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
    final java.util.List<org.fudgemsg.FudgeField> types = fudgeMsg.getAllByOrdinal (0);
    for (org.fudgemsg.FudgeField field : types) {
      final String className = (String)field.getValue ();
      if ("com.opengamma.financial.security.future.MetalFutureSecurity".equals (className)) break;
      try {
        return (com.opengamma.financial.security.future.MetalFutureSecurity)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializationContext.class, org.fudgemsg.FudgeMsg.class).invoke (null, fudgeContext, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
    }
    return new MetalFutureSecurity (fudgeContext, fudgeMsg);
  }
  ...
  public boolean equals (final Object o) {
    ...
    if (!(o instanceof MetalFutureSecurity)) return false;
    MetalFutureSecurity msg = (MetalFutureSecurity)o;
    if (_underlyingIdentifier != null) {
