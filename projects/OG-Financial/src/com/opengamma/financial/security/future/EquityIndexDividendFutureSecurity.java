...
public class EquityIndexDividendFutureSecurity extends com.opengamma.financial.security.future.EquityFutureSecurity implements java.io.Serializable {
  ...
  protected EquityIndexDividendFutureSecurity (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
    super (fudgeContext, fudgeMsg);
  }
  public EquityIndexDividendFutureSecurity (com.opengamma.id.UniqueIdentifier uniqueId, String name, String securityType, com.opengamma.id.IdentifierBundle identifiers, com.opengamma.util.time.Expiry expiry, String tradingExchange, String settlementExchange, com.opengamma.util.money.Currency currency, double unitAmount, javax.time.calendar.ZonedDateTime settlementDate, com.opengamma.id.Identifier underlyingIdentifier) {
  ...
  public static EquityIndexDividendFutureSecurity fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializationContext fudgeContext, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (org.fudgemsg.FudgeField field : types) {
      ...
      try {
        return (com.opengamma.financial.security.future.EquityIndexDividendFutureSecurity)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializationContext.class, org.fudgemsg.FudgeMsg.class).invoke (null, fudgeContext, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
    }
    return new EquityIndexDividendFutureSecurity (fudgeContext, fudgeMsg);
  }
