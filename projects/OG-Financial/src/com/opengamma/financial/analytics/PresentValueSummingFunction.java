 ...
 */
public class PresentValueSummingFunction extends FilteringSummingFunction implements FinancialSecurityVisitor<Boolean> {

  public PresentValueSummingFunction() {
    super(ValueRequirementNames.PRESENT_VALUE, Collections.<String>emptySet());
  }
