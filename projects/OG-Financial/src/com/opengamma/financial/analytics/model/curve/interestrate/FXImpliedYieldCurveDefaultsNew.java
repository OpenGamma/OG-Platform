...
public class FXImpliedYieldCurveDefaultsNew extends DefaultPropertyFunction {
  ...
  public FXImpliedYieldCurveDefaultsNew(final String absoluteTolerance, final String relativeTolerance, final String maxIterations, final String decomposition,
