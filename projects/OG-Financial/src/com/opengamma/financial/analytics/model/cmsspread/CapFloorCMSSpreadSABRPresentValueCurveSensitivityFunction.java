 ...
 * 
 */
public class CapFloorCMSSpreadSABRPresentValueCurveSensitivityFunction extends CapFloorCMSSpreadSABRFunction {
  private final PresentValueCurveSensitivityCalculator _calculator;

  public CapFloorCMSSpreadSABRPresentValueCurveSensitivityFunction(final String currency, final String definitionName, String forwardCurveName, String fundingCurveName) {
    this(Currency.of(currency), definitionName, forwardCurveName, fundingCurveName);
  }

  public CapFloorCMSSpreadSABRPresentValueCurveSensitivityFunction(final Currency currency, final String definitionName, String forwardCurveName, String fundingCurveName) {
    super(currency, definitionName, forwardCurveName, fundingCurveName);
    _calculator = PresentValueCurveSensitivitySABRCalculator.getInstance();
  }
