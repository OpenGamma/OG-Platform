 ...
 * 
 */
public class ForexSingleBarrierOptionPresentValueCurveSensitivityFunction extends ForexSingleBarrierOptionFunction {
  ...
  public ForexSingleBarrierOptionPresentValueCurveSensitivityFunction(final String putFundingCurveName, final String putForwardCurveName, final String callFundingCurveName,
  ...
  protected Set<ComputedValue> getResult(final InstrumentDerivative fxSingleBarrierOption, final SmileDeltaTermStructureDataBundle data, final FunctionInputs inputs, final ComputationTarget target) {
    ...
    final MultipleCurrencyInterestRateCurveSensitivity result = CALCULATOR.visit(fxSingleBarrierOption, data);
