...
public class ForexOptionBlackDeltaPnLFunction extends AbstractFunction.NonCompiledInvoker {
  ...
  public Set<ValueRequirement> getRequirements(final FunctionCompilationContext context, final ComputationTarget target, final ValueRequirement desiredValue) {
    ...
    final Set<String> putCurveCalculationConfigs = constraints.getValues(ForexOptionBlackFunctionNew.PUT_CURVE_CALC_CONFIG);
    ...
    final Set<String> callCurveCalculationConfigs = constraints.getValues(ForexOptionBlackFunctionNew.CALL_CURVE_CALC_CONFIG);
    ...
    final ValueProperties properties = ValueProperties.builder()
        .with(ValuePropertyNames.CALCULATION_METHOD, ForexOptionBlackFunctionNew.BLACK_METHOD)
        .with(ForexOptionBlackFunctionNew.PUT_CURVE, putCurveName)
        .with(ForexOptionBlackFunctionNew.PUT_CURVE_CALC_CONFIG, putCurveCalculationConfig)
        .with(ForexOptionBlackFunctionNew.CALL_CURVE, callCurveName)
        .with(ForexOptionBlackFunctionNew.CALL_CURVE_CALC_CONFIG, callCurveCalculationConfig)
        .with(ValuePropertyNames.SURFACE, surfaceName)
        .with(InterpolatedDataProperties.X_INTERPOLATOR_NAME, interpolatorName)
        .with(InterpolatedDataProperties.LEFT_X_EXTRAPOLATOR_NAME, leftExtrapolatorName)
