...
public class SABRPresentValueCapFloorCMSSpreadFunction extends SABRPresentValueFunction {
  ...
  public SABRPresentValueCapFloorCMSSpreadFunction(final String currency, final String definitionName, String forwardCurveName, String fundingCurveName) {
    this(Currency.of(currency), definitionName, forwardCurveName, fundingCurveName);
  }

  public SABRPresentValueCapFloorCMSSpreadFunction(final Currency currency, final String definitionName, String forwardCurveName, String fundingCurveName) {
