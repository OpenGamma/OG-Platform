...
public class InterestRateInstrumentPV01Function extends InterestRateInstrumentFunction {
  ...
  public Set<ValueSpecification> getResults(final ComputationTarget target, final String forwardCurveName, final String fundingCurveName, final String curveCalculationMethod) {
    return Sets.newHashSet(getResultSpec(target, forwardCurveName, forwardCurveName, fundingCurveName), 
        getResultSpec(target, fundingCurveName, forwardCurveName, fundingCurveName));
  }
