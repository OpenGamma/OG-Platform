 ...
 * 
 */
public abstract class CapFloorSABRFunction extends AbstractFunction.NonCompiledInvoker {
  ...
  public CapFloorSABRFunction(final String currency, final String definitionName, final String useSABRExtrapolation, String forwardCurveName, String fundingCurveName) {
    this(Currency.of(currency), definitionName, Boolean.parseBoolean(useSABRExtrapolation), forwardCurveName, fundingCurveName);
  }

  public CapFloorSABRFunction(final Currency currency, final String definitionName, final boolean useSABRExtrapolation, String forwardCurveName, String fundingCurveName) {
  ...
  protected CapFloorSecurityConverter getVisitor() {
    return _capFloorVisitor;
  }
