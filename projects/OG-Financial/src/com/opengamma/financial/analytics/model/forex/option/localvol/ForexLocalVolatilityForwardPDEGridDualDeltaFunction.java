 ...
 * 
 */
public class ForexLocalVolatilityForwardPDEGridDualDeltaFunction extends ForexLocalVolatilityForwardPDEFunction {

  public ForexLocalVolatilityForwardPDEGridDualDeltaFunction(final String blackSmileInterpolatorName) {
    super(blackSmileInterpolatorName);
  }

  @Override
  protected String getRequirementName() {
    return ValueRequirementNames.GRID_DUAL_DELTA;
  }
