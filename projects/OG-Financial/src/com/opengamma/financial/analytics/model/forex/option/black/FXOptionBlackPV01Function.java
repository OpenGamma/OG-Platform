 ...
 * 
 */
public class FXOptionBlackPV01Function extends AbstractFunction.NonCompiledInvoker {
  ...
  public Set<ValueRequirement> getRequirements(final FunctionCompilationContext context, final ComputationTarget target, final ValueRequirement desiredValue) {
    ...
    final Set<String> putCurveConfigs = constraints.getValues(FXOptionBlackFunction.PUT_CURVE_CALC_CONFIG);
    if (putCurveConfigs == null || putCurveConfigs.size() != 1) {
      return null;
    }
    final Set<String> callCurveConfigs = constraints.getValues(FXOptionBlackFunction.CALL_CURVE_CALC_CONFIG);
  ...
  private ValueRequirement getCurveSensitivitiesRequirement(final String putCurveName, final String callCurveName, final String putCurveConfig,
    ...
    final ValueProperties properties = ValueProperties.builder()
        ...
        .with(ValuePropertyNames.CURRENCY, FXOptionBlackSingleValuedFunction.getResultCurrency(target)).get();
