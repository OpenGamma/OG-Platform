...
public class ParRateFixedFloatSwapFunction extends AbstractFunction implements FunctionInvoker {
  ...
  public ParRateFixedFloatSwapFunction(final String currency, final String name) {
    this(Currency.getInstance(currency), name);
  }

  public ParRateFixedFloatSwapFunction(final Currency currency, final String name) {
