...
public class BondMarketCleanPriceFunction extends BondFunction {
  ...
  @Override
  protected Set<ComputedValue> getComputedValues(final FunctionExecutionContext context, final CurrencyUnit currency, final Security security, final BondDefinition bond, final Object value,
