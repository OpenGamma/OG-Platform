 ...
 * 
 */
public class JensenAlphaDefaultPropertiesFunction extends DefaultPropertyFunction {
  ...
  public JensenAlphaDefaultPropertiesFunction(final String samplingPeriodName, final String scheduleCalculatorName, final String samplingFunctionName,
  ...
  protected void getDefaults(final PropertyDefaults defaults) {
    defaults.addValuePropertyName(ValueRequirementNames.JENSENS_ALPHA, ValuePropertyNames.SAMPLING_PERIOD);
    defaults.addValuePropertyName(ValueRequirementNames.JENSENS_ALPHA, ValuePropertyNames.SCHEDULE_CALCULATOR);
    defaults.addValuePropertyName(ValueRequirementNames.JENSENS_ALPHA, ValuePropertyNames.SAMPLING_FUNCTION);
    defaults.addValuePropertyName(ValueRequirementNames.JENSENS_ALPHA, ValuePropertyNames.RETURN_CALCULATOR);
    defaults.addValuePropertyName(ValueRequirementNames.JENSENS_ALPHA, ValuePropertyNames.STD_DEV_CALCULATOR);
    defaults.addValuePropertyName(ValueRequirementNames.JENSENS_ALPHA, ValuePropertyNames.EXCESS_RETURN_CALCULATOR);
    defaults.addValuePropertyName(ValueRequirementNames.JENSENS_ALPHA, ValuePropertyNames.COVARIANCE_CALCULATOR);
    defaults.addValuePropertyName(ValueRequirementNames.JENSENS_ALPHA, ValuePropertyNames.VARIANCE_CALCULATOR);
  }
