 ...
 *
 */
public class FXForwardThetaDefaults extends FXForwardDefaults {
  private final String _defaultNumberOfDays;

  public FXForwardThetaDefaults(final String priority, final String defaultNumberOfDays, final String... currencyCurveConfigAndDiscountingCurveNames) {
    super(priority, currencyCurveConfigAndDiscountingCurveNames);
