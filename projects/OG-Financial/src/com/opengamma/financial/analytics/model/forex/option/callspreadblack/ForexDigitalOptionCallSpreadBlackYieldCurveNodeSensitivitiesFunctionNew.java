 ...
 * 
 */
public class ForexDigitalOptionCallSpreadBlackYieldCurveNodeSensitivitiesFunctionNew extends AbstractFunction.NonCompiledInvoker {
  private static final Logger s_logger = LoggerFactory.getLogger(ForexDigitalOptionCallSpreadBlackYieldCurveNodeSensitivitiesFunctionNew.class);
  ...
  public Set<ComputedValue> execute(final FunctionExecutionContext executionContext, final FunctionInputs inputs, final ComputationTarget target, final Set<ValueRequirement> desiredValues) {
    ...
    final String spread = desiredValue.getConstraint(ForexDigitalOptionCallSpreadBlackFunctionNew.PROPERTY_CALL_SPREAD_VALUE);
  ...
  public Set<ValueRequirement> getRequirements(final FunctionCompilationContext context, final ComputationTarget target, final ValueRequirement desiredValue) {
    ...
    final Set<String> spreads = constraints.getValues(ForexDigitalOptionCallSpreadBlackFunctionNew.PROPERTY_CALL_SPREAD_VALUE);
  ...
  private ValueProperties getResultProperties() {
    return createValueProperties()
        ...
        .with(ValuePropertyNames.CALCULATION_METHOD, ForexDigitalOptionCallSpreadBlackFunctionNew.CALL_SPREAD_BLACK_METHOD)
        ...
        .withAny(ForexDigitalOptionCallSpreadBlackFunctionNew.PROPERTY_CALL_SPREAD_VALUE).get();
  }
  ...
  private ValueProperties getResultProperties(final String ccy, final String curveName, final String putCurveName, final String putForwardCurveName,
    ...
    return createValueProperties()
        ...
        .with(ForexDigitalOptionCallSpreadBlackFunctionNew.PROPERTY_CALL_SPREAD_VALUE, spread)
  ...
  private ValueRequirement getCurveSensitivitiesRequirement(final String putCurveName, final String putForwardCurveName, final String putCurveCalculationMethod, final String callCurveName,
    ...
    final ValueProperties properties = ValueProperties.builder()
        ...
        .with(InterpolatedDataProperties.LEFT_X_EXTRAPOLATOR_NAME, leftExtrapolatorName)
        .with(InterpolatedDataProperties.RIGHT_X_EXTRAPOLATOR_NAME, rightExtrapolatorName)
        .with(ValuePropertyNames.CURRENCY, ForexDigitalOptionCallSpreadBlackSingleValuedFunctionNew.getResultCurrency(target))
        .with(ForexDigitalOptionCallSpreadBlackFunctionNew.PROPERTY_CALL_SPREAD_VALUE, spread).get();
