...
public class ExternallyProvidedSensitivitiesCreditFactorsFunction extends AbstractFunction.NonCompiledInvoker {
  ...
  public Set<ValueSpecification> getResults(final FunctionCompilationContext context, final ComputationTarget target) {
    ...
    Set<ValueSpecification> results = Collections.singleton(new ValueSpecification(CREDIT_SENSITIVITIES_REQUIREMENT, target.toSpecification(), externalProperties.get()));
  ...
  public Set<ValueSpecification> getResults(final FunctionCompilationContext context, final ComputationTarget target, final Map<ValueSpecification, ValueRequirement> inputs) {
    ...
    Set<ValueSpecification> results = Collections.singleton(new ValueSpecification(CREDIT_SENSITIVITIES_REQUIREMENT, targetSpec, createCurrencyValueProperties(target).get()));
  ...
  private Set<ComputedValue> getResultsForExternalRiskFactors(SecuritySource secSource, FunctionInputs inputs, ComputationTarget target, RawSecurity security) {
    ...
    ValueSpecification valueSpecification = new ValueSpecification(CREDIT_SENSITIVITIES_REQUIREMENT, target.toSpecification(), createCurrencyValueProperties(target).get());
