...
public abstract class TreynorRatioFunction extends AbstractFunction implements FunctionInvoker {
  ...
  public TreynorRatioFunction(final String expectedAssetReturnCalculatorName, final String expectedRiskFreeReturnCalculator, final String startDate) {
    Validate.notNull(expectedAssetReturnCalculatorName, "expected excess return calculator name");
    Validate.notNull(expectedRiskFreeReturnCalculator, "standard deviation calculator name");
    ...
    final Function<double[], Double> standardDeviationCalculator = StatisticsCalculatorFactory.getCalculator(expectedRiskFreeReturnCalculator);
    _treynorRatio = new TreynorRatioCalculator(WORKING_DAYS_PER_YEAR, new DoubleTimeSeriesStatisticsCalculator(expectedExcessReturnCalculator),
