...
public class AliasedHistoricalTimeSeriesLatestPortfolioNodeValueFunction extends AliasedHistoricalTimeSeriesLatestValueFunction {
   ...
   * @param aliasedValueRequirementName  the value requirement name under which to expose the output, not null
   */
  public AliasedHistoricalTimeSeriesLatestPortfolioNodeValueFunction(String htsDataField, String ageLimit, String aliasedValueRequirementName) {
    super(htsDataField, Period.parse(ageLimit), aliasedValueRequirementName, ComputationTargetType.PORTFOLIO_NODE);
  }
