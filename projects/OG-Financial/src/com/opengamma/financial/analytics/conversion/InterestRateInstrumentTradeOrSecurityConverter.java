...
public class InterestRateInstrumentTradeOrSecurityConverter {
  private final FinancialSecurityVisitor<FixedIncomeInstrumentConverter<?>> _securityVisitor;
  ...
  public InterestRateInstrumentTradeOrSecurityConverter(final HolidaySource holidaySource, final ConventionBundleSource conventionSource, final RegionSource regionSource,
    ...
    _securityVisitor = FinancialSecurityVisitorAdapter.<FixedIncomeInstrumentConverter<?>>builder()
  ...
  public FixedIncomeInstrumentConverter<?> visit(final Trade trade) {
  ...
  public FixedIncomeInstrumentConverter<?> visit(final Security security) {
