 ...
 */
public class PV01SummingFunction extends FilteringSummingFunction implements FinancialSecurityVisitor<Boolean> {

  public PV01SummingFunction() {
    super(ValueRequirementNames.PV01, Collections.<String>emptySet());
  }
