...
public interface VolatilitySurfaceDefinitionSource {
   ...
   */
  VolatilitySurfaceDefinition<?, ?> getDefinition(Currency currency, String name, String instrumentType);
   ...
   * @return the definition, null if not found
   */
  VolatilitySurfaceDefinition<?, ?> getDefinition(Currency currency, String name, Instant version, String instrumentType);
