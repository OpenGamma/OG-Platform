...
public class SecurityToFixedIncomeFutureDefinitionConverter implements FutureSecurityVisitor<FixedIncomeFutureInstrumentDefinition<?>> {
  ...
  public SecurityToFixedIncomeFutureDefinitionConverter(final HolidaySource holidaySource, final ConventionBundleSource conventionSource,
  ...
  public FixedIncomeFutureInstrumentDefinition<?> visitBondFutureSecurity(final BondFutureSecurity security) {
    throw new OpenGammaRuntimeException("Cannot construct a FixedIncomeInstrumentDefinition from an BondFutureSecurity");
  }
