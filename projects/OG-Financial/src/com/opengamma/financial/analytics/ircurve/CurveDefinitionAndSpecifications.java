...
//    }
  ...
  public static YieldCurveDefinition buildFundingCurve(Currency ccy, Tenor[] liborStrips, Tenor[] tenorSwaps) {
    final Collection<FixedIncomeStrip> strips = new ArrayList<FixedIncomeStrip>();
    ...
    final YieldCurveDefinition definition = new YieldCurveDefinition(ccy, "FUNDING", Interpolator1DFactory.DOUBLE_QUADRATIC, strips);
    return definition;
  }
  ...
  public static Map<String, Map<Currency, YieldCurveDefinition>> buildStandardCurveDefintions() {
    ...
    forwardDefinitions.put(usd, buildForwardCurve(usd, makeShortEnd(true, false, true), Tenor.ofYears(1), 3, makeLongEnd(2, 15, new int[] {20, 25, 30, 40, 50, 60 })));
    fundingDefinitions.put(usd, buildFundingCurve(usd, makeShortEnd(true, false, true), makeLongEnd(1, 10, new int[] {12, 15, 20, 25, 30 })));
    singleDefinitions.put(usd, buildSingleCurve(usd, makeShortEnd(true, false, true), Tenor.ofYears(1), 3, makeLongEnd(2, 15, new int[] {20, 25, 30, 40, 50, 60 })));
    Currency eur = Currency.getInstance("EUR");
    forwardDefinitions.put(eur, buildForwardCurve(eur, makeShortEnd(false, false, false), Tenor.ofYears(1), 3, makeLongEnd(2, 15, new int[] {20, 25, 30, 40, 50, 60 })));
    fundingDefinitions.put(eur, buildFundingCurve(eur, makeShortEnd(false, false, false), makeLongEnd(1, 15, new int[] {20, 25, 30, 40, 50 })));
    singleDefinitions.put(eur, buildSingleCurve(eur, makeShortEnd(false, false, false), Tenor.ofYears(1), 3, makeLongEnd(2, 15, new int[] {20, 25, 30, 40, 50, 60 })));
    Currency gbp = Currency.getInstance("GBP");
    forwardDefinitions.put(gbp, buildForwardCurve(gbp, makeShortEnd(true, false, true), Tenor.ofYears(1), 3, makeLongEnd(2, 15, new int[] {20, 25, 30, 40, 50, 60 })));
  ...
  public static CurveSpecificationBuilderConfiguration buildStandardCurveSpecificationBuilderConfiguration(String generalPrefix, String futurePrefix, String swapPostfix, String basisSwapPostfix,
    ...
    if (includeOvernight) {
      liborRateInstrumentProviders.put(Tenor.ofDays(1), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, generalPrefix + "00O/N Index")));
    }
    if (includeSpotNext) {
      liborRateInstrumentProviders.put(Tenor.ofDays(3), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, generalPrefix + "00S/N Index")));
    }
    liborRateInstrumentProviders.put(Tenor.ofDays(7), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, generalPrefix + "0001W Index")));
    if (include2W) {
      liborRateInstrumentProviders.put(Tenor.ofDays(14), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, generalPrefix + "0002W Index")));
    }
    for (int i = 1; i <= 12; i++) {
      liborRateInstrumentProviders.put(Tenor.ofMonths(i), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, generalPrefix + "00" + (i < 10 ? "0" : "") + i + "M Index")));
    }
    ...
    for (int i = 1; i <= swapMonthCodes.length; i++) { // i here is 1-based so Jan=1, Dec=12.
      swapInstrumentProviders.put(Tenor.ofMonths(i), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, generalPrefix + "SW" + swapMonthCodes[i-1] + " Curncy"))); // no postfix here.
    }
    for (int i = 1; i <= swapsEndContiguousYears; i++) {
      swapInstrumentProviders.put(Tenor.ofYears(i), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, generalPrefix + "SW" + i + swapPostfix + " Curncy")));
    }
    ...
    for (int i : basisSwapsMonths) { // i here is 1-based so Jan=1, Dec=12.
      tenorSwapInstrumentProviders.put(Tenor.ofMonths(i), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, generalPrefix + basisSwapPostfix + monthCodes[i-1] + " Curncy")));
    }
    for (int i=1 ; i <= basisSwapsEndContiguousYears; i++) {
      tenorSwapInstrumentProviders.put(Tenor.ofYears(i), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, generalPrefix + basisSwapPostfix + i + " Curncy")));
    }
  ...
  public static CurveSpecificationBuilderConfiguration buildUSDCurveSpecificationBuilderConfiguration() {
    final Map<Tenor, CurveInstrumentProvider> liborRateInstrumentProviders = new LinkedHashMap<Tenor, CurveInstrumentProvider>();
    liborRateInstrumentProviders.put(Tenor.ofDays(1), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, "US00O/N Index")));
    liborRateInstrumentProviders.put(Tenor.ofDays(7), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, "US0001W Index")));
    liborRateInstrumentProviders.put(Tenor.ofDays(14), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, "US0002W Index")));
    for (int i = 1; i <= 12; i++) {
    ...
    for (final int i : availableYears) {
      swapInstrumentProviders.put(Tenor.ofYears(i), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, "USSW" + i + " Curncy")));
    }
    ...
    for (final int i : tenorAvailableYears) {
      tenorSwapInstrumentProviders.put(Tenor.ofYears(i), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, "USBG" + i + " Curncy")));
    }
  ...
  public static CurveSpecificationBuilderConfiguration buildTestConfiguration() {
    ...
    cashInstrumentProviders.put(Tenor.ofDays(1), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, "US00O/N Curncy")));
    cashInstrumentProviders.put(Tenor.ofDays(7), new StaticCurveInstrumentProvider(Identifier.of(IdentificationScheme.BLOOMBERG_TICKER, "US0001W Curncy")));
