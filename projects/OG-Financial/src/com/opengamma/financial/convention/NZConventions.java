  ...
  public static synchronized void addFixedIncomeInstrumentConventions(final ConventionBundleMaster conventionMaster) {
    ...
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("NZ0003M Index"), ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZD LIBOR 3m"),
            ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDLIBORP3M")), "NZD LIBOR 3m", act365, following, Period.ofMonths(3), 2, false, null);
    conventionMaster.addConventionBundle(
    ...
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("NZ0006M Index"), ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZD LIBOR 6m"),
            ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDLIBORP6M")), "NZD LIBOR 6m", act365, following, Period.ofMonths(6), 2, false, null);
    conventionMaster.addConventionBundle(
    ...
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("NZ0012M Index"), ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZD LIBOR 12m"),
            ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDLIBORP12M")), "NZD LIBOR 12m", act365, following, Period.ofMonths(12), 2, false, null);
    ...
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP1D", act365, following, Period.ofDays(1), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP1M", act365, modified, Period.ofMonths(1), 2, false, null);
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP2M", act365, modified, Period.ofMonths(2), 2, false, null);
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP3M", act365, modified, Period.ofMonths(3), 2, false, null);
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP4M", act365, modified, Period.ofMonths(4), 2, false, null);
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP5M", act365, modified, Period.ofMonths(5), 2, false, null);
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP6M", act365, modified, Period.ofMonths(6), 2, false, null);
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP7M", act365, modified, Period.ofMonths(7), 2, false, null);
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP8M", act365, modified, Period.ofMonths(8), 2, false, null);
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP9M", act365, modified, Period.ofMonths(9), 2, false, null);
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP10M", act365, modified, Period.ofMonths(10), 2, false, null);
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP11M", act365, modified, Period.ofMonths(1), 2, false, null);
    conventionMaster.addConventionBundle(
        ...
        "NZDCASHP12M", act365, modified, Period.ofMonths(12), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP2Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP2Y")),
        "NZDSWAPP2Y", act365, modified, Period.ofYears(2), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP3Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP3Y")),
        "NZDSWAPP3Y", act365, modified, Period.ofYears(3), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP4Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP4Y")),
        "NZDSWAPP4Y", act365, modified, Period.ofYears(4), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP5Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP5Y")),
        "NZDSWAPP5Y", act365, modified, Period.ofYears(5), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP6Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP6Y")),
        "NZDSWAPP6Y", act365, modified, Period.ofYears(6), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP7Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP7Y")),
        "NZDSWAPP7Y", act365, modified, Period.ofYears(7), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP8Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP8Y")),
        "NZDSWAPP8Y", act365, modified, Period.ofYears(8), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP9Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP9Y")),
        "NZDSWAPP9Y", act365, modified, Period.ofYears(9), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP10Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP10Y")),
        "NZDSWAPP10Y", act365, modified, Period.ofYears(10), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP12Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP12Y")),
        "NZDSWAPP12Y", act365, modified, Period.ofYears(12), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP15Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP15Y")),
        "NZDSWAPP15Y", act365, modified, Period.ofYears(15), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP20Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP20Y")),
        "NZDSWAPP20Y", act365, modified, Period.ofYears(20), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP25Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP25Y")),
        "NZDSWAPP25Y", act365, modified, Period.ofYears(25), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP30Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP30Y")),
        "NZDSWAPP30Y", act365, modified, Period.ofYears(30), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP40Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP40Y")),
        "NZDSWAPP40Y", act365, modified, Period.ofYears(40), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP50Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP50Y")),
        "NZDSWAPP50Y", act365, modified, Period.ofYears(50), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "NZDSWAPP80Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "NZDSWAPP80Y")),
        "NZDSWAPP80Y", act365, modified, Period.ofYears(80), 2, false, null);
  }
}
