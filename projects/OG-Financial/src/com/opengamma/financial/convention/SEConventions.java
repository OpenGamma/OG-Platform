...
public class SEConventions {
  ...
  public static void addFixedIncomeInstrumentConventions(final ConventionBundleMaster conventionMaster) {
    ...
    final ExternalId dk = ExternalSchemes.financialRegionId("SE");
    ...
    utils.addConventionBundle(ExternalIdBundle.of(simpleNameSecurityId("SEK_SWAP")), "SEK_SWAP", thirty360, modified, annual, 1, dk, act360,
        modified, quarterly, 1, simpleNameSecurityId("SEK DEPOSIT 3m"), dk, true);
    utils.addConventionBundle(ExternalIdBundle.of(simpleNameSecurityId("SEK_3M_SWAP")), "SEK_3M_SWAP", thirty360, modified, annual, 2, dk,
        act360, modified, quarterly, 2, simpleNameSecurityId("SEK DEPOSIT 3m"), dk, true);
    utils.addConventionBundle(ExternalIdBundle.of(simpleNameSecurityId("SEK_6M_SWAP")), "SEK_6M_SWAP", thirty360, modified, annual, 2, dk,
        act360, modified, semiAnnual, 2, simpleNameSecurityId("SEK DEPOSIT 6m"), dk, true);
