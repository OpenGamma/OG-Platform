...
public class InMemoryConventionBundleMaster implements ConventionBundleMaster {
  ...
  private void addUSDFixedIncomeInstruments() {
    ...
    final Identifier usgb = Identifier.of(InMemoryRegionMaster.REGION_FILE_SCHEME_ISO2, "US+GB");
  ...
  private void addEURFixedIncomeInstruments() {
    ...
    final Identifier eu = Identifier.of(InMemoryRegionMaster.REGION_FILE_SCHEME_ISO2, "EU");
  ...
  private void addJPYFixedIncomeInstruments() {
    ...
    final Identifier jp = Identifier.of(InMemoryRegionMaster.REGION_FILE_SCHEME_ISO2, "JP");
  ...
  private void addCADFixedIncomeInstruments() {
    ...
    final Identifier ca = Identifier.of(InMemoryRegionMaster.REGION_FILE_SCHEME_ISO2, "CA");
  ...
  private void addGBPFixedIncomeInstruments() {
    ...
    final Identifier gb = Identifier.of(InMemoryRegionMaster.REGION_FILE_SCHEME_ISO2, "GB");
  ...
  private void addAUDFixedIncomeInstruments() {
    ...
    final Identifier au = Identifier.of(InMemoryRegionMaster.REGION_FILE_SCHEME_ISO2, "AU");
  ...
  private void addCHFFixedIncomeInstruments() {
    ...
    final Identifier ch = Identifier.of(InMemoryRegionMaster.REGION_FILE_SCHEME_ISO2, "CH");
