  ...
  private void addEUFixedIncomeInstruments() {
    ...
    addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("EU0003M Index"),
            ExternalId.of(SIMPLE_NAME_SCHEME, "EUR LIBOR 3m"), ExternalId.of(OG_SYNTHETIC_TICKER, "EURLIBORP3M")), "EUR LIBOR 3m", act360, modified,
        Period.ofMonths(3), 2, false, null);
    addConventionBundle(
    ...
    addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("EU0006M Index"),
            ExternalId.of(SIMPLE_NAME_SCHEME, "EUR LIBOR 6m"), ExternalId.of(OG_SYNTHETIC_TICKER, "EURLIBORP6M")), "EUR LIBOR 6m", act360, modified,
        Period.ofMonths(6), 2, false, null);
    addConventionBundle(
  ...
  private void addJPFixedIncomeInstruments() {
    ...
    addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("JY0003M Index"),
            ExternalId.of(SIMPLE_NAME_SCHEME, "JPY LIBOR 3m"), ExternalId.of(OG_SYNTHETIC_TICKER, "JPYLIBORP3M")), "JPY LIBOR 3m", act360, following,
        Period.ofMonths(3), 2, false, null);
    addConventionBundle(
    ...
    addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("JY0006M Index"),
            ExternalId.of(SIMPLE_NAME_SCHEME, "JPY LIBOR 6m"), ExternalId.of(OG_SYNTHETIC_TICKER, "JPYLIBORP6M")), "JPY LIBOR 6m", act360, following,
        Period.ofMonths(6), 2, false, null);
    addConventionBundle(
    ...
    addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("JY0012M Index"),
            ExternalId.of(SIMPLE_NAME_SCHEME, "JPY LIBOR 12m"), ExternalId.of(OG_SYNTHETIC_TICKER, "JPYLIBORP12M")), "JPY LIBOR 12m", act360, following,
        Period.ofMonths(12), 2, false, null);
