...
public class GBConventions {
  ...
  public static synchronized void addFixedIncomeInstrumentConventions(final ConventionBundleMaster conventionMaster) {
    ...
    conventionMaster.addConventionBundle(
        ...
        following, Period.ofDays(7), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        following, Period.ofDays(14), 0, false, null);
    conventionMaster.addConventionBundle(
    ...
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("BP0003M Index"), ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBP LIBOR 3m"),
            ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPLIBORP3M")), "GBP LIBOR 3m", act365, modified, Period.ofMonths(3), 0, false, null);
    conventionMaster.addConventionBundle(
    ...
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("BP0006M Index"), ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBP LIBOR 6m"),
            ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPLIBORP6M")), "GBP LIBOR 6m", act365, modified, Period.ofMonths(6), 0, false, null);
    conventionMaster.addConventionBundle(
    ...
    conventionMaster.addConventionBundle(
        ...
        modified, Period.ofMonths(11), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("BP0012M Index"), ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBP LIBOR 12m"),
            ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPLIBORP12M")), "GBP LIBOR 12m", act365, modified, Period.ofMonths(12), 0, false, null);
    conventionMaster.addConventionBundle(
    ...
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("BPFR0CI Curncy"), ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBP FRA 3x9")), "GBP FRA 3x9", act365,
        following, Period.ofMonths(6), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("BPFR0F1 Curncy"), ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBP FRA 6x12")), "GBP FRA 6x12", act365,
        following, Period.ofMonths(6), 2, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(SecurityUtils.bloombergTickerSecurityId("BPFR0I1C Curncy"), ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBP FRA 9x15")), "GBP FRA 9x15", act365,
        following, Period.ofMonths(6), 2, false, null);
    ...
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP1D", act365, following, Period.ofDays(1), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP1M", act365, modified, Period.ofMonths(1), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP2M", act365, modified, Period.ofMonths(2), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP3M", act365, modified, Period.ofMonths(3), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP4M", act365, modified, Period.ofMonths(4), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP5M", act365, modified, Period.ofMonths(5), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP6M", act365, modified, Period.ofMonths(6), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP7M", act365, modified, Period.ofMonths(7), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP8M", act365, modified, Period.ofMonths(8), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP9M", act365, modified, Period.ofMonths(9), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP10M", act365, modified, Period.ofMonths(10), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP11M", act365, modified, Period.ofMonths(1), 0, false, null);
    conventionMaster.addConventionBundle(
        ...
        "GBPCASHP12M", act365, modified, Period.ofMonths(12), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP2Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP2Y")),
        "GBPSWAPP2Y", act365, modified, Period.ofYears(2), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP3Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP3Y")),
        "GBPSWAPP3Y", act365, modified, Period.ofYears(3), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP4Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP4Y")),
        "GBPSWAPP4Y", act365, modified, Period.ofYears(4), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP5Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP5Y")),
        "GBPSWAPP5Y", act365, modified, Period.ofYears(5), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP6Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP6Y")),
        "GBPSWAPP6Y", act365, modified, Period.ofYears(6), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP7Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP7Y")),
        "GBPSWAPP7Y", act365, modified, Period.ofYears(7), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP8Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP8Y")),
        "GBPSWAPP8Y", act365, modified, Period.ofYears(8), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP9Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP9Y")),
        "GBPSWAPP9Y", act365, modified, Period.ofYears(9), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP10Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP10Y")),
        "GBPSWAPP10Y", act365, modified, Period.ofYears(10), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP12Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP12Y")),
        "GBPSWAPP12Y", act365, modified, Period.ofYears(12), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP15Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP15Y")),
        "GBPSWAPP15Y", act365, modified, Period.ofYears(15), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP20Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP20Y")),
        "GBPSWAPP20Y", act365, modified, Period.ofYears(20), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP25Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP25Y")),
        "GBPSWAPP25Y", act365, modified, Period.ofYears(25), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP30Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP30Y")),
        "GBPSWAPP30Y", act365, modified, Period.ofYears(30), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP40Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP40Y")),
        "GBPSWAPP40Y", act365, modified, Period.ofYears(40), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP50Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP50Y")),
        "GBPSWAPP50Y", act365, modified, Period.ofYears(50), 0, false, null);
    conventionMaster.addConventionBundle(
        ExternalIdBundle.of(ExternalId.of(InMemoryConventionBundleMaster.SIMPLE_NAME_SCHEME, "GBPSWAPP80Y"), ExternalId.of(InMemoryConventionBundleMaster.OG_SYNTHETIC_TICKER, "GBPSWAPP80Y")),
        "GBPSWAPP80Y", act365, modified, Period.ofYears(80), 0, false, null);
  }
