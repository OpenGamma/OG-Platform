...
public class CapFloorSecurityBuilder extends AbstractFudgeBuilder implements FudgeBuilder<CapFloorSecurity> {
  ...
  public MutableFudgeMsg buildMessage(FudgeSerializer serializer, CapFloorSecurity object) {
    ...
    CapFloorSecurityBuilder.toFudgeMsg(serializer, object, msg);
    return msg;
  }
  ...
  public static void fromFudgeMsg(FudgeDeserializer deserializer, FudgeMsg msg, CapFloorSecurity object) {
    ...
    object.setIsIbor(msg.getBoolean(IS_IBOR_KEY));
  }
