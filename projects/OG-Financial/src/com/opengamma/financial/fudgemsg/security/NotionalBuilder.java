 ...
 */
public class NotionalBuilder extends AbstractFudgeBuilder {
  ...
  public static class CommodityNotionalBuilder extends NotionalBuilder implements FudgeBuilder<CommodityNotional>  {
  ...
  public static class InterestRateNotionalBuilder extends NotionalBuilder implements FudgeBuilder<InterestRateNotional>  {
    /** Field name. */
  ...
  public static class SecurityNotionalBuilder extends NotionalBuilder implements FudgeBuilder<SecurityNotional>  {
    /** Field name. */
