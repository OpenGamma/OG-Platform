...
public class FXFutureSecurityBuilder extends AbstractFudgeBuilder implements FudgeBuilder<FXFutureSecurity> {
  ...
  public MutableFudgeMsg buildMessage(FudgeSerializer serializer, FXFutureSecurity object) {
    ...
    FXFutureSecurityBuilder.toFudgeMsg(serializer, object, msg);
    return msg;
  }
