 ...
 */
public class PayoffStyleBuilder extends AbstractFudgeBuilder {
  ...
  public static class AssetOrNothingPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<AssetOrNothingPayoffStyle>  {
  ...
  public static class AsymmetricPoweredPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<AsymmetricPoweredPayoffStyle>  {
    /** Field name. */
  ...
  public static class BarrierPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<BarrierPayoffStyle>  {
  ...
  public static class CappedPoweredPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<CappedPoweredPayoffStyle>  {
    /** Field name. */
    public static final String POWER_KEY = "power";
    /** Field name. */
  ...
  public static class CashOrNothingPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<CashOrNothingPayoffStyle>  {
    /** Field name. */
  ...
  public static class ExtremeSpreadPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<ExtremeSpreadPayoffStyle>  {
    /** Field name. */
  ...
  public static class FadeInPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<FadeInPayoffStyle>  {
    /** Field name. */
  ...
  public static class FixedStrikeLookbackPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<FixedStrikeLookbackPayoffStyle>  {
  ...
  public static class FloatingStrikeLookbackPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<FloatingStrikeLookbackPayoffStyle>  {
  ...
  public static class GapPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<GapPayoffStyle>  {
    /** Field name. */
    public static final String PAYMENT_KEY = "payment";
  ...
  public static class PoweredPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<PoweredPayoffStyle>  {
    /** Field name. */
    public static final String POWER_KEY = "power";
  ...
  public static class SimpleChooserPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<SimpleChooserPayoffStyle>  {
    /** Field name. */
  ...
  public static class SupersharePayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<SupersharePayoffStyle>  {
    /** Field name. */
    public static final String LOWER_BOUND_KEY = "lowerBound";
    /** Field name. */
    public static final String UPPER_BOUND_KEY = "upperBound";
  ...
  public static class VanillaPayoffStyleBuilder extends PayoffStyleBuilder implements FudgeBuilder<VanillaPayoffStyle>  {
