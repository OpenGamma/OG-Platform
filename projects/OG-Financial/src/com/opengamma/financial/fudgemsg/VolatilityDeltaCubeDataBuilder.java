 ...
 * 
 */
@FudgeBuilderFor(VolatilityDeltaCubeData.class)
public class VolatilityDeltaCubeDataBuilder implements FudgeBuilder<VolatilityDeltaCubeData<Object, Object, Object>> {
  ...
  @Override
  public MutableFudgeMsg buildMessage(final FudgeSerializer serializer, final VolatilityDeltaCubeData<Object, Object, Object> object) {
    final MutableFudgeMsg message = serializer.newMessage();
    FudgeSerializer.addClassHeader(message, VolatilityDeltaCubeData.class);
    for (final Map.Entry<Triple<Object, Object, Object>, Double> entry : object.getVolatilityPoints().entrySet()) {
      ...
      serializer.addToMessage(data, DELTA_FIELD, null, entry.getKey().getThird());
  ...
  @Override
  public VolatilityDeltaCubeData<Object, Object, Object> buildObject(final FudgeDeserializer deserializer, final FudgeMsg message) {
    ...
    for (final FudgeField dataField : dataFields) {
      ...
      final Object delta = deserializer.fieldValueToObject(Double.class, dataMsg.getByName(DELTA_FIELD));
    ...
    return new VolatilityDeltaCubeData<Object, Object, Object>(data);
  }
