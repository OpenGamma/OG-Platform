...
public class BloombergSwaptionVolatilitySurfaceInstrumentProviderBuilder implements FudgeBuilder<BloombergSwaptionVolatilitySurfaceInstrumentProvider> {
  ...
  @Override
  public MutableFudgeMsg buildMessage(FudgeSerializationContext context, BloombergSwaptionVolatilitySurfaceInstrumentProvider object) {
  ...
  @Override
  public BloombergSwaptionVolatilitySurfaceInstrumentProvider buildObject(FudgeDeserializationContext context, FudgeMsg message) {
