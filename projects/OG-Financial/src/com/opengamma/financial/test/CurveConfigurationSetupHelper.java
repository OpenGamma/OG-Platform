...
import com.opengamma.engine.config.DbMasterConfigSource;
...
public class CurveConfigurationSetupHelper {
  ...
  public CurveConfigurationSetupHelper() {
    ...
    DbMasterConfigSource configSource = _applicationContext.getBean("sharedConfigSource", DbMasterConfigSource.class);
    YieldCurveConfigPopulator.populateCurveDefinitionConfigMaster(configSource.getMaster(YieldCurveDefinition.class));
    YieldCurveConfigPopulator.populateCurveSpecificationBuilderConfigMaster(configSource.getMaster(CurveSpecificationBuilderConfiguration.class));
  ...
  public void tearDown() {
    // may need to delete config table data here
