...
public class BatchDataSearchResult extends DirectBean {
  ...
  /**
   * Gets the unique entry by {@code ComputationTargetSpecification}. Mainly useful in tests
   * because in general uniqueness cannot be assumed.
   *   
   * @param spec computation target
   * @return only result in batch DB for this computation target. Null if not found
   * @throws IllegalArgumentException if there is more than 1 entry in batch DB for the
   * given computation target
   */
  public ViewResultEntry getEntry(ComputationTargetSpecification spec) {
    ViewResultEntry result = null;
    for (ViewResultEntry item : _items) {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code BatchDataSearchResult}.
   * @return the meta-bean, not null
   */
  public static BatchDataSearchResult.Meta meta() {
    return BatchDataSearchResult.Meta.INSTANCE;
  }

  @Override
  public BatchDataSearchResult.Meta metaBean() {
    return BatchDataSearchResult.Meta.INSTANCE;
  }
  ...
  protected void propertySet(String propertyName, Object newValue) {
    switch (propertyName.hashCode()) {
      case -995747956:  // paging
        ...
        return;
      case 100526016:  // items
        setItems((List<ViewResultEntry>) newValue);
        return;
    }
   ...
   * @return the value of the property
   */
  public List<ViewResultEntry> getItems() {
    return _items;
  }
   ...
   */
  public void setItems(List<ViewResultEntry> items) {
    this._items.clear();
   ...
   * @return the property, not null
   */
  public final Property<List<ViewResultEntry>> items() {
  ...
  public static class Meta extends BasicMetaBean {
    ...
    private final MetaProperty<List<ViewResultEntry>> _items = DirectMetaProperty.ofReadWrite(this, "items", (Class) List.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BatchDataSearchResult createBean() {
      return new BatchDataSearchResult();
    }

    @Override
    public Class<? extends BatchDataSearchResult> beanType() {
      return BatchDataSearchResult.class;
    }
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<List<ViewResultEntry>> items() {
      return _items;
    }
