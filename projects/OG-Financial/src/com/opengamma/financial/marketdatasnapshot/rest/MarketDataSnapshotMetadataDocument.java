...
public class MarketDataSnapshotMetadataDocument extends AbstractDocument {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      MarketDataSnapshotMetadataDocument other = (MarketDataSnapshotMetadataDocument) obj;
  ...
  public static class Meta extends AbstractDocument.Meta {
    ...
    private final MetaProperty<UniqueIdentifier> _uniqueId = DirectMetaProperty.ofReadWrite(
        this, "uniqueId", MarketDataSnapshotMetadataDocument.class, UniqueIdentifier.class);
    /**
     * The meta-property for the {@code name} property.
     */
    private final MetaProperty<String> _name = DirectMetaProperty.ofReadWrite(
        this, "name", MarketDataSnapshotMetadataDocument.class, String.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends MarketDataSnapshotMetadataDocument> builder() {
      return new BasicBeanBuilder<MarketDataSnapshotMetadataDocument>(new MarketDataSnapshotMetadataDocument());
    }
