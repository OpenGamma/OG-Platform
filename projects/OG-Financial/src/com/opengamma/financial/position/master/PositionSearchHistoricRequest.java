...
/**
 * Request for searching for historic positions.
 * <p>
 ...
 */
@BeanDefinition
public class PositionSearchHistoricRequest extends DirectBean {
   ...
   */
  public PositionSearchHistoricRequest() {
  }
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code PositionSearchHistoricRequest}.
   * @return the meta-bean, not null
   */
  public static PositionSearchHistoricRequest.Meta meta() {
    return PositionSearchHistoricRequest.Meta.INSTANCE;
  }

  @Override
  public PositionSearchHistoricRequest.Meta metaBean() {
    return PositionSearchHistoricRequest.Meta.INSTANCE;
  }
  ...
  public static class Meta extends BasicMetaBean {
    ...
    @Override
    public PositionSearchHistoricRequest createBean() {
      return new PositionSearchHistoricRequest();
    }

    @Override
    public Class<? extends PositionSearchHistoricRequest> beanType() {
      return PositionSearchHistoricRequest.class;
    }
