...
public class FixedIncomeStripWithIdentifierBuilderTest extends FinancialTestBase {
  ...
  public void testCycle() {
    ...
    assertEquals(strip, cycleObject(FixedIncomeStripWithIdentifier.class, strip));
    strip = new FixedIncomeStripWithIdentifier(StripInstrumentType.FRA, Tenor.YEAR, Tenor.THREE_MONTHS, ExternalId.of(SecurityUtils.BLOOMBERG_TICKER, "USFR01C Curncy"));
    assertEquals(strip, cycleObject(FixedIncomeStripWithIdentifier.class, strip));
    strip = new FixedIncomeStripWithIdentifier(StripInstrumentType.SWAP, Tenor.YEAR, Tenor.THREE_MONTHS, ExternalId.of(SecurityUtils.BLOOMBERG_TICKER, "USSW1 Curncy"));
    assertEquals(strip, cycleObject(FixedIncomeStripWithIdentifier.class, strip));
