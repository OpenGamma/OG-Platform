...
public class InterpolatedYieldCurveSpecificationWithSecuritiesFudgeBuilderTest extends FinancialTestBase {
  ...
  public void testCycle() {
    ...
    final InterpolatedYieldCurveSpecificationWithSecurities spec = new InterpolatedYieldCurveSpecificationWithSecurities(LocalDate.now(), "FUNDING", Currency.USD, Interpolator1DFactory.LINEAR_INSTANCE, strips);
