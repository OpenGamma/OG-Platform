...
public class CurveSpecificationBuilderConfigurationBuilderTest extends FinancialTestBase {
  private static final Logger s_logger = LoggerFactory.getLogger(CurveSpecificationBuilderConfigurationBuilderTest.class);
