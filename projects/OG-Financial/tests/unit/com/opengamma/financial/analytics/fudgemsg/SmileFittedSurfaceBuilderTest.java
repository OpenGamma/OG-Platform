...
public class SmileFittedSurfaceBuilderTest extends AnalyticsTestBase {
  ...
  public void testSABRFittedDataPoints() {
    ...
    externalIds.put(Pair.of(Tenor.ONE_YEAR, Tenor.ONE_YEAR), new ExternalId[] {ExternalId.of("TEST", "USSV0101A"), ExternalId.of("TEST", "USSV0101B"), ExternalId.of("TEST", "USSV0101C"), ExternalId.of("TEST", "USSV0101D")});
    relativeStrikes.put(Pair.of(Tenor.ONE_YEAR, Tenor.ONE_YEAR), new Double[] {-100., -50., 0., 50.});
    externalIds.put(Pair.of(Tenor.ONE_YEAR, Tenor.ofYears(5)), new ExternalId[] {ExternalId.of("TEST", "USSV0105A"), ExternalId.of("TEST", "USSV0105B"), ExternalId.of("TEST", "USSV0105C"), ExternalId.of("TEST", "USSV0105D")});
    relativeStrikes.put(Pair.of(Tenor.ONE_YEAR, Tenor.ofYears(5)), new Double[] {-50., 0., 50., 100.});
    externalIds.put(Pair.of(Tenor.ofYears(5), Tenor.ONE_YEAR), new ExternalId[] {ExternalId.of("TEST", "USSV0501A"), ExternalId.of("TEST", "USSV0501B"), ExternalId.of("TEST", "USSV0501C"), ExternalId.of("TEST", "USSV0501D")});
    relativeStrikes.put(Pair.of(Tenor.ofYears(5), Tenor.ONE_YEAR), new Double[] {-50., 0., 50., 100.});
    externalIds.put(Pair.of(Tenor.ofYears(7), Tenor.ofYears(3)), new ExternalId[] {ExternalId.of("TEST", "USSV0703A"), ExternalId.of("TEST", "USSV0703B"), ExternalId.of("TEST", "USSV0703C"), ExternalId.of("TEST", "USSV0703D")});
