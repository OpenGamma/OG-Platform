...
public class InMemoryInterpolatedYieldCurveDefinitionMasterTest {
  ...
  public void testGetDefinition_versioned () {
    ...
    _master.update(new YieldCurveDefinitionDocument(UniqueId.of(_master.getIdentifierScheme(), "1_GBP"), new YieldCurveDefinition(Currency.GBP, null, "1", "E")));
    ...
    sleep();
    _master.remove(UniqueId.of(_master.getIdentifierScheme(), "3_GBP"));
  ...
  @Test
  public void testGet () {
    YieldCurveDefinitionDocument ycdoc = _master.get(UniqueId.of(_master.getIdentifierScheme(), "1_USD"));
    assertNotNull(ycdoc);
  ...
  public void testGet_missing () {
    _master.get(UniqueId.of(_master.getIdentifierScheme(), "GBP_3"));
  }
  
  @Test(expectedExceptions = DataNotFoundException.class)
  public void testGet_deleted () {
    _master.remove(UniqueId.of(_master.getIdentifierScheme(), "USD_1"));
    _master.get(UniqueId.of(_master.getIdentifierScheme(), "USD_1"));
  }
  
  @Test
  public void testRemove () {
    assertNotNull(_master.getDefinition(Currency.USD, "1"));
    _master.remove(UniqueId.of(_master.getIdentifierScheme(), "1_USD"));
    assertNull(_master.getDefinition(Currency.USD, "1"));
  }
  
  @Test(expectedExceptions = DataNotFoundException.class)
  public void testRemove_missing () {
    _master.remove(UniqueId.of(_master.getIdentifierScheme(), "3_USD"));
  }
  ...
  public void testUpdate_missing () {
    _master.update(new YieldCurveDefinitionDocument(UniqueId.of(_master.getIdentifierScheme(), "3_USD"), new YieldCurveDefinition(Currency.USD, null, "3", "E")));
  }
