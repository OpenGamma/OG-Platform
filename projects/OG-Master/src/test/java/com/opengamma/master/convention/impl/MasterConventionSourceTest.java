...
public class MasterConventionSourceTest {
  ...
  public void test_constructor_2arg_nullMaster() throws Exception {
    new MasterConventionSource(null, null);
  }
  ...
  public void test_getConvention_UniqueId_found() throws Exception {
    ConventionMaster mock = mock(ConventionMaster.class);
    
    ConventionDocument doc = new ConventionDocument(example());
    when(mock.get(OID, VC)).thenReturn(doc);
    MasterConventionSource test = new MasterConventionSource(mock, VC);
    Convention testResult = test.get(UID);
  ...
  //-------------------------------------------------------------------------
  public void test_getConventionsByExternalIdBundle() throws Exception {
    ConventionMaster mock = mock(ConventionMaster.class);
  ...
  //-------------------------------------------------------------------------
  public void test_getConvention_ExternalId() throws Exception {
    ConventionMaster mock = mock(ConventionMaster.class);
    ConventionSearchRequest request = new ConventionSearchRequest();
    request.addExternalId(ID1);
    request.addExternalId(ID2);
