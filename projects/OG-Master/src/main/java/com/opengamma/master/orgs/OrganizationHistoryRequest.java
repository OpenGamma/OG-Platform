 ...
 * <p/>
 * A full organization master implements historical storage of data.
 ...
 * A simple organization master might simply replace the original version with the corrected value.
 ...
 * <p/>
 * For example, a organization added on Monday and updated on Thursday has two versions.
...
@PublicSPI
@BeanDefinition
public class OrganizationHistoryRequest extends AbstractHistoryRequest {

  /**
   * Creates an instance.
   * The object identifier must be added before searching.
   */
  public OrganizationHistoryRequest() {
    super();
  }
   ...
   */
  public OrganizationHistoryRequest(final ObjectIdentifiable objectId) {
    super(objectId);
  }
   ...
   */
  public OrganizationHistoryRequest(final ObjectIdentifiable objectId, Instant versionInstant, Instant correctedToInstant) {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code OrganizationHistoryRequest}.
   * @return the meta-bean, not null
   */
  public static OrganizationHistoryRequest.Meta meta() {
    return OrganizationHistoryRequest.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(OrganizationHistoryRequest.Meta.INSTANCE);
  }

  @Override
  public OrganizationHistoryRequest.Meta metaBean() {
    return OrganizationHistoryRequest.Meta.INSTANCE;
  }
  ...
  public static class Meta extends AbstractHistoryRequest.Meta {
    ...
    @Override
    public BeanBuilder<? extends OrganizationHistoryRequest> builder() {
      return new DirectBeanBuilder<OrganizationHistoryRequest>(new OrganizationHistoryRequest());
    }

    @Override
    public Class<? extends OrganizationHistoryRequest> beanType() {
      return OrganizationHistoryRequest.class;
    }
