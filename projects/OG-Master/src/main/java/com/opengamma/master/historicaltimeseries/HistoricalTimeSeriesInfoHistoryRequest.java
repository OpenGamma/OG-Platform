...
public class HistoricalTimeSeriesInfoHistoryRequest extends AbstractHistoryRequest {
   ...
   */
  public HistoricalTimeSeriesInfoHistoryRequest(final ObjectIdentifiable objectId, Instant versionInstant, Instant correctedToInstant) {
  ...
  public String toString() {
    ...
    buf.append("HistoricalTimeSeriesInfoHistoryRequest{");
    int len = buf.length();
    toString(buf);
    if (buf.length() > len) {
