...
/**
 * Available sort orders for holidays.
 */
@PublicSPI
public enum HolidaySearchSortOrder implements Comparator<HolidayDocument> {
  ...
  OBJECT_ID_ASC {
    @Override
    public int compare(HolidayDocument obj1, HolidayDocument obj2) {
