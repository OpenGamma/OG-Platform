 ...
 * <p/>
 * A full role master implements historical storage of data.
 ...
 * A simple role master might simply replace the original version with the corrected value.
 ...
 * <p/>
 * For example, a role added on Monday and updated on Thursday has two versions.
...
@PublicSPI
@BeanDefinition
public class RoleHistoryRequest extends AbstractHistoryRequest {

  /**
   * Creates an instance.
   * The object identifier must be added before searching.
   */
  public RoleHistoryRequest() {
    super();
  }
   ...
   */
  public RoleHistoryRequest(final ObjectIdentifiable objectId) {
    super(objectId);
  }
   ...
   */
  public RoleHistoryRequest(final ObjectIdentifiable objectId, Instant versionInstant, Instant correctedToInstant) {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code RoleHistoryRequest}.
   * @return the meta-bean, not null
   */
  public static RoleHistoryRequest.Meta meta() {
    return RoleHistoryRequest.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(RoleHistoryRequest.Meta.INSTANCE);
  }

  @Override
  public RoleHistoryRequest.Meta metaBean() {
    return RoleHistoryRequest.Meta.INSTANCE;
  }
  ...
  public static class Meta extends AbstractHistoryRequest.Meta {
    ...
    @Override
    public BeanBuilder<? extends RoleHistoryRequest> builder() {
      return new DirectBeanBuilder<RoleHistoryRequest>(new RoleHistoryRequest());
    }

    @Override
    public Class<? extends RoleHistoryRequest> beanType() {
      return RoleHistoryRequest.class;
    }
