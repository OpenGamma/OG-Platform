...
public class MasterConventionSource extends AbstractMasterSource<Convention, ConventionDocument, ConventionMaster> implements ConventionSource {
  ...
  public Collection<Convention> get(final ExternalIdBundle bundle) {
    ...
    for (ManageableConvention manageableConvention : getSecuritiesInternal(bundle, getVersionCorrection())) {
  ...
  @Override
  public ManageableConvention getSingle(final ExternalIdBundle bundle) {
    ArgumentChecker.notNull(bundle, "bundle");
    Collection<ManageableConvention> conventions = getSecuritiesInternal(bundle, getVersionCorrection());
    // simply picks the first returned convention
    return conventions.isEmpty() ? null : conventions.iterator().next();
  }
  ...
  @Override
  public Map<ExternalIdBundle, Convention> getSingle(final Collection<ExternalIdBundle> bundle, final VersionCorrection versionCorrection) {
