...
/**
 * Request for the history of a organisation.
 * <p/>
 * A full organisation master implements historical storage of data.
 ...
 * A simple organisation master might simply replace the original version with the corrected value.
 ...
 * <p/>
 * For example, a organisation added on Monday and updated on Thursday has two versions.
...
@PublicSPI
@BeanDefinition
public class OrganisationHistoryRequest extends AbstractHistoryRequest {

  /**
   * Creates an instance.
   * The object identifier must be added before searching.
   */
  public OrganisationHistoryRequest() {
    super();
  }
   ...
   */
  public OrganisationHistoryRequest(final ObjectIdentifiable objectId) {
    super(objectId);
  }
   ...
   */
  public OrganisationHistoryRequest(final ObjectIdentifiable objectId, InstantProvider versionInstantProvider, InstantProvider correctedToInstantProvider) {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code OrganisationHistoryRequest}.
   * @return the meta-bean, not null
   */
  public static OrganisationHistoryRequest.Meta meta() {
    return OrganisationHistoryRequest.Meta.INSTANCE;
  }
  static {
    JodaBeanUtils.registerMetaBean(OrganisationHistoryRequest.Meta.INSTANCE);
  }

  @Override
  public OrganisationHistoryRequest.Meta metaBean() {
    return OrganisationHistoryRequest.Meta.INSTANCE;
  }
  ...
  public static class Meta extends AbstractHistoryRequest.Meta {
    ...
    @Override
    public BeanBuilder<? extends OrganisationHistoryRequest> builder() {
      return new DirectBeanBuilder<OrganisationHistoryRequest>(new OrganisationHistoryRequest());
    }

    @Override
    public Class<? extends OrganisationHistoryRequest> beanType() {
      return OrganisationHistoryRequest.class;
    }
