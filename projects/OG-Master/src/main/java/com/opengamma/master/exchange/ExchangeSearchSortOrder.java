...
/**
 * Available sort orders for exchanges.
 */
@PublicSPI
public enum ExchangeSearchSortOrder implements Comparator<ExchangeDocument> {
  ...
  OBJECT_ID_ASC {
    @Override
    public int compare(ExchangeDocument obj1, ExchangeDocument obj2) {
