 ...
 */
@PublicSPI
public interface HistoricalDataMaster {
   ...
   */
  HistoricalDataSearchResult search(HistoricalDataSearchRequest request);
   ...
   */
  HistoricalDataDocument get(UniqueIdentifier uniqueId);
   ...
   * @throws DataNotFoundException if there is no document with that unique identifier
   */
  HistoricalDataDocument get(HistoricalDataGetRequest request);
   ...
   * @throws IllegalArgumentException if the request is invalid
   */
  HistoricalDataDocument add(HistoricalDataDocument document);
   ...
   */
  HistoricalDataDocument update(HistoricalDataDocument document);
   ...
   * @return the search result, not null
   */
  HistoricalDataSearchHistoricResult searchHistoric(HistoricalDataSearchHistoricRequest request);
   ...
   * @throws DataNotFoundException if there is no document with that unique identifier
   */
  void appendTimeSeries(HistoricalDataDocument document);
