...
@PublicSPI
@BeanDefinition
public class HistoricalDataSearchHistoricRequest extends DirectBean {
   ...
   * Creates an instance.
   */
  public HistoricalDataSearchHistoricRequest() {
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code HistoricalDataSearchHistoricRequest}.
   * @return the meta-bean, not null
   */
  public static HistoricalDataSearchHistoricRequest.Meta meta() {
    return HistoricalDataSearchHistoricRequest.Meta.INSTANCE;
  }

  @Override
  public HistoricalDataSearchHistoricRequest.Meta metaBean() {
    return HistoricalDataSearchHistoricRequest.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      HistoricalDataSearchHistoricRequest other = (HistoricalDataSearchHistoricRequest) obj;
      return JodaBeanUtils.equal(getPagingRequest(), other.getPagingRequest()) &&
          JodaBeanUtils.equal(getHistoricalDataId(), other.getHistoricalDataId()) &&
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PagingRequest> _pagingRequest = DirectMetaProperty.ofReadWrite(
        this, "pagingRequest", HistoricalDataSearchHistoricRequest.class, PagingRequest.class);
    /**
    ...
    private final MetaProperty<UniqueIdentifier> _historicalDataId = DirectMetaProperty.ofReadWrite(
        this, "historicalDataId", HistoricalDataSearchHistoricRequest.class, UniqueIdentifier.class);
    /**
    ...
    private final MetaProperty<IdentifierBundle> _identifiers = DirectMetaProperty.ofReadWrite(
        this, "identifiers", HistoricalDataSearchHistoricRequest.class, IdentifierBundle.class);
    /**
    ...
    private final MetaProperty<LocalDate> _currentDate = DirectMetaProperty.ofReadWrite(
        this, "currentDate", HistoricalDataSearchHistoricRequest.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<String> _dataSource = DirectMetaProperty.ofReadWrite(
        this, "dataSource", HistoricalDataSearchHistoricRequest.class, String.class);
    /**
    ...
    private final MetaProperty<String> _dataProvider = DirectMetaProperty.ofReadWrite(
        this, "dataProvider", HistoricalDataSearchHistoricRequest.class, String.class);
    /**
    ...
    private final MetaProperty<String> _dataField = DirectMetaProperty.ofReadWrite(
        this, "dataField", HistoricalDataSearchHistoricRequest.class, String.class);
    /**
    ...
    private final MetaProperty<String> _observationTime = DirectMetaProperty.ofReadWrite(
        this, "observationTime", HistoricalDataSearchHistoricRequest.class, String.class);
    /**
    ...
    private final MetaProperty<Instant> _timestamp = DirectMetaProperty.ofReadWrite(
        this, "timestamp", HistoricalDataSearchHistoricRequest.class, Instant.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends HistoricalDataSearchHistoricRequest> builder() {
      return new DirectBeanBuilder<HistoricalDataSearchHistoricRequest>(new HistoricalDataSearchHistoricRequest());
    }

    @Override
    public Class<? extends HistoricalDataSearchHistoricRequest> beanType() {
      return HistoricalDataSearchHistoricRequest.class;
    }
