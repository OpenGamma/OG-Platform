...
public class HistoricalTimeSeriesInfo extends DirectBean {
   ...
   * Creates an instance.
   * 
   * @param document  the document to copy from, not null
   */
  public HistoricalTimeSeriesInfo(HistoricalTimeSeriesDocument document) {
    ManageableHistoricalTimeSeries series = document.getSeries();
    setIdentifiers(series.getIdentifiers());
    setDataSource(series.getDataSource());
    setDataProvider(series.getDataProvider());
    setDataField(series.getDataField());
    setObservationTime(series.getObservationTime());
  }
