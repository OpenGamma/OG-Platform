...
@PublicSPI
@BeanDefinition
public class HistoricalTimeSeriesSearchRequest extends DirectBean {
   ...
   */
  public HistoricalTimeSeriesSearchRequest(Identifier identifier) {
   ...
   */
  public HistoricalTimeSeriesSearchRequest(Iterable<Identifier> identifiers) {
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<PagingRequest> _pagingRequest = DirectMetaProperty.ofReadWrite(
        this, "pagingRequest", HistoricalTimeSeriesSearchRequest.class, PagingRequest.class);
    /**
    ...
    private final MetaProperty<List<Identifier>> _identifiers = DirectMetaProperty.ofReadWrite(
        this, "identifiers", HistoricalTimeSeriesSearchRequest.class, (Class) List.class);
    /**
