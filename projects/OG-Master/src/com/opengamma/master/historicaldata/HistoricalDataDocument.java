...
/**
 * A document used to pass into and out of the historical data master.
 * <p>
...
public class HistoricalDataDocument extends DirectBean implements UniqueIdentifiable, MutableUniqueIdentifiable {
  ...
  /**
   * The historical data unique identifier.
  ...
  //-------------------------------------------------------------------------
  /**
   * Converts the information to a {@code HistoricalDataInfo}.
   * 
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code HistoricalDataDocument}.
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the historical data unique identifier.
   * This field is managed by the master but must be set for updates.
  ...
  /**
   * Sets the historical data unique identifier.
   * This field is managed by the master but must be set for updates.
