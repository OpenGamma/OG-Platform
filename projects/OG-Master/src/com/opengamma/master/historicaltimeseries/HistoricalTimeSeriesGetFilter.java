...
public class HistoricalTimeSeriesGetFilter extends DirectBean {
   ...
   * This limits the number of returned points within the date range.
   * If the number is positive, the points are counted from the latest date backwards.
   * If the number is negative, the points are counted from the earliest date forwards.
   * Setting this to zero, returns an empty time-series.
   * The value one will therefore get the latest point, and minus one gets the earliest point.
   * @return the value of the property
   */
