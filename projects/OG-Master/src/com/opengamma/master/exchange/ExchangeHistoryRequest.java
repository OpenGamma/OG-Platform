...
public class ExchangeHistoryRequest extends AbstractHistoryRequest {
   ...
   */
  public ExchangeHistoryRequest(final ObjectIdentifiable objectId, InstantProvider versionInstantProvider, InstantProvider correctedToInstantProvider) {
  ...
  public static class Meta extends AbstractHistoryRequest.Meta {
    ...
    public BeanBuilder<? extends ExchangeHistoryRequest> builder() {
      return new BasicBeanBuilder<ExchangeHistoryRequest>(new ExchangeHistoryRequest());
    }
