...
public class SecurityMetaDataResult extends AbstractMetaDataResult {
  ...
  public static class Meta extends AbstractMetaDataResult.Meta {
    ...
    private final MetaProperty<List<String>> _securityTypes = DirectMetaProperty.ofReadWrite(this, "securityTypes", (Class) List.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public SecurityMetaDataResult createBean() {
      return new SecurityMetaDataResult();
    }
