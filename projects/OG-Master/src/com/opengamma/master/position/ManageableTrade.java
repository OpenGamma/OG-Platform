...
public class ManageableTrade extends DirectBean implements MutableUniqueIdentifiable {
  ...
  protected Object propertyGet(String propertyName) {
    switch (propertyName.hashCode()) {
      ...
      case -318440977:  // premuim
        return getPremuim();
      case -888803552:  // premuimCurrency
        return getPremuimCurrency();
  ...
  protected void propertySet(String propertyName, Object newValue) {
    switch (propertyName.hashCode()) {
      ...
      case 2064682670:  // providerKey
        ...
        return;
      case -318440977:  // premuim
        setPremuim((Double) newValue);
        return;
      case -888803552:  // premuimCurrency
        setPremuimCurrency((Currency) newValue);
        return;
      case 651701925:  // premiumDate
   ...
   * @param premuim  the new value of the property
   */
  public void setPremuim(Double premuim) {
    this._premuim = premuim;
  }

  /**
   * Gets the the {@code premuim} property.
   * @return the property, not null
   */
  public final Property<Double> premuim() {
    return metaBean().premuim().createProperty(this);
  }
   ...
   * @return the value of the property
   */
  public Currency getPremuimCurrency() {
    return _premuimCurrency;
  }

  /**
   * Sets currency of payment at time of purchase
   * @param premuimCurrency  the new value of the property
   */
  public void setPremuimCurrency(Currency premuimCurrency) {
    this._premuimCurrency = premuimCurrency;
  }

  /**
   * Gets the the {@code premuimCurrency} property.
   * @return the property, not null
   */
  public final Property<Currency> premuimCurrency() {
    return metaBean().premuimCurrency().createProperty(this);
  }
  ...
  public static class Meta extends BasicMetaBean {
    ...
    /**
     * The meta-property for the {@code premuim} property.
     */
    private final MetaProperty<Double> _premuim = DirectMetaProperty.ofReadWrite(this, "premuim", Double.class);
    /**
     * The meta-property for the {@code premuimCurrency} property.
     */
    private final MetaProperty<Currency> _premuimCurrency = DirectMetaProperty.ofReadWrite(this, "premuimCurrency", Currency.class);
    /**
    ...
    protected Meta() {
      ...
      temp.put("premuim", _premuim);
      temp.put("premuimCurrency", _premuimCurrency);
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<Double> premuim() {
      return _premuim;
    }
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<Currency> premuimCurrency() {
      return _premuimCurrency;
    }
