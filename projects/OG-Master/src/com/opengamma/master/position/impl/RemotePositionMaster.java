 ...
 */
public class RemotePositionMaster extends AbstractRemoteDocumentMaster<PositionDocument> implements PositionMaster {
  ...
  public void remove(final UniqueId uniqueId) {
    ...
    URI uri = (new DataPositionResource()).uri(getBaseUri(), uniqueId, null);
