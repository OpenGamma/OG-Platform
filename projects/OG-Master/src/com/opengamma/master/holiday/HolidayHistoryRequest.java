...
public class HolidayHistoryRequest extends AbstractHistoryRequest {
   ...
   */
  public HolidayHistoryRequest(final ObjectIdentifiable objectId) {
    super(objectId);
  }
   ...
   */
  public HolidayHistoryRequest(final ObjectIdentifiable objectId, InstantProvider versionInstantProvider, InstantProvider correctedToInstantProvider) {
  ...
  public static class Meta extends AbstractHistoryRequest.Meta {
    ...
    @Override
    public BeanBuilder<? extends HolidayHistoryRequest> builder() {
      return new DirectBeanBuilder<HolidayHistoryRequest>(new HolidayHistoryRequest());
    }
