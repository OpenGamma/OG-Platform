...
public class PortfolioHistoryRequest extends AbstractHistoryRequest {
   ...
   */
  public PortfolioHistoryRequest(final UniqueIdentifier oid) {
    this(oid, null, null);
  }
   ...
   */
  public PortfolioHistoryRequest(final UniqueIdentifier oid, InstantProvider versionInstantProvider) {
   ...
   */
  public PortfolioHistoryRequest(final UniqueIdentifier oid, InstantProvider versionInstantProvider, InstantProvider correctedToInstantProvider) {
    setObjectId(oid);
