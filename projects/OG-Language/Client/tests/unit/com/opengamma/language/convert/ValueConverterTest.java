...
public class ValueConverterTest extends AbstractConverterTest {
  ...
  public void testToValue() {
    ...
    assertValidConversion(_valueConverter, Boolean.TRUE, target, ValueUtil.of(true));
    assertValidConversion(_valueConverter, (Integer) 42, target, ValueUtil.of(42));
    assertValidConversion(_valueConverter, (Double) 3.14, target, ValueUtil.of(3.14));
    assertValidConversion(_valueConverter, "foo", target, ValueUtil.of("foo"));
    assertValidConversion(_valueConverter, FudgeContext.EMPTY_MESSAGE, target, ValueUtil.of(FudgeContext.EMPTY_MESSAGE));
    assertInvalidConversion(_valueConverter, DataUtil.of(42), target);
  ...
  public void testToBoolean() {
    ...
    assertEquals(true, _valueConverter.canConvertTo(target));
    assertValidConversion(_valueConverter, ValueUtil.of(true), target, Boolean.TRUE);
  ...
  public void testToInteger() {
    ...
    assertEquals(true, _valueConverter.canConvertTo(target));
    assertValidConversion(_valueConverter, ValueUtil.of(42), target, (Integer) 42);
    assertConversionCount(1, _valueConverter, target);
  }
  ...
  public void testToDouble() {
    ...
    assertEquals(true, _valueConverter.canConvertTo(target));
    assertValidConversion(_valueConverter, ValueUtil.of(3.14), target, (Double) 3.14);
    assertConversionCount(1, _valueConverter, target);
  }
  ...
  public void testToString() {
    ...
    assertEquals(true, _valueConverter.canConvertTo(target));
    assertValidConversion(_valueConverter, ValueUtil.of("foo"), target, "foo");
    assertConversionCount(1, _valueConverter, target);
  }
