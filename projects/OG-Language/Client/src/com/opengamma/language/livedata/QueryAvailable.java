...
// Created from com/opengamma/language/livedata/QueryAvailable.proto:12(10)
...
public class QueryAvailable extends com.opengamma.language.connector.LiveData implements java.io.Serializable {
  ...
  public static QueryAvailable fromFudgeMsg (final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (org.fudgemsg.FudgeField field : types) {
      ...
      try {
        return (com.opengamma.language.livedata.QueryAvailable)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeMsg.class).invoke (null, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
