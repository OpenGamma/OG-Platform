...
public class QueryAvailable extends com.opengamma.language.connector.LiveData implements java.io.Serializable {
  ...
  public static QueryAvailable fromFudgeMsg (final org.fudgemsg.FudgeFieldContainer fudgeMsg) {
    ...
    for (org.fudgemsg.FudgeField field : types) {
      ...
      try {
        return (com.opengamma.language.livedata.QueryAvailable)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeFieldContainer.class).invoke (null, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
