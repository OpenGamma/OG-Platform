...
public class Available extends com.opengamma.language.connector.Procedure implements java.io.Serializable {
  ...
  public static class Entry implements java.io.Serializable {
    ...
    protected Entry (final org.fudgemsg.FudgeMsg fudgeMsg) {
      ...
      try {
        _definition = com.opengamma.language.procedure.Definition.fromFudgeMsg (fudgeMsg.getFieldValue (org.fudgemsg.FudgeMsg.class, fudgeField));
      }
      catch (IllegalArgumentException e) {
    ...
    public static Entry fromFudgeMsg (final org.fudgemsg.FudgeMsg fudgeMsg) {
      ...
      for (org.fudgemsg.FudgeField field : types) {
        ...
        try {
          return (com.opengamma.language.procedure.Available.Entry)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeMsg.class).invoke (null, fudgeMsg);
        }
        catch (Throwable t) {
          // no-action
        }
    ...
    if (fudgeFields.size () > 0)  {
      ...
      for (org.fudgemsg.FudgeField fudge2 : fudgeFields) {
        try {
          ...
          fudge3 = com.opengamma.language.procedure.Available.Entry.fromFudgeMsg (fudgeMsg.getFieldValue (org.fudgemsg.FudgeMsg.class, fudge2));
          fudge1.add (fudge3);
        }
        catch (IllegalArgumentException e) {
  ...
  public static Available fromFudgeMsg (final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (org.fudgemsg.FudgeField field : types) {
      ...
      try {
        return (com.opengamma.language.procedure.Available)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.FudgeMsg.class).invoke (null, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
