...
public class Invoke extends com.opengamma.language.connector.Procedure implements java.io.Serializable {
  public <T1,T2> T1 accept (final ProcedureVisitor<T1,T2> visitor, final T2 data) throws com.opengamma.language.async.AsynchronousExecution { return visitor.visitInvoke (this, data); }
  ...
  public static Invoke fromFudgeMsg (final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.language.procedure.Invoke".equals (className)) break;
      try {
        return (com.opengamma.language.procedure.Invoke)Class.forName (className).getDeclaredMethod ("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializer.class, org.fudgemsg.FudgeMsg.class).invoke (null, deserializer, fudgeMsg);
      }
      catch (Throwable t) {
        // no-action
      }
