...
public class UserMessagePayloadAdapter<T1, T2> implements UserMessagePayloadVisitor<T1, T2> {
  ...
  @Override
  public T1 visitUserMessagePayload(final UserMessagePayload payload, final T2 data) {
    return getUnderlying().visitUserMessagePayload(payload, data);
  }

  @Override
  public T1 visitTest(final Test message, final T2 data) {
    return getUnderlying().visitTest(message, data);
  }

  @Override
  public T1 visitLiveData(final LiveData message, final T2 data) {
    return getUnderlying().visitLiveData(message, data);
  }

  @Override
  public T1 visitFunction(final Function message, final T2 data) {
    return getUnderlying().visitFunction(message, data);
  }

  @Override
  public T1 visitProcedure(final Procedure message, final T2 data) {
