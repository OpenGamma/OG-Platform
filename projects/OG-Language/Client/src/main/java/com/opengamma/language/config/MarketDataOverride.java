...
public class MarketDataOverride extends com.opengamma.language.config.ConfigurationItem implements java.io.Serializable {
  @Override
  public <T> T accept(final ConfigurationItemVisitor<T> visitor) {
    return visitor.visitMarketDataOverride(this);
  }
  ...
  public MarketDataOverride(final com.opengamma.engine.value.ValueRequirement valueRequirement) {
    if (valueRequirement == null)
      throw new NullPointerException("'valueRequirement' cannot be null");
    else {
  ...
  protected MarketDataOverride(final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    if (fudgeField == null)
      throw new IllegalArgumentException("Fudge message is not a MarketDataOverride - field 'valueRequirement' is not present");
    try {
  ...
  public MarketDataOverride(final com.opengamma.engine.value.ValueRequirement valueRequirement, final Object value, final com.opengamma.language.config.MarketDataOverride.Operation operation) {
    if (valueRequirement == null)
      throw new NullPointerException("'valueRequirement' cannot be null");
    else {
      _valueRequirement = valueRequirement;
  ...
  protected MarketDataOverride(final MarketDataOverride source) {
    ...
    if (source._valueRequirement == null)
      _valueRequirement = null;
    else {
  ...
  public static MarketDataOverride fromFudgeMsg(final org.fudgemsg.mapping.FudgeDeserializer deserializer, final org.fudgemsg.FudgeMsg fudgeMsg) {
    ...
    for (final org.fudgemsg.FudgeField field : types) {
      ...
      if ("com.opengamma.language.config.MarketDataOverride".equals(className))
        break;
      try {
        return (com.opengamma.language.config.MarketDataOverride) Class.forName(className).getDeclaredMethod("fromFudgeMsg", org.fudgemsg.mapping.FudgeDeserializer.class, org.fudgemsg.FudgeMsg.class)
  ...
  public void setValueRequirement(final com.opengamma.engine.value.ValueRequirement valueRequirement) {
    if (valueRequirement == null)
      throw new NullPointerException("'valueRequirement' cannot be null");
    else {
      _valueRequirement = valueRequirement;
  ...
  public void setOperation(final com.opengamma.language.config.MarketDataOverride.Operation operation) {
    _operation = operation;
  }
  ...
  public boolean equals(final Object o) {
    if (o == this)
      return true;
    if (!(o instanceof MarketDataOverride))
      return false;
    final MarketDataOverride msg = (MarketDataOverride) o;
    if (_valueRequirement != null) {
      if (msg._valueRequirement != null) {
        if (!_valueRequirement.equals(msg._valueRequirement))
          return false;
      }
      else
        return false;
    }
    else if (msg._valueRequirement != null)
      return false;
    if (_value != null) {
      if (msg._value != null) {
        if (!_value.equals(msg._value))
          return false;
      }
      else
        return false;
    }
    else if (msg._value != null)
      return false;
    if (_operation != null) {
      if (msg._operation != null) {
        if (!_operation.equals(msg._operation))
          return false;
      }
      else
        return false;
    }
    else if (msg._operation != null)
      return false;
  ...
  public int hashCode() {
    ...
    hc *= 31;
    if (_valueRequirement != null)
      hc += _valueRequirement.hashCode();
    hc *= 31;
    if (_value != null)
      hc += _value.hashCode();
    hc *= 31;
    if (_operation != null)
      hc += _operation.hashCode();
    return hc;
  }
