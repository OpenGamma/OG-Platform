...
public class VolatilityCubeTensorTest {
  ...
  private ManageableVolatilityCubeSnapshot createSnapshot() {
    ...
    values.put(new VolatilityPoint(Tenor.DAY, Tenor.MONTH, 0), new ValueSnapshot(0.2, 0.25));
    values.put(new VolatilityPoint(Tenor.MONTH, Tenor.MONTH, 4.2), new ValueSnapshot(null, 0.35));
  ...
  public void testUpdateMarketValue() {
    ...
    assertValue(snapshot, Tenor.MONTH, Tenor.DAY, 0, 0.6, null);
    assertValue(snapshot, Tenor.DAY, Tenor.MONTH, 0, 0.7, 0.25);
    assertValue(snapshot, Tenor.MONTH, Tenor.MONTH, 0, 0.8, null);
    assertValue(snapshot, Tenor.DAY, Tenor.DAY, 4.2, 0.9, null);
    assertValue(snapshot, Tenor.MONTH, Tenor.DAY, 4.2, 1.0, null);
    assertValue(snapshot, Tenor.DAY, Tenor.MONTH, 4.2, 1.1, null);
    assertValue(snapshot, Tenor.MONTH, Tenor.MONTH, 4.2, 1.2, 0.35);
  }
  ...
  public void testUpdateOverrideValue() {
    ...
    assertValue(snapshot, Tenor.MONTH, Tenor.DAY, 0, null, 0.6);
    assertValue(snapshot, Tenor.DAY, Tenor.MONTH, 0, 0.2, 0.7);
    assertValue(snapshot, Tenor.MONTH, Tenor.MONTH, 0, null, 0.8);
    assertValue(snapshot, Tenor.DAY, Tenor.DAY, 4.2, null, 0.9);
    assertValue(snapshot, Tenor.MONTH, Tenor.DAY, 4.2, null, 1.0);
    assertValue(snapshot, Tenor.DAY, Tenor.MONTH, 4.2, null, 1.1);
    assertValue(snapshot, Tenor.MONTH, Tenor.MONTH, 4.2, null, 1.2);
  }
  ...
  public void testUpdateMixedValue() {
    ...
    assertValue(snapshot, Tenor.MONTH, Tenor.DAY, 0, 1.4, 0.6);
    assertValue(snapshot, Tenor.DAY, Tenor.MONTH, 0, 1.5, 0.7);
    assertValue(snapshot, Tenor.MONTH, Tenor.MONTH, 0, 1.6, 0.8);
    assertValue(snapshot, Tenor.DAY, Tenor.DAY, 4.2, 1.7, 0.9);
    assertValue(snapshot, Tenor.MONTH, Tenor.DAY, 4.2, 1.8, 1.0);
    assertValue(snapshot, Tenor.DAY, Tenor.MONTH, 4.2, 1.9, 1.1);
    assertValue(snapshot, Tenor.MONTH, Tenor.MONTH, 4.2, 2.0, 1.2);
  }
