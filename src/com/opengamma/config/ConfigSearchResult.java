...
/**
 * Result from searching config docs.
 * 
 * @param <T> Type of Document 
 */
@BeanDefinition
public class ConfigSearchResult<T> extends DirectBean {
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code ConfigSearchResult<T>}.
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the list of matched config documents.
   * @return the value of the property
   */
