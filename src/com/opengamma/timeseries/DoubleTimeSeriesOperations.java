...
public class DoubleTimeSeriesOperations {
   ...
   */
  public static DoubleTimeSeries unionOperate(final DoubleTimeSeries a, final DoubleTimeSeries b, final BinaryOperator operator) {
    final Set<ZonedDateTime> unionTimes = new TreeSet<ZonedDateTime>(a.times());
    unionTimes.addAll(b.times());
    final int max = unionTimes.size();
    final long[] times = new long[max];
    final double[] values = new double[max];
    final TimeZone[] zones = new TimeZone[max];
    int pos = 0;
    for (final ZonedDateTime dateTime : unionTimes) {
      final Double valueA = a.getDataPoint(dateTime);
      final Double valueB = b.getDataPoint(dateTime);
      times[pos] = dateTime.toInstant().toEpochMillisLong();
   ...
   */
  public static DoubleTimeSeries operate(final DoubleTimeSeries a, final DoubleTimeSeries b, final BinaryOperator operator) {
    final int max = Math.max(a.size(), b.size());
    final long[] times = new long[max];
    final double[] values = new double[max];
    final TimeZone[] zones = new TimeZone[max];
    int pos = 0;
    for (final Entry<ZonedDateTime, Double> entry : a) {
      final Double valueB = b.getDataPoint(entry.getKey());
      if (valueB != null) {
        final double newValue = operator.operate(entry.getValue(), valueB);
        times[pos] = entry.getKey().toInstant().toEpochMillisLong();
        values[pos] = newValue;
        zones[pos] = entry.getKey().getZone();
        pos++;
      }
    }
    final long[] trimmedTimes = new long[pos];
    final double[] trimmedValues = new double[pos];
    final TimeZone[] trimmedZones = new TimeZone[pos];
   ...
   */
  public static DoubleTimeSeries operate(final DoubleTimeSeries a, final UnaryOperator operator) {
    final int size = a.size();
    final long[] times = new long[size];
    final double[] values = new double[size];
    final TimeZone[] zones = new TimeZone[size];
    final int pos = 0;
    for (final Entry<ZonedDateTime, Double> entry : a) {
      times[pos] = entry.getKey().toInstant().toEpochMillisLong();
   ...
   * @return
   */
  public static DoubleTimeSeries operate(final DoubleTimeSeries a, final double b, final BinaryOperator operator) {
    final int size = a.size();
    final long[] times = new long[size];
    final double[] values = new double[size];
    final TimeZone[] zones = new TimeZone[size];
   ...
   */
  public static DoubleTimeSeries unionAdd(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries add(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries add(final DoubleTimeSeries a, final double b) {
    return operate(a, b, s_addOperator);
  }
   ...
   */
  public static DoubleTimeSeries unionSubtract(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries subtract(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   * @return supplied time series with each element subtracted by a scalar value
   */
  public static DoubleTimeSeries subtract(final DoubleTimeSeries a, final double b) {
    return operate(a, b, s_subtractOperator);
  }
   ...
   */
  public static DoubleTimeSeries unionMultiply(final DoubleTimeSeries a, final DoubleTimeSeries b) {
    return unionOperate(a, b, s_addOperator);
  }
   ...
   */
  public static DoubleTimeSeries multiply(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries multiply(final DoubleTimeSeries a, final double b) {
    return operate(a, b, s_multiplyOperator);
  }
   ...
   */
  public static DoubleTimeSeries unionDivide(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries divide(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries divide(final DoubleTimeSeries a, final double b) {
    return operate(a, b, s_divideOperator);
  }
   ...
   */
  public static DoubleTimeSeries unionPow(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries pow(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries pow(final DoubleTimeSeries a, final double b) {
    return operate(a, b, s_powerOperator);
  }
   ...
   */
  public static DoubleTimeSeries unionMin(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries min(final DoubleTimeSeries a, final DoubleTimeSeries b) {
    return operate(a, b, s_minimumOperator);
  }

  public static DoubleTimeSeries min(final DoubleTimeSeries a, final double b) {
    return operate(a, b, s_minimumOperator);
  }
   ...
   */
  public static DoubleTimeSeries unionMax(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries max(final DoubleTimeSeries a, final DoubleTimeSeries b) {
    return operate(a, b, s_maximumOperator);
  }

  public static DoubleTimeSeries max(final DoubleTimeSeries a, final double b) {
    return operate(a, b, s_maximumOperator);
  }
   ...
   */
  public static DoubleTimeSeries unionAverage(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries average(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries intersectionFirstValues(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries intersectionSecondValues(final DoubleTimeSeries a, final DoubleTimeSeries b) {
   ...
   */
  public static DoubleTimeSeries negate(final DoubleTimeSeries a) {
   ...
   */
  public static DoubleTimeSeries reciprocal(final DoubleTimeSeries a) {
   ...
   */
  public static DoubleTimeSeries log(final DoubleTimeSeries a) {
   ...
   */
  public static DoubleTimeSeries log10(final DoubleTimeSeries a) {
   ...
   */
  public static DoubleTimeSeries abs(final DoubleTimeSeries a) {
   ...
   */
  public static double maxValue(final DoubleTimeSeries a) {
    if (a == null || a.isEmpty()) {
   ...
   */
  public static double minValue(final DoubleTimeSeries a) {
    if (a == null || a.isEmpty()) {
   ...
   * @return the resulting time series
   */
  public static DoubleTimeSeries lag(final DoubleTimeSeries a, final int lag) {
    ...
    final Iterator<ZonedDateTime> timeIter = a.timeIterator();
