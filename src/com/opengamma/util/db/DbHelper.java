...
public abstract class DbHelper {
   ...
   */
  public String sqlWildcardOperator(String str) {
   ...
   */
  public String sqlWildcardQuery(String prefix, String paramName, String value) {
    if (value == null) {
      return "";
   ...
   * @return the combined SQL, not null
   */
  public String sqlApplyPaging(String sqlSelectFromWhere, String sqlOrderBy, PagingRequest paging) {
