...
public class MapYearOffsetDoubleTimeSeries extends MutableYearOffsetDoubleTimeSeries.Long {
  ...
  public MapYearOffsetDoubleTimeSeries(final ZonedDateTime zeroDate) {
    super(new YearOffsetEpochMillisConverter(zeroDate), new FastMapLongDoubleTimeSeries(DateTimeNumericEncoding.TIME_EPOCH_MILLIS));
  }
  
  public MapYearOffsetDoubleTimeSeries(final java.util.TimeZone timeZone, final Date zeroDate) {
    super(new YearOffsetEpochMillisConverter(timeZone, zeroDate), new FastMapLongDoubleTimeSeries(DateTimeNumericEncoding.TIME_EPOCH_MILLIS));
  }
  
  public MapYearOffsetDoubleTimeSeries(final ZonedDateTime zeroDate, final Double[] dates, final double[] values) {
    super(new YearOffsetEpochMillisConverter(zeroDate), new FastMapLongDoubleTimeSeries(DateTimeNumericEncoding.TIME_EPOCH_MILLIS, new YearOffsetEpochMillisConverter(zeroDate).convertToLong(dates), values));
  }
  ...
  public MapYearOffsetDoubleTimeSeries(final java.util.TimeZone timeZone, Date zeroDate, final Double[] dates, final double[] values) {
    super(new YearOffsetEpochMillisConverter(timeZone, zeroDate), new FastMapLongDoubleTimeSeries(DateTimeNumericEncoding.TIME_EPOCH_MILLIS, new YearOffsetEpochMillisConverter(timeZone, zeroDate)
  ...
  public MapYearOffsetDoubleTimeSeries(final YearOffsetDoubleTimeSeries dts) {
    super(new YearOffsetEpochMillisConverter(((YearOffsetEpochMillisConverter)dts.getConverter()).getZonedOffset()), (FastMutableLongDoubleTimeSeries) new YearOffsetEpochMillisConverter(((YearOffsetEpochMillisConverter)dts.getConverter()).getZonedOffset()).convertToLong(new FastMapLongDoubleTimeSeries(DateTimeNumericEncoding.TIME_EPOCH_MILLIS), dts));
  }

  public MapYearOffsetDoubleTimeSeries(final ZonedDateTime zeroDate, final YearOffsetDoubleTimeSeries dts) {
    super(new YearOffsetEpochMillisConverter(zeroDate), (FastMutableLongDoubleTimeSeries) new YearOffsetEpochMillisConverter(zeroDate).convertToLong(new FastMapLongDoubleTimeSeries(DateTimeNumericEncoding.TIME_EPOCH_MILLIS), dts));
  }
  ...
  public MapYearOffsetDoubleTimeSeries(final java.util.TimeZone timeZone, final Date zeroDate, final YearOffsetDoubleTimeSeries dts) {
    super(new YearOffsetEpochMillisConverter(timeZone, zeroDate), (FastMutableLongDoubleTimeSeries) new YearOffsetEpochMillisConverter(timeZone, zeroDate).convertToLong(new FastMapLongDoubleTimeSeries(
