...
public class ListYearOffsetDoubleTimeSeries extends MutableYearOffsetDoubleTimeSeries.Long {
  ...
  public ListYearOffsetDoubleTimeSeries(final ZonedDateTime zeroDate, final Double[] dates, final double[] values) {
    super(new YearOffsetEpochMillisConverter(zeroDate), new FastListLongDoubleTimeSeries(DateTimeNumericEncoding.TIME_EPOCH_MILLIS, new YearOffsetEpochMillisConverter(zeroDate).convertToLong(dates), values));
  }
  ...
  public ListYearOffsetDoubleTimeSeries(final YearOffsetDoubleTimeSeries dts) {
    super(new YearOffsetEpochMillisConverter(((YearOffsetEpochMillisConverter)dts.getConverter()).getZonedOffset()), 
        (FastMutableLongDoubleTimeSeries) new YearOffsetEpochMillisConverter(((YearOffsetEpochMillisConverter)dts.getConverter()).getZonedOffset()).convertToLong(new FastListLongDoubleTimeSeries(DateTimeNumericEncoding.TIME_EPOCH_MILLIS), dts));
  }
  
  public ListYearOffsetDoubleTimeSeries(final ZonedDateTime zeroDate, final YearOffsetDoubleTimeSeries dts) {
    super(new YearOffsetEpochMillisConverter(zeroDate), (FastMutableLongDoubleTimeSeries) new YearOffsetEpochMillisConverter(zeroDate).convertToLong(new FastListLongDoubleTimeSeries(
  ...
  public ListYearOffsetDoubleTimeSeries(final java.util.TimeZone timeZone, final Date zeroDate, final YearOffsetDoubleTimeSeries dts) {
    super(new YearOffsetEpochMillisConverter(timeZone, zeroDate), (FastMutableLongDoubleTimeSeries) new YearOffsetEpochMillisConverter(timeZone, zeroDate).convertToLong(new FastListLongDoubleTimeSeries(
        DateTimeNumericEncoding.TIME_EPOCH_MILLIS), dts));
  }
