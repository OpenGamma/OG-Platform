...
public class ExcessContinuouslyCompoundedTimeSeriesReturnCalculator<T extends DoubleTimeSeries<?>> extends TimeSeriesReturnCalculator<T> {
  ...
  public ExcessContinuouslyCompoundedTimeSeriesReturnCalculator(final CalculationMode mode) {
    super(mode);
    _returnCalculator = new ContinuouslyCompoundedTimeSeriesReturnCalculator<T>(mode);
  }
