...
/**
 * Request for searching for historic nodes.
 * <p>
 ...
 * <p>
 * For example, a node added on Monday and updated on Thursday has two versions.
 ...
 */
@BeanDefinition
public class PortfolioNodeSearchHistoricRequest extends DirectBean {
   ...
   */
  public PortfolioNodeSearchHistoricRequest() {
  }
   ...
   */
  public PortfolioNodeSearchHistoricRequest(final UniqueIdentifier uid) {
    this(uid, null, null);
  }
   ...
   */
  public PortfolioNodeSearchHistoricRequest(final UniqueIdentifier uid, InstantProvider versionInstantProvider) {
   ...
   */
  public PortfolioNodeSearchHistoricRequest(final UniqueIdentifier uid, InstantProvider versionInstantProvider, InstantProvider correctedToInstantProvider) {
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code PortfolioNodeSearchHistoricRequest}.
   * @return the meta-bean, not null
   */
  public static PortfolioNodeSearchHistoricRequest.Meta meta() {
    return PortfolioNodeSearchHistoricRequest.Meta.INSTANCE;
  }

  @Override
  public PortfolioNodeSearchHistoricRequest.Meta metaBean() {
    return PortfolioNodeSearchHistoricRequest.Meta.INSTANCE;
  }
  ...
  public static class Meta extends BasicMetaBean {
    ...
    @Override
    public PortfolioNodeSearchHistoricRequest createBean() {
      return new PortfolioNodeSearchHistoricRequest();
    }

    @Override
    public Class<? extends PortfolioNodeSearchHistoricRequest> beanType() {
      return PortfolioNodeSearchHistoricRequest.class;
    }
