 ...
 */
@BeanDefinition
public class PortfolioSearchHistoricRequest extends DirectBean {
   ...
   */
  public PortfolioSearchHistoricRequest() {
  }
   ...
   */
  public PortfolioSearchHistoricRequest(final UniqueIdentifier uid) {
    this(uid, null, null);
  }
   ...
   */
  public PortfolioSearchHistoricRequest(final UniqueIdentifier uid, InstantProvider versionInstantProvider) {
   ...
   */
  public PortfolioSearchHistoricRequest(final UniqueIdentifier uid, InstantProvider versionInstantProvider, InstantProvider correctedToInstantProvider) {
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code PortfolioSearchHistoricRequest}.
   * @return the meta-bean, not null
   */
  public static PortfolioSearchHistoricRequest.Meta meta() {
    return PortfolioSearchHistoricRequest.Meta.INSTANCE;
  }

  @Override
  public PortfolioSearchHistoricRequest.Meta metaBean() {
    return PortfolioSearchHistoricRequest.Meta.INSTANCE;
  }
  ...
  public static class Meta extends BasicMetaBean {
    ...
    @Override
    public PortfolioSearchHistoricRequest createBean() {
      return new PortfolioSearchHistoricRequest();
    }

    @Override
    public Class<? extends PortfolioSearchHistoricRequest> beanType() {
      return PortfolioSearchHistoricRequest.class;
    }
