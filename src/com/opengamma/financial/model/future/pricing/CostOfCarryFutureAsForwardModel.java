...
public class CostOfCarryFutureAsForwardModel implements FutureModel<StandardFutureDataBundle> {
  ...
  @Override
  public GreekResultCollection getGreeks(final FutureDefinition definition, final StandardFutureDataBundle data,
    ...
    final StandardForwardDataBundle forwardData = new StandardForwardDataBundle(data.getYield(), data
        .getDiscountCurve(), data.getSpot(), data.getDate(), data.getStorageCost());
