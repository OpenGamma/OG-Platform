...
public class SkewKurtosisOptionDataBundle extends StandardOptionDataBundle {
  ...
  public SkewKurtosisOptionDataBundle(DiscountCurve discountCurve, double b, VolatilitySurface volatilitySurface, double spot, Date date, double skew, double kurtosis) {
