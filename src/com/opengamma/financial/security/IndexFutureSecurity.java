...
public class IndexFutureSecurity extends FutureSecurity {
  ...
  public IndexFutureSecurity(final Expiry expiry, final String tradingExchange, final String settlementExchange, final DomainSpecificIdentifier underlyingIdentifier) {
