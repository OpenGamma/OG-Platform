...
public class StockFutureSecurity extends FutureSecurity {
  ...
  public StockFutureSecurity(final Expiry expiry, final String tradingExchange, final String settlementExchange, final Currency currency, final Identifier underlyingIdentifier) {
