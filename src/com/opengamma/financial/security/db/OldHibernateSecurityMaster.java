 ...
 * 
 */
public class OldHibernateSecurityMaster implements SecuritySource {
  ...
  public UniqueIdentifier putSecurity(final Date now, final Security security) {
    return (UniqueIdentifier) _hibernateTemplate.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(final Session session) throws HibernateException, SQLException {
        ...
        if (security.getUniqueIdentifier() == null || security.getUniqueIdentifier().getScheme().equals(getIdentifierScheme()) == false) {
          // add security
