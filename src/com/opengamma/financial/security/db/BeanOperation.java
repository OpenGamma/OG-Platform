...
/* package */ interface BeanOperation<S extends Security, SBean extends SecurityBean> {
   ...
   * of SecurityBean.
   */
  SBean createBean(OperationContext context, HibernateSecurityMasterDao secMasterSession, S security);
  
  /**
   * Convert a bean representation to a security.
   */
  S createSecurity(OperationContext context, SBean bean);
  
  /**
   * Test a bean and security representation for equality.
   */
  boolean beanEquals(OperationContext context, SBean bean, S security);
   ...
   */
  SBean resolve(OperationContext context, HibernateSecurityMasterDao secMasterSession, Date now, SBean bean);
   ...
   */
  void postPersistBean(OperationContext context, HibernateSecurityMasterDao secMasterSession, Date effectiveDate, SBean bean);
