  ...
  public SecurityDocument add(final SecurityDocument document) {
    return (SecurityDocument) getHibernateTemplate().execute(new HibernateCallback() {
      ...
      public Object doInHibernate(final Session session) throws HibernateException, SQLException {
        ...
        final SecurityBean bean = secMasterSession.createSecurityBean(beanOperation, now, false, now, null, null, security);
        for (Identifier identifier : security.getIdentifiers()) {
  ...
  public void remove(final UniqueIdentifier uid) {
    getHibernateTemplate().execute(new HibernateCallback() {
      ...
      public Object doInHibernate(final Session session) throws HibernateException, SQLException {
        ...
        secMasterSession.createSecurityBean(beanOperation, now, true, now, MODIFIED_BY, bean.getFirstVersion(), beanOperation.createSecurity(bean));
        return null;
      }
    });
  }
  ...
  public SecurityDocument update(final SecurityDocument document) {
    return (SecurityDocument) getHibernateTemplate().execute(new HibernateCallback() {
      ...
      public Object doInHibernate(final Session session) throws HibernateException, SQLException {
        ...
        final SecurityBean updatedDbBean = secMasterSession.createSecurityBean(beanOperation, now, false, now, MODIFIED_BY, origDbBean.getFirstVersion(), security);
