...
/* package */final class EquitySecurityBeanOperation extends AbstractBeanOperation<EquitySecurity, EquitySecurityBean> {
  ...
  /* package */EquitySecurityBean createBean(final ExchangeBean exchange, final String companyName, final CurrencyBean currency, final GICSCodeBean gicsCode) {
  ...
  /* package */EquitySecurityBean createBean(final HibernateSecurityMasterDao secMasterSession, final Date effectiveDateTime, final boolean deleted, final Date lastModified, final String modifiedBy,
