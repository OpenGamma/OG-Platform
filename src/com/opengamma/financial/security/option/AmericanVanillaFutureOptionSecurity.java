...
public class AmericanVanillaFutureOptionSecurity extends FutureOptionSecurity implements AmericanVanillaOption {
  ...
  public AmericanVanillaFutureOptionSecurity(final OptionType optionType, final double strike, final Expiry expiry, final DomainSpecificIdentifier underlyingUniqueId,
