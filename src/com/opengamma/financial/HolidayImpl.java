...
public class HolidayImpl implements Holiday {
   ...
   */
  public HolidayImpl(Currency currency, Collection<LocalDate> holidaySeries) {
    _currency = currency;
   ...
   */
  public HolidayImpl(Identifier regionOrExchangeId, HolidayType holidayType, Collection<LocalDate> holidaySeries) {
    switch (holidayType) {
      case BANK:
  ...
  public String getCurrencyISO() {
    return _currency == null ? null : _currency.getISOCode();
  }
