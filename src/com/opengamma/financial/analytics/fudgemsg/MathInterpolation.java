...
public class MathInterpolation {
  ...
  public static FudgeBuilder<GridInterpolator2D> GRID_INTERPOLATOR_2D = new GridInterpolator2DBuilder ();
  public static FudgeBuilder<Interpolator1D> INTERPOLATOR_1D = new Interpolator1DBuilder ();
  ...
  public static class GridInterpolator2DBuilder extends FudgeBuilderBase<GridInterpolator2D> {
    ...
    public GridInterpolator2D buildObject (final FudgeDeserializationContext context, final FudgeFieldContainer message) {
      return new GridInterpolator2D (context.fieldValueToObject (Interpolator1D.class, message.getByName (X_FIELD_NAME)), context.fieldValueToObject (Interpolator1D.class, message.getByName (Y_FIELD_NAME)));
    }
