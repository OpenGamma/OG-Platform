 ...
 * 
 */
public class SwapImpliedFundingAndForwardCurveFunction extends AbstractFunction implements FunctionInvoker {
  ...
  public SwapImpliedFundingAndForwardCurveFunction(final Currency currency) {
  ...
  public Set<ComputedValue> execute(final FunctionExecutionContext executionContext, final FunctionInputs inputs, final ComputationTarget target, final Set<ValueRequirement> desiredValues) {
    ...
    final DoubleCurveJacobian<Interpolator1DCubicSplineWithSensitivitiesDataBundle> jacobian = new DoubleCurveJacobian<Interpolator1DCubicSplineWithSensitivitiesDataBundle>(swaps, _spotRate,
        fundingNodeTimes, forwardNodeTimes, _fundingInterpolatorWithSensitivity, _forwardInterpolatorWithSensitivity);
    final DoubleCurveFinder curveFinder = new DoubleCurveFinder(swaps, marketRates, _spotRate, fundingNodeTimes, forwardNodeTimes, fundingCurve, forwardCurve, _fundingInterpolator,
    ...
    final YieldAndDiscountCurve forwardResult = new InterpolatedYieldCurve(fundingNodeTimes, yields, _fundingInterpolator);
