 ...
 */
public class ResolvedFixedIncomeStripSecurityAndMaturityBuilder {
  ...
  public ResolvedFixedIncomeStripSecurityAndMaturityBuilder(RegionSource regionSource, ConventionBundleSource conventionBundleSource, SecuritySource secSource) {
  ...
  private CashSecurity getCash(InterpolatedYieldCurveSpecification spec, ResolvedFixedIncomeStrip strip) {
  ...
  private FRASecurity getFRA(InterpolatedYieldCurveSpecification spec, ResolvedFixedIncomeStrip strip) {
  ...
  private FutureSecurity getFuture(InterpolatedYieldCurveSpecification spec, ResolvedFixedIncomeStrip strip) {
    return (FutureSecurity) _secSource.getSecurity(IdentifierBundle.of(strip.getSecurity()));
  }
  
  private SwapSecurity getSwap(InterpolatedYieldCurveSpecification spec, ResolvedFixedIncomeStrip strip, Map<Identifier, Double> marketValues) {
