...
public class ResolvedFixedIncomeStrip {
  ...
  public ResolvedFixedIncomeStrip(StripInstrumentType instrumentType, Tenor maturity, Identifier security) {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof ResolvedFixedIncomeStrip) {
      ResolvedFixedIncomeStrip other = (ResolvedFixedIncomeStrip) obj;
  ...
  public int compareTo(ResolvedFixedIncomeStrip o) {
