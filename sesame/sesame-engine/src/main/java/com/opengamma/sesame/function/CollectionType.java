...
/**
 * Type information for a collection containing the collection class and the class of its elements.
 */
@BeanDefinition
public class CollectionType extends ParameterType implements ImmutableBean {

  /** The class of the collection. */
  @PropertyDefinition(validate = "notNull")
  private final Class<?> _type;

  /** The class of the collection's elements. */
  @PropertyDefinition(validate = "notNull")
  private final Class<?> _elementType;

  /* package */ CollectionType(Type type) {
  ...
  public String getName() {
    return getType().getSimpleName() + "<" + _elementType.getSimpleName() + ">";
  }

  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code CollectionType}.
   * @return the meta-bean, not null
   */
  public static CollectionType.Meta meta() {
    return CollectionType.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(CollectionType.Meta.INSTANCE);
  }
   ...
   */
  public static CollectionType.Builder builder() {
   ...
   */
  protected CollectionType(CollectionType.Builder builder) {
  ...
  @Override
  public CollectionType.Meta metaBean() {
    return CollectionType.Meta.INSTANCE;
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Class<?>> _type = DirectMetaProperty.ofImmutable(
        this, "type", CollectionType.class, (Class) Class.class);
    /**
    ...
    private final MetaProperty<Class<?>> _elementType = DirectMetaProperty.ofImmutable(
        this, "elementType", CollectionType.class, (Class) Class.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public CollectionType.Builder builder() {
      return new CollectionType.Builder();
    }

    @Override
    public Class<? extends CollectionType> beanType() {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3575610:  // type
          return ((CollectionType) bean).getType();
        case 673924182:  // elementType
          return ((CollectionType) bean).getElementType();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code CollectionType}.
   */
  public static class Builder extends DirectFieldsBeanBuilder<CollectionType> {
     ...
     */
    protected Builder(CollectionType beanToCopy) {
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(96);
      buf.append("CollectionType.Builder{");
      int len = buf.length();
      toString(buf);
      if (buf.length() > len) {
        buf.setLength(buf.length() - 2);
