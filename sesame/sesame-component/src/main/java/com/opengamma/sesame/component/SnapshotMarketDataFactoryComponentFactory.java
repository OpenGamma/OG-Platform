...
/**
 * Component factory for creating a {@link SnapshotMarketDataFactory}.
 */
@BeanDefinition
public class SnapshotMarketDataFactoryComponentFactory extends AbstractComponentFactory {
  ...
  /** A source of market data snapshots. */
  @PropertyDefinition
  private MarketDataSnapshotSource _snapshotSource;

  @Override
  public void init(ComponentRepository repo, LinkedHashMap<String, String> configuration) throws Exception {
    SnapshotMarketDataFactory marketDataFactory = new SnapshotMarketDataFactory(_snapshotSource);
    repo.registerComponent(SnapshotMarketDataFactory.class, _classifier, marketDataFactory);
  }
  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets a source of market data snapshots.
  ...
  /**
   * Sets a source of market data snapshots.
   * @param snapshotSource  the new value of the property
   */
  ...
  public static class Meta extends AbstractComponentFactory.Meta {
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notEmpty(((SnapshotMarketDataFactoryComponentFactory) bean)._classifier, "classifier");
      super.validate(bean);
    }
