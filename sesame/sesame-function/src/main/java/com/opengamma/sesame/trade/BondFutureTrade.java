...
public final class BondFutureTrade extends TradeWrapper<BondFutureSecurity> implements ImmutableBean {
  ...
  @Override
  public TradeWrapper<BondFutureSecurity> updateBundle(ImmutableTradeBundle bundle) {
    return toBuilder().tradeBundle(bundle).build();
  }
  
  @ImmutableConstructor
  private BondFutureTrade(ImmutableTradeBundle tradeBundle) {
    super(BondFutureSecurity.class, tradeBundle);
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableTradeBundle> _tradeBundle = DirectMetaProperty.ofImmutable(
        this, "tradeBundle", BondFutureTrade.class, ImmutableTradeBundle.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1481798406:  // tradeBundle
          return ((BondFutureTrade) bean).getTradeBundle();
      }
