 ...
 */
@BeanDefinition
public final class IRFutureOptionTrade extends TradeWrapper<IRFutureOptionSecurity> implements ImmutableBean {
  ...
  private IRFutureOptionTrade(ImmutableTradeBundle tradeBundle) {
    super(IRFutureOptionSecurity.class, tradeBundle);
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableTradeBundle> _tradeBundle = DirectMetaProperty.ofImmutable(
        this, "tradeBundle", IRFutureOptionTrade.class, ImmutableTradeBundle.class);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1481798406:  // tradeBundle
          return ((IRFutureOptionTrade) bean).getTradeBundle();
      }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<IRFutureOptionTrade> {
     ...
     */
    private Builder(IRFutureOptionTrade beanToCopy) {
