 ...
 */
@BeanDefinition
public final class IndexCDSTrade extends TradeWrapper<IndexCDSSecurity> implements ImmutableBean {
  ...
  private IndexCDSTrade(ImmutableTradeBundle tradeBundle) {
    super(IndexCDSSecurity.class, tradeBundle);
    _tradeBundle = tradeBundle;
  }
  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code IndexCDSTrade}.
   * @return the meta-bean, not null
   */
  public static IndexCDSTrade.Meta meta() {
    return IndexCDSTrade.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(IndexCDSTrade.Meta.INSTANCE);
  }
   ...
   */
  public static IndexCDSTrade.Builder builder() {
    return new IndexCDSTrade.Builder();
  }

  @Override
  public IndexCDSTrade.Meta metaBean() {
    return IndexCDSTrade.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      IndexCDSTrade other = (IndexCDSTrade) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableTradeBundle> _tradeBundle = DirectMetaProperty.ofImmutable(
        this, "tradeBundle", IndexCDSTrade.class, ImmutableTradeBundle.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public IndexCDSTrade.Builder builder() {
      return new IndexCDSTrade.Builder();
    }

    @Override
    public Class<? extends IndexCDSTrade> beanType() {
      return IndexCDSTrade.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1481798406:  // tradeBundle
          return ((IndexCDSTrade) bean).getTradeBundle();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code IndexCDSTrade}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<IndexCDSTrade> {
     ...
     */
    private Builder(IndexCDSTrade beanToCopy) {
    ...
    @Override
    public IndexCDSTrade build() {
      return new IndexCDSTrade(
          _tradeBundle);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(64);
      buf.append("IndexCDSTrade.Builder{");
