...
public final class InflationMulticurveId implements MarketDataId<InflationProviderBundle>, ImmutableBean {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code InflationMulticurveId}.
  ...
  public String toString() {
    ...
    buf.append("InflationMulticurveId{");
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code InflationMulticurveId}.
   */
  private static final class Builder extends DirectFieldsBeanBuilder<InflationMulticurveId> {
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(96);
      buf.append("InflationMulticurveId.Builder{");
