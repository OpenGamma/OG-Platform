 ...
 */
@BeanDefinition
public final class LegacyCDSTrade extends TradeWrapper<LegacyCDSSecurity> implements ImmutableBean {
  ...
  private LegacyCDSTrade(ImmutableTradeBundle tradeBundle) {
    super(LegacyCDSSecurity.class, tradeBundle);
    _tradeBundle = tradeBundle;
  }
  //------------------------- AUTOGENERATED START -------------------------
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code LegacyCDSTrade}.
   * @return the meta-bean, not null
   */
  public static LegacyCDSTrade.Meta meta() {
    return LegacyCDSTrade.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(LegacyCDSTrade.Meta.INSTANCE);
  }
   ...
   */
  public static LegacyCDSTrade.Builder builder() {
    return new LegacyCDSTrade.Builder();
  }

  @Override
  public LegacyCDSTrade.Meta metaBean() {
    return LegacyCDSTrade.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      LegacyCDSTrade other = (LegacyCDSTrade) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableTradeBundle> _tradeBundle = DirectMetaProperty.ofImmutable(
        this, "tradeBundle", LegacyCDSTrade.class, ImmutableTradeBundle.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public LegacyCDSTrade.Builder builder() {
      return new LegacyCDSTrade.Builder();
    }

    @Override
    public Class<? extends LegacyCDSTrade> beanType() {
      return LegacyCDSTrade.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1481798406:  // tradeBundle
          return ((LegacyCDSTrade) bean).getTradeBundle();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code LegacyCDSTrade}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<LegacyCDSTrade> {
     ...
     */
    private Builder(LegacyCDSTrade beanToCopy) {
    ...
    @Override
    public LegacyCDSTrade build() {
      return new LegacyCDSTrade(
          _tradeBundle);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(64);
      buf.append("LegacyCDSTrade.Builder{");
