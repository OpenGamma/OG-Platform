...
-----------
* Improvement
   * [PLAT-4575] Add an implementation of the new and refactored CombinedMaster base class for ConfigMasters
   * [PLAT-5099] Add fluent apis for new scenario implementations
