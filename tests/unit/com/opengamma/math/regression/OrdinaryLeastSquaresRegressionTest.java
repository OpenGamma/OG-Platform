...
public class OrdinaryLeastSquaresRegressionTest {
  ...
  public void test() {
    ...
    final OrdinaryLeastSquaresRegression regression = new OrdinaryLeastSquaresRegression();
    ...
    result = regression.regress(x, yIntercept, true);
    testRegression(4, 3, result, a0, a1, a2, a3, eps);
    result = regression.regress(x, yNoIntercept, false);
    testRegression(3, result, a1, a2, a3, eps);
  }
