...
public class Interpolator1DFactoryTest {
  ...
  public void test() {
    ...
    assertEquals(Interpolator1DFactory.CUBIC_SPLINE_WITH_SENSITIVITIES, Interpolator1DFactory.getInterpolatorName(Interpolator1DFactory
        .getInterpolator(Interpolator1DFactory.CUBIC_SPLINE_WITH_SENSITIVITIES)));
    assertEquals(Interpolator1DFactory.LINEAR_WITH_SENSITIVITIES, Interpolator1DFactory.getInterpolatorName(Interpolator1DFactory.getInterpolator(Interpolator1DFactory.LINEAR_WITH_SENSITIVITIES)));
