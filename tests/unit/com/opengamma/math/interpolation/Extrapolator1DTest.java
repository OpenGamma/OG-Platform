...
public class Extrapolator1DTest {
  ...
  private static final ExtrapolatorMethod<? extends Interpolator1DDataBundle, ? extends InterpolationResult> LINEAR_EM = new LinearExtrapolator();
  private static final ExtrapolatorMethod<? extends Interpolator1DDataBundle, ? extends InterpolationResult> FLAT_EM = new FlatExtrapolator();
  ...
  private static final Extrapolator1D<Interpolator1DDataBundle, InterpolationResult> EXTRAPOLATOR = new Extrapolator1D(LINEAR_EM, FLAT_EM, INTERPOLATOR);
  ...
  private static final double[] Y_TEST = new double[] {-1.1, 3.0, 3.87, 3.1, 2.0, 2.0};
