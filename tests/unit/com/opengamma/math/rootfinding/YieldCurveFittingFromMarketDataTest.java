...
public class YieldCurveFittingFromMarketDataTest extends YieldCurveFittingSetup {
  ...
  private YieldCurveFittingTestDataBundle getSingleCurveSetup() {
    ...
    marketRates.put("swap", new double[] {0.030407786, 0.029916004, 0.034584884, 0.038229798, 0.04087903, 0.043113012, 0.044647485, 0.046907134, 0.046181716, 0.045213019, 0.044375644, 0.043817929});
