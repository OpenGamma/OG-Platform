...
public abstract class HistoricalVolatilityCalculatorTestCase {
  ...
  private static final double[] CLOSE =
      new double[] {132.5, 133.5, 135., 133., 133., 137., 135., 135., 142.5, 143., 144.5, 145., 146., 149., 148., 147., 147., 147., 145., 145., 150.};
  private static final double[] HIGH =
      new double[] {132.5, 134., 136., 137., 136., 137., 136.5, 136., 143.5, 145., 147., 147.5, 147., 150., 149., 149.5, 147.5, 149., 147.5, 145., 150.};
  private static final double[] LOW =
      new double[] {131., 131., 134., 133., 133., 133., 135., 135., 137., 142., 142., 145., 143., 148., 146.5, 147., 146., 146.5, 144.5, 144., 143.5};
  ...
  protected static final RelativeTimeSeriesReturnCalculator RELATIVE_RETURN_CALCULATOR =
  ...
  public void testInputs1() {
    getCalculator().testDatesCoincide(
        new DoubleTimeSeries[] {new FastArrayLongDoubleTimeSeries(ENCODING, new long[] {1l, 2l, 3l}, new double[] {3, 4, 5}),
  ...
  public void testInputs2() {
    getCalculator().testDatesCoincide(
        new DoubleTimeSeries[] {new FastArrayLongDoubleTimeSeries(ENCODING, new long[] {1l, 2l, 3l}, new double[] {3, 4, 5}),
            new FastArrayLongDoubleTimeSeries(ENCODING, new long[] {1l, 2l, 3l}, new double[] {4, 5, 6}),
            new FastArrayLongDoubleTimeSeries(ENCODING, new long[] {2l, 3l, 4l}, new double[] {4, 5, 6})});
  }
