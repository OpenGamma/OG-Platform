...
public class ParametricVaRDataBundleTest {
  ...
  public void testMoreCovariances() {
    ...
    covariances.put(Sensitivity.VALUE_DELTA, new DoubleMatrix2D(new double[][] { new double[] { 2 } }));
    covariances.put(Sensitivity.VALUE_GAMMA, new DoubleMatrix2D(new double[][] { new double[] { 2 } }));
    new ParametricVaRDataBundle(VECTOR, covariances);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNullSensitivity() {
    final Map<Sensitivity, Matrix<?>> sensitivities = Collections.<Sensitivity, Matrix<?>> singletonMap(Sensitivity.VALUE_DELTA, null);
    new ParametricVaRDataBundle(sensitivities, MATRIX);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testBadFirstOrderSensitivity() {
    final Map<Sensitivity, Matrix<?>> sensitivities = Collections.<Sensitivity, Matrix<?>> singletonMap(Sensitivity.VALUE_DELTA, new DoubleMatrix2D(
        new double[][] { new double[] { 2 } }));
    new ParametricVaRDataBundle(sensitivities, MATRIX);
  }
  ...
  public void testNonSquareSensitivityMatrix() {
    final Map<Sensitivity, Matrix<?>> sensitivities = Collections.<Sensitivity, Matrix<?>> singletonMap(Sensitivity.VALUE_GAMMA, new DoubleMatrix2D(new double[][] { new double[] {
        2, 1 } }));
    new ParametricVaRDataBundle(sensitivities, MATRIX);
  }
  ...
  public void test3DMatrix() {
    ...
    final Map<Sensitivity, Matrix<?>> sensitivities = Collections.<Sensitivity, Matrix<?>> singletonMap(Sensitivity.VALUE_DELTA, m);
    new ParametricVaRDataBundle(sensitivities, MATRIX);
  }
  ...
  public void testNonSquareCovarianceMatrix() {
    final Map<Sensitivity, DoubleMatrix2D> m = Collections.<Sensitivity, DoubleMatrix2D> singletonMap(Sensitivity.VALUE_DELTA, new DoubleMatrix2D(new double[][] { new double[] {
        1, 2 } }));
  ...
  public void testNonMatchingSensitivityAndCovarianceMatrices() {
    final Map<Sensitivity, DoubleMatrix2D> m = Collections.<Sensitivity, DoubleMatrix2D> singletonMap(Sensitivity.VALUE_DELTA, new DoubleMatrix2D(new double[][] {
  ...
  public void testConversionToMatrix() {
    final Map<Sensitivity, Matrix<?>> sensitivities = Collections.<Sensitivity, Matrix<?>> singletonMap(Sensitivity.VALUE_GAMMA, new DoubleMatrix1D(new double[] { 2, 1 }));
    final ParametricVaRDataBundle data = new ParametricVaRDataBundle(sensitivities, MATRIX);
    final Matrix<?> m = data.getSensitivityData(Sensitivity.VALUE_GAMMA);
  ...
  @Test
  public void test() {
    assertEquals(VECTOR.get(Sensitivity.VALUE_DELTA), DATA.getSensitivityData(Sensitivity.VALUE_DELTA));
