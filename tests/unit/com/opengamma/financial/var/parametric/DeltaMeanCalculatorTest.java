...
public class DeltaMeanCalculatorTest {
  ...
  public void testDifferentVectorSizes() {
    ...
    final ParametricWithMeanVaRDataBundle data = new ParametricWithMeanVaRDataBundle(Collections.<Integer, DoubleMatrix1D> singletonMap(1, v),
        Collections.<Integer, Matrix<?>> singletonMap(1, VECTOR), Collections.<Integer, DoubleMatrix2D> singletonMap(1, MATRIX));
    F.evaluate(data);
  }
