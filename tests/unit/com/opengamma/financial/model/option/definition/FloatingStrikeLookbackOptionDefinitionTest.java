...
public class FloatingStrikeLookbackOptionDefinitionTest {
  ...
  private static final DoubleTimeSeries<?> HIGH_TS = new FastArrayIntDoubleTimeSeries(DateTimeNumericEncoding.DATE_DDMMYYYY, new int[] { 20100529, 20100530, 20100531 }, new double[] { SPOT,
      SPOT + DIFF, SPOT });
  private static final DoubleTimeSeries<?> LOW_TS = new FastArrayIntDoubleTimeSeries(DateTimeNumericEncoding.DATE_DDMMYYYY, new int[] { 20100529, 20100530, 20100531 }, new double[] { SPOT,
      SPOT - DIFF, SPOT });
  private static final StandardOptionWithSpotTimeSeriesDataBundle HIGH_DATA = new StandardOptionWithSpotTimeSeriesDataBundle(new ConstantInterestRateDiscountCurve(0.1), 0.05,
      new ConstantVolatilitySurface(0.2), SPOT, DateUtil.getUTCDate(2010, 6, 1), HIGH_TS);
  private static final StandardOptionWithSpotTimeSeriesDataBundle LOW_DATA = new StandardOptionWithSpotTimeSeriesDataBundle(new ConstantInterestRateDiscountCurve(0.1), 0.05,
