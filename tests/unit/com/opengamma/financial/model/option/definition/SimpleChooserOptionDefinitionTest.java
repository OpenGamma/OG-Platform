...
public class SimpleChooserOptionDefinitionTest {
  ...
  private static final StandardOptionDataBundle DATA = new StandardOptionDataBundle(new ConstantYieldCurve(0.06), 0., new ConstantVolatilitySurface(0.15), STRIKE, DATE);
