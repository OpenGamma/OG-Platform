...
public class EuropeanExchangeAssetOptionDefinitionTest {
  ...
  private static final StandardTwoAssetOptionDataBundle DATA = new StandardTwoAssetOptionDataBundle(new ConstantYieldCurve(0.02), 0, 0, new ConstantVolatilitySurface(0.2),
