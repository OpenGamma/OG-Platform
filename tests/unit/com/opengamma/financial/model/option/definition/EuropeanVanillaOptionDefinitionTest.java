...
public class EuropeanVanillaOptionDefinitionTest {
  ...
  private static final StandardOptionDataBundle DATA = new StandardOptionDataBundle(new ConstantYieldCurve(0.05), 0., new ConstantVolatilitySurface(0.2), 100., DATE);
