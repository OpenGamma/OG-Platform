...
public class TrinomialOptionModelTest {
  ...
  public void test() {
    ...
    expected[0][0] = Pair.of(df3 * 100., 8.4253);
    expected[1][0] = Pair.of(df2 * 81.87, 0.6525);
    expected[1][1] = Pair.of(df2 * 100., 6.4148);
    expected[1][2] = Pair.of(df2 * 122.14, 24.0802);
    expected[2][0] = Pair.of(df1 * 67.03, 0.);
    expected[2][1] = Pair.of(df1 * 81.87, 0.);
    expected[2][2] = Pair.of(df1 * 100., 3.8008);
    expected[2][3] = Pair.of(df1 * 122.14, 22.9051);
    expected[2][4] = Pair.of(df1 * 149.18, 49.6782);
    expected[3][0] = Pair.of(54.88, 0.);
    expected[3][1] = Pair.of(67.03, 0.);
    expected[3][2] = Pair.of(81.87, 0.);
    expected[3][3] = Pair.of(100., 0.);
    expected[3][4] = Pair.of(122.14, 22.1403);
    expected[3][5] = Pair.of(149.18, 49.1825);
    expected[3][6] = Pair.of(182.21, 82.2119);
    for (int i = 0; i < 4; i++) {
