 ...
 * @author emcleod
 */
public class BatesGeneralizedJumpDiffusionOptionModelTest {
  private static final AnalyticOptionModel<OptionDefinition, BatesGeneralizedJumpDiffusionModelOptionDataBundle> MODEL = new BatesGeneralizedJumpDiffusionOptionModel();
