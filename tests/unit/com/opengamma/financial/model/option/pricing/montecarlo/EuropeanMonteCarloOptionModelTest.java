...
public class EuropeanMonteCarloOptionModelTest {
  ...
  private static final StandardOptionDataBundle DATA =
      new StandardOptionDataBundle(new ConstantYieldCurve(0.06), 0.06, new ConstantVolatilitySurface(0.2), 100., DATE);
  @SuppressWarnings("unused")
  ...
  public void test() {
    @SuppressWarnings("unused")
    final EuropeanMonteCarloOptionModel model =
        new EuropeanMonteCarloOptionModel(200000, 100, new BlackScholesGeometricBrownianMotionProcess<OptionDefinition, StandardOptionDataBundle>(), GENERATOR);
    @SuppressWarnings("unused")
    final EuropeanMonteCarloOptionModel model1 =
        new EuropeanMonteCarloOptionModel(200000, 100, new BlackScholesGeometricBrownianMotionProcess<OptionDefinition, StandardOptionDataBundle>(), GENERATOR,
