...
public class EuropeanMonteCarloOptionModelTest {
  ...
  private static final StandardOptionDataBundle DATA = new StandardOptionDataBundle(new ConstantInterestRateDiscountCurve(0.06), 0.06, new ConstantVolatilitySurface(0.2), 100.,
      DATE);
  private static final OptionDefinition CALL = new EuropeanVanillaOptionDefinition(110, EXPIRY, true);

  @Test
  public void test() {
    final EuropeanMonteCarloOptionModel model = new EuropeanMonteCarloOptionModel(200000, 100,
        new BlackScholesGeometricBrownianMotionProcess<OptionDefinition, StandardOptionDataBundle>(), GENERATOR);
    final EuropeanMonteCarloOptionModel model1 = new EuropeanMonteCarloOptionModel(200000, 100,
        new BlackScholesGeometricBrownianMotionProcess<OptionDefinition, StandardOptionDataBundle>(), GENERATOR,
        new AntitheticVariate<OptionDefinition, StandardOptionDataBundle>());
  }
}
