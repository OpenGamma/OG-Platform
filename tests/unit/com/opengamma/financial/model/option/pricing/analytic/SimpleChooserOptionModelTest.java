...
public class SimpleChooserOptionModelTest {
  ...
  public void test() {
    ...
    StandardOptionDataBundle bundle = new StandardOptionDataBundle(new ConstantInterestRateDiscountCurve(date, 0.08), 0.08, new ConstantVolatilitySurface(date, 0.25), 50, date);
