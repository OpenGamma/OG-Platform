...
public class BlackDermanToyYieldCurveOnlyModelTest {
  ...
  public void test() {
    ...
    final BlackDermanToyDataBundle data = new BlackDermanToyDataBundle(new ConstantInterestRateDiscountCurve(0.05), new ConstantVolatilityCurve(0.1), date);
    final BlackDermanToyYieldOnlyInterestRateModel model = new BlackDermanToyYieldOnlyInterestRateModel(4);
