 ...
 * @author emcleod
 */
public class ParRateBootstrapDiscountCurveModelTest {
  ...
  public void test() {
    ...
    final InterpolatedDiscountCurve curve = new ParRateBootstrapDiscountCurveModel(new LinearInterpolator1D()).getCurve(data, date);
