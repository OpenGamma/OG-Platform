...
public class HullWhiteTwoFactorInterestRateModelTest {
  ...
  public void test() {
    ...
    //    final HullWhiteTwoFactorInterestRateDataBundle data =
    //        new HullWhiteTwoFactorInterestRateDataBundle(date, new ConstantYieldCurve(0.05), 0.1, 1.4, 0.01, 0.05, new ConstantVolatilityCurve(0.01),
