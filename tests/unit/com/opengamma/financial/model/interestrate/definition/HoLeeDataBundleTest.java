 ...
 * 
 */
public class HoLeeDataBundleTest {
  ...
  private static final HoLeeDataBundle DATA = new HoLeeDataBundle(R_CURVE, SIGMA_CURVE, DATE);

  @Test(expected = IllegalArgumentException.class)
  public void testNullYieldCurve() {
    new HoLeeDataBundle(null, SIGMA_CURVE, DATE);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNullVolatilityCurve() {
    new HoLeeDataBundle(R_CURVE, null, DATE);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNullDate() {
    new HoLeeDataBundle(R_CURVE, SIGMA_CURVE, null);
  }
  ...
  public void testHashCodeAndEquals() {
    HoLeeDataBundle other = new HoLeeDataBundle(R_CURVE, SIGMA_CURVE, DATE);
    assertEquals(other, DATA);
    assertEquals(other.hashCode(), DATA.hashCode());
    other = new HoLeeDataBundle(new ConstantYieldCurve(R + 0.01), SIGMA_CURVE, DATE);
    assertFalse(other.equals(DATA));
    other = new HoLeeDataBundle(R_CURVE, new ConstantVolatilityCurve(SIGMA + 0.1), DATE);
    assertFalse(other.equals(DATA));
    other = new HoLeeDataBundle(R_CURVE, SIGMA_CURVE, DATE.minusDays(2));
    assertFalse(other.equals(DATA));
  }
}
