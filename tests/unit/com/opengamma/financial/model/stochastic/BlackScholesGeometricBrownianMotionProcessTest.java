...
public class BlackScholesGeometricBrownianMotionProcessTest {
  ...
  private static final StochasticProcess<OptionDefinition, StandardOptionDataBundle> PROCESS =
      new BlackScholesGeometricBrownianMotionProcess<OptionDefinition, StandardOptionDataBundle>();
  ...
  private static final StandardOptionDataBundle DATA = new StandardOptionDataBundle(new ConstantYieldCurve(R), B, new ConstantVolatilitySurface(0.), S, DATE);
