 ...
 * 
 */
public class DiscretelyCompoundedBondYieldCalculatorTest {
  private static final DiscretelyCompoundedBondYieldCalculator CALCULATOR = new DiscretelyCompoundedBondYieldCalculator();
  ...
  @Test
  public void test() {
    assertEquals(CALCULATOR.calculate(TS, 1.2559, DATE), 0.0422, 1e-4);
  }
}
