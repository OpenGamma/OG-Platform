...
public class SingeCurveJacobianTest {
  ...
  static {
    ...
    FRA_ONLY_JACOBIAN = new SingleCurveJacobian<Interpolator1DDataBundle>(FRA, NODES, INTERPOLATOR);
    X = new DoubleMatrix1D(data);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNullDerivatives() {
    new SingleCurveJacobian<Interpolator1DDataBundle>(null, NODES, INTERPOLATOR);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNullTimes() {
    new SingleCurveJacobian<Interpolator1DDataBundle>(CASH, null, INTERPOLATOR);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNullInterpolator() {
    new SingleCurveJacobian<Interpolator1DDataBundle>(CASH, NODES, null);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testEmptyDerivatives() {
    new SingleCurveJacobian<Interpolator1DDataBundle>(new ArrayList<InterestRateDerivative>(), NODES, INTERPOLATOR);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testEmptyTimes() {
    new SingleCurveJacobian<Interpolator1DDataBundle>(CASH, new double[0], INTERPOLATOR);
  }
