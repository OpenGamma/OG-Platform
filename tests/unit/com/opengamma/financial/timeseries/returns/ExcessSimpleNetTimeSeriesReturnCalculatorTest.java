...
public class ExcessSimpleNetTimeSeriesReturnCalculatorTest {
  ...
  @Test
  public void test() {
    assertEquals(CALCULATOR.evaluate(new DoubleTimeSeries<?>[] { TS1, FastArrayIntDoubleTimeSeries.EMPTY_SERIES, TS2, FastArrayIntDoubleTimeSeries.EMPTY_SERIES }), RETURNS.evaluate(TS1));
