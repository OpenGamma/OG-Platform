...
public final class EngineRunScenariosArguments implements ImmutableBean {
   ...
   * @param marketData market data for running the calculations, one set for each scenario.
   *   The engine will try to provide any data required by the calculations but not included in the environment.
   * @param portfolio items in the portfolio (normally trades) which are the inputs to the calculations
   */
  @ImmutableConstructor
  public EngineRunScenariosArguments(ViewConfig viewConfig,
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code EngineRunScenariosArguments}.
  ...
  public String toString() {
    ...
    buf.append("EngineRunScenariosArguments{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ScenarioCalculationArguments> _calculationArguments = DirectMetaProperty.ofImmutable(
        this, "calculationArguments", EngineRunScenariosArguments.class, ScenarioCalculationArguments.class);
    /**
    ...
    private final MetaProperty<ScenarioMarketDataEnvironment> _marketData = DirectMetaProperty.ofImmutable(
        this, "marketData", EngineRunScenariosArguments.class, ScenarioMarketDataEnvironment.class);
    /**
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code EngineRunScenariosArguments}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<EngineRunScenariosArguments> {
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(160);
      buf.append("EngineRunScenariosArguments.Builder{");
