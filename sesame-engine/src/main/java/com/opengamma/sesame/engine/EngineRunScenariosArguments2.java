 ...
 */
@BeanDefinition
public final class EngineRunScenariosArguments2 implements ImmutableBean {
   ...
   */
  public static EngineRunScenariosArguments2.Meta meta() {
    return EngineRunScenariosArguments2.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(EngineRunScenariosArguments2.Meta.INSTANCE);
  }
   ...
   */
  public static EngineRunScenariosArguments2.Builder builder() {
    return new EngineRunScenariosArguments2.Builder();
  }

  private EngineRunScenariosArguments2(
  ...
  @Override
  public EngineRunScenariosArguments2.Meta metaBean() {
    return EngineRunScenariosArguments2.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      EngineRunScenariosArguments2 other = (EngineRunScenariosArguments2) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ViewConfig> _viewConfig = DirectMetaProperty.ofImmutable(
        this, "viewConfig", EngineRunScenariosArguments2.class, ViewConfig.class);
    /**
    ...
    private final MetaProperty<CalculationArguments> _calculationArguments = DirectMetaProperty.ofImmutable(
        this, "calculationArguments", EngineRunScenariosArguments2.class, CalculationArguments.class);
    /**
    ...
    private final MetaProperty<MarketDataEnvironment> _marketData = DirectMetaProperty.ofImmutable(
        this, "marketData", EngineRunScenariosArguments2.class, MarketDataEnvironment.class);
    /**
    ...
    private final MetaProperty<ScenarioDefinition> _scenarioDefinition = DirectMetaProperty.ofImmutable(
        this, "scenarioDefinition", EngineRunScenariosArguments2.class, ScenarioDefinition.class);
    /**
    ...
    private final MetaProperty<List<Object>> _portfolio = DirectMetaProperty.ofImmutable(
        this, "portfolio", EngineRunScenariosArguments2.class, (Class) List.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public EngineRunScenariosArguments2.Builder builder() {
      return new EngineRunScenariosArguments2.Builder();
    }

    @Override
    public Class<? extends EngineRunScenariosArguments2> beanType() {
      return EngineRunScenariosArguments2.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1970035271:  // viewConfig
          return ((EngineRunScenariosArguments2) bean).getViewConfig();
        case -172471155:  // calculationArguments
          return ((EngineRunScenariosArguments2) bean).getCalculationArguments();
        case 1116764678:  // marketData
          return ((EngineRunScenariosArguments2) bean).getMarketData();
        case -690925309:  // scenarioDefinition
          return ((EngineRunScenariosArguments2) bean).getScenarioDefinition();
        case 1121781064:  // portfolio
          return ((EngineRunScenariosArguments2) bean).getPortfolio();
      }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<EngineRunScenariosArguments2> {
     ...
     */
    private Builder(EngineRunScenariosArguments2 beanToCopy) {
    ...
    @Override
    public EngineRunScenariosArguments2 build() {
      return new EngineRunScenariosArguments2(
          _viewConfig,
