...
public final class SingleValueRequirement extends MarketDataRequirement implements ImmutableBean {
  ...
  public static SingleValueRequirement of(MarketDataId key, ZonedDateTime time) {
    return new SingleValueRequirement(key, MarketDataTime.of(time));
  }

  public static SingleValueRequirement of(MarketDataId key, LocalDate date) {
    return new SingleValueRequirement(key, MarketDataTime.of(date));
  }

  public static SingleValueRequirement of(MarketDataId key) {
    return new SingleValueRequirement(key, MarketDataTime.VALUATION_TIME);
  }

  public static SingleValueRequirement of(MarketDataId key, MarketDataTime time) {
    return new SingleValueRequirement(key, time);
  }
