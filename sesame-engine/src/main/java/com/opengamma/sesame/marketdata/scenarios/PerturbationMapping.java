 ...
 */
@BeanDefinition
public final class PerturbationMapping implements ImmutableBean {
  ...
  private final ImmutableList<Perturbation> _perturbations;
   ...
   */
  public static PerturbationMapping.Builder builder() {
  ...
  @Override
  public PerturbationMapping.Meta metaBean() {
    return PerturbationMapping.Meta.INSTANCE;
  }
   ...
   */
  public ImmutableList<Perturbation> getPerturbations() {
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ImmutableList<Perturbation>> _perturbations = DirectMetaProperty.ofImmutable(
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<ImmutableList<Perturbation>> perturbations() {
      return _perturbations;
    }
   ...
   */
  public static final class Builder extends DirectFieldsBeanBuilder<PerturbationMapping> {

    private MarketDataFilter _filter;
    private List<Perturbation> _perturbations = new ArrayList<Perturbation>();
     ...
     */
    private Builder(PerturbationMapping beanToCopy) {
      this._filter = beanToCopy.getFilter();
      this._perturbations = new ArrayList<Perturbation>(beanToCopy.getPerturbations());
    }
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case -1274492040:  // filter
          ...
          break;
        case 1397849260:  // perturbations
          this._perturbations = (List<Perturbation>) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
     ...
     * @return this, for chaining, not null
     */
    public Builder perturbations(List<Perturbation> perturbations) {
      JodaBeanUtils.notEmpty(perturbations, "perturbations");
     ...
     * @return this, for chaining, not null
     */
    public Builder perturbations(Perturbation... perturbations) {
