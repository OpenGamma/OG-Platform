...
public class MapMarketDataEnvironment<T> implements MarketDataEnvironment<T>, ImmutableBean {
  ...
  private final Map<T, MapMarketDataBundle> _bundles;

  /**
   * Creates a new environment backed by a map.
   *
   * @param bundles a map of market data bundles keyed by scenario ID. Bundles are stored in the map in the order
   *   the scenarios were added
   */
  MapMarketDataEnvironment(LinkedHashMap<T, MapMarketDataBundle> bundles) {
    _bundles = Collections.unmodifiableMap(new LinkedHashMap<>(bundles));
  }
  ...
  protected MapMarketDataEnvironment(MapMarketDataEnvironment.Builder<T> builder) {
    JodaBeanUtils.notNull(builder._bundles, "bundles");
    this._bundles = ImmutableMap.copyOf(builder._bundles);
  }
   ...
   */
  private Map<T, MapMarketDataBundle> getBundles() {
    return _bundles;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(getBundles(), other.getBundles());
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash += hash * 31 + JodaBeanUtils.hashCode(getBundles());
    return hash;
  }
  ...
  protected void toString(StringBuilder buf) {
    buf.append("bundles").append('=').append(JodaBeanUtils.toString(getBundles())).append(',').append(' ');
  }
  ...
  public static class Meta<T> extends DirectMetaBean {
    ...
    /**
     * The meta-property for the {@code bundles} property.
     */
    @SuppressWarnings({"unchecked", "rawtypes" })
    private final MetaProperty<Map<T, MapMarketDataBundle>> _bundles = DirectMetaProperty.ofImmutable(
        this, "bundles", MapMarketDataEnvironment.class, (Class) Map.class);
    /**
     * The meta-properties.
     */
     ...
     */
    public final MetaProperty<Map<T, MapMarketDataBundle>> bundles() {
      return _bundles;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 235331633:  // bundles
          return ((MapMarketDataEnvironment<?>) bean).getBundles();
      }
  ...
  private static class Builder<T> extends DirectFieldsBeanBuilder<MapMarketDataEnvironment<T>> {
    ...
    private Map<T, MapMarketDataBundle> _bundles = new HashMap<T, MapMarketDataBundle>();
    ...
    public Builder<T> set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case 235331633:  // bundles
          this._bundles = (Map<T, MapMarketDataBundle>) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
    ...
    protected void toString(StringBuilder buf) {
      buf.append("bundles").append('=').append(JodaBeanUtils.toString(_bundles)).append(',').append(' ');
    }
