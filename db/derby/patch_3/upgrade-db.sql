...
CREATE UNIQUE INDEX idx_data_point_id_date ON tss_data_point (meta_data_id, ts_date); 
...
CREATE UNIQUE INDEX idx_data_point_delta_id_stamp_date ON tss_data_point_delta (meta_data_id, time_stamp, ts_date);
