...
--DROP SEQUENCE data_provider_sequence;
--DROP SEQUENCE data_field_sequence;
--DROP SEQUENCE observation_time_sequence;
--DROP SEQUENCE time_series_key_sequence;
--DROP SEQUENCE time_series_data_sequence;
--DROP SEQUENCE domain_sequence;
--DROP SEQUENCE domain_spec_identifier_sequence;